...
echo 'add a remote pseudo for the cim-energy-repo repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/cim-energy-repo
