...
public class LoadAggregateValidator {
  ...
  /** factory method */
  public static LoadAggregateValidator getInstance() {
  ...
  public void validate(CreateLoadAggregateCommand loadAggregate) throws Exception {
    ...
    //		Assert.isNull( loadAggregate.getLoadAggregateId(), "CreateLoadAggregateCommand identifier
    // should be null" );
  }
  ...
  public void validate(UpdateLoadAggregateCommand loadAggregate) throws Exception {
    ...
    Assert.notNull(
        loadAggregate.getLoadAggregateId(),
        "UpdateLoadAggregateCommand identifier should not be null");
  }
  ...
  public void validate(DeleteLoadAggregateCommand loadAggregate) throws Exception {
    ...
    Assert.notNull(
        loadAggregate.getLoadAggregateId(),
        "DeleteLoadAggregateCommand identifier should not be null");
  }
  ...
  public void validate(LoadAggregateFetchOneSummary summary) throws Exception {
    ...
    Assert.notNull(
        summary.getLoadAggregateId(), "LoadAggregateFetchOneSummary identifier should not be null");
  }
}
