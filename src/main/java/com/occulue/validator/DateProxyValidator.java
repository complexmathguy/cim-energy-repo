...
public class DateProxyValidator {
  ...
  /** factory method */
  public static DateProxyValidator getInstance() {
  ...
  public void validate(CreateDateProxyCommand dateProxy) throws Exception {
    ...
    //		Assert.isNull( dateProxy.getDateProxyId(), "CreateDateProxyCommand identifier should be
    // null" );
  }
  ...
  public void validate(UpdateDateProxyCommand dateProxy) throws Exception {
    ...
    Assert.notNull(
        dateProxy.getDateProxyId(), "UpdateDateProxyCommand identifier should not be null");
  }
  ...
  public void validate(DeleteDateProxyCommand dateProxy) throws Exception {
    ...
    Assert.notNull(
        dateProxy.getDateProxyId(), "DeleteDateProxyCommand identifier should not be null");
  }
  ...
  public void validate(DateProxyFetchOneSummary summary) throws Exception {
    ...
    Assert.notNull(
        summary.getDateProxyId(), "DateProxyFetchOneSummary identifier should not be null");
  }
}
