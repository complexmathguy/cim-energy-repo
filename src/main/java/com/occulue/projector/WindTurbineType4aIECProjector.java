...
/**
 * Projector for WindTurbineType4aIEC as outlined for the CQRS pattern. All event handling and query
 * handling related to WindTurbineType4aIEC are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class WindTurbineType4aIECProjector extends WindTurbineType4aIECEntityProjector {
  ...
  // core constructor
  public WindTurbineType4aIECProjector(
      WindTurbineType4aIECRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<WindTurbineType4aIEC> handle(FindAllWindTurbineType4aIECQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindWindTurbineType4aIEC, but only if the id matches
   *
  ...
  protected void emitFindWindTurbineType4aIEC(WindTurbineType4aIEC entity) {
    ...
    queryUpdateEmitter.emit(
        FindWindTurbineType4aIECQuery.class,
        query ->
            query
                .getFilter()
                .getWindTurbineType4aIECId()
                .equals(entity.getWindTurbineType4aIECId()),
        entity);
  }
  ...
  protected void emitFindAllWindTurbineType4aIEC(WindTurbineType4aIEC entity) {
    ...
    queryUpdateEmitter.emit(FindAllWindTurbineType4aIECQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType4aIECProjector.class.getName());
}
