...
/**
 * Projector for ConnectivityNodeContainer as outlined for the CQRS pattern. All event handling and
 * query handling related to ConnectivityNodeContainer are invoked here and dispersed as an event to
 * be handled elsewhere.
 *
 * <p>Commands are handled by ConnectivityNodeContainerAggregate
 *
...
public class ConnectivityNodeContainerProjector extends ConnectivityNodeContainerEntityProjector {
  ...
  // core constructor
  public ConnectivityNodeContainerProjector(
      ConnectivityNodeContainerRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<ConnectivityNodeContainer> handle(FindAllConnectivityNodeContainerQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindConnectivityNodeContainer, but only if the id matches
   *
  ...
  protected void emitFindConnectivityNodeContainer(ConnectivityNodeContainer entity) {
    ...
    queryUpdateEmitter.emit(
        FindConnectivityNodeContainerQuery.class,
        query ->
            query
                .getFilter()
                .getConnectivityNodeContainerId()
                .equals(entity.getConnectivityNodeContainerId()),
        entity);
  }
  ...
  protected void emitFindAllConnectivityNodeContainer(ConnectivityNodeContainer entity) {
    ...
    queryUpdateEmitter.emit(FindAllConnectivityNodeContainerQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ConnectivityNodeContainerProjector.class.getName());
}
