...
/**
 * Projector for WindType1or2UserDefined as outlined for the CQRS pattern. All event handling and
 * query handling related to WindType1or2UserDefined are invoked here and dispersed as an event to
...
public class WindType1or2UserDefinedProjector extends WindType1or2UserDefinedEntityProjector {
  ...
  // core constructor
  public WindType1or2UserDefinedProjector(
      WindType1or2UserDefinedRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignProprietaryToWindType1or2UserDefinedEvent
   */
  @EventHandler(payloadType = AssignProprietaryToWindType1or2UserDefinedEvent.class)
  public void handle(AssignProprietaryToWindType1or2UserDefinedEvent event) {
    LOGGER.info("handling AssignProprietaryToWindType1or2UserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindType1or2UserDefined entity =
        assignProprietary(event.getWindType1or2UserDefinedId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignProprietaryFromWindType1or2UserDefinedEvent
   */
  @EventHandler(payloadType = UnAssignProprietaryFromWindType1or2UserDefinedEvent.class)
  public void handle(UnAssignProprietaryFromWindType1or2UserDefinedEvent event) {
    LOGGER.info("handling UnAssignProprietaryFromWindType1or2UserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    WindType1or2UserDefined entity = unAssignProprietary(event.getWindType1or2UserDefinedId());
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<WindType1or2UserDefined> handle(FindAllWindType1or2UserDefinedQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindWindType1or2UserDefined, but only if the id matches
   *
  ...
  protected void emitFindWindType1or2UserDefined(WindType1or2UserDefined entity) {
    ...
    queryUpdateEmitter.emit(
        FindWindType1or2UserDefinedQuery.class,
        query ->
            query
                .getFilter()
                .getWindType1or2UserDefinedId()
                .equals(entity.getWindType1or2UserDefinedId()),
        entity);
  }
  ...
  protected void emitFindAllWindType1or2UserDefined(WindType1or2UserDefined entity) {
    ...
    queryUpdateEmitter.emit(FindAllWindType1or2UserDefinedQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindType1or2UserDefinedProjector.class.getName());
}
