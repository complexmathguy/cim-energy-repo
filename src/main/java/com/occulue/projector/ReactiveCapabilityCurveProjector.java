...
/**
 * Projector for ReactiveCapabilityCurve as outlined for the CQRS pattern. All event handling and
 * query handling related to ReactiveCapabilityCurve are invoked here and dispersed as an event to
...
public class ReactiveCapabilityCurveProjector extends ReactiveCapabilityCurveEntityProjector {
  ...
  // core constructor
  public ReactiveCapabilityCurveProjector(
      ReactiveCapabilityCurveRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<ReactiveCapabilityCurve> handle(FindAllReactiveCapabilityCurveQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindReactiveCapabilityCurve, but only if the id matches
   *
  ...
  protected void emitFindReactiveCapabilityCurve(ReactiveCapabilityCurve entity) {
    ...
    queryUpdateEmitter.emit(
        FindReactiveCapabilityCurveQuery.class,
        query ->
            query
                .getFilter()
                .getReactiveCapabilityCurveId()
                .equals(entity.getReactiveCapabilityCurveId()),
        entity);
  }
  ...
  protected void emitFindAllReactiveCapabilityCurve(ReactiveCapabilityCurve entity) {
    ...
    queryUpdateEmitter.emit(FindAllReactiveCapabilityCurveQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ReactiveCapabilityCurveProjector.class.getName());
}
