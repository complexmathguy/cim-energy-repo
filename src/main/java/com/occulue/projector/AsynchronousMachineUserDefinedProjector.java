...
/**
 * Projector for AsynchronousMachineUserDefined as outlined for the CQRS pattern. All event handling
 * and query handling related to AsynchronousMachineUserDefined are invoked here and dispersed as an
...
public class AsynchronousMachineUserDefinedProjector
    extends AsynchronousMachineUserDefinedEntityProjector {

  // core constructor
  public AsynchronousMachineUserDefinedProjector(
      AsynchronousMachineUserDefinedRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignProprietaryToAsynchronousMachineUserDefinedEvent
   */
  @EventHandler(payloadType = AssignProprietaryToAsynchronousMachineUserDefinedEvent.class)
  public void handle(AssignProprietaryToAsynchronousMachineUserDefinedEvent event) {
    LOGGER.info("handling AssignProprietaryToAsynchronousMachineUserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    AsynchronousMachineUserDefined entity =
        assignProprietary(event.getAsynchronousMachineUserDefinedId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignProprietaryFromAsynchronousMachineUserDefinedEvent
   */
  @EventHandler(payloadType = UnAssignProprietaryFromAsynchronousMachineUserDefinedEvent.class)
  public void handle(UnAssignProprietaryFromAsynchronousMachineUserDefinedEvent event) {
    LOGGER.info("handling UnAssignProprietaryFromAsynchronousMachineUserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    AsynchronousMachineUserDefined entity =
        unAssignProprietary(event.getAsynchronousMachineUserDefinedId());
   ...
   * AsynchronousMachineUserDefinedPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<AsynchronousMachineUserDefined> handle(
      FindAllAsynchronousMachineUserDefinedQuery query) throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindAsynchronousMachineUserDefined, but only if the id
   * matches
   *
  ...
  protected void emitFindAsynchronousMachineUserDefined(AsynchronousMachineUserDefined entity) {
    ...
    queryUpdateEmitter.emit(
        FindAsynchronousMachineUserDefinedQuery.class,
        query ->
            query
                .getFilter()
                .getAsynchronousMachineUserDefinedId()
                .equals(entity.getAsynchronousMachineUserDefinedId()),
        entity);
  }
  ...
  protected void emitFindAllAsynchronousMachineUserDefined(AsynchronousMachineUserDefined entity) {
    ...
    queryUpdateEmitter.emit(
        FindAllAsynchronousMachineUserDefinedQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(AsynchronousMachineUserDefinedProjector.class.getName());
}
