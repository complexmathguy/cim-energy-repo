...
/**
 * Projector for ExcitationSystemUserDefined as outlined for the CQRS pattern. All event handling
 * and query handling related to ExcitationSystemUserDefined are invoked here and dispersed as an
...
public class ExcitationSystemUserDefinedProjector
    extends ExcitationSystemUserDefinedEntityProjector {

  // core constructor
  public ExcitationSystemUserDefinedProjector(
      ExcitationSystemUserDefinedRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignProprietaryToExcitationSystemUserDefinedEvent
   */
  @EventHandler(payloadType = AssignProprietaryToExcitationSystemUserDefinedEvent.class)
  public void handle(AssignProprietaryToExcitationSystemUserDefinedEvent event) {
    LOGGER.info("handling AssignProprietaryToExcitationSystemUserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    ExcitationSystemUserDefined entity =
        assignProprietary(event.getExcitationSystemUserDefinedId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignProprietaryFromExcitationSystemUserDefinedEvent
   */
  @EventHandler(payloadType = UnAssignProprietaryFromExcitationSystemUserDefinedEvent.class)
  public void handle(UnAssignProprietaryFromExcitationSystemUserDefinedEvent event) {
    LOGGER.info("handling UnAssignProprietaryFromExcitationSystemUserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    ExcitationSystemUserDefined entity =
        unAssignProprietary(event.getExcitationSystemUserDefinedId());
  ...
  /**
   * Method to retrieve the ExcitationSystemUserDefined via an
   * ExcitationSystemUserDefinedPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<ExcitationSystemUserDefined> handle(FindAllExcitationSystemUserDefinedQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindExcitationSystemUserDefined, but only if the id
   * matches
   *
  ...
  protected void emitFindExcitationSystemUserDefined(ExcitationSystemUserDefined entity) {
    ...
    queryUpdateEmitter.emit(
        FindExcitationSystemUserDefinedQuery.class,
        query ->
            query
                .getFilter()
                .getExcitationSystemUserDefinedId()
                .equals(entity.getExcitationSystemUserDefinedId()),
        entity);
  }
  ...
  protected void emitFindAllExcitationSystemUserDefined(ExcitationSystemUserDefined entity) {
    ...
    queryUpdateEmitter.emit(FindAllExcitationSystemUserDefinedQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ExcitationSystemUserDefinedProjector.class.getName());
}
