...
/**
 * Projector for ENTSOEOperationalLimitType as outlined for the CQRS pattern. All event handling and
 * query handling related to ENTSOEOperationalLimitType are invoked here and dispersed as an event
...
public class ENTSOEOperationalLimitTypeProjector extends ENTSOEOperationalLimitTypeEntityProjector {
  ...
  // core constructor
  public ENTSOEOperationalLimitTypeProjector(
      ENTSOEOperationalLimitTypeRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<ENTSOEOperationalLimitType> handle(FindAllENTSOEOperationalLimitTypeQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindENTSOEOperationalLimitType, but only if the id matches
   *
  ...
  protected void emitFindENTSOEOperationalLimitType(ENTSOEOperationalLimitType entity) {
    ...
    queryUpdateEmitter.emit(
        FindENTSOEOperationalLimitTypeQuery.class,
        query ->
            query
                .getFilter()
                .getENTSOEOperationalLimitTypeId()
                .equals(entity.getENTSOEOperationalLimitTypeId()),
        entity);
  }
  ...
  protected void emitFindAllENTSOEOperationalLimitType(ENTSOEOperationalLimitType entity) {
    ...
    queryUpdateEmitter.emit(FindAllENTSOEOperationalLimitTypeQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ENTSOEOperationalLimitTypeProjector.class.getName());
}
