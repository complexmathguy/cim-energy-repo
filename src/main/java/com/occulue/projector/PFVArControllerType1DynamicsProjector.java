...
/**
 * Projector for PFVArControllerType1Dynamics as outlined for the CQRS pattern. All event handling
 * and query handling related to PFVArControllerType1Dynamics are invoked here and dispersed as an
...
public class PFVArControllerType1DynamicsProjector
    extends PFVArControllerType1DynamicsEntityProjector {

  // core constructor
  public PFVArControllerType1DynamicsProjector(
      PFVArControllerType1DynamicsRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
   ...
   * PFVArControllerType1DynamicsPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<PFVArControllerType1Dynamics> handle(FindAllPFVArControllerType1DynamicsQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindPFVArControllerType1Dynamics, but only if the id
   * matches
   *
  ...
  protected void emitFindPFVArControllerType1Dynamics(PFVArControllerType1Dynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindPFVArControllerType1DynamicsQuery.class,
        query ->
            query
                .getFilter()
                .getPFVArControllerType1DynamicsId()
                .equals(entity.getPFVArControllerType1DynamicsId()),
        entity);
  }
  ...
  protected void emitFindAllPFVArControllerType1Dynamics(PFVArControllerType1Dynamics entity) {
    ...
    queryUpdateEmitter.emit(FindAllPFVArControllerType1DynamicsQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArControllerType1DynamicsProjector.class.getName());
}
