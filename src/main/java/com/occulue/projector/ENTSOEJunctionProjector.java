...
/**
 * Projector for ENTSOEJunction as outlined for the CQRS pattern. All event handling and query
 * handling related to ENTSOEJunction are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class ENTSOEJunctionProjector extends ENTSOEJunctionEntityProjector {
  ...
  // core constructor
  public ENTSOEJunctionProjector(
      ENTSOEJunctionRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /**
   * emit to subscription queries of type FindENTSOEJunction, but only if the id matches
   *
  ...
  protected void emitFindAllENTSOEJunction(ENTSOEJunction entity) {
    ...
    queryUpdateEmitter.emit(FindAllENTSOEJunctionQuery.class, query -> true, entity);
  }
