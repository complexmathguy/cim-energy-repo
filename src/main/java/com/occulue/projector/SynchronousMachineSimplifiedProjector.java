...
/**
 * Projector for SynchronousMachineSimplified as outlined for the CQRS pattern. All event handling
 * and query handling related to SynchronousMachineSimplified are invoked here and dispersed as an
 * event to be handled elsewhere.
 *
 * <p>Commands are handled by SynchronousMachineSimplifiedAggregate
 *
 * @author your_name_here
 */
// @ProcessingGroup("synchronousMachineSimplified")
@Component("synchronousMachineSimplified-projector")
public class SynchronousMachineSimplifiedProjector
    extends SynchronousMachineSimplifiedEntityProjector {

  // core constructor
  public SynchronousMachineSimplifiedProjector(
      SynchronousMachineSimplifiedRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /**
   * Method to retrieve the SynchronousMachineSimplified via an
   * SynchronousMachineSimplifiedPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<SynchronousMachineSimplified> handle(FindAllSynchronousMachineSimplifiedQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindSynchronousMachineSimplified, but only if the id
   * matches
   *
  ...
  protected void emitFindSynchronousMachineSimplified(SynchronousMachineSimplified entity) {
    ...
    queryUpdateEmitter.emit(
        FindSynchronousMachineSimplifiedQuery.class,
        query ->
            query
                .getFilter()
                .getSynchronousMachineSimplifiedId()
                .equals(entity.getSynchronousMachineSimplifiedId()),
        entity);
  }
  ...
  protected void emitFindAllSynchronousMachineSimplified(SynchronousMachineSimplified entity) {
    ...
    queryUpdateEmitter.emit(FindAllSynchronousMachineSimplifiedQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineSimplifiedProjector.class.getName());
}
