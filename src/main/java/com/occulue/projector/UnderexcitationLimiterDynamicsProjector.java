...
/**
 * Projector for UnderexcitationLimiterDynamics as outlined for the CQRS pattern. All event handling
 * and query handling related to UnderexcitationLimiterDynamics are invoked here and dispersed as an
...
public class UnderexcitationLimiterDynamicsProjector
    extends UnderexcitationLimiterDynamicsEntityProjector {

  // core constructor
  public UnderexcitationLimiterDynamicsProjector(
      UnderexcitationLimiterDynamicsRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
   ...
   * UnderexcitationLimiterDynamicsPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<UnderexcitationLimiterDynamics> handle(
      FindAllUnderexcitationLimiterDynamicsQuery query) throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindUnderexcitationLimiterDynamics, but only if the id
   * matches
   *
  ...
  protected void emitFindUnderexcitationLimiterDynamics(UnderexcitationLimiterDynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindUnderexcitationLimiterDynamicsQuery.class,
        query ->
            query
                .getFilter()
                .getUnderexcitationLimiterDynamicsId()
                .equals(entity.getUnderexcitationLimiterDynamicsId()),
        entity);
  }
  ...
  protected void emitFindAllUnderexcitationLimiterDynamics(UnderexcitationLimiterDynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindAllUnderexcitationLimiterDynamicsQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(UnderexcitationLimiterDynamicsProjector.class.getName());
}
