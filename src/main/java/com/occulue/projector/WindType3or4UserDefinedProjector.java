...
/**
 * Projector for WindType3or4UserDefined as outlined for the CQRS pattern. All event handling and
 * query handling related to WindType3or4UserDefined are invoked here and dispersed as an event to
...
public class WindType3or4UserDefinedProjector extends WindType3or4UserDefinedEntityProjector {
  ...
  // core constructor
  public WindType3or4UserDefinedProjector(
      WindType3or4UserDefinedRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignProprietaryToWindType3or4UserDefinedEvent
   */
  @EventHandler(payloadType = AssignProprietaryToWindType3or4UserDefinedEvent.class)
  public void handle(AssignProprietaryToWindType3or4UserDefinedEvent event) {
    LOGGER.info("handling AssignProprietaryToWindType3or4UserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    WindType3or4UserDefined entity =
        assignProprietary(event.getWindType3or4UserDefinedId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignProprietaryFromWindType3or4UserDefinedEvent
   */
  @EventHandler(payloadType = UnAssignProprietaryFromWindType3or4UserDefinedEvent.class)
  public void handle(UnAssignProprietaryFromWindType3or4UserDefinedEvent event) {
    LOGGER.info("handling UnAssignProprietaryFromWindType3or4UserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    WindType3or4UserDefined entity = unAssignProprietary(event.getWindType3or4UserDefinedId());
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<WindType3or4UserDefined> handle(FindAllWindType3or4UserDefinedQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindWindType3or4UserDefined, but only if the id matches
   *
  ...
  protected void emitFindWindType3or4UserDefined(WindType3or4UserDefined entity) {
    ...
    queryUpdateEmitter.emit(
        FindWindType3or4UserDefinedQuery.class,
        query ->
            query
                .getFilter()
                .getWindType3or4UserDefinedId()
                .equals(entity.getWindType3or4UserDefinedId()),
        entity);
  }
  ...
  protected void emitFindAllWindType3or4UserDefined(WindType3or4UserDefined entity) {
    ...
    queryUpdateEmitter.emit(FindAllWindType3or4UserDefinedQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindType3or4UserDefinedProjector.class.getName());
}
