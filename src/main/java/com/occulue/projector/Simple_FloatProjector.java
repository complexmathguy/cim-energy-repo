...
/**
 * Projector for Simple_Float as outlined for the CQRS pattern. All event handling and query
 * handling related to Simple_Float are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class Simple_FloatProjector extends Simple_FloatEntityProjector {
  ...
  // core constructor
  public Simple_FloatProjector(
      Simple_FloatRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignValueToSimple_FloatEvent
   */
  @EventHandler(payloadType = AssignValueToSimple_FloatEvent.class)
  public void handle(AssignValueToSimple_FloatEvent event) {
    LOGGER.info("handling AssignValueToSimple_FloatEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    Simple_Float entity = assignValue(event.getSimple_FloatId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignValueFromSimple_FloatEvent
   */
  @EventHandler(payloadType = UnAssignValueFromSimple_FloatEvent.class)
  public void handle(UnAssignValueFromSimple_FloatEvent event) {
    LOGGER.info("handling UnAssignValueFromSimple_FloatEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    Simple_Float entity = unAssignValue(event.getSimple_FloatId());
  ...
  /**
   * emit to subscription queries of type FindSimple_Float, but only if the id matches
   *
  ...
  protected void emitFindAllSimple_Float(Simple_Float entity) {
    ...
    queryUpdateEmitter.emit(FindAllSimple_FloatQuery.class, query -> true, entity);
  }
