...
/**
 * Projector for RemoteInputSignal as outlined for the CQRS pattern. All event handling and query
 * handling related to RemoteInputSignal are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class RemoteInputSignalProjector extends RemoteInputSignalEntityProjector {
  ...
  // core constructor
  public RemoteInputSignalProjector(
      RemoteInputSignalRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<RemoteInputSignal> handle(FindAllRemoteInputSignalQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindRemoteInputSignal, but only if the id matches
   *
  ...
  protected void emitFindRemoteInputSignal(RemoteInputSignal entity) {
    ...
    queryUpdateEmitter.emit(
        FindRemoteInputSignalQuery.class,
  ...
  protected void emitFindAllRemoteInputSignal(RemoteInputSignal entity) {
    ...
    queryUpdateEmitter.emit(FindAllRemoteInputSignalQuery.class, query -> true, entity);
  }
