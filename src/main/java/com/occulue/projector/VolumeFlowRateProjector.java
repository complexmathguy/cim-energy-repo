...
/**
 * Projector for VolumeFlowRate as outlined for the CQRS pattern. All event handling and query
 * handling related to VolumeFlowRate are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class VolumeFlowRateProjector extends VolumeFlowRateEntityProjector {
  ...
  // core constructor
  public VolumeFlowRateProjector(
      VolumeFlowRateRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignValueToVolumeFlowRateEvent
   */
  @EventHandler(payloadType = AssignValueToVolumeFlowRateEvent.class)
  public void handle(AssignValueToVolumeFlowRateEvent event) {
    LOGGER.info("handling AssignValueToVolumeFlowRateEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    VolumeFlowRate entity = assignValue(event.getVolumeFlowRateId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignValueFromVolumeFlowRateEvent
   */
  @EventHandler(payloadType = UnAssignValueFromVolumeFlowRateEvent.class)
  public void handle(UnAssignValueFromVolumeFlowRateEvent event) {
    LOGGER.info("handling UnAssignValueFromVolumeFlowRateEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    VolumeFlowRate entity = unAssignValue(event.getVolumeFlowRateId());
  ...
  /**
   * emit to subscription queries of type FindVolumeFlowRate, but only if the id matches
   *
  ...
  protected void emitFindAllVolumeFlowRate(VolumeFlowRate entity) {
    ...
    queryUpdateEmitter.emit(FindAllVolumeFlowRateQuery.class, query -> true, entity);
  }
