...
/**
 * Projector for ConformLoadGroup as outlined for the CQRS pattern. All event handling and query
 * handling related to ConformLoadGroup are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
 * <p>Commands are handled by ConformLoadGroupAggregate
 *
...
public class ConformLoadGroupProjector extends ConformLoadGroupEntityProjector {
  ...
  // core constructor
  public ConformLoadGroupProjector(
      ConformLoadGroupRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<ConformLoadGroup> handle(FindAllConformLoadGroupQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindConformLoadGroup, but only if the id matches
   *
  ...
  protected void emitFindConformLoadGroup(ConformLoadGroup entity) {
    ...
    queryUpdateEmitter.emit(
        FindConformLoadGroupQuery.class,
  ...
  protected void emitFindAllConformLoadGroup(ConformLoadGroup entity) {
    ...
    queryUpdateEmitter.emit(FindAllConformLoadGroupQuery.class, query -> true, entity);
  }
