...
/**
 * Projector for DCTopologicalNode as outlined for the CQRS pattern. All event handling and query
 * handling related to DCTopologicalNode are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class DCTopologicalNodeProjector extends DCTopologicalNodeEntityProjector {
  ...
  // core constructor
  public DCTopologicalNodeProjector(
      DCTopologicalNodeRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<DCTopologicalNode> handle(FindAllDCTopologicalNodeQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindDCTopologicalNode, but only if the id matches
   *
  ...
  protected void emitFindDCTopologicalNode(DCTopologicalNode entity) {
    ...
    queryUpdateEmitter.emit(
        FindDCTopologicalNodeQuery.class,
  ...
  protected void emitFindAllDCTopologicalNode(DCTopologicalNode entity) {
    ...
    queryUpdateEmitter.emit(FindAllDCTopologicalNodeQuery.class, query -> true, entity);
  }
