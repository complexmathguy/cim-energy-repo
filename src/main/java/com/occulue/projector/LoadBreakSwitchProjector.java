...
/**
 * Projector for LoadBreakSwitch as outlined for the CQRS pattern. All event handling and query
 * handling related to LoadBreakSwitch are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class LoadBreakSwitchProjector extends LoadBreakSwitchEntityProjector {
  ...
  // core constructor
  public LoadBreakSwitchProjector(
      LoadBreakSwitchRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<LoadBreakSwitch> handle(FindAllLoadBreakSwitchQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindLoadBreakSwitch, but only if the id matches
   *
  ...
  protected void emitFindLoadBreakSwitch(LoadBreakSwitch entity) {
    ...
    queryUpdateEmitter.emit(
        FindLoadBreakSwitchQuery.class,
  ...
  protected void emitFindAllLoadBreakSwitch(LoadBreakSwitch entity) {
    ...
    queryUpdateEmitter.emit(FindAllLoadBreakSwitchQuery.class, query -> true, entity);
  }
