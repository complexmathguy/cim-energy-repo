...
/**
 * Projector for SynchronousMachineDynamics as outlined for the CQRS pattern. All event handling and
 * query handling related to SynchronousMachineDynamics are invoked here and dispersed as an event
...
public class SynchronousMachineDynamicsProjector extends SynchronousMachineDynamicsEntityProjector {
  ...
  // core constructor
  public SynchronousMachineDynamicsProjector(
      SynchronousMachineDynamicsRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<SynchronousMachineDynamics> handle(FindAllSynchronousMachineDynamicsQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindSynchronousMachineDynamics, but only if the id matches
   *
  ...
  protected void emitFindSynchronousMachineDynamics(SynchronousMachineDynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindSynchronousMachineDynamicsQuery.class,
        query ->
            query
                .getFilter()
                .getSynchronousMachineDynamicsId()
                .equals(entity.getSynchronousMachineDynamicsId()),
        entity);
  }
  ...
  protected void emitFindAllSynchronousMachineDynamics(SynchronousMachineDynamics entity) {
    ...
    queryUpdateEmitter.emit(FindAllSynchronousMachineDynamicsQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineDynamicsProjector.class.getName());
}
