...
/**
 * Projector for TurbineGovernorDynamics as outlined for the CQRS pattern. All event handling and
 * query handling related to TurbineGovernorDynamics are invoked here and dispersed as an event to
...
public class TurbineGovernorDynamicsProjector extends TurbineGovernorDynamicsEntityProjector {
  ...
  // core constructor
  public TurbineGovernorDynamicsProjector(
      TurbineGovernorDynamicsRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<TurbineGovernorDynamics> handle(FindAllTurbineGovernorDynamicsQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindTurbineGovernorDynamics, but only if the id matches
   *
  ...
  protected void emitFindTurbineGovernorDynamics(TurbineGovernorDynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindTurbineGovernorDynamicsQuery.class,
        query ->
            query
                .getFilter()
                .getTurbineGovernorDynamicsId()
                .equals(entity.getTurbineGovernorDynamicsId()),
        entity);
  }
  ...
  protected void emitFindAllTurbineGovernorDynamics(TurbineGovernorDynamics entity) {
    ...
    queryUpdateEmitter.emit(FindAllTurbineGovernorDynamicsQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(TurbineGovernorDynamicsProjector.class.getName());
}
