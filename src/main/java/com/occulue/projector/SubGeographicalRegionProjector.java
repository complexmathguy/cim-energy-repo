...
/**
 * Projector for SubGeographicalRegion as outlined for the CQRS pattern. All event handling and
 * query handling related to SubGeographicalRegion are invoked here and dispersed as an event to be
 * handled elsewhere.
 *
...
public class SubGeographicalRegionProjector extends SubGeographicalRegionEntityProjector {
  ...
  // core constructor
  public SubGeographicalRegionProjector(
      SubGeographicalRegionRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<SubGeographicalRegion> handle(FindAllSubGeographicalRegionQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindSubGeographicalRegion, but only if the id matches
   *
  ...
  protected void emitFindSubGeographicalRegion(SubGeographicalRegion entity) {
    ...
    queryUpdateEmitter.emit(
        FindSubGeographicalRegionQuery.class,
        query ->
            query
                .getFilter()
                .getSubGeographicalRegionId()
                .equals(entity.getSubGeographicalRegionId()),
        entity);
  }
  ...
  protected void emitFindAllSubGeographicalRegion(SubGeographicalRegion entity) {
    ...
    queryUpdateEmitter.emit(FindAllSubGeographicalRegionQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SubGeographicalRegionProjector.class.getName());
}
