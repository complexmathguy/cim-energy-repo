...
/**
 * Projector for TapChangerControl as outlined for the CQRS pattern. All event handling and query
 * handling related to TapChangerControl are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
 * <p>Commands are handled by TapChangerControlAggregate
 *
...
public class TapChangerControlProjector extends TapChangerControlEntityProjector {
  ...
  // core constructor
  public TapChangerControlProjector(
      TapChangerControlRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<TapChangerControl> handle(FindAllTapChangerControlQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindTapChangerControl, but only if the id matches
   *
  ...
  protected void emitFindTapChangerControl(TapChangerControl entity) {
    ...
    queryUpdateEmitter.emit(
        FindTapChangerControlQuery.class,
  ...
  protected void emitFindAllTapChangerControl(TapChangerControl entity) {
    ...
    queryUpdateEmitter.emit(FindAllTapChangerControlQuery.class, query -> true, entity);
  }
