...
/**
 * Projector for VsCapabilityCurve as outlined for the CQRS pattern. All event handling and query
 * handling related to VsCapabilityCurve are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
 * <p>Commands are handled by VsCapabilityCurveAggregate
 *
...
public class VsCapabilityCurveProjector extends VsCapabilityCurveEntityProjector {
  ...
  // core constructor
  public VsCapabilityCurveProjector(
      VsCapabilityCurveRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<VsCapabilityCurve> handle(FindAllVsCapabilityCurveQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindVsCapabilityCurve, but only if the id matches
   *
  ...
  protected void emitFindVsCapabilityCurve(VsCapabilityCurve entity) {
    ...
    queryUpdateEmitter.emit(
        FindVsCapabilityCurveQuery.class,
  ...
  protected void emitFindAllVsCapabilityCurve(VsCapabilityCurve entity) {
    ...
    queryUpdateEmitter.emit(FindAllVsCapabilityCurveQuery.class, query -> true, entity);
  }
