...
/**
 * Projector for WindTurbineType3or4IEC as outlined for the CQRS pattern. All event handling and
 * query handling related to WindTurbineType3or4IEC are invoked here and dispersed as an event to be
 * handled elsewhere.
 *
...
public class WindTurbineType3or4IECProjector extends WindTurbineType3or4IECEntityProjector {
  ...
  // core constructor
  public WindTurbineType3or4IECProjector(
      WindTurbineType3or4IECRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<WindTurbineType3or4IEC> handle(FindAllWindTurbineType3or4IECQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindWindTurbineType3or4IEC, but only if the id matches
   *
  ...
  protected void emitFindWindTurbineType3or4IEC(WindTurbineType3or4IEC entity) {
    ...
    queryUpdateEmitter.emit(
        FindWindTurbineType3or4IECQuery.class,
        query ->
            query
                .getFilter()
                .getWindTurbineType3or4IECId()
                .equals(entity.getWindTurbineType3or4IECId()),
        entity);
  }
  ...
  protected void emitFindAllWindTurbineType3or4IEC(WindTurbineType3or4IEC entity) {
    ...
    queryUpdateEmitter.emit(FindAllWindTurbineType3or4IECQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType3or4IECProjector.class.getName());
}
