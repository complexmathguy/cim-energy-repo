...
/**
 * Projector for OverexcitationLimiterDynamics as outlined for the CQRS pattern. All event handling
 * and query handling related to OverexcitationLimiterDynamics are invoked here and dispersed as an
...
public class OverexcitationLimiterDynamicsProjector
    extends OverexcitationLimiterDynamicsEntityProjector {

  // core constructor
  public OverexcitationLimiterDynamicsProjector(
      OverexcitationLimiterDynamicsRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
   ...
   * OverexcitationLimiterDynamicsPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<OverexcitationLimiterDynamics> handle(FindAllOverexcitationLimiterDynamicsQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindOverexcitationLimiterDynamics, but only if the id
   * matches
   *
  ...
  protected void emitFindOverexcitationLimiterDynamics(OverexcitationLimiterDynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindOverexcitationLimiterDynamicsQuery.class,
        query ->
            query
                .getFilter()
                .getOverexcitationLimiterDynamicsId()
                .equals(entity.getOverexcitationLimiterDynamicsId()),
        entity);
  }
  ...
  protected void emitFindAllOverexcitationLimiterDynamics(OverexcitationLimiterDynamics entity) {
    ...
    queryUpdateEmitter.emit(FindAllOverexcitationLimiterDynamicsQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(OverexcitationLimiterDynamicsProjector.class.getName());
}
