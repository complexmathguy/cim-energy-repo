...
/**
 * Projector for WindGenTurbineType1IEC as outlined for the CQRS pattern. All event handling and
 * query handling related to WindGenTurbineType1IEC are invoked here and dispersed as an event to be
 * handled elsewhere.
 *
...
public class WindGenTurbineType1IECProjector extends WindGenTurbineType1IECEntityProjector {
  ...
  // core constructor
  public WindGenTurbineType1IECProjector(
      WindGenTurbineType1IECRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<WindGenTurbineType1IEC> handle(FindAllWindGenTurbineType1IECQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindWindGenTurbineType1IEC, but only if the id matches
   *
  ...
  protected void emitFindWindGenTurbineType1IEC(WindGenTurbineType1IEC entity) {
    ...
    queryUpdateEmitter.emit(
        FindWindGenTurbineType1IECQuery.class,
        query ->
            query
                .getFilter()
                .getWindGenTurbineType1IECId()
                .equals(entity.getWindGenTurbineType1IECId()),
        entity);
  }
  ...
  protected void emitFindAllWindGenTurbineType1IEC(WindGenTurbineType1IEC entity) {
    ...
    queryUpdateEmitter.emit(FindAllWindGenTurbineType1IECQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindGenTurbineType1IECProjector.class.getName());
}
