...
/**
 * Projector for WindTurbineType3or4Dynamics as outlined for the CQRS pattern. All event handling
 * and query handling related to WindTurbineType3or4Dynamics are invoked here and dispersed as an
...
public class WindTurbineType3or4DynamicsProjector
    extends WindTurbineType3or4DynamicsEntityProjector {

  // core constructor
  public WindTurbineType3or4DynamicsProjector(
      WindTurbineType3or4DynamicsRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /**
   * Method to retrieve the WindTurbineType3or4Dynamics via an
   * WindTurbineType3or4DynamicsPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<WindTurbineType3or4Dynamics> handle(FindAllWindTurbineType3or4DynamicsQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindWindTurbineType3or4Dynamics, but only if the id
   * matches
   *
  ...
  protected void emitFindWindTurbineType3or4Dynamics(WindTurbineType3or4Dynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindWindTurbineType3or4DynamicsQuery.class,
        query ->
            query
                .getFilter()
                .getWindTurbineType3or4DynamicsId()
                .equals(entity.getWindTurbineType3or4DynamicsId()),
        entity);
  }
  ...
  protected void emitFindAllWindTurbineType3or4Dynamics(WindTurbineType3or4Dynamics entity) {
    ...
    queryUpdateEmitter.emit(FindAllWindTurbineType3or4DynamicsQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType3or4DynamicsProjector.class.getName());
}
