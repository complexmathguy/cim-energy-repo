...
/**
 * Projector for DCConductingEquipment as outlined for the CQRS pattern. All event handling and
 * query handling related to DCConductingEquipment are invoked here and dispersed as an event to be
 * handled elsewhere.
 *
...
public class DCConductingEquipmentProjector extends DCConductingEquipmentEntityProjector {
  ...
  // core constructor
  public DCConductingEquipmentProjector(
      DCConductingEquipmentRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<DCConductingEquipment> handle(FindAllDCConductingEquipmentQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindDCConductingEquipment, but only if the id matches
   *
  ...
  protected void emitFindDCConductingEquipment(DCConductingEquipment entity) {
    ...
    queryUpdateEmitter.emit(
        FindDCConductingEquipmentQuery.class,
        query ->
            query
                .getFilter()
                .getDCConductingEquipmentId()
                .equals(entity.getDCConductingEquipmentId()),
        entity);
  }
  ...
  protected void emitFindAllDCConductingEquipment(DCConductingEquipment entity) {
    ...
    queryUpdateEmitter.emit(FindAllDCConductingEquipmentQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DCConductingEquipmentProjector.class.getName());
}
