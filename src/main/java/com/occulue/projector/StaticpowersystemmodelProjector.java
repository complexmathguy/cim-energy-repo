...
/**
 * Projector for Staticpowersystemmodel as outlined for the CQRS pattern. All event handling and
 * query handling related to Staticpowersystemmodel are invoked here and dispersed as an event to be
 * handled elsewhere.
 *
 * <p>Commands are handled by StaticpowersystemmodelAggregate
 *
...
public class StaticpowersystemmodelProjector extends StaticpowersystemmodelEntityProjector {
  ...
  // core constructor
  public StaticpowersystemmodelProjector(
      StaticpowersystemmodelRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<Staticpowersystemmodel> handle(FindAllStaticpowersystemmodelQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindStaticpowersystemmodel, but only if the id matches
   *
  ...
  protected void emitFindStaticpowersystemmodel(Staticpowersystemmodel entity) {
    ...
    queryUpdateEmitter.emit(
        FindStaticpowersystemmodelQuery.class,
        query ->
            query
                .getFilter()
                .getStaticpowersystemmodelId()
                .equals(entity.getStaticpowersystemmodelId()),
        entity);
  }
  ...
  protected void emitFindAllStaticpowersystemmodel(Staticpowersystemmodel entity) {
    ...
    queryUpdateEmitter.emit(FindAllStaticpowersystemmodelQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(StaticpowersystemmodelProjector.class.getName());
}
