...
public class StaticpowersystemmodelEntityProjector {
  ...
  public List<Staticpowersystemmodel> findAll(FindAllStaticpowersystemmodelQuery query) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "Failed to find all Staticpowersystemmodel - {0}", exc.getMessage());
    }
    return null;
  }
  ...
  // attributes
  // --------------------------------------------------
  @Autowired protected final StaticpowersystemmodelRepository repository;

  private static final Logger LOGGER =
      Logger.getLogger(StaticpowersystemmodelEntityProjector.class.getName());
}
