...
/**
 * Projector for PhaseTapChangerAsymmetrical as outlined for the CQRS pattern. All event handling
 * and query handling related to PhaseTapChangerAsymmetrical are invoked here and dispersed as an
...
public class PhaseTapChangerAsymmetricalProjector
    extends PhaseTapChangerAsymmetricalEntityProjector {

  // core constructor
  public PhaseTapChangerAsymmetricalProjector(
      PhaseTapChangerAsymmetricalRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalEvent
   */
  @EventHandler(payloadType = AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalEvent.class)
  public void handle(AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalEvent event) {
    LOGGER.info(
        "handling AssignWindingConnectionAngleToPhaseTapChangerAsymmetricalEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    PhaseTapChangerAsymmetrical entity =
        assignWindingConnectionAngle(
            event.getPhaseTapChangerAsymmetricalId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent
   */
  @EventHandler(
      payloadType = UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent.class)
  public void handle(UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent event) {
    LOGGER.info(
        "handling UnAssignWindingConnectionAngleFromPhaseTapChangerAsymmetricalEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    PhaseTapChangerAsymmetrical entity =
        unAssignWindingConnectionAngle(event.getPhaseTapChangerAsymmetricalId());
  ...
  /**
   * Method to retrieve the PhaseTapChangerAsymmetrical via an
   * PhaseTapChangerAsymmetricalPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<PhaseTapChangerAsymmetrical> handle(FindAllPhaseTapChangerAsymmetricalQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindPhaseTapChangerAsymmetrical, but only if the id
   * matches
   *
  ...
  protected void emitFindPhaseTapChangerAsymmetrical(PhaseTapChangerAsymmetrical entity) {
    ...
    queryUpdateEmitter.emit(
        FindPhaseTapChangerAsymmetricalQuery.class,
        query ->
            query
                .getFilter()
                .getPhaseTapChangerAsymmetricalId()
                .equals(entity.getPhaseTapChangerAsymmetricalId()),
        entity);
  }
  ...
  protected void emitFindAllPhaseTapChangerAsymmetrical(PhaseTapChangerAsymmetrical entity) {
    ...
    queryUpdateEmitter.emit(FindAllPhaseTapChangerAsymmetricalQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PhaseTapChangerAsymmetricalProjector.class.getName());
}
