...
/**
 * Projector for StringMeasurement as outlined for the CQRS pattern. All event handling and query
 * handling related to StringMeasurement are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class StringMeasurementProjector extends StringMeasurementEntityProjector {
  ...
  // core constructor
  public StringMeasurementProjector(
      StringMeasurementRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<StringMeasurement> handle(FindAllStringMeasurementQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindStringMeasurement, but only if the id matches
   *
  ...
  protected void emitFindStringMeasurement(StringMeasurement entity) {
    ...
    queryUpdateEmitter.emit(
        FindStringMeasurementQuery.class,
  ...
  protected void emitFindAllStringMeasurement(StringMeasurement entity) {
    ...
    queryUpdateEmitter.emit(FindAllStringMeasurementQuery.class, query -> true, entity);
  }
