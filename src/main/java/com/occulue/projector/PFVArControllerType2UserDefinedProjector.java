...
/**
 * Projector for PFVArControllerType2UserDefined as outlined for the CQRS pattern. All event
 * handling and query handling related to PFVArControllerType2UserDefined are invoked here and
...
public class PFVArControllerType2UserDefinedProjector
    extends PFVArControllerType2UserDefinedEntityProjector {

  // core constructor
  public PFVArControllerType2UserDefinedProjector(
      PFVArControllerType2UserDefinedRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignProprietaryToPFVArControllerType2UserDefinedEvent
   */
  @EventHandler(payloadType = AssignProprietaryToPFVArControllerType2UserDefinedEvent.class)
  public void handle(AssignProprietaryToPFVArControllerType2UserDefinedEvent event) {
    LOGGER.info("handling AssignProprietaryToPFVArControllerType2UserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    PFVArControllerType2UserDefined entity =
        assignProprietary(event.getPFVArControllerType2UserDefinedId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignProprietaryFromPFVArControllerType2UserDefinedEvent
   */
  @EventHandler(payloadType = UnAssignProprietaryFromPFVArControllerType2UserDefinedEvent.class)
  public void handle(UnAssignProprietaryFromPFVArControllerType2UserDefinedEvent event) {
    LOGGER.info("handling UnAssignProprietaryFromPFVArControllerType2UserDefinedEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    PFVArControllerType2UserDefined entity =
        unAssignProprietary(event.getPFVArControllerType2UserDefinedId());
   ...
   * PFVArControllerType2UserDefinedPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<PFVArControllerType2UserDefined> handle(
      FindAllPFVArControllerType2UserDefinedQuery query) throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindPFVArControllerType2UserDefined, but only if the id
   * matches
   *
  ...
  protected void emitFindPFVArControllerType2UserDefined(PFVArControllerType2UserDefined entity) {
    ...
    queryUpdateEmitter.emit(
        FindPFVArControllerType2UserDefinedQuery.class,
        query ->
            query
                .getFilter()
                .getPFVArControllerType2UserDefinedId()
                .equals(entity.getPFVArControllerType2UserDefinedId()),
        entity);
  }
   ...
   * @param entity PFVArControllerType2UserDefined
   */
  protected void emitFindAllPFVArControllerType2UserDefined(
      PFVArControllerType2UserDefined entity) {
    LOGGER.info("handling emitFindAllPFVArControllerType2UserDefined");

    queryUpdateEmitter.emit(
        FindAllPFVArControllerType2UserDefinedQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArControllerType2UserDefinedProjector.class.getName());
}
