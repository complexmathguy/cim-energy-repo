...
/**
 * Projector for SvTapStep as outlined for the CQRS pattern. All event handling and query handling
 * related to SvTapStep are invoked here and dispersed as an event to be handled elsewhere.
 *
...
public class SvTapStepProjector extends SvTapStepEntityProjector {
  ...
  /*
   * @param	event AssignPositionToSvTapStepEvent
   */
  @EventHandler(payloadType = AssignPositionToSvTapStepEvent.class)
  public void handle(AssignPositionToSvTapStepEvent event) {
    LOGGER.info("handling AssignPositionToSvTapStepEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    SvTapStep entity = assignPosition(event.getSvTapStepId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignPositionFromSvTapStepEvent
   */
  @EventHandler(payloadType = UnAssignPositionFromSvTapStepEvent.class)
  public void handle(UnAssignPositionFromSvTapStepEvent event) {
    LOGGER.info("handling UnAssignPositionFromSvTapStepEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    SvTapStep entity = unAssignPosition(event.getSvTapStepId());
  ...
  /**
   * emit to subscription queries of type FindSvTapStep, but only if the id matches
   *
  ...
  protected void emitFindAllSvTapStep(SvTapStep entity) {
    ...
    queryUpdateEmitter.emit(FindAllSvTapStepQuery.class, query -> true, entity);
  }
