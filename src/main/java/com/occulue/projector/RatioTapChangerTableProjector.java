...
/**
 * Projector for RatioTapChangerTable as outlined for the CQRS pattern. All event handling and query
 * handling related to RatioTapChangerTable are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
 * <p>Commands are handled by RatioTapChangerTableAggregate
 *
...
public class RatioTapChangerTableProjector extends RatioTapChangerTableEntityProjector {
  ...
  // core constructor
  public RatioTapChangerTableProjector(
      RatioTapChangerTableRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<RatioTapChangerTable> handle(FindAllRatioTapChangerTableQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindRatioTapChangerTable, but only if the id matches
   *
  ...
  protected void emitFindRatioTapChangerTable(RatioTapChangerTable entity) {
    ...
    queryUpdateEmitter.emit(
        FindRatioTapChangerTableQuery.class,
        query ->
            query
                .getFilter()
                .getRatioTapChangerTableId()
                .equals(entity.getRatioTapChangerTableId()),
        entity);
  }
  ...
  protected void emitFindAllRatioTapChangerTable(RatioTapChangerTable entity) {
    ...
    queryUpdateEmitter.emit(FindAllRatioTapChangerTableQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(RatioTapChangerTableProjector.class.getName());
}
