...
public class AngleDegreesEntityProjector {
  ...
  CsConverterEntityProjector CsConverterProjector;

  @Autowired
  @Qualifier(value = "phaseTapChangerAsymmetrical-entity-projector")
  PhaseTapChangerAsymmetricalEntityProjector PhaseTapChangerAsymmetricalProjector;

  @Autowired
  @Qualifier(value = "phaseTapChangerLinear-entity-projector")
  PhaseTapChangerLinearEntityProjector PhaseTapChangerLinearProjector;

  @Autowired
  @Qualifier(value = "phaseTapChangerTablePoint-entity-projector")
  PhaseTapChangerTablePointEntityProjector PhaseTapChangerTablePointProjector;
