...
public class PerLengthDCLineParameterEntityProjector {
  ...
  CapacitancePerLengthEntityProjector CapacitancePerLengthProjector;

  @Autowired
  @Qualifier(value = "inductancePerLength-entity-projector")
  InductancePerLengthEntityProjector InductancePerLengthProjector;

  @Autowired
  @Qualifier(value = "resistancePerLength-entity-projector")
  ResistancePerLengthEntityProjector ResistancePerLengthProjector;
