...
/**
 * Projector for SwitchSchedule as outlined for the CQRS pattern. All event handling and query
 * handling related to SwitchSchedule are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class SwitchScheduleProjector extends SwitchScheduleEntityProjector {
  ...
  // core constructor
  public SwitchScheduleProjector(
      SwitchScheduleRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /**
   * emit to subscription queries of type FindSwitchSchedule, but only if the id matches
   *
  ...
  protected void emitFindAllSwitchSchedule(SwitchSchedule entity) {
    ...
    queryUpdateEmitter.emit(FindAllSwitchScheduleQuery.class, query -> true, entity);
  }
