...
public class DiagramObjectGluePointEntityProjector {
  ...
  public List<DiagramObjectGluePoint> findAll(FindAllDiagramObjectGluePointQuery query) {
    ...
    try {
      ...
      LOGGER.log(
          Level.WARNING, "Failed to find all DiagramObjectGluePoint - {0}", exc.getMessage());
    }
    return null;
  }
  ...
  // attributes
  // --------------------------------------------------
  @Autowired protected final DiagramObjectGluePointRepository repository;

  private static final Logger LOGGER =
      Logger.getLogger(DiagramObjectGluePointEntityProjector.class.getName());
}
