...
/**
 * Projector for CoordinateSystem as outlined for the CQRS pattern. All event handling and query
 * handling related to CoordinateSystem are invoked here and dispersed as an event to be handled
 * elsewhere.
 *
...
public class CoordinateSystemProjector extends CoordinateSystemEntityProjector {
  ...
  // core constructor
  public CoordinateSystemProjector(
      CoordinateSystemRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /*
   * @param	event AssignCrsUrnToCoordinateSystemEvent
   */
  @EventHandler(payloadType = AssignCrsUrnToCoordinateSystemEvent.class)
  public void handle(AssignCrsUrnToCoordinateSystemEvent event) {
    LOGGER.info("handling AssignCrsUrnToCoordinateSystemEvent - " + event);

    // ------------------------------------------
    // delegate to assignTo
    // ------------------------------------------
    CoordinateSystem entity = assignCrsUrn(event.getCoordinateSystemId(), event.getAssignment());
  ...
  /*
   * @param	event UnAssignCrsUrnFromCoordinateSystemEvent
   */
  @EventHandler(payloadType = UnAssignCrsUrnFromCoordinateSystemEvent.class)
  public void handle(UnAssignCrsUrnFromCoordinateSystemEvent event) {
    LOGGER.info("handling UnAssignCrsUrnFromCoordinateSystemEvent - " + event);

    // ------------------------------------------
    // delegate to unAssignFrom
    // ------------------------------------------
    CoordinateSystem entity = unAssignCrsUrn(event.getCoordinateSystemId());
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<CoordinateSystem> handle(FindAllCoordinateSystemQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindCoordinateSystem, but only if the id matches
   *
  ...
  protected void emitFindCoordinateSystem(CoordinateSystem entity) {
    ...
    queryUpdateEmitter.emit(
        FindCoordinateSystemQuery.class,
  ...
  protected void emitFindAllCoordinateSystem(CoordinateSystem entity) {
    ...
    queryUpdateEmitter.emit(FindAllCoordinateSystemQuery.class, query -> true, entity);
  }
