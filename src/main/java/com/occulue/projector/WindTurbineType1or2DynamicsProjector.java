...
/**
 * Projector for WindTurbineType1or2Dynamics as outlined for the CQRS pattern. All event handling
 * and query handling related to WindTurbineType1or2Dynamics are invoked here and dispersed as an
...
public class WindTurbineType1or2DynamicsProjector
    extends WindTurbineType1or2DynamicsEntityProjector {

  // core constructor
  public WindTurbineType1or2DynamicsProjector(
      WindTurbineType1or2DynamicsRepository repository, QueryUpdateEmitter queryUpdateEmitter) {
    super(repository);
  ...
  /**
   * Method to retrieve the WindTurbineType1or2Dynamics via an
   * WindTurbineType1or2DynamicsPrimaryKey.
   *
   * @param id Long
  ...
  @SuppressWarnings("unused")
  @QueryHandler
  public List<WindTurbineType1or2Dynamics> handle(FindAllWindTurbineType1or2DynamicsQuery query)
      throws ProcessingException {
    return findAll(query);
  }

  /**
   * emit to subscription queries of type FindWindTurbineType1or2Dynamics, but only if the id
   * matches
   *
  ...
  protected void emitFindWindTurbineType1or2Dynamics(WindTurbineType1or2Dynamics entity) {
    ...
    queryUpdateEmitter.emit(
        FindWindTurbineType1or2DynamicsQuery.class,
        query ->
            query
                .getFilter()
                .getWindTurbineType1or2DynamicsId()
                .equals(entity.getWindTurbineType1or2DynamicsId()),
        entity);
  }
  ...
  protected void emitFindAllWindTurbineType1or2Dynamics(WindTurbineType1or2Dynamics entity) {
    ...
    queryUpdateEmitter.emit(FindAllWindTurbineType1or2DynamicsQuery.class, query -> true, entity);
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType1or2DynamicsProjector.class.getName());
}
