...
public class SubGeographicalRegionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SubGeographicalRegion : "
                          + successValue.getSubGeographicalRegionId());
                  if (successValue.getSubGeographicalRegionId().equals(subGeographicalRegionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSubGeographicalRegionList - 1,
      ...
      subscriber
          .subGeographicalRegionSubscribe(subGeographicalRegionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SubGeographicalRegion : "
                          + successValue.getSubGeographicalRegionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on subGeographicalRegion for subGeographicalRegionId consumed"));
  ...
  protected SubGeographicalRegion read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SubGeographicalRegion with primary key");
    msg.append(subGeographicalRegionId);

    SubGeographicalRegionFetchOneSummary fetchOneSummary =
        new SubGeographicalRegionFetchOneSummary(subGeographicalRegionId);

    try {
      entity =
          SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance()
              .getSubGeographicalRegion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SubGeographicalRegionBusinessDelegate proxy =
          SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance()
          .delete(new DeleteSubGeographicalRegionCommand(entity.getSubGeographicalRegionId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SubGeographicalRegion with id " + subGeographicalRegionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SubGeographicalRegion with id " + subGeographicalRegionId);
  ...
  protected List<SubGeographicalRegion> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of SubGeographicalRegion was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSubGeographicalRegionId(), "-- entity in Collection has a null primary key");
