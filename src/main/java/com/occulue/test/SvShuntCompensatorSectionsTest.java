...
public class SvShuntCompensatorSectionsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SvShuntCompensatorSections : "
                          + successValue.getSvShuntCompensatorSectionsId());
                  if (successValue
                      .getSvShuntCompensatorSectionsId()
                      .equals(svShuntCompensatorSectionsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSvShuntCompensatorSectionsList - 1,
      ...
      subscriber
          .svShuntCompensatorSectionsSubscribe(svShuntCompensatorSectionsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SvShuntCompensatorSections : "
                          + successValue.getSvShuntCompensatorSectionsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on svShuntCompensatorSections for svShuntCompensatorSectionsId consumed"));
  ...
  protected SvShuntCompensatorSections read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SvShuntCompensatorSections with primary key");
    msg.append(svShuntCompensatorSectionsId);

    SvShuntCompensatorSectionsFetchOneSummary fetchOneSummary =
        new SvShuntCompensatorSectionsFetchOneSummary(svShuntCompensatorSectionsId);

    try {
      entity =
          SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance()
              .getSvShuntCompensatorSections(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SvShuntCompensatorSectionsBusinessDelegate proxy =
          SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SvShuntCompensatorSections with id "
              + svShuntCompensatorSectionsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SvShuntCompensatorSections with id " + svShuntCompensatorSectionsId);
    ...
    try {
      SvShuntCompensatorSectionsBusinessDelegate.getSvShuntCompensatorSectionsInstance()
          .delete(
              new DeleteSvShuntCompensatorSectionsCommand(entity.getSvShuntCompensatorSectionsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SvShuntCompensatorSections with id "
              + svShuntCompensatorSectionsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SvShuntCompensatorSections with id " + svShuntCompensatorSectionsId);
  ...
  protected List<SvShuntCompensatorSections> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of SvShuntCompensatorSections was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSvShuntCompensatorSectionsId(),
  ...
  protected CreateSvShuntCompensatorSectionsCommand generateNewCommand() {
    CreateSvShuntCompensatorSectionsCommand command =
        new CreateSvShuntCompensatorSectionsCommand(null);
  ...
  protected UpdateSvShuntCompensatorSectionsCommand generateUpdateCommand() {
    UpdateSvShuntCompensatorSectionsCommand command =
        new UpdateSvShuntCompensatorSectionsCommand(null, null);
