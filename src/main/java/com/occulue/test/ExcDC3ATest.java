...
public class ExcDC3ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excDC3AId =
        ExcDC3ABusinessDelegate.getExcDC3AInstance().createExcDC3A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcDC3A : " + successValue.getExcDC3AId());
                  if (successValue.getExcDC3AId().equals(excDC3AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcDC3AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcDC3A : "
                          + successValue.getExcDC3AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excDC3AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcDC3ABusinessDelegate.getExcDC3AInstance()
          .delete(new DeleteExcDC3ACommand(entity.getExcDC3AId()))
          .get();
  ...
  protected UpdateExcDC3ACommand generateUpdateCommand() {
    UpdateExcDC3ACommand command =
        new UpdateExcDC3ACommand(
