...
public class DiscExcContIEEEDEC3ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DiscExcContIEEEDEC3A : "
                          + successValue.getDiscExcContIEEEDEC3AId());
                  if (successValue.getDiscExcContIEEEDEC3AId().equals(discExcContIEEEDEC3AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiscExcContIEEEDEC3AList - 1,
      ...
      subscriber
          .discExcContIEEEDEC3ASubscribe(discExcContIEEEDEC3AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DiscExcContIEEEDEC3A : "
                          + successValue.getDiscExcContIEEEDEC3AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on discExcContIEEEDEC3A for discExcContIEEEDEC3AId consumed"));
  ...
  protected DiscExcContIEEEDEC3A read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read DiscExcContIEEEDEC3A with primary key");
    msg.append(discExcContIEEEDEC3AId);

    DiscExcContIEEEDEC3AFetchOneSummary fetchOneSummary =
        new DiscExcContIEEEDEC3AFetchOneSummary(discExcContIEEEDEC3AId);

    try {
      entity =
          DiscExcContIEEEDEC3ABusinessDelegate.getDiscExcContIEEEDEC3AInstance()
              .getDiscExcContIEEEDEC3A(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DiscExcContIEEEDEC3ABusinessDelegate proxy =
          DiscExcContIEEEDEC3ABusinessDelegate.getDiscExcContIEEEDEC3AInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DiscExcContIEEEDEC3ABusinessDelegate.getDiscExcContIEEEDEC3AInstance()
          .delete(new DeleteDiscExcContIEEEDEC3ACommand(entity.getDiscExcContIEEEDEC3AId()))
          .get();
  ...
  protected List<DiscExcContIEEEDEC3A> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          DiscExcContIEEEDEC3ABusinessDelegate.getDiscExcContIEEEDEC3AInstance()
              .getAllDiscExcContIEEEDEC3A();
      assertNotNull(
          collection, "An Empty collection of DiscExcContIEEEDEC3A was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDiscExcContIEEEDEC3AId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateDiscExcContIEEEDEC3ACommand generateUpdateCommand() {
    UpdateDiscExcContIEEEDEC3ACommand command =
        new UpdateDiscExcContIEEEDEC3ACommand(null, null, null);
