...
public class OperationalLimitSetTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OperationalLimitSet : "
                          + successValue.getOperationalLimitSetId());
                  if (successValue.getOperationalLimitSetId().equals(operationalLimitSetId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOperationalLimitSetList - 1,
      ...
      subscriber
          .operationalLimitSetSubscribe(operationalLimitSetId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OperationalLimitSet : "
                          + successValue.getOperationalLimitSetId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on operationalLimitSet for operationalLimitSetId consumed"));
  ...
  protected OperationalLimitSet read() throws Throwable {
    ...
    OperationalLimitSetFetchOneSummary fetchOneSummary =
        new OperationalLimitSetFetchOneSummary(operationalLimitSetId);

    try {
      entity =
          OperationalLimitSetBusinessDelegate.getOperationalLimitSetInstance()
              .getOperationalLimitSet(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      OperationalLimitSetBusinessDelegate proxy =
          OperationalLimitSetBusinessDelegate.getOperationalLimitSetInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      OperationalLimitSetBusinessDelegate.getOperationalLimitSetInstance()
          .delete(new DeleteOperationalLimitSetCommand(entity.getOperationalLimitSetId()))
          .get();
  ...
  protected List<OperationalLimitSet> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of OperationalLimitSet was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getOperationalLimitSetId(), "-- entity in Collection has a null primary key");
