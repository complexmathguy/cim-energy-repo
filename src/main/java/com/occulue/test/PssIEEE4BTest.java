...
public class PssIEEE4BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    PssIEEE4BBusinessDelegate.getPssIEEE4BInstance().createPssIEEE4B(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PssIEEE4B : " + successValue.getPssIEEE4BId());
                  if (successValue.getPssIEEE4BId().equals(pssIEEE4BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPssIEEE4BList - 1,
      ...
      subscriber
          .pssIEEE4BSubscribe(pssIEEE4BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PssIEEE4B : "
                          + successValue.getPssIEEE4BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssIEEE4BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssIEEE4BBusinessDelegate.getPssIEEE4BInstance()
          .delete(new DeletePssIEEE4BCommand(entity.getPssIEEE4BId()))
          .get();
  ...
  protected UpdatePssIEEE4BCommand generateUpdateCommand() {
    UpdatePssIEEE4BCommand command =
        new UpdatePssIEEE4BCommand(
