...
public class ExcAVR7Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAVR7Id =
        ExcAVR7BusinessDelegate.getExcAVR7Instance().createExcAVR7(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAVR7 : " + successValue.getExcAVR7Id());
                  if (successValue.getExcAVR7Id().equals(excAVR7Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAVR7List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAVR7 : "
                          + successValue.getExcAVR7Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAVR7Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAVR7BusinessDelegate.getExcAVR7Instance()
          .delete(new DeleteExcAVR7Command(entity.getExcAVR7Id()))
          .get();
  ...
  protected UpdateExcAVR7Command generateUpdateCommand() {
    UpdateExcAVR7Command command =
        new UpdateExcAVR7Command(
