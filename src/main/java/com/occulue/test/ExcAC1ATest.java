...
public class ExcAC1ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAC1AId =
        ExcAC1ABusinessDelegate.getExcAC1AInstance().createExcAC1A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAC1A : " + successValue.getExcAC1AId());
                  if (successValue.getExcAC1AId().equals(excAC1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAC1AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAC1A : "
                          + successValue.getExcAC1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAC1AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAC1ABusinessDelegate.getExcAC1AInstance()
          .delete(new DeleteExcAC1ACommand(entity.getExcAC1AId()))
          .get();
  ...
  protected UpdateExcAC1ACommand generateUpdateCommand() {
    UpdateExcAC1ACommand command =
        new UpdateExcAC1ACommand(
