...
public class WindContPType3IECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindContPType3IEC : "
                          + successValue.getWindContPType3IECId());
                  if (successValue.getWindContPType3IECId().equals(windContPType3IECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindContPType3IECList - 1,
      ...
      subscriber
          .windContPType3IECSubscribe(windContPType3IECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindContPType3IEC : "
                          + successValue.getWindContPType3IECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windContPType3IEC for windContPType3IECId consumed"));
  ...
  protected WindContPType3IEC read() throws Throwable {
    ...
    WindContPType3IECFetchOneSummary fetchOneSummary =
        new WindContPType3IECFetchOneSummary(windContPType3IECId);

    try {
      entity =
          WindContPType3IECBusinessDelegate.getWindContPType3IECInstance()
              .getWindContPType3IEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindContPType3IECBusinessDelegate proxy =
          WindContPType3IECBusinessDelegate.getWindContPType3IECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindContPType3IECBusinessDelegate.getWindContPType3IECInstance()
          .delete(new DeleteWindContPType3IECCommand(entity.getWindContPType3IECId()))
          .get();
  ...
  protected List<WindContPType3IEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindContPType3IECBusinessDelegate.getWindContPType3IECInstance()
              .getAllWindContPType3IEC();
      assertNotNull(
          collection, "An Empty collection of WindContPType3IEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindContPType3IECId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateWindContPType3IECCommand generateUpdateCommand() {
    UpdateWindContPType3IECCommand command =
        new UpdateWindContPType3IECCommand(
