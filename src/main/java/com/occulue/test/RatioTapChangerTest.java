...
public class RatioTapChangerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RatioTapChanger : "
                          + successValue.getRatioTapChangerId());
                  if (successValue.getRatioTapChangerId().equals(ratioTapChangerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRatioTapChangerList - 1,
      ...
      subscriber
          .ratioTapChangerSubscribe(ratioTapChangerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RatioTapChanger : "
                          + successValue.getRatioTapChangerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected RatioTapChanger read() throws Throwable {
    ...
    RatioTapChangerFetchOneSummary fetchOneSummary =
        new RatioTapChangerFetchOneSummary(ratioTapChangerId);

    try {
      entity =
          RatioTapChangerBusinessDelegate.getRatioTapChangerInstance()
              .getRatioTapChanger(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RatioTapChangerBusinessDelegate proxy =
          RatioTapChangerBusinessDelegate.getRatioTapChangerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      RatioTapChangerBusinessDelegate.getRatioTapChangerInstance()
          .delete(new DeleteRatioTapChangerCommand(entity.getRatioTapChangerId()))
          .get();
  ...
  protected List<RatioTapChanger> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRatioTapChangerId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateRatioTapChangerCommand generateNewCommand() {
    CreateRatioTapChangerCommand command =
        new CreateRatioTapChangerCommand(null, TransformerControlMode.values()[0]);
  ...
  protected UpdateRatioTapChangerCommand generateUpdateCommand() {
    UpdateRatioTapChangerCommand command =
        new UpdateRatioTapChangerCommand(null, null, TransformerControlMode.values()[0]);
