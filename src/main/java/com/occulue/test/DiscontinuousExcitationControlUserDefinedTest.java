...
public class DiscontinuousExcitationControlUserDefinedTest {
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DiscontinuousExcitationControlUserDefined : "
                          + successValue.getDiscontinuousExcitationControlUserDefinedId());
                  if (successValue
                      .getDiscontinuousExcitationControlUserDefinedId()
                      .equals(discontinuousExcitationControlUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size()
                              == sizeOfDiscontinuousExcitationControlUserDefinedList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "DiscontinuousExcitationControlUserDefined test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
              ...
              () ->
                  LOGGER.info(
                      "Subscription on discontinuousExcitationControlUserDefined consumed"));
      subscriber
          .discontinuousExcitationControlUserDefinedSubscribe(
              discontinuousExcitationControlUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DiscontinuousExcitationControlUserDefined : "
                          + successValue.getDiscontinuousExcitationControlUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on discontinuousExcitationControlUserDefined for discontinuousExcitationControlUserDefinedId consumed"));
  ...
  protected DiscontinuousExcitationControlUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder(
            "-- Failed to read DiscontinuousExcitationControlUserDefined with primary key");
    msg.append(discontinuousExcitationControlUserDefinedId);

    DiscontinuousExcitationControlUserDefinedFetchOneSummary fetchOneSummary =
        new DiscontinuousExcitationControlUserDefinedFetchOneSummary(
            discontinuousExcitationControlUserDefinedId);
    ...
    try {
      entity =
          DiscontinuousExcitationControlUserDefinedBusinessDelegate
              .getDiscontinuousExcitationControlUserDefinedInstance()
              .getDiscontinuousExcitationControlUserDefined(fetchOneSummary);

      assertNotNull(entity, msg.toString());

      LOGGER.info(
          "-- Successfully found DiscontinuousExcitationControlUserDefined " + entity.toString());
    } catch (Throwable e) {
  ...
  protected void update() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("Failed to update a DiscontinuousExcitationControlUserDefined : ");
    ...
    command.setDiscontinuousExcitationControlUserDefinedId(
        entity.getDiscontinuousExcitationControlUserDefinedId());
    ...
    try {
      ...
      DiscontinuousExcitationControlUserDefinedBusinessDelegate proxy =
          DiscontinuousExcitationControlUserDefinedBusinessDelegate
              .getDiscontinuousExcitationControlUserDefinedInstance();
      ...
      LOGGER.info(
          "-- Successfully saved DiscontinuousExcitationControlUserDefined - " + entity.toString());
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString()
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read DiscontinuousExcitationControlUserDefined with id "
              + discontinuousExcitationControlUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read DiscontinuousExcitationControlUserDefined with id "
              + discontinuousExcitationControlUserDefinedId);
    ...
    try {
      DiscontinuousExcitationControlUserDefinedBusinessDelegate
          ...
          .get();
      LOGGER.info(
          "-- Successfully deleted DiscontinuousExcitationControlUserDefined with id "
              + discontinuousExcitationControlUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete DiscontinuousExcitationControlUserDefined with id "
              + discontinuousExcitationControlUserDefinedId);
  ...
  protected List<DiscontinuousExcitationControlUserDefined> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all DiscontinuousExcitationControlUserDefined : ");
    ...
    try {
      ...
      collection =
          DiscontinuousExcitationControlUserDefinedBusinessDelegate
              .getDiscontinuousExcitationControlUserDefinedInstance()
              .getAllDiscontinuousExcitationControlUserDefined();
      assertNotNull(
          collection,
          "An Empty collection of DiscontinuousExcitationControlUserDefined was incorrectly returned.");
  ...
  protected CreateDiscontinuousExcitationControlUserDefinedCommand generateNewCommand() {
    CreateDiscontinuousExcitationControlUserDefinedCommand command =
        new CreateDiscontinuousExcitationControlUserDefinedCommand(null);
  ...
  protected UpdateDiscontinuousExcitationControlUserDefinedCommand generateUpdateCommand() {
    UpdateDiscontinuousExcitationControlUserDefinedCommand command =
        new UpdateDiscontinuousExcitationControlUserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(DiscontinuousExcitationControlUserDefinedTest.class.getName());
