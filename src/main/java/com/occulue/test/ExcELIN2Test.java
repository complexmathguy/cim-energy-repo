...
public class ExcELIN2Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excELIN2Id =
        ExcELIN2BusinessDelegate.getExcELIN2Instance().createExcELIN2(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcELIN2 : " + successValue.getExcELIN2Id());
                  if (successValue.getExcELIN2Id().equals(excELIN2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcELIN2List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcELIN2 : "
                          + successValue.getExcELIN2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excELIN2Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcELIN2BusinessDelegate.getExcELIN2Instance()
          .delete(new DeleteExcELIN2Command(entity.getExcELIN2Id()))
          .get();
  ...
  protected UpdateExcELIN2Command generateUpdateCommand() {
    UpdateExcELIN2Command command =
        new UpdateExcELIN2Command(
