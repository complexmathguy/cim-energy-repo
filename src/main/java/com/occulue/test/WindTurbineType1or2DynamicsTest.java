...
public class WindTurbineType1or2DynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindTurbineType1or2Dynamics : "
                          + successValue.getWindTurbineType1or2DynamicsId());
                  if (successValue
                      .getWindTurbineType1or2DynamicsId()
                      .equals(windTurbineType1or2DynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindTurbineType1or2DynamicsList - 1,
      ...
      subscriber
          .windTurbineType1or2DynamicsSubscribe(windTurbineType1or2DynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindTurbineType1or2Dynamics : "
                          + successValue.getWindTurbineType1or2DynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windTurbineType1or2Dynamics for windTurbineType1or2DynamicsId consumed"));
  ...
  protected WindTurbineType1or2Dynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindTurbineType1or2Dynamics with primary key");
    msg.append(windTurbineType1or2DynamicsId);

    WindTurbineType1or2DynamicsFetchOneSummary fetchOneSummary =
        new WindTurbineType1or2DynamicsFetchOneSummary(windTurbineType1or2DynamicsId);

    try {
      entity =
          WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance()
              .getWindTurbineType1or2Dynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindTurbineType1or2DynamicsBusinessDelegate proxy =
          WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindTurbineType1or2Dynamics with id "
              + windTurbineType1or2DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindTurbineType1or2Dynamics with id " + windTurbineType1or2DynamicsId);
    ...
    try {
      WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance()
          .delete(
              new DeleteWindTurbineType1or2DynamicsCommand(
                  entity.getWindTurbineType1or2DynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindTurbineType1or2Dynamics with id "
              + windTurbineType1or2DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindTurbineType1or2Dynamics with id "
              + windTurbineType1or2DynamicsId);
  ...
  protected List<WindTurbineType1or2Dynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindTurbineType1or2DynamicsBusinessDelegate.getWindTurbineType1or2DynamicsInstance()
              .getAllWindTurbineType1or2Dynamics();
      assertNotNull(
          collection,
          "An Empty collection of WindTurbineType1or2Dynamics was incorrectly returned.");
  ...
  protected CreateWindTurbineType1or2DynamicsCommand generateNewCommand() {
    CreateWindTurbineType1or2DynamicsCommand command =
        new CreateWindTurbineType1or2DynamicsCommand(null);
  ...
  protected UpdateWindTurbineType1or2DynamicsCommand generateUpdateCommand() {
    UpdateWindTurbineType1or2DynamicsCommand command =
        new UpdateWindTurbineType1or2DynamicsCommand(null);
