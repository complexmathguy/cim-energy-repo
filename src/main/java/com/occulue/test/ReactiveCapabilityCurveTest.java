...
public class ReactiveCapabilityCurveTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ReactiveCapabilityCurve : "
                          + successValue.getReactiveCapabilityCurveId());
                  if (successValue
                      .getReactiveCapabilityCurveId()
                      .equals(reactiveCapabilityCurveId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfReactiveCapabilityCurveList - 1,
      ...
      subscriber
          .reactiveCapabilityCurveSubscribe(reactiveCapabilityCurveId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ReactiveCapabilityCurve : "
                          + successValue.getReactiveCapabilityCurveId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on reactiveCapabilityCurve for reactiveCapabilityCurveId consumed"));
  ...
  protected ReactiveCapabilityCurve read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ReactiveCapabilityCurve with primary key");
    msg.append(reactiveCapabilityCurveId);

    ReactiveCapabilityCurveFetchOneSummary fetchOneSummary =
        new ReactiveCapabilityCurveFetchOneSummary(reactiveCapabilityCurveId);

    try {
      entity =
          ReactiveCapabilityCurveBusinessDelegate.getReactiveCapabilityCurveInstance()
              .getReactiveCapabilityCurve(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ReactiveCapabilityCurveBusinessDelegate proxy =
          ReactiveCapabilityCurveBusinessDelegate.getReactiveCapabilityCurveInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ReactiveCapabilityCurve with id " + reactiveCapabilityCurveId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ReactiveCapabilityCurve with id " + reactiveCapabilityCurveId);
    ...
    try {
      ReactiveCapabilityCurveBusinessDelegate.getReactiveCapabilityCurveInstance()
          .delete(new DeleteReactiveCapabilityCurveCommand(entity.getReactiveCapabilityCurveId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ReactiveCapabilityCurve with id " + reactiveCapabilityCurveId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ReactiveCapabilityCurve with id " + reactiveCapabilityCurveId);
  ...
  protected List<ReactiveCapabilityCurve> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ReactiveCapabilityCurveBusinessDelegate.getReactiveCapabilityCurveInstance()
              .getAllReactiveCapabilityCurve();
      assertNotNull(
          collection, "An Empty collection of ReactiveCapabilityCurve was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getReactiveCapabilityCurveId(),
