...
public class TopologicalIslandTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TopologicalIsland : "
                          + successValue.getTopologicalIslandId());
                  if (successValue.getTopologicalIslandId().equals(topologicalIslandId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTopologicalIslandList - 1,
      ...
      subscriber
          .topologicalIslandSubscribe(topologicalIslandId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TopologicalIsland : "
                          + successValue.getTopologicalIslandId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on topologicalIsland for topologicalIslandId consumed"));
  ...
  protected TopologicalIsland read() throws Throwable {
    ...
    TopologicalIslandFetchOneSummary fetchOneSummary =
        new TopologicalIslandFetchOneSummary(topologicalIslandId);

    try {
      entity =
          TopologicalIslandBusinessDelegate.getTopologicalIslandInstance()
              .getTopologicalIsland(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TopologicalIslandBusinessDelegate proxy =
          TopologicalIslandBusinessDelegate.getTopologicalIslandInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TopologicalIslandBusinessDelegate.getTopologicalIslandInstance()
          .delete(new DeleteTopologicalIslandCommand(entity.getTopologicalIslandId()))
          .get();
  ...
  protected List<TopologicalIsland> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          TopologicalIslandBusinessDelegate.getTopologicalIslandInstance()
              .getAllTopologicalIsland();
      assertNotNull(
          collection, "An Empty collection of TopologicalIsland was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTopologicalIslandId(), "-- entity in Collection has a null primary key");
