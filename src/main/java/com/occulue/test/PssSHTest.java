...
public class PssSHTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pssSHId = PssSHBusinessDelegate.getPssSHInstance().createPssSH(generateNewCommand()).get();
    ...
    PssSHBusinessDelegate.getPssSHInstance().createPssSH(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for PssSH : "
                          + successValue.getPssSHId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssSHId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssSHBusinessDelegate.getPssSHInstance()
          .delete(new DeletePssSHCommand(entity.getPssSHId()))
          .get();
  ...
  protected UpdatePssSHCommand generateUpdateCommand() {
    UpdatePssSHCommand command =
        new UpdatePssSHCommand(
