...
public class LengthTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    lengthId = LengthBusinessDelegate.getLengthInstance().createLength(generateNewCommand()).get();
    ...
    LengthBusinessDelegate.getLengthInstance().createLength(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Length : "
                          + successValue.getLengthId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + lengthId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LengthBusinessDelegate.getLengthInstance()
          .delete(new DeleteLengthCommand(entity.getLengthId()))
          .get();
  ...
  protected CreateLengthCommand generateNewCommand() {
    CreateLengthCommand command =
        new CreateLengthCommand(null, UnitMultiplier.values()[0], UnitSymbol.values()[0]);
  ...
  protected UpdateLengthCommand generateUpdateCommand() {
    UpdateLengthCommand command =
        new UpdateLengthCommand(null, UnitMultiplier.values()[0], UnitSymbol.values()[0], null);
