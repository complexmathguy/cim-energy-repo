...
public class ExcIEEEST1ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEST1A : "
                          + successValue.getExcIEEEST1AId());
                  if (successValue.getExcIEEEST1AId().equals(excIEEEST1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEST1AList - 1,
      ...
      subscriber
          .excIEEEST1ASubscribe(excIEEEST1AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEST1A : "
                          + successValue.getExcIEEEST1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEST1ABusinessDelegate.getExcIEEEST1AInstance()
          .delete(new DeleteExcIEEEST1ACommand(entity.getExcIEEEST1AId()))
          .get();
  ...
  protected CreateExcIEEEST1ACommand generateNewCommand() {
    CreateExcIEEEST1ACommand command =
        new CreateExcIEEEST1ACommand(null, ExcIEEEST1AUELselectorKind.values()[0]);
  ...
  protected UpdateExcIEEEST1ACommand generateUpdateCommand() {
    UpdateExcIEEEST1ACommand command =
        new UpdateExcIEEEST1ACommand(
            null,
            null,
            null,
            null,
            ...
            null,
            null,
            ExcIEEEST1AUELselectorKind.values()[0],
            null,
            null,
            null,
            null,
