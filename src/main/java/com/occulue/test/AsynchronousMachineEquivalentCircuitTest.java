...
public class AsynchronousMachineEquivalentCircuitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AsynchronousMachineEquivalentCircuit : "
                          + successValue.getAsynchronousMachineEquivalentCircuitId());
                  if (successValue
                      .getAsynchronousMachineEquivalentCircuitId()
                      .equals(asynchronousMachineEquivalentCircuitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAsynchronousMachineEquivalentCircuitList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "AsynchronousMachineEquivalentCircuit test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          .asynchronousMachineEquivalentCircuitSubscribe(asynchronousMachineEquivalentCircuitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AsynchronousMachineEquivalentCircuit : "
                          + successValue.getAsynchronousMachineEquivalentCircuitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on asynchronousMachineEquivalentCircuit for asynchronousMachineEquivalentCircuitId consumed"));
  ...
  protected AsynchronousMachineEquivalentCircuit read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder(
            "-- Failed to read AsynchronousMachineEquivalentCircuit with primary key");
    msg.append(asynchronousMachineEquivalentCircuitId);

    AsynchronousMachineEquivalentCircuitFetchOneSummary fetchOneSummary =
    ...
    try {
      entity =
          AsynchronousMachineEquivalentCircuitBusinessDelegate
              .getAsynchronousMachineEquivalentCircuitInstance()
              .getAsynchronousMachineEquivalentCircuit(fetchOneSummary);

      assertNotNull(entity, msg.toString());

      LOGGER.info(
          "-- Successfully found AsynchronousMachineEquivalentCircuit " + entity.toString());
    } catch (Throwable e) {
  ...
  protected void update() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("Failed to update a AsynchronousMachineEquivalentCircuit : ");
    ...
    command.setAsynchronousMachineEquivalentCircuitId(
        entity.getAsynchronousMachineEquivalentCircuitId());
    ...
    try {
      ...
      AsynchronousMachineEquivalentCircuitBusinessDelegate proxy =
          AsynchronousMachineEquivalentCircuitBusinessDelegate
              .getAsynchronousMachineEquivalentCircuitInstance();
      ...
      LOGGER.info(
          "-- Successfully saved AsynchronousMachineEquivalentCircuit - " + entity.toString());
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString()
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read AsynchronousMachineEquivalentCircuit with id "
              + asynchronousMachineEquivalentCircuitId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read AsynchronousMachineEquivalentCircuit with id "
              + asynchronousMachineEquivalentCircuitId);
    ...
    try {
      AsynchronousMachineEquivalentCircuitBusinessDelegate
          ...
          .get();
      LOGGER.info(
          "-- Successfully deleted AsynchronousMachineEquivalentCircuit with id "
              + asynchronousMachineEquivalentCircuitId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete AsynchronousMachineEquivalentCircuit with id "
              + asynchronousMachineEquivalentCircuitId);
  ...
  protected List<AsynchronousMachineEquivalentCircuit> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all AsynchronousMachineEquivalentCircuit : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of AsynchronousMachineEquivalentCircuit was incorrectly returned.");
  ...
  protected CreateAsynchronousMachineEquivalentCircuitCommand generateNewCommand() {
    CreateAsynchronousMachineEquivalentCircuitCommand command =
        new CreateAsynchronousMachineEquivalentCircuitCommand(null);
  ...
  protected UpdateAsynchronousMachineEquivalentCircuitCommand generateUpdateCommand() {
    UpdateAsynchronousMachineEquivalentCircuitCommand command =
        new UpdateAsynchronousMachineEquivalentCircuitCommand(null, null, null, null, null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(AsynchronousMachineEquivalentCircuitTest.class.getName());
