...
public class ExcST1ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excST1AId =
        ExcST1ABusinessDelegate.getExcST1AInstance().createExcST1A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcST1A : " + successValue.getExcST1AId());
                  if (successValue.getExcST1AId().equals(excST1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcST1AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcST1A : "
                          + successValue.getExcST1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excST1AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcST1ABusinessDelegate.getExcST1AInstance()
          .delete(new DeleteExcST1ACommand(entity.getExcST1AId()))
          .get();
  ...
  protected UpdateExcST1ACommand generateUpdateCommand() {
    UpdateExcST1ACommand command =
        new UpdateExcST1ACommand(
