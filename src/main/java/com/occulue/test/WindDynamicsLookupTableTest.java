...
public class WindDynamicsLookupTableTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindDynamicsLookupTable : "
                          + successValue.getWindDynamicsLookupTableId());
                  if (successValue
                      .getWindDynamicsLookupTableId()
                      .equals(windDynamicsLookupTableId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindDynamicsLookupTableList - 1,
      ...
      subscriber
          .windDynamicsLookupTableSubscribe(windDynamicsLookupTableId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindDynamicsLookupTable : "
                          + successValue.getWindDynamicsLookupTableId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windDynamicsLookupTable for windDynamicsLookupTableId consumed"));
  ...
  protected WindDynamicsLookupTable read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindDynamicsLookupTable with primary key");
    msg.append(windDynamicsLookupTableId);

    WindDynamicsLookupTableFetchOneSummary fetchOneSummary =
        new WindDynamicsLookupTableFetchOneSummary(windDynamicsLookupTableId);

    try {
      entity =
          WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance()
              .getWindDynamicsLookupTable(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindDynamicsLookupTableBusinessDelegate proxy =
          WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindDynamicsLookupTable with id " + windDynamicsLookupTableId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindDynamicsLookupTable with id " + windDynamicsLookupTableId);
    ...
    try {
      WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance()
          .delete(new DeleteWindDynamicsLookupTableCommand(entity.getWindDynamicsLookupTableId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindDynamicsLookupTable with id " + windDynamicsLookupTableId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindDynamicsLookupTable with id " + windDynamicsLookupTableId);
  ...
  protected List<WindDynamicsLookupTable> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindDynamicsLookupTableBusinessDelegate.getWindDynamicsLookupTableInstance()
              .getAllWindDynamicsLookupTable();
      assertNotNull(
          collection, "An Empty collection of WindDynamicsLookupTable was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindDynamicsLookupTableId(),
  ...
  protected CreateWindDynamicsLookupTableCommand generateNewCommand() {
    CreateWindDynamicsLookupTableCommand command =
        new CreateWindDynamicsLookupTableCommand(null, WindLookupTableFunctionKind.values()[0]);
  ...
  protected UpdateWindDynamicsLookupTableCommand generateUpdateCommand() {
    UpdateWindDynamicsLookupTableCommand command =
        new UpdateWindDynamicsLookupTableCommand(
            null, null, WindLookupTableFunctionKind.values()[0], null, null);
