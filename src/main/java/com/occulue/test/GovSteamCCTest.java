...
public class GovSteamCCTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovSteamCCBusinessDelegate.getGovSteamCCInstance().createGovSteamCC(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteamCC : " + successValue.getGovSteamCCId());
                  if (successValue.getGovSteamCCId().equals(govSteamCCId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteamCCList - 1,
      ...
      subscriber
          .govSteamCCSubscribe(govSteamCCId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteamCC : "
                          + successValue.getGovSteamCCId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteamCCBusinessDelegate.getGovSteamCCInstance()
          .delete(new DeleteGovSteamCCCommand(entity.getGovSteamCCId()))
          .get();
  ...
  protected UpdateGovSteamCCCommand generateUpdateCommand() {
    UpdateGovSteamCCCommand command =
        new UpdateGovSteamCCCommand(
