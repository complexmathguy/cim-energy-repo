...
public class ConnectorTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    ConnectorBusinessDelegate.getConnectorInstance().createConnector(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Connector : " + successValue.getConnectorId());
                  if (successValue.getConnectorId().equals(connectorId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfConnectorList - 1,
      ...
      subscriber
          .connectorSubscribe(connectorId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for Connector : "
                          + successValue.getConnectorId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + connectorId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ConnectorBusinessDelegate.getConnectorInstance()
          .delete(new DeleteConnectorCommand(entity.getConnectorId()))
          .get();
