...
public class WindTurbineType1or2IECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindTurbineType1or2IEC : "
                          + successValue.getWindTurbineType1or2IECId());
                  if (successValue.getWindTurbineType1or2IECId().equals(windTurbineType1or2IECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindTurbineType1or2IECList - 1,
      ...
      subscriber
          .windTurbineType1or2IECSubscribe(windTurbineType1or2IECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindTurbineType1or2IEC : "
                          + successValue.getWindTurbineType1or2IECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windTurbineType1or2IEC for windTurbineType1or2IECId consumed"));
  ...
  protected WindTurbineType1or2IEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindTurbineType1or2IEC with primary key");
    msg.append(windTurbineType1or2IECId);

    WindTurbineType1or2IECFetchOneSummary fetchOneSummary =
        new WindTurbineType1or2IECFetchOneSummary(windTurbineType1or2IECId);

    try {
      entity =
          WindTurbineType1or2IECBusinessDelegate.getWindTurbineType1or2IECInstance()
              .getWindTurbineType1or2IEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindTurbineType1or2IECBusinessDelegate proxy =
          WindTurbineType1or2IECBusinessDelegate.getWindTurbineType1or2IECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindTurbineType1or2IEC with id " + windTurbineType1or2IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindTurbineType1or2IEC with id " + windTurbineType1or2IECId);
    ...
    try {
      WindTurbineType1or2IECBusinessDelegate.getWindTurbineType1or2IECInstance()
          .delete(new DeleteWindTurbineType1or2IECCommand(entity.getWindTurbineType1or2IECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindTurbineType1or2IEC with id " + windTurbineType1or2IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindTurbineType1or2IEC with id " + windTurbineType1or2IECId);
  ...
  protected List<WindTurbineType1or2IEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindTurbineType1or2IECBusinessDelegate.getWindTurbineType1or2IECInstance()
              .getAllWindTurbineType1or2IEC();
      assertNotNull(
          collection, "An Empty collection of WindTurbineType1or2IEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindTurbineType1or2IECId(), "-- entity in Collection has a null primary key");
