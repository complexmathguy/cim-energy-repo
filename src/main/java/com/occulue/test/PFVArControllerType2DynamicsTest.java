...
public class PFVArControllerType2DynamicsTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pFVArControllerType2DynamicsId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArControllerType2Dynamics : "
                          + successValue.getPFVArControllerType2DynamicsId());
                  if (successValue
                      .getPFVArControllerType2DynamicsId()
                      .equals(pFVArControllerType2DynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArControllerType2DynamicsList - 1,
      ...
      subscriber
          .pFVArControllerType2DynamicsSubscribe(pFVArControllerType2DynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArControllerType2Dynamics : "
                          + successValue.getPFVArControllerType2DynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArControllerType2Dynamics for pFVArControllerType2DynamicsId consumed"));
  ...
  protected PFVArControllerType2Dynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArControllerType2Dynamics with primary key");
    msg.append(pFVArControllerType2DynamicsId);

    PFVArControllerType2DynamicsFetchOneSummary fetchOneSummary =
        new PFVArControllerType2DynamicsFetchOneSummary(pFVArControllerType2DynamicsId);

    try {
      entity =
          PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance()
              .getPFVArControllerType2Dynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArControllerType2DynamicsBusinessDelegate proxy =
          PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArControllerType2Dynamics with id "
              + pFVArControllerType2DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArControllerType2Dynamics with id "
              + pFVArControllerType2DynamicsId);
    ...
    try {
      PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance()
          .delete(
              new DeletePFVArControllerType2DynamicsCommand(
                  entity.getPFVArControllerType2DynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArControllerType2Dynamics with id "
              + pFVArControllerType2DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArControllerType2Dynamics with id "
              + pFVArControllerType2DynamicsId);
  ...
  protected List<PFVArControllerType2Dynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PFVArControllerType2DynamicsBusinessDelegate.getPFVArControllerType2DynamicsInstance()
              .getAllPFVArControllerType2Dynamics();
      assertNotNull(
          collection,
          "An Empty collection of PFVArControllerType2Dynamics was incorrectly returned.");
  ...
  protected CreatePFVArControllerType2DynamicsCommand generateNewCommand() {
    CreatePFVArControllerType2DynamicsCommand command =
        new CreatePFVArControllerType2DynamicsCommand(null);
  ...
  protected UpdatePFVArControllerType2DynamicsCommand generateUpdateCommand() {
    UpdatePFVArControllerType2DynamicsCommand command =
        new UpdatePFVArControllerType2DynamicsCommand(null);
