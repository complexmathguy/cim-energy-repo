...
public class DCBusbarTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dCBusbarId =
        DCBusbarBusinessDelegate.getDCBusbarInstance().createDCBusbar(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCBusbar : " + successValue.getDCBusbarId());
                  if (successValue.getDCBusbarId().equals(dCBusbarId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCBusbarList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DCBusbar : "
                          + successValue.getDCBusbarId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dCBusbarId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCBusbarBusinessDelegate.getDCBusbarInstance()
          .delete(new DeleteDCBusbarCommand(entity.getDCBusbarId()))
          .get();
