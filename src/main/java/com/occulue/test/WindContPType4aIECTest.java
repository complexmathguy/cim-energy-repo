...
public class WindContPType4aIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindContPType4aIEC : "
                          + successValue.getWindContPType4aIECId());
                  if (successValue.getWindContPType4aIECId().equals(windContPType4aIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindContPType4aIECList - 1,
      ...
      subscriber
          .windContPType4aIECSubscribe(windContPType4aIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindContPType4aIEC : "
                          + successValue.getWindContPType4aIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windContPType4aIEC for windContPType4aIECId consumed"));
  ...
  protected WindContPType4aIEC read() throws Throwable {
    ...
    WindContPType4aIECFetchOneSummary fetchOneSummary =
        new WindContPType4aIECFetchOneSummary(windContPType4aIECId);

    try {
      entity =
          WindContPType4aIECBusinessDelegate.getWindContPType4aIECInstance()
              .getWindContPType4aIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindContPType4aIECBusinessDelegate proxy =
          WindContPType4aIECBusinessDelegate.getWindContPType4aIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindContPType4aIECBusinessDelegate.getWindContPType4aIECInstance()
          .delete(new DeleteWindContPType4aIECCommand(entity.getWindContPType4aIECId()))
          .get();
  ...
  protected List<WindContPType4aIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindContPType4aIECBusinessDelegate.getWindContPType4aIECInstance()
              .getAllWindContPType4aIEC();
      assertNotNull(
          collection, "An Empty collection of WindContPType4aIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindContPType4aIECId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateWindContPType4aIECCommand generateUpdateCommand() {
    UpdateWindContPType4aIECCommand command =
        new UpdateWindContPType4aIECCommand(null, null, null, null);
