...
public class PFVArType2Common1Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArType2Common1 : "
                          + successValue.getPFVArType2Common1Id());
                  if (successValue.getPFVArType2Common1Id().equals(pFVArType2Common1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArType2Common1List - 1,
      ...
      subscriber
          .pFVArType2Common1Subscribe(pFVArType2Common1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArType2Common1 : "
                          + successValue.getPFVArType2Common1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArType2Common1 for pFVArType2Common1Id consumed"));
  ...
  protected PFVArType2Common1 read() throws Throwable {
    ...
    PFVArType2Common1FetchOneSummary fetchOneSummary =
        new PFVArType2Common1FetchOneSummary(pFVArType2Common1Id);

    try {
      entity =
          PFVArType2Common1BusinessDelegate.getPFVArType2Common1Instance()
              .getPFVArType2Common1(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArType2Common1BusinessDelegate proxy =
          PFVArType2Common1BusinessDelegate.getPFVArType2Common1Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PFVArType2Common1BusinessDelegate.getPFVArType2Common1Instance()
          .delete(new DeletePFVArType2Common1Command(entity.getPFVArType2Common1Id()))
          .get();
  ...
  protected List<PFVArType2Common1> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PFVArType2Common1BusinessDelegate.getPFVArType2Common1Instance()
              .getAllPFVArType2Common1();
      assertNotNull(
          collection, "An Empty collection of PFVArType2Common1 was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPFVArType2Common1Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdatePFVArType2Common1Command generateUpdateCommand() {
    UpdatePFVArType2Common1Command command =
        new UpdatePFVArType2Common1Command(null, null, null, null, null, null);
