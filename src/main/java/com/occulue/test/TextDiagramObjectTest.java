...
public class TextDiagramObjectTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TextDiagramObject : "
                          + successValue.getTextDiagramObjectId());
                  if (successValue.getTextDiagramObjectId().equals(textDiagramObjectId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTextDiagramObjectList - 1,
      ...
      subscriber
          .textDiagramObjectSubscribe(textDiagramObjectId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TextDiagramObject : "
                          + successValue.getTextDiagramObjectId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on textDiagramObject for textDiagramObjectId consumed"));
  ...
  protected TextDiagramObject read() throws Throwable {
    ...
    TextDiagramObjectFetchOneSummary fetchOneSummary =
        new TextDiagramObjectFetchOneSummary(textDiagramObjectId);

    try {
      entity =
          TextDiagramObjectBusinessDelegate.getTextDiagramObjectInstance()
              .getTextDiagramObject(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TextDiagramObjectBusinessDelegate proxy =
          TextDiagramObjectBusinessDelegate.getTextDiagramObjectInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TextDiagramObjectBusinessDelegate.getTextDiagramObjectInstance()
          .delete(new DeleteTextDiagramObjectCommand(entity.getTextDiagramObjectId()))
          .get();
  ...
  protected List<TextDiagramObject> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of TextDiagramObject was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTextDiagramObjectId(), "-- entity in Collection has a null primary key");
