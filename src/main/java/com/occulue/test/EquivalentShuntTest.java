...
public class EquivalentShuntTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EquivalentShunt : "
                          + successValue.getEquivalentShuntId());
                  if (successValue.getEquivalentShuntId().equals(equivalentShuntId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEquivalentShuntList - 1,
      ...
      subscriber
          .equivalentShuntSubscribe(equivalentShuntId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EquivalentShunt : "
                          + successValue.getEquivalentShuntId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected EquivalentShunt read() throws Throwable {
    ...
    EquivalentShuntFetchOneSummary fetchOneSummary =
        new EquivalentShuntFetchOneSummary(equivalentShuntId);

    try {
      entity =
          EquivalentShuntBusinessDelegate.getEquivalentShuntInstance()
              .getEquivalentShunt(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EquivalentShuntBusinessDelegate proxy =
          EquivalentShuntBusinessDelegate.getEquivalentShuntInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EquivalentShuntBusinessDelegate.getEquivalentShuntInstance()
          .delete(new DeleteEquivalentShuntCommand(entity.getEquivalentShuntId()))
          .get();
  ...
  protected List<EquivalentShunt> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          EquivalentShuntBusinessDelegate.getEquivalentShuntInstance().getAllEquivalentShunt();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEquivalentShuntId(), "-- entity in Collection has a null primary key");
