...
public class PssPTIST3Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    PssPTIST3BusinessDelegate.getPssPTIST3Instance().createPssPTIST3(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PssPTIST3 : " + successValue.getPssPTIST3Id());
                  if (successValue.getPssPTIST3Id().equals(pssPTIST3Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPssPTIST3List - 1,
      ...
      subscriber
          .pssPTIST3Subscribe(pssPTIST3Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PssPTIST3 : "
                          + successValue.getPssPTIST3Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssPTIST3Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssPTIST3BusinessDelegate.getPssPTIST3Instance()
          .delete(new DeletePssPTIST3Command(entity.getPssPTIST3Id()))
          .get();
  ...
  protected UpdatePssPTIST3Command generateUpdateCommand() {
    UpdatePssPTIST3Command command =
        new UpdatePssPTIST3Command(
