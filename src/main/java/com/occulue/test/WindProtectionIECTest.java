...
public class WindProtectionIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindProtectionIEC : "
                          + successValue.getWindProtectionIECId());
                  if (successValue.getWindProtectionIECId().equals(windProtectionIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindProtectionIECList - 1,
      ...
      subscriber
          .windProtectionIECSubscribe(windProtectionIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindProtectionIEC : "
                          + successValue.getWindProtectionIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windProtectionIEC for windProtectionIECId consumed"));
  ...
  protected WindProtectionIEC read() throws Throwable {
    ...
    WindProtectionIECFetchOneSummary fetchOneSummary =
        new WindProtectionIECFetchOneSummary(windProtectionIECId);

    try {
      entity =
          WindProtectionIECBusinessDelegate.getWindProtectionIECInstance()
              .getWindProtectionIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindProtectionIECBusinessDelegate proxy =
          WindProtectionIECBusinessDelegate.getWindProtectionIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindProtectionIECBusinessDelegate.getWindProtectionIECInstance()
          .delete(new DeleteWindProtectionIECCommand(entity.getWindProtectionIECId()))
          .get();
  ...
  protected List<WindProtectionIEC> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of WindProtectionIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindProtectionIECId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateWindProtectionIECCommand generateUpdateCommand() {
    UpdateWindProtectionIECCommand command =
        new UpdateWindProtectionIECCommand(null, null, null, null, null, null, null, null, null);
