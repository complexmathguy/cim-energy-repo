...
public class ENTSOEIdentifiedObjectTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ENTSOEIdentifiedObject : "
                          + successValue.getENTSOEIdentifiedObjectId());
                  if (successValue.getENTSOEIdentifiedObjectId().equals(eNTSOEIdentifiedObjectId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfENTSOEIdentifiedObjectList - 1,
      ...
      subscriber
          .eNTSOEIdentifiedObjectSubscribe(eNTSOEIdentifiedObjectId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ENTSOEIdentifiedObject : "
                          + successValue.getENTSOEIdentifiedObjectId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on eNTSOEIdentifiedObject for eNTSOEIdentifiedObjectId consumed"));
  ...
  protected ENTSOEIdentifiedObject read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ENTSOEIdentifiedObject with primary key");
    msg.append(eNTSOEIdentifiedObjectId);

    ENTSOEIdentifiedObjectFetchOneSummary fetchOneSummary =
        new ENTSOEIdentifiedObjectFetchOneSummary(eNTSOEIdentifiedObjectId);

    try {
      entity =
          ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance()
              .getENTSOEIdentifiedObject(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ENTSOEIdentifiedObjectBusinessDelegate proxy =
          ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ENTSOEIdentifiedObject with id " + eNTSOEIdentifiedObjectId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ENTSOEIdentifiedObject with id " + eNTSOEIdentifiedObjectId);
    ...
    try {
      ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance()
          .delete(new DeleteENTSOEIdentifiedObjectCommand(entity.getENTSOEIdentifiedObjectId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ENTSOEIdentifiedObject with id " + eNTSOEIdentifiedObjectId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ENTSOEIdentifiedObject with id " + eNTSOEIdentifiedObjectId);
  ...
  protected List<ENTSOEIdentifiedObject> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ENTSOEIdentifiedObjectBusinessDelegate.getENTSOEIdentifiedObjectInstance()
              .getAllENTSOEIdentifiedObject();
      assertNotNull(
          collection, "An Empty collection of ENTSOEIdentifiedObject was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getENTSOEIdentifiedObjectId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateENTSOEIdentifiedObjectCommand generateUpdateCommand() {
    UpdateENTSOEIdentifiedObjectCommand command =
        new UpdateENTSOEIdentifiedObjectCommand(null, null, null);
