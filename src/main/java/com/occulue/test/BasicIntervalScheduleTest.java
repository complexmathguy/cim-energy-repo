...
public class BasicIntervalScheduleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for BasicIntervalSchedule : "
                          + successValue.getBasicIntervalScheduleId());
                  if (successValue.getBasicIntervalScheduleId().equals(basicIntervalScheduleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfBasicIntervalScheduleList - 1,
      ...
      subscriber
          .basicIntervalScheduleSubscribe(basicIntervalScheduleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for BasicIntervalSchedule : "
                          + successValue.getBasicIntervalScheduleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on basicIntervalSchedule for basicIntervalScheduleId consumed"));
  ...
  protected BasicIntervalSchedule read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read BasicIntervalSchedule with primary key");
    msg.append(basicIntervalScheduleId);

    BasicIntervalScheduleFetchOneSummary fetchOneSummary =
        new BasicIntervalScheduleFetchOneSummary(basicIntervalScheduleId);

    try {
      entity =
          BasicIntervalScheduleBusinessDelegate.getBasicIntervalScheduleInstance()
              .getBasicIntervalSchedule(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      BasicIntervalScheduleBusinessDelegate proxy =
          BasicIntervalScheduleBusinessDelegate.getBasicIntervalScheduleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      BasicIntervalScheduleBusinessDelegate.getBasicIntervalScheduleInstance()
          .delete(new DeleteBasicIntervalScheduleCommand(entity.getBasicIntervalScheduleId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted BasicIntervalSchedule with id " + basicIntervalScheduleId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete BasicIntervalSchedule with id " + basicIntervalScheduleId);
  ...
  protected List<BasicIntervalSchedule> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of BasicIntervalSchedule was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getBasicIntervalScheduleId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateBasicIntervalScheduleCommand generateNewCommand() {
    CreateBasicIntervalScheduleCommand command =
        new CreateBasicIntervalScheduleCommand(
            null, UnitSymbol.values()[0], UnitSymbol.values()[0]);
  ...
  protected UpdateBasicIntervalScheduleCommand generateUpdateCommand() {
    UpdateBasicIntervalScheduleCommand command =
        new UpdateBasicIntervalScheduleCommand(
            null, null, UnitSymbol.values()[0], UnitSymbol.values()[0]);
