...
public class GovGASTTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    govGASTId =
        GovGASTBusinessDelegate.getGovGASTInstance().createGovGAST(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovGAST : " + successValue.getGovGASTId());
                  if (successValue.getGovGASTId().equals(govGASTId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovGASTList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for GovGAST : "
                          + successValue.getGovGASTId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govGASTId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovGASTBusinessDelegate.getGovGASTInstance()
          .delete(new DeleteGovGASTCommand(entity.getGovGASTId()))
          .get();
  ...
  protected UpdateGovGASTCommand generateUpdateCommand() {
    UpdateGovGASTCommand command =
        new UpdateGovGASTCommand(null, null, null, null, null, null, null, null, null, null, null);
