...
public class NonlinearShuntCompensatorTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for NonlinearShuntCompensator : "
                          + successValue.getNonlinearShuntCompensatorId());
                  if (successValue
                      .getNonlinearShuntCompensatorId()
                      .equals(nonlinearShuntCompensatorId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfNonlinearShuntCompensatorList - 1,
      ...
      subscriber
          .nonlinearShuntCompensatorSubscribe(nonlinearShuntCompensatorId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for NonlinearShuntCompensator : "
                          + successValue.getNonlinearShuntCompensatorId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on nonlinearShuntCompensator for nonlinearShuntCompensatorId consumed"));
  ...
  protected NonlinearShuntCompensator read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read NonlinearShuntCompensator with primary key");
    msg.append(nonlinearShuntCompensatorId);

    NonlinearShuntCompensatorFetchOneSummary fetchOneSummary =
        new NonlinearShuntCompensatorFetchOneSummary(nonlinearShuntCompensatorId);

    try {
      entity =
          NonlinearShuntCompensatorBusinessDelegate.getNonlinearShuntCompensatorInstance()
              .getNonlinearShuntCompensator(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      NonlinearShuntCompensatorBusinessDelegate proxy =
          NonlinearShuntCompensatorBusinessDelegate.getNonlinearShuntCompensatorInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read NonlinearShuntCompensator with id " + nonlinearShuntCompensatorId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read NonlinearShuntCompensator with id " + nonlinearShuntCompensatorId);
    ...
    try {
      NonlinearShuntCompensatorBusinessDelegate.getNonlinearShuntCompensatorInstance()
          .delete(
              new DeleteNonlinearShuntCompensatorCommand(entity.getNonlinearShuntCompensatorId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted NonlinearShuntCompensator with id "
              + nonlinearShuntCompensatorId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete NonlinearShuntCompensator with id " + nonlinearShuntCompensatorId);
  ...
  protected List<NonlinearShuntCompensator> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of NonlinearShuntCompensator was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getNonlinearShuntCompensatorId(),
  ...
  protected CreateNonlinearShuntCompensatorCommand generateNewCommand() {
    CreateNonlinearShuntCompensatorCommand command =
        new CreateNonlinearShuntCompensatorCommand(null);
  ...
  protected UpdateNonlinearShuntCompensatorCommand generateUpdateCommand() {
    UpdateNonlinearShuntCompensatorCommand command =
        new UpdateNonlinearShuntCompensatorCommand(null);
