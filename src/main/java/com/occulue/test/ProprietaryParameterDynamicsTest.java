...
public class ProprietaryParameterDynamicsTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    proprietaryParameterDynamicsId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ProprietaryParameterDynamics : "
                          + successValue.getProprietaryParameterDynamicsId());
                  if (successValue
                      .getProprietaryParameterDynamicsId()
                      .equals(proprietaryParameterDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfProprietaryParameterDynamicsList - 1,
      ...
      subscriber
          .proprietaryParameterDynamicsSubscribe(proprietaryParameterDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ProprietaryParameterDynamics : "
                          + successValue.getProprietaryParameterDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on proprietaryParameterDynamics for proprietaryParameterDynamicsId consumed"));
  ...
  protected ProprietaryParameterDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ProprietaryParameterDynamics with primary key");
    msg.append(proprietaryParameterDynamicsId);

    ProprietaryParameterDynamicsFetchOneSummary fetchOneSummary =
        new ProprietaryParameterDynamicsFetchOneSummary(proprietaryParameterDynamicsId);

    try {
      entity =
          ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance()
              .getProprietaryParameterDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ProprietaryParameterDynamicsBusinessDelegate proxy =
          ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ProprietaryParameterDynamics with id "
              + proprietaryParameterDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ProprietaryParameterDynamics with id "
              + proprietaryParameterDynamicsId);
    ...
    try {
      ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance()
          .delete(
              new DeleteProprietaryParameterDynamicsCommand(
                  entity.getProprietaryParameterDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ProprietaryParameterDynamics with id "
              + proprietaryParameterDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ProprietaryParameterDynamics with id "
              + proprietaryParameterDynamicsId);
  ...
  protected List<ProprietaryParameterDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ProprietaryParameterDynamicsBusinessDelegate.getProprietaryParameterDynamicsInstance()
              .getAllProprietaryParameterDynamics();
      assertNotNull(
          collection,
          "An Empty collection of ProprietaryParameterDynamics was incorrectly returned.");
  ...
  protected CreateProprietaryParameterDynamicsCommand generateNewCommand() {
    CreateProprietaryParameterDynamicsCommand command =
        new CreateProprietaryParameterDynamicsCommand(null);
  ...
  protected UpdateProprietaryParameterDynamicsCommand generateUpdateCommand() {
    UpdateProprietaryParameterDynamicsCommand command =
        new UpdateProprietaryParameterDynamicsCommand(null, null, null, null, null);
