...
public class PhaseTapChangerSymmetricalTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PhaseTapChangerSymmetrical : "
                          + successValue.getPhaseTapChangerSymmetricalId());
                  if (successValue
                      .getPhaseTapChangerSymmetricalId()
                      .equals(phaseTapChangerSymmetricalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPhaseTapChangerSymmetricalList - 1,
      ...
      subscriber
          .phaseTapChangerSymmetricalSubscribe(phaseTapChangerSymmetricalId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PhaseTapChangerSymmetrical : "
                          + successValue.getPhaseTapChangerSymmetricalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on phaseTapChangerSymmetrical for phaseTapChangerSymmetricalId consumed"));
  ...
  protected PhaseTapChangerSymmetrical read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PhaseTapChangerSymmetrical with primary key");
    msg.append(phaseTapChangerSymmetricalId);

    PhaseTapChangerSymmetricalFetchOneSummary fetchOneSummary =
        new PhaseTapChangerSymmetricalFetchOneSummary(phaseTapChangerSymmetricalId);

    try {
      entity =
          PhaseTapChangerSymmetricalBusinessDelegate.getPhaseTapChangerSymmetricalInstance()
              .getPhaseTapChangerSymmetrical(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PhaseTapChangerSymmetricalBusinessDelegate proxy =
          PhaseTapChangerSymmetricalBusinessDelegate.getPhaseTapChangerSymmetricalInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PhaseTapChangerSymmetrical with id "
              + phaseTapChangerSymmetricalId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PhaseTapChangerSymmetrical with id " + phaseTapChangerSymmetricalId);
    ...
    try {
      PhaseTapChangerSymmetricalBusinessDelegate.getPhaseTapChangerSymmetricalInstance()
          .delete(
              new DeletePhaseTapChangerSymmetricalCommand(entity.getPhaseTapChangerSymmetricalId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PhaseTapChangerSymmetrical with id "
              + phaseTapChangerSymmetricalId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PhaseTapChangerSymmetrical with id " + phaseTapChangerSymmetricalId);
  ...
  protected List<PhaseTapChangerSymmetrical> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PhaseTapChangerSymmetricalBusinessDelegate.getPhaseTapChangerSymmetricalInstance()
              .getAllPhaseTapChangerSymmetrical();
      assertNotNull(
          collection,
          "An Empty collection of PhaseTapChangerSymmetrical was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPhaseTapChangerSymmetricalId(),
  ...
  protected CreatePhaseTapChangerSymmetricalCommand generateNewCommand() {
    CreatePhaseTapChangerSymmetricalCommand command =
        new CreatePhaseTapChangerSymmetricalCommand(null);
  ...
  protected UpdatePhaseTapChangerSymmetricalCommand generateUpdateCommand() {
    UpdatePhaseTapChangerSymmetricalCommand command =
        new UpdatePhaseTapChangerSymmetricalCommand(null);
