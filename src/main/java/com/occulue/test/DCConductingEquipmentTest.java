...
public class DCConductingEquipmentTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCConductingEquipment : "
                          + successValue.getDCConductingEquipmentId());
                  if (successValue.getDCConductingEquipmentId().equals(dCConductingEquipmentId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCConductingEquipmentList - 1,
      ...
      subscriber
          .dCConductingEquipmentSubscribe(dCConductingEquipmentId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCConductingEquipment : "
                          + successValue.getDCConductingEquipmentId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on dCConductingEquipment for dCConductingEquipmentId consumed"));
  ...
  protected DCConductingEquipment read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read DCConductingEquipment with primary key");
    msg.append(dCConductingEquipmentId);

    DCConductingEquipmentFetchOneSummary fetchOneSummary =
        new DCConductingEquipmentFetchOneSummary(dCConductingEquipmentId);

    try {
      entity =
          DCConductingEquipmentBusinessDelegate.getDCConductingEquipmentInstance()
              .getDCConductingEquipment(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DCConductingEquipmentBusinessDelegate proxy =
          DCConductingEquipmentBusinessDelegate.getDCConductingEquipmentInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCConductingEquipmentBusinessDelegate.getDCConductingEquipmentInstance()
          .delete(new DeleteDCConductingEquipmentCommand(entity.getDCConductingEquipmentId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted DCConductingEquipment with id " + dCConductingEquipmentId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete DCConductingEquipment with id " + dCConductingEquipmentId);
  ...
  protected List<DCConductingEquipment> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          DCConductingEquipmentBusinessDelegate.getDCConductingEquipmentInstance()
              .getAllDCConductingEquipment();
      assertNotNull(
          collection, "An Empty collection of DCConductingEquipment was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDCConductingEquipmentId(), "-- entity in Collection has a null primary key");
