...
public class StringMeasurementTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for StringMeasurement : "
                          + successValue.getStringMeasurementId());
                  if (successValue.getStringMeasurementId().equals(stringMeasurementId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfStringMeasurementList - 1,
      ...
      subscriber
          .stringMeasurementSubscribe(stringMeasurementId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for StringMeasurement : "
                          + successValue.getStringMeasurementId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on stringMeasurement for stringMeasurementId consumed"));
  ...
  protected StringMeasurement read() throws Throwable {
    ...
    StringMeasurementFetchOneSummary fetchOneSummary =
        new StringMeasurementFetchOneSummary(stringMeasurementId);

    try {
      entity =
          StringMeasurementBusinessDelegate.getStringMeasurementInstance()
              .getStringMeasurement(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      StringMeasurementBusinessDelegate proxy =
          StringMeasurementBusinessDelegate.getStringMeasurementInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      StringMeasurementBusinessDelegate.getStringMeasurementInstance()
          .delete(new DeleteStringMeasurementCommand(entity.getStringMeasurementId()))
          .get();
  ...
  protected List<StringMeasurement> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          StringMeasurementBusinessDelegate.getStringMeasurementInstance()
              .getAllStringMeasurement();
      assertNotNull(
          collection, "An Empty collection of StringMeasurement was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getStringMeasurementId(), "-- entity in Collection has a null primary key");
