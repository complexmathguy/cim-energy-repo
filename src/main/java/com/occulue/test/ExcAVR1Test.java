...
public class ExcAVR1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAVR1Id =
        ExcAVR1BusinessDelegate.getExcAVR1Instance().createExcAVR1(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAVR1 : " + successValue.getExcAVR1Id());
                  if (successValue.getExcAVR1Id().equals(excAVR1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAVR1List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAVR1 : "
                          + successValue.getExcAVR1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAVR1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAVR1BusinessDelegate.getExcAVR1Instance()
          .delete(new DeleteExcAVR1Command(entity.getExcAVR1Id()))
          .get();
  ...
  protected UpdateExcAVR1Command generateUpdateCommand() {
    UpdateExcAVR1Command command =
        new UpdateExcAVR1Command(
