...
public class GroundDisconnectorTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GroundDisconnector : "
                          + successValue.getGroundDisconnectorId());
                  if (successValue.getGroundDisconnectorId().equals(groundDisconnectorId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGroundDisconnectorList - 1,
      ...
      subscriber
          .groundDisconnectorSubscribe(groundDisconnectorId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GroundDisconnector : "
                          + successValue.getGroundDisconnectorId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on groundDisconnector for groundDisconnectorId consumed"));
  ...
  protected GroundDisconnector read() throws Throwable {
    ...
    GroundDisconnectorFetchOneSummary fetchOneSummary =
        new GroundDisconnectorFetchOneSummary(groundDisconnectorId);

    try {
      entity =
          GroundDisconnectorBusinessDelegate.getGroundDisconnectorInstance()
              .getGroundDisconnector(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GroundDisconnectorBusinessDelegate proxy =
          GroundDisconnectorBusinessDelegate.getGroundDisconnectorInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GroundDisconnectorBusinessDelegate.getGroundDisconnectorInstance()
          .delete(new DeleteGroundDisconnectorCommand(entity.getGroundDisconnectorId()))
          .get();
  ...
  protected List<GroundDisconnector> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          GroundDisconnectorBusinessDelegate.getGroundDisconnectorInstance()
              .getAllGroundDisconnector();
      assertNotNull(
          collection, "An Empty collection of GroundDisconnector was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGroundDisconnectorId(), "-- entity in Collection has a null primary key");
