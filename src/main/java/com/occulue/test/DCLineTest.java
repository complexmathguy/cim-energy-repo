...
public class DCLineTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dCLineId = DCLineBusinessDelegate.getDCLineInstance().createDCLine(generateNewCommand()).get();
    ...
    DCLineBusinessDelegate.getDCLineInstance().createDCLine(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DCLine : "
                          + successValue.getDCLineId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dCLineId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCLineBusinessDelegate.getDCLineInstance()
          .delete(new DeleteDCLineCommand(entity.getDCLineId()))
          .get();
