...
public class ENTSOETopologicalNodeTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ENTSOETopologicalNode : "
                          + successValue.getENTSOETopologicalNodeId());
                  if (successValue.getENTSOETopologicalNodeId().equals(eNTSOETopologicalNodeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfENTSOETopologicalNodeList - 1,
      ...
      subscriber
          .eNTSOETopologicalNodeSubscribe(eNTSOETopologicalNodeId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ENTSOETopologicalNode : "
                          + successValue.getENTSOETopologicalNodeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on eNTSOETopologicalNode for eNTSOETopologicalNodeId consumed"));
  ...
  protected ENTSOETopologicalNode read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ENTSOETopologicalNode with primary key");
    msg.append(eNTSOETopologicalNodeId);

    ENTSOETopologicalNodeFetchOneSummary fetchOneSummary =
        new ENTSOETopologicalNodeFetchOneSummary(eNTSOETopologicalNodeId);

    try {
      entity =
          ENTSOETopologicalNodeBusinessDelegate.getENTSOETopologicalNodeInstance()
              .getENTSOETopologicalNode(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ENTSOETopologicalNodeBusinessDelegate proxy =
          ENTSOETopologicalNodeBusinessDelegate.getENTSOETopologicalNodeInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ENTSOETopologicalNodeBusinessDelegate.getENTSOETopologicalNodeInstance()
          .delete(new DeleteENTSOETopologicalNodeCommand(entity.getENTSOETopologicalNodeId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ENTSOETopologicalNode with id " + eNTSOETopologicalNodeId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ENTSOETopologicalNode with id " + eNTSOETopologicalNodeId);
  ...
  protected List<ENTSOETopologicalNode> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ENTSOETopologicalNodeBusinessDelegate.getENTSOETopologicalNodeInstance()
              .getAllENTSOETopologicalNode();
      assertNotNull(
          collection, "An Empty collection of ENTSOETopologicalNode was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getENTSOETopologicalNodeId(), "-- entity in Collection has a null primary key");
