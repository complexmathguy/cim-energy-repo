...
public class WindGenType4IECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindGenType4IEC : "
                          + successValue.getWindGenType4IECId());
                  if (successValue.getWindGenType4IECId().equals(windGenType4IECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindGenType4IECList - 1,
      ...
      subscriber
          .windGenType4IECSubscribe(windGenType4IECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindGenType4IEC : "
                          + successValue.getWindGenType4IECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected WindGenType4IEC read() throws Throwable {
    ...
    WindGenType4IECFetchOneSummary fetchOneSummary =
        new WindGenType4IECFetchOneSummary(windGenType4IECId);

    try {
      entity =
          WindGenType4IECBusinessDelegate.getWindGenType4IECInstance()
              .getWindGenType4IEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindGenType4IECBusinessDelegate proxy =
          WindGenType4IECBusinessDelegate.getWindGenType4IECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindGenType4IECBusinessDelegate.getWindGenType4IECInstance()
          .delete(new DeleteWindGenType4IECCommand(entity.getWindGenType4IECId()))
          .get();
  ...
  protected List<WindGenType4IEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindGenType4IECBusinessDelegate.getWindGenType4IECInstance().getAllWindGenType4IEC();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindGenType4IECId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateWindGenType4IECCommand generateUpdateCommand() {
    UpdateWindGenType4IECCommand command =
        new UpdateWindGenType4IECCommand(null, null, null, null, null);
