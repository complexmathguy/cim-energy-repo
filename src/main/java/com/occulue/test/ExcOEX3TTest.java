...
public class ExcOEX3TTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excOEX3TId =
        ExcOEX3TBusinessDelegate.getExcOEX3TInstance().createExcOEX3T(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcOEX3T : " + successValue.getExcOEX3TId());
                  if (successValue.getExcOEX3TId().equals(excOEX3TId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcOEX3TList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcOEX3T : "
                          + successValue.getExcOEX3TId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excOEX3TId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcOEX3TBusinessDelegate.getExcOEX3TInstance()
          .delete(new DeleteExcOEX3TCommand(entity.getExcOEX3TId()))
          .get();
  ...
  protected UpdateExcOEX3TCommand generateUpdateCommand() {
    UpdateExcOEX3TCommand command =
        new UpdateExcOEX3TCommand(
