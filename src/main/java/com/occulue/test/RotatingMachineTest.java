...
public class RotatingMachineTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RotatingMachine : "
                          + successValue.getRotatingMachineId());
                  if (successValue.getRotatingMachineId().equals(rotatingMachineId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRotatingMachineList - 1,
      ...
      subscriber
          .rotatingMachineSubscribe(rotatingMachineId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RotatingMachine : "
                          + successValue.getRotatingMachineId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected RotatingMachine read() throws Throwable {
    ...
    RotatingMachineFetchOneSummary fetchOneSummary =
        new RotatingMachineFetchOneSummary(rotatingMachineId);

    try {
      entity =
          RotatingMachineBusinessDelegate.getRotatingMachineInstance()
              .getRotatingMachine(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RotatingMachineBusinessDelegate proxy =
          RotatingMachineBusinessDelegate.getRotatingMachineInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      RotatingMachineBusinessDelegate.getRotatingMachineInstance()
          .delete(new DeleteRotatingMachineCommand(entity.getRotatingMachineId()))
          .get();
  ...
  protected List<RotatingMachine> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRotatingMachineId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateRotatingMachineCommand generateUpdateCommand() {
    UpdateRotatingMachineCommand command = new UpdateRotatingMachineCommand(null, null, null, null);
