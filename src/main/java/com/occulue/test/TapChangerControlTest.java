...
public class TapChangerControlTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TapChangerControl : "
                          + successValue.getTapChangerControlId());
                  if (successValue.getTapChangerControlId().equals(tapChangerControlId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTapChangerControlList - 1,
      ...
      subscriber
          .tapChangerControlSubscribe(tapChangerControlId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TapChangerControl : "
                          + successValue.getTapChangerControlId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on tapChangerControl for tapChangerControlId consumed"));
  ...
  protected TapChangerControl read() throws Throwable {
    ...
    TapChangerControlFetchOneSummary fetchOneSummary =
        new TapChangerControlFetchOneSummary(tapChangerControlId);

    try {
      entity =
          TapChangerControlBusinessDelegate.getTapChangerControlInstance()
              .getTapChangerControl(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TapChangerControlBusinessDelegate proxy =
          TapChangerControlBusinessDelegate.getTapChangerControlInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TapChangerControlBusinessDelegate.getTapChangerControlInstance()
          .delete(new DeleteTapChangerControlCommand(entity.getTapChangerControlId()))
          .get();
  ...
  protected List<TapChangerControl> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          TapChangerControlBusinessDelegate.getTapChangerControlInstance()
              .getAllTapChangerControl();
      assertNotNull(
          collection, "An Empty collection of TapChangerControl was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTapChangerControlId(), "-- entity in Collection has a null primary key");
