...
public class ENTSOEConnectivityNodeTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ENTSOEConnectivityNode : "
                          + successValue.getENTSOEConnectivityNodeId());
                  if (successValue.getENTSOEConnectivityNodeId().equals(eNTSOEConnectivityNodeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfENTSOEConnectivityNodeList - 1,
      ...
      subscriber
          .eNTSOEConnectivityNodeSubscribe(eNTSOEConnectivityNodeId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ENTSOEConnectivityNode : "
                          + successValue.getENTSOEConnectivityNodeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on eNTSOEConnectivityNode for eNTSOEConnectivityNodeId consumed"));
  ...
  protected ENTSOEConnectivityNode read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ENTSOEConnectivityNode with primary key");
    msg.append(eNTSOEConnectivityNodeId);

    ENTSOEConnectivityNodeFetchOneSummary fetchOneSummary =
        new ENTSOEConnectivityNodeFetchOneSummary(eNTSOEConnectivityNodeId);

    try {
      entity =
          ENTSOEConnectivityNodeBusinessDelegate.getENTSOEConnectivityNodeInstance()
              .getENTSOEConnectivityNode(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ENTSOEConnectivityNodeBusinessDelegate proxy =
          ENTSOEConnectivityNodeBusinessDelegate.getENTSOEConnectivityNodeInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ENTSOEConnectivityNode with id " + eNTSOEConnectivityNodeId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ENTSOEConnectivityNode with id " + eNTSOEConnectivityNodeId);
    ...
    try {
      ENTSOEConnectivityNodeBusinessDelegate.getENTSOEConnectivityNodeInstance()
          .delete(new DeleteENTSOEConnectivityNodeCommand(entity.getENTSOEConnectivityNodeId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ENTSOEConnectivityNode with id " + eNTSOEConnectivityNodeId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ENTSOEConnectivityNode with id " + eNTSOEConnectivityNodeId);
  ...
  protected List<ENTSOEConnectivityNode> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of ENTSOEConnectivityNode was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getENTSOEConnectivityNodeId(), "-- entity in Collection has a null primary key");
