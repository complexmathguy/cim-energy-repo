...
public class SynchronousMachineTimeConstantReactanceTest {
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SynchronousMachineTimeConstantReactance : "
                          + successValue.getSynchronousMachineTimeConstantReactanceId());
                  if (successValue
                      .getSynchronousMachineTimeConstantReactanceId()
                      .equals(synchronousMachineTimeConstantReactanceId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSynchronousMachineTimeConstantReactanceList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "SynchronousMachineTimeConstantReactance test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for SynchronousMachineTimeConstantReactance : "
                          + successValue.getSynchronousMachineTimeConstantReactanceId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on synchronousMachineTimeConstantReactance for synchronousMachineTimeConstantReactanceId consumed"));
  ...
  protected SynchronousMachineTimeConstantReactance read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder(
            "-- Failed to read SynchronousMachineTimeConstantReactance with primary key");
    msg.append(synchronousMachineTimeConstantReactanceId);

    SynchronousMachineTimeConstantReactanceFetchOneSummary fetchOneSummary =
    ...
    try {
      entity =
          SynchronousMachineTimeConstantReactanceBusinessDelegate
              .getSynchronousMachineTimeConstantReactanceInstance()
              .getSynchronousMachineTimeConstantReactance(fetchOneSummary);

      assertNotNull(entity, msg.toString());

      LOGGER.info(
          "-- Successfully found SynchronousMachineTimeConstantReactance " + entity.toString());
    } catch (Throwable e) {
  ...
  protected void update() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("Failed to update a SynchronousMachineTimeConstantReactance : ");
    ...
    command.setSynchronousMachineTimeConstantReactanceId(
        entity.getSynchronousMachineTimeConstantReactanceId());
    ...
    try {
      ...
      SynchronousMachineTimeConstantReactanceBusinessDelegate proxy =
          SynchronousMachineTimeConstantReactanceBusinessDelegate
              .getSynchronousMachineTimeConstantReactanceInstance();
      ...
      LOGGER.info(
          "-- Successfully saved SynchronousMachineTimeConstantReactance - " + entity.toString());
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString()
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SynchronousMachineTimeConstantReactance with id "
              + synchronousMachineTimeConstantReactanceId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SynchronousMachineTimeConstantReactance with id "
              + synchronousMachineTimeConstantReactanceId);
    ...
    try {
      SynchronousMachineTimeConstantReactanceBusinessDelegate
          ...
          .get();
      LOGGER.info(
          "-- Successfully deleted SynchronousMachineTimeConstantReactance with id "
              + synchronousMachineTimeConstantReactanceId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SynchronousMachineTimeConstantReactance with id "
              + synchronousMachineTimeConstantReactanceId);
  ...
  protected List<SynchronousMachineTimeConstantReactance> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all SynchronousMachineTimeConstantReactance : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of SynchronousMachineTimeConstantReactance was incorrectly returned.");
  ...
  protected CreateSynchronousMachineTimeConstantReactanceCommand generateNewCommand() {
    CreateSynchronousMachineTimeConstantReactanceCommand command =
        new CreateSynchronousMachineTimeConstantReactanceCommand(
            null, SynchronousMachineModelKind.values()[0], RotorKind.values()[0]);
  ...
  protected UpdateSynchronousMachineTimeConstantReactanceCommand generateUpdateCommand() {
    UpdateSynchronousMachineTimeConstantReactanceCommand command =
        new UpdateSynchronousMachineTimeConstantReactanceCommand(
            null,
            null,
            SynchronousMachineModelKind.values()[0],
            RotorKind.values()[0],
            null,
            null,
            null,
  ...
  private final Logger LOGGER =
      Logger.getLogger(SynchronousMachineTimeConstantReactanceTest.class.getName());
