...
public class TopologyVersionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TopologyVersion : "
                          + successValue.getTopologyVersionId());
                  if (successValue.getTopologyVersionId().equals(topologyVersionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTopologyVersionList - 1,
      ...
      subscriber
          .topologyVersionSubscribe(topologyVersionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TopologyVersion : "
                          + successValue.getTopologyVersionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected TopologyVersion read() throws Throwable {
    ...
    TopologyVersionFetchOneSummary fetchOneSummary =
        new TopologyVersionFetchOneSummary(topologyVersionId);

    try {
      entity =
          TopologyVersionBusinessDelegate.getTopologyVersionInstance()
              .getTopologyVersion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TopologyVersionBusinessDelegate proxy =
          TopologyVersionBusinessDelegate.getTopologyVersionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TopologyVersionBusinessDelegate.getTopologyVersionInstance()
          .delete(new DeleteTopologyVersionCommand(entity.getTopologyVersionId()))
          .get();
  ...
  protected List<TopologyVersion> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          TopologyVersionBusinessDelegate.getTopologyVersionInstance().getAllTopologyVersion();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTopologyVersionId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateTopologyVersionCommand generateUpdateCommand() {
    UpdateTopologyVersionCommand command =
        new UpdateTopologyVersionCommand(
