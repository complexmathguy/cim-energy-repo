...
public class ExcIEEEST4BTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEST4B : "
                          + successValue.getExcIEEEST4BId());
                  if (successValue.getExcIEEEST4BId().equals(excIEEEST4BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEST4BList - 1,
      ...
      subscriber
          .excIEEEST4BSubscribe(excIEEEST4BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEST4B : "
                          + successValue.getExcIEEEST4BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEST4BBusinessDelegate.getExcIEEEST4BInstance()
          .delete(new DeleteExcIEEEST4BCommand(entity.getExcIEEEST4BId()))
          .get();
  ...
  protected UpdateExcIEEEST4BCommand generateUpdateCommand() {
    UpdateExcIEEEST4BCommand command =
        new UpdateExcIEEEST4BCommand(
