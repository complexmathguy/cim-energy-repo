...
public class SynchronousMachineEquivalentCircuitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SynchronousMachineEquivalentCircuit : "
                          + successValue.getSynchronousMachineEquivalentCircuitId());
                  if (successValue
                      .getSynchronousMachineEquivalentCircuitId()
                      .equals(synchronousMachineEquivalentCircuitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSynchronousMachineEquivalentCircuitList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "SynchronousMachineEquivalentCircuit test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          .synchronousMachineEquivalentCircuitSubscribe(synchronousMachineEquivalentCircuitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SynchronousMachineEquivalentCircuit : "
                          + successValue.getSynchronousMachineEquivalentCircuitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on synchronousMachineEquivalentCircuit for synchronousMachineEquivalentCircuitId consumed"));
  ...
  protected SynchronousMachineEquivalentCircuit read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SynchronousMachineEquivalentCircuit with primary key");
    msg.append(synchronousMachineEquivalentCircuitId);

    SynchronousMachineEquivalentCircuitFetchOneSummary fetchOneSummary =
    ...
    try {
      entity =
          SynchronousMachineEquivalentCircuitBusinessDelegate
              .getSynchronousMachineEquivalentCircuitInstance()
              .getSynchronousMachineEquivalentCircuit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("Failed to update a SynchronousMachineEquivalentCircuit : ");
    ...
    command.setSynchronousMachineEquivalentCircuitId(
        entity.getSynchronousMachineEquivalentCircuitId());
    ...
    try {
      ...
      SynchronousMachineEquivalentCircuitBusinessDelegate proxy =
          SynchronousMachineEquivalentCircuitBusinessDelegate
              .getSynchronousMachineEquivalentCircuitInstance();
      ...
      LOGGER.info(
          "-- Successfully saved SynchronousMachineEquivalentCircuit - " + entity.toString());
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString()
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SynchronousMachineEquivalentCircuit with id "
              + synchronousMachineEquivalentCircuitId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SynchronousMachineEquivalentCircuit with id "
              + synchronousMachineEquivalentCircuitId);
    ...
    try {
      SynchronousMachineEquivalentCircuitBusinessDelegate
          .getSynchronousMachineEquivalentCircuitInstance()
          .delete(
              new DeleteSynchronousMachineEquivalentCircuitCommand(
                  entity.getSynchronousMachineEquivalentCircuitId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SynchronousMachineEquivalentCircuit with id "
              + synchronousMachineEquivalentCircuitId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SynchronousMachineEquivalentCircuit with id "
              + synchronousMachineEquivalentCircuitId);
  ...
  protected List<SynchronousMachineEquivalentCircuit> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all SynchronousMachineEquivalentCircuit : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of SynchronousMachineEquivalentCircuit was incorrectly returned.");
  ...
  protected CreateSynchronousMachineEquivalentCircuitCommand generateNewCommand() {
    CreateSynchronousMachineEquivalentCircuitCommand command =
        new CreateSynchronousMachineEquivalentCircuitCommand(null);
  ...
  protected UpdateSynchronousMachineEquivalentCircuitCommand generateUpdateCommand() {
    UpdateSynchronousMachineEquivalentCircuitCommand command =
        new UpdateSynchronousMachineEquivalentCircuitCommand(
  ...
  private final Logger LOGGER =
      Logger.getLogger(SynchronousMachineEquivalentCircuitTest.class.getName());
