...
public class ExtensionVersionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExtensionVersion : "
                          + successValue.getExtensionVersionId());
                  if (successValue.getExtensionVersionId().equals(extensionVersionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExtensionVersionList - 1,
      ...
      subscriber
          .extensionVersionSubscribe(extensionVersionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExtensionVersion : "
                          + successValue.getExtensionVersionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ExtensionVersion read() throws Throwable {
    ...
    ExtensionVersionFetchOneSummary fetchOneSummary =
        new ExtensionVersionFetchOneSummary(extensionVersionId);

    try {
      entity =
          ExtensionVersionBusinessDelegate.getExtensionVersionInstance()
              .getExtensionVersion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ExtensionVersionBusinessDelegate proxy =
          ExtensionVersionBusinessDelegate.getExtensionVersionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExtensionVersionBusinessDelegate.getExtensionVersionInstance()
          .delete(new DeleteExtensionVersionCommand(entity.getExtensionVersionId()))
          .get();
  ...
  protected List<ExtensionVersion> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of ExtensionVersion was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getExtensionVersionId(), "-- entity in Collection has a null primary key");
