...
public class MonthDayIntervalTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for MonthDayInterval : "
                          + successValue.getMonthDayIntervalId());
                  if (successValue.getMonthDayIntervalId().equals(monthDayIntervalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfMonthDayIntervalList - 1,
      ...
      subscriber
          .monthDayIntervalSubscribe(monthDayIntervalId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for MonthDayInterval : "
                          + successValue.getMonthDayIntervalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected MonthDayInterval read() throws Throwable {
    ...
    MonthDayIntervalFetchOneSummary fetchOneSummary =
        new MonthDayIntervalFetchOneSummary(monthDayIntervalId);

    try {
      entity =
          MonthDayIntervalBusinessDelegate.getMonthDayIntervalInstance()
              .getMonthDayInterval(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      MonthDayIntervalBusinessDelegate proxy =
          MonthDayIntervalBusinessDelegate.getMonthDayIntervalInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      MonthDayIntervalBusinessDelegate.getMonthDayIntervalInstance()
          .delete(new DeleteMonthDayIntervalCommand(entity.getMonthDayIntervalId()))
          .get();
  ...
  protected List<MonthDayInterval> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          MonthDayIntervalBusinessDelegate.getMonthDayIntervalInstance().getAllMonthDayInterval();
      assertNotNull(
          collection, "An Empty collection of MonthDayInterval was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getMonthDayIntervalId(), "-- entity in Collection has a null primary key");
