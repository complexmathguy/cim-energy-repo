...
public class DayTypeTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dayTypeId =
        DayTypeBusinessDelegate.getDayTypeInstance().createDayType(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DayType : " + successValue.getDayTypeId());
                  if (successValue.getDayTypeId().equals(dayTypeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDayTypeList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DayType : "
                          + successValue.getDayTypeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dayTypeId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DayTypeBusinessDelegate.getDayTypeInstance()
          .delete(new DeleteDayTypeCommand(entity.getDayTypeId()))
          .get();
