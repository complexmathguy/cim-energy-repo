...
public class SvStatusTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    svStatusId =
        SvStatusBusinessDelegate.getSvStatusInstance().createSvStatus(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SvStatus : " + successValue.getSvStatusId());
                  if (successValue.getSvStatusId().equals(svStatusId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSvStatusList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for SvStatus : "
                          + successValue.getSvStatusId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + svStatusId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SvStatusBusinessDelegate.getSvStatusInstance()
          .delete(new DeleteSvStatusCommand(entity.getSvStatusId()))
          .get();
  ...
  protected UpdateSvStatusCommand generateUpdateCommand() {
    UpdateSvStatusCommand command = new UpdateSvStatusCommand(null, null);
