...
public class DCChopperTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    DCChopperBusinessDelegate.getDCChopperInstance().createDCChopper(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCChopper : " + successValue.getDCChopperId());
                  if (successValue.getDCChopperId().equals(dCChopperId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCChopperList - 1,
      ...
      subscriber
          .dCChopperSubscribe(dCChopperId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCChopper : "
                          + successValue.getDCChopperId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dCChopperId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCChopperBusinessDelegate.getDCChopperInstance()
          .delete(new DeleteDCChopperCommand(entity.getDCChopperId()))
          .get();
