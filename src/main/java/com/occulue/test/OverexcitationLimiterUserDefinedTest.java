...
public class OverexcitationLimiterUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OverexcitationLimiterUserDefined : "
                          + successValue.getOverexcitationLimiterUserDefinedId());
                  if (successValue
                      .getOverexcitationLimiterUserDefinedId()
                      .equals(overexcitationLimiterUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOverexcitationLimiterUserDefinedList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "OverexcitationLimiterUserDefined test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          .overexcitationLimiterUserDefinedSubscribe(overexcitationLimiterUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OverexcitationLimiterUserDefined : "
                          + successValue.getOverexcitationLimiterUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on overexcitationLimiterUserDefined for overexcitationLimiterUserDefinedId consumed"));
  ...
  protected OverexcitationLimiterUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read OverexcitationLimiterUserDefined with primary key");
    msg.append(overexcitationLimiterUserDefinedId);

    OverexcitationLimiterUserDefinedFetchOneSummary fetchOneSummary =
        new OverexcitationLimiterUserDefinedFetchOneSummary(overexcitationLimiterUserDefinedId);

    try {
      entity =
          OverexcitationLimiterUserDefinedBusinessDelegate
              .getOverexcitationLimiterUserDefinedInstance()
              .getOverexcitationLimiterUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      OverexcitationLimiterUserDefinedBusinessDelegate proxy =
          OverexcitationLimiterUserDefinedBusinessDelegate
              .getOverexcitationLimiterUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read OverexcitationLimiterUserDefined with id "
              + overexcitationLimiterUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read OverexcitationLimiterUserDefined with id "
              + overexcitationLimiterUserDefinedId);
    ...
    try {
      OverexcitationLimiterUserDefinedBusinessDelegate.getOverexcitationLimiterUserDefinedInstance()
          .delete(
              new DeleteOverexcitationLimiterUserDefinedCommand(
                  entity.getOverexcitationLimiterUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted OverexcitationLimiterUserDefined with id "
              + overexcitationLimiterUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete OverexcitationLimiterUserDefined with id "
              + overexcitationLimiterUserDefinedId);
  ...
  protected List<OverexcitationLimiterUserDefined> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all OverexcitationLimiterUserDefined : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of OverexcitationLimiterUserDefined was incorrectly returned.");
  ...
  protected CreateOverexcitationLimiterUserDefinedCommand generateNewCommand() {
    CreateOverexcitationLimiterUserDefinedCommand command =
        new CreateOverexcitationLimiterUserDefinedCommand(null);
  ...
  protected UpdateOverexcitationLimiterUserDefinedCommand generateUpdateCommand() {
    UpdateOverexcitationLimiterUserDefinedCommand command =
        new UpdateOverexcitationLimiterUserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(OverexcitationLimiterUserDefinedTest.class.getName());
