...
public class ExcAVR5Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAVR5Id =
        ExcAVR5BusinessDelegate.getExcAVR5Instance().createExcAVR5(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAVR5 : " + successValue.getExcAVR5Id());
                  if (successValue.getExcAVR5Id().equals(excAVR5Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAVR5List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAVR5 : "
                          + successValue.getExcAVR5Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAVR5Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAVR5BusinessDelegate.getExcAVR5Instance()
          .delete(new DeleteExcAVR5Command(entity.getExcAVR5Id()))
          .get();
