...
public class DCEquipmentContainerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCEquipmentContainer : "
                          + successValue.getDCEquipmentContainerId());
                  if (successValue.getDCEquipmentContainerId().equals(dCEquipmentContainerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCEquipmentContainerList - 1,
      ...
      subscriber
          .dCEquipmentContainerSubscribe(dCEquipmentContainerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCEquipmentContainer : "
                          + successValue.getDCEquipmentContainerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on dCEquipmentContainer for dCEquipmentContainerId consumed"));
  ...
  protected DCEquipmentContainer read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read DCEquipmentContainer with primary key");
    msg.append(dCEquipmentContainerId);

    DCEquipmentContainerFetchOneSummary fetchOneSummary =
        new DCEquipmentContainerFetchOneSummary(dCEquipmentContainerId);

    try {
      entity =
          DCEquipmentContainerBusinessDelegate.getDCEquipmentContainerInstance()
              .getDCEquipmentContainer(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DCEquipmentContainerBusinessDelegate proxy =
          DCEquipmentContainerBusinessDelegate.getDCEquipmentContainerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCEquipmentContainerBusinessDelegate.getDCEquipmentContainerInstance()
          .delete(new DeleteDCEquipmentContainerCommand(entity.getDCEquipmentContainerId()))
          .get();
  ...
  protected List<DCEquipmentContainer> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of DCEquipmentContainer was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDCEquipmentContainerId(), "-- entity in Collection has a null primary key");
