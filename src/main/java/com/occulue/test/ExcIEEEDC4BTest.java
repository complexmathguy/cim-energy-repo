...
public class ExcIEEEDC4BTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEDC4B : "
                          + successValue.getExcIEEEDC4BId());
                  if (successValue.getExcIEEEDC4BId().equals(excIEEEDC4BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEDC4BList - 1,
      ...
      subscriber
          .excIEEEDC4BSubscribe(excIEEEDC4BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEDC4B : "
                          + successValue.getExcIEEEDC4BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEDC4BBusinessDelegate.getExcIEEEDC4BInstance()
          .delete(new DeleteExcIEEEDC4BCommand(entity.getExcIEEEDC4BId()))
          .get();
  ...
  protected UpdateExcIEEEDC4BCommand generateUpdateCommand() {
    UpdateExcIEEEDC4BCommand command =
        new UpdateExcIEEEDC4BCommand(
