...
public class SvTapStepTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    SvTapStepBusinessDelegate.getSvTapStepInstance().createSvTapStep(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SvTapStep : " + successValue.getSvTapStepId());
                  if (successValue.getSvTapStepId().equals(svTapStepId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSvTapStepList - 1,
      ...
      subscriber
          .svTapStepSubscribe(svTapStepId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SvTapStep : "
                          + successValue.getSvTapStepId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + svTapStepId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SvTapStepBusinessDelegate.getSvTapStepInstance()
          .delete(new DeleteSvTapStepCommand(entity.getSvTapStepId()))
          .get();
  ...
  protected UpdateSvTapStepCommand generateUpdateCommand() {
    UpdateSvTapStepCommand command = new UpdateSvTapStepCommand(null, null);
