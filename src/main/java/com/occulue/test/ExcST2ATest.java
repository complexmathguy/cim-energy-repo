...
public class ExcST2ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excST2AId =
        ExcST2ABusinessDelegate.getExcST2AInstance().createExcST2A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcST2A : " + successValue.getExcST2AId());
                  if (successValue.getExcST2AId().equals(excST2AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcST2AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcST2A : "
                          + successValue.getExcST2AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excST2AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcST2ABusinessDelegate.getExcST2AInstance()
          .delete(new DeleteExcST2ACommand(entity.getExcST2AId()))
          .get();
