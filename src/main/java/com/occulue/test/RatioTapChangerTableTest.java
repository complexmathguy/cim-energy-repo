...
public class RatioTapChangerTableTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RatioTapChangerTable : "
                          + successValue.getRatioTapChangerTableId());
                  if (successValue.getRatioTapChangerTableId().equals(ratioTapChangerTableId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRatioTapChangerTableList - 1,
      ...
      subscriber
          .ratioTapChangerTableSubscribe(ratioTapChangerTableId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RatioTapChangerTable : "
                          + successValue.getRatioTapChangerTableId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on ratioTapChangerTable for ratioTapChangerTableId consumed"));
  ...
  protected RatioTapChangerTable read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read RatioTapChangerTable with primary key");
    msg.append(ratioTapChangerTableId);

    RatioTapChangerTableFetchOneSummary fetchOneSummary =
        new RatioTapChangerTableFetchOneSummary(ratioTapChangerTableId);

    try {
      entity =
          RatioTapChangerTableBusinessDelegate.getRatioTapChangerTableInstance()
              .getRatioTapChangerTable(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RatioTapChangerTableBusinessDelegate proxy =
          RatioTapChangerTableBusinessDelegate.getRatioTapChangerTableInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      RatioTapChangerTableBusinessDelegate.getRatioTapChangerTableInstance()
          .delete(new DeleteRatioTapChangerTableCommand(entity.getRatioTapChangerTableId()))
          .get();
  ...
  protected List<RatioTapChangerTable> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of RatioTapChangerTable was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRatioTapChangerTableId(), "-- entity in Collection has a null primary key");
