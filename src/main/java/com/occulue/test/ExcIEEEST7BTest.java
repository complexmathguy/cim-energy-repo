...
public class ExcIEEEST7BTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEST7B : "
                          + successValue.getExcIEEEST7BId());
                  if (successValue.getExcIEEEST7BId().equals(excIEEEST7BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEST7BList - 1,
      ...
      subscriber
          .excIEEEST7BSubscribe(excIEEEST7BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEST7B : "
                          + successValue.getExcIEEEST7BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEST7BBusinessDelegate.getExcIEEEST7BInstance()
          .delete(new DeleteExcIEEEST7BCommand(entity.getExcIEEEST7BId()))
          .get();
  ...
  protected CreateExcIEEEST7BCommand generateNewCommand() {
    CreateExcIEEEST7BCommand command =
        new CreateExcIEEEST7BCommand(
  ...
  protected UpdateExcIEEEST7BCommand generateUpdateCommand() {
    UpdateExcIEEEST7BCommand command =
        new UpdateExcIEEEST7BCommand(
            null,
            null,
            null,
            null,
