...
public class VCompIEEEType2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VCompIEEEType2 : "
                          + successValue.getVCompIEEEType2Id());
                  if (successValue.getVCompIEEEType2Id().equals(vCompIEEEType2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVCompIEEEType2List - 1,
      ...
      subscriber
          .vCompIEEEType2Subscribe(vCompIEEEType2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VCompIEEEType2 : "
                          + successValue.getVCompIEEEType2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected VCompIEEEType2 read() throws Throwable {
    ...
    VCompIEEEType2FetchOneSummary fetchOneSummary =
        new VCompIEEEType2FetchOneSummary(vCompIEEEType2Id);

    try {
      entity =
          VCompIEEEType2BusinessDelegate.getVCompIEEEType2Instance()
              .getVCompIEEEType2(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VCompIEEEType2BusinessDelegate proxy =
          VCompIEEEType2BusinessDelegate.getVCompIEEEType2Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      VCompIEEEType2BusinessDelegate.getVCompIEEEType2Instance()
          .delete(new DeleteVCompIEEEType2Command(entity.getVCompIEEEType2Id()))
          .get();
  ...
  protected List<VCompIEEEType2> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          VCompIEEEType2BusinessDelegate.getVCompIEEEType2Instance().getAllVCompIEEEType2();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVCompIEEEType2Id(), "-- entity in Collection has a null primary key");
