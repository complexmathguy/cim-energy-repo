...
public class IdentifiedObjectTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for IdentifiedObject : "
                          + successValue.getIdentifiedObjectId());
                  if (successValue.getIdentifiedObjectId().equals(identifiedObjectId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfIdentifiedObjectList - 1,
      ...
      subscriber
          .identifiedObjectSubscribe(identifiedObjectId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for IdentifiedObject : "
                          + successValue.getIdentifiedObjectId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected IdentifiedObject read() throws Throwable {
    ...
    IdentifiedObjectFetchOneSummary fetchOneSummary =
        new IdentifiedObjectFetchOneSummary(identifiedObjectId);

    try {
      entity =
          IdentifiedObjectBusinessDelegate.getIdentifiedObjectInstance()
              .getIdentifiedObject(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      IdentifiedObjectBusinessDelegate proxy =
          IdentifiedObjectBusinessDelegate.getIdentifiedObjectInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      IdentifiedObjectBusinessDelegate.getIdentifiedObjectInstance()
          .delete(new DeleteIdentifiedObjectCommand(entity.getIdentifiedObjectId()))
          .get();
  ...
  protected List<IdentifiedObject> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          IdentifiedObjectBusinessDelegate.getIdentifiedObjectInstance().getAllIdentifiedObject();
      assertNotNull(
          collection, "An Empty collection of IdentifiedObject was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getIdentifiedObjectId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateIdentifiedObjectCommand generateUpdateCommand() {
    UpdateIdentifiedObjectCommand command =
        new UpdateIdentifiedObjectCommand(null, null, null, null, null, null);
