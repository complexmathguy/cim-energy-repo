...
public class PssSB4Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pssSB4Id = PssSB4BusinessDelegate.getPssSB4Instance().createPssSB4(generateNewCommand()).get();
    ...
    PssSB4BusinessDelegate.getPssSB4Instance().createPssSB4(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for PssSB4 : "
                          + successValue.getPssSB4Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssSB4Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssSB4BusinessDelegate.getPssSB4Instance()
          .delete(new DeletePssSB4Command(entity.getPssSB4Id()))
          .get();
  ...
  protected UpdatePssSB4Command generateUpdateCommand() {
    UpdatePssSB4Command command =
        new UpdatePssSB4Command(
