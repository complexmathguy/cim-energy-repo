...
public class ExcIEEEDC1ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEDC1A : "
                          + successValue.getExcIEEEDC1AId());
                  if (successValue.getExcIEEEDC1AId().equals(excIEEEDC1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEDC1AList - 1,
      ...
      subscriber
          .excIEEEDC1ASubscribe(excIEEEDC1AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEDC1A : "
                          + successValue.getExcIEEEDC1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEDC1ABusinessDelegate.getExcIEEEDC1AInstance()
          .delete(new DeleteExcIEEEDC1ACommand(entity.getExcIEEEDC1AId()))
          .get();
  ...
  protected UpdateExcIEEEDC1ACommand generateUpdateCommand() {
    UpdateExcIEEEDC1ACommand command =
        new UpdateExcIEEEDC1ACommand(
