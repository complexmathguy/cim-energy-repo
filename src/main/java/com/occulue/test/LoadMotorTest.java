...
public class LoadMotorTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    LoadMotorBusinessDelegate.getLoadMotorInstance().createLoadMotor(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LoadMotor : " + successValue.getLoadMotorId());
                  if (successValue.getLoadMotorId().equals(loadMotorId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLoadMotorList - 1,
      ...
      subscriber
          .loadMotorSubscribe(loadMotorId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for LoadMotor : "
                          + successValue.getLoadMotorId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + loadMotorId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LoadMotorBusinessDelegate.getLoadMotorInstance()
          .delete(new DeleteLoadMotorCommand(entity.getLoadMotorId()))
          .get();
  ...
  protected UpdateLoadMotorCommand generateUpdateCommand() {
    UpdateLoadMotorCommand command =
        new UpdateLoadMotorCommand(
