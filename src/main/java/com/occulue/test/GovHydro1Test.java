...
public class GovHydro1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovHydro1BusinessDelegate.getGovHydro1Instance().createGovHydro1(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydro1 : " + successValue.getGovHydro1Id());
                  if (successValue.getGovHydro1Id().equals(govHydro1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydro1List - 1,
      ...
      subscriber
          .govHydro1Subscribe(govHydro1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydro1 : "
                          + successValue.getGovHydro1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govHydro1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydro1BusinessDelegate.getGovHydro1Instance()
          .delete(new DeleteGovHydro1Command(entity.getGovHydro1Id()))
          .get();
  ...
  protected UpdateGovHydro1Command generateUpdateCommand() {
    UpdateGovHydro1Command command =
        new UpdateGovHydro1Command(
