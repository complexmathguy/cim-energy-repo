...
public class LinearShuntCompensatorTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LinearShuntCompensator : "
                          + successValue.getLinearShuntCompensatorId());
                  if (successValue.getLinearShuntCompensatorId().equals(linearShuntCompensatorId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLinearShuntCompensatorList - 1,
      ...
      subscriber
          .linearShuntCompensatorSubscribe(linearShuntCompensatorId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for LinearShuntCompensator : "
                          + successValue.getLinearShuntCompensatorId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on linearShuntCompensator for linearShuntCompensatorId consumed"));
  ...
  protected LinearShuntCompensator read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read LinearShuntCompensator with primary key");
    msg.append(linearShuntCompensatorId);

    LinearShuntCompensatorFetchOneSummary fetchOneSummary =
        new LinearShuntCompensatorFetchOneSummary(linearShuntCompensatorId);

    try {
      entity =
          LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance()
              .getLinearShuntCompensator(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LinearShuntCompensatorBusinessDelegate proxy =
          LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read LinearShuntCompensator with id " + linearShuntCompensatorId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read LinearShuntCompensator with id " + linearShuntCompensatorId);
    ...
    try {
      LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance()
          .delete(new DeleteLinearShuntCompensatorCommand(entity.getLinearShuntCompensatorId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted LinearShuntCompensator with id " + linearShuntCompensatorId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete LinearShuntCompensator with id " + linearShuntCompensatorId);
  ...
  protected List<LinearShuntCompensator> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          LinearShuntCompensatorBusinessDelegate.getLinearShuntCompensatorInstance()
              .getAllLinearShuntCompensator();
      assertNotNull(
          collection, "An Empty collection of LinearShuntCompensator was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getLinearShuntCompensatorId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateLinearShuntCompensatorCommand generateUpdateCommand() {
    UpdateLinearShuntCompensatorCommand command =
        new UpdateLinearShuntCompensatorCommand(null, null, null, null, null);
