...
public class SeasonDayTypeScheduleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SeasonDayTypeSchedule : "
                          + successValue.getSeasonDayTypeScheduleId());
                  if (successValue.getSeasonDayTypeScheduleId().equals(seasonDayTypeScheduleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSeasonDayTypeScheduleList - 1,
      ...
      subscriber
          .seasonDayTypeScheduleSubscribe(seasonDayTypeScheduleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SeasonDayTypeSchedule : "
                          + successValue.getSeasonDayTypeScheduleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on seasonDayTypeSchedule for seasonDayTypeScheduleId consumed"));
  ...
  protected SeasonDayTypeSchedule read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SeasonDayTypeSchedule with primary key");
    msg.append(seasonDayTypeScheduleId);

    SeasonDayTypeScheduleFetchOneSummary fetchOneSummary =
        new SeasonDayTypeScheduleFetchOneSummary(seasonDayTypeScheduleId);

    try {
      entity =
          SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance()
              .getSeasonDayTypeSchedule(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SeasonDayTypeScheduleBusinessDelegate proxy =
          SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance()
          .delete(new DeleteSeasonDayTypeScheduleCommand(entity.getSeasonDayTypeScheduleId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SeasonDayTypeSchedule with id " + seasonDayTypeScheduleId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SeasonDayTypeSchedule with id " + seasonDayTypeScheduleId);
  ...
  protected List<SeasonDayTypeSchedule> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SeasonDayTypeScheduleBusinessDelegate.getSeasonDayTypeScheduleInstance()
              .getAllSeasonDayTypeSchedule();
      assertNotNull(
          collection, "An Empty collection of SeasonDayTypeSchedule was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSeasonDayTypeScheduleId(), "-- entity in Collection has a null primary key");
