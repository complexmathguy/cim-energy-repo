...
public class PowerTransformerEndTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PowerTransformerEnd : "
                          + successValue.getPowerTransformerEndId());
                  if (successValue.getPowerTransformerEndId().equals(powerTransformerEndId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPowerTransformerEndList - 1,
      ...
      subscriber
          .powerTransformerEndSubscribe(powerTransformerEndId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PowerTransformerEnd : "
                          + successValue.getPowerTransformerEndId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on powerTransformerEnd for powerTransformerEndId consumed"));
  ...
  protected PowerTransformerEnd read() throws Throwable {
    ...
    PowerTransformerEndFetchOneSummary fetchOneSummary =
        new PowerTransformerEndFetchOneSummary(powerTransformerEndId);

    try {
      entity =
          PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance()
              .getPowerTransformerEnd(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PowerTransformerEndBusinessDelegate proxy =
          PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PowerTransformerEndBusinessDelegate.getPowerTransformerEndInstance()
          .delete(new DeletePowerTransformerEndCommand(entity.getPowerTransformerEndId()))
          .get();
  ...
  protected List<PowerTransformerEnd> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of PowerTransformerEnd was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPowerTransformerEndId(), "-- entity in Collection has a null primary key");
  ...
  protected CreatePowerTransformerEndCommand generateNewCommand() {
    CreatePowerTransformerEndCommand command =
        new CreatePowerTransformerEndCommand(null, WindingConnection.values()[0]);
  ...
  protected UpdatePowerTransformerEndCommand generateUpdateCommand() {
    UpdatePowerTransformerEndCommand command =
        new UpdatePowerTransformerEndCommand(
            null,
            null,
            null,
            WindingConnection.values()[0],
            null,
            null,
            null,
            null,
