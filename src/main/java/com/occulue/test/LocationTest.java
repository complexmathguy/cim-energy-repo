...
public class LocationTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    locationId =
        LocationBusinessDelegate.getLocationInstance().createLocation(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Location : " + successValue.getLocationId());
                  if (successValue.getLocationId().equals(locationId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLocationList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Location : "
                          + successValue.getLocationId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + locationId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LocationBusinessDelegate.getLocationInstance()
          .delete(new DeleteLocationCommand(entity.getLocationId()))
          .get();
