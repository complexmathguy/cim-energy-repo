...
public class DCGroundTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dCGroundId =
        DCGroundBusinessDelegate.getDCGroundInstance().createDCGround(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCGround : " + successValue.getDCGroundId());
                  if (successValue.getDCGroundId().equals(dCGroundId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCGroundList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DCGround : "
                          + successValue.getDCGroundId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dCGroundId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCGroundBusinessDelegate.getDCGroundInstance()
          .delete(new DeleteDCGroundCommand(entity.getDCGroundId()))
          .get();
