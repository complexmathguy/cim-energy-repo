...
public class Pss2STTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pss2STId = Pss2STBusinessDelegate.getPss2STInstance().createPss2ST(generateNewCommand()).get();
    ...
    Pss2STBusinessDelegate.getPss2STInstance().createPss2ST(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Pss2ST : "
                          + successValue.getPss2STId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pss2STId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      Pss2STBusinessDelegate.getPss2STInstance()
          .delete(new DeletePss2STCommand(entity.getPss2STId()))
          .get();
  ...
  protected CreatePss2STCommand generateNewCommand() {
    CreatePss2STCommand command =
        new CreatePss2STCommand(null, InputSignalKind.values()[0], InputSignalKind.values()[0]);
  ...
  protected UpdatePss2STCommand generateUpdateCommand() {
    UpdatePss2STCommand command =
        new UpdatePss2STCommand(
            null,
