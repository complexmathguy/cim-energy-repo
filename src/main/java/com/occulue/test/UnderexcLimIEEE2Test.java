...
public class UnderexcLimIEEE2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for UnderexcLimIEEE2 : "
                          + successValue.getUnderexcLimIEEE2Id());
                  if (successValue.getUnderexcLimIEEE2Id().equals(underexcLimIEEE2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfUnderexcLimIEEE2List - 1,
      ...
      subscriber
          .underexcLimIEEE2Subscribe(underexcLimIEEE2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for UnderexcLimIEEE2 : "
                          + successValue.getUnderexcLimIEEE2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected UnderexcLimIEEE2 read() throws Throwable {
    ...
    UnderexcLimIEEE2FetchOneSummary fetchOneSummary =
        new UnderexcLimIEEE2FetchOneSummary(underexcLimIEEE2Id);

    try {
      entity =
          UnderexcLimIEEE2BusinessDelegate.getUnderexcLimIEEE2Instance()
              .getUnderexcLimIEEE2(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      UnderexcLimIEEE2BusinessDelegate proxy =
          UnderexcLimIEEE2BusinessDelegate.getUnderexcLimIEEE2Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      UnderexcLimIEEE2BusinessDelegate.getUnderexcLimIEEE2Instance()
          .delete(new DeleteUnderexcLimIEEE2Command(entity.getUnderexcLimIEEE2Id()))
          .get();
  ...
  protected List<UnderexcLimIEEE2> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          UnderexcLimIEEE2BusinessDelegate.getUnderexcLimIEEE2Instance().getAllUnderexcLimIEEE2();
      assertNotNull(
          collection, "An Empty collection of UnderexcLimIEEE2 was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getUnderexcLimIEEE2Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateUnderexcLimIEEE2Command generateUpdateCommand() {
    UpdateUnderexcLimIEEE2Command command =
        new UpdateUnderexcLimIEEE2Command(
