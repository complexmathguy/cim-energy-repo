...
public class WindPlantDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindPlantDynamics : "
                          + successValue.getWindPlantDynamicsId());
                  if (successValue.getWindPlantDynamicsId().equals(windPlantDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindPlantDynamicsList - 1,
      ...
      subscriber
          .windPlantDynamicsSubscribe(windPlantDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindPlantDynamics : "
                          + successValue.getWindPlantDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windPlantDynamics for windPlantDynamicsId consumed"));
  ...
  protected WindPlantDynamics read() throws Throwable {
    ...
    WindPlantDynamicsFetchOneSummary fetchOneSummary =
        new WindPlantDynamicsFetchOneSummary(windPlantDynamicsId);

    try {
      entity =
          WindPlantDynamicsBusinessDelegate.getWindPlantDynamicsInstance()
              .getWindPlantDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindPlantDynamicsBusinessDelegate proxy =
          WindPlantDynamicsBusinessDelegate.getWindPlantDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindPlantDynamicsBusinessDelegate.getWindPlantDynamicsInstance()
          .delete(new DeleteWindPlantDynamicsCommand(entity.getWindPlantDynamicsId()))
          .get();
  ...
  protected List<WindPlantDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of WindPlantDynamics was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindPlantDynamicsId(), "-- entity in Collection has a null primary key");
