...
public class StringMeasurementValueTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for StringMeasurementValue : "
                          + successValue.getStringMeasurementValueId());
                  if (successValue.getStringMeasurementValueId().equals(stringMeasurementValueId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfStringMeasurementValueList - 1,
      ...
      subscriber
          .stringMeasurementValueSubscribe(stringMeasurementValueId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for StringMeasurementValue : "
                          + successValue.getStringMeasurementValueId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on stringMeasurementValue for stringMeasurementValueId consumed"));
  ...
  protected StringMeasurementValue read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read StringMeasurementValue with primary key");
    msg.append(stringMeasurementValueId);

    StringMeasurementValueFetchOneSummary fetchOneSummary =
        new StringMeasurementValueFetchOneSummary(stringMeasurementValueId);

    try {
      entity =
          StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance()
              .getStringMeasurementValue(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      StringMeasurementValueBusinessDelegate proxy =
          StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read StringMeasurementValue with id " + stringMeasurementValueId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read StringMeasurementValue with id " + stringMeasurementValueId);
    ...
    try {
      StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance()
          .delete(new DeleteStringMeasurementValueCommand(entity.getStringMeasurementValueId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted StringMeasurementValue with id " + stringMeasurementValueId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete StringMeasurementValue with id " + stringMeasurementValueId);
  ...
  protected List<StringMeasurementValue> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          StringMeasurementValueBusinessDelegate.getStringMeasurementValueInstance()
              .getAllStringMeasurementValue();
      assertNotNull(
          collection, "An Empty collection of StringMeasurementValue was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getStringMeasurementValueId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateStringMeasurementValueCommand generateUpdateCommand() {
    UpdateStringMeasurementValueCommand command =
        new UpdateStringMeasurementValueCommand(null, null);
