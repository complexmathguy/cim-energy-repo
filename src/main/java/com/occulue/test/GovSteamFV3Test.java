...
public class GovSteamFV3Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteamFV3 : "
                          + successValue.getGovSteamFV3Id());
                  if (successValue.getGovSteamFV3Id().equals(govSteamFV3Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteamFV3List - 1,
      ...
      subscriber
          .govSteamFV3Subscribe(govSteamFV3Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteamFV3 : "
                          + successValue.getGovSteamFV3Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteamFV3BusinessDelegate.getGovSteamFV3Instance()
          .delete(new DeleteGovSteamFV3Command(entity.getGovSteamFV3Id()))
          .get();
