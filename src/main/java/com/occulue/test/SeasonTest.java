...
public class SeasonTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    seasonId = SeasonBusinessDelegate.getSeasonInstance().createSeason(generateNewCommand()).get();
    ...
    SeasonBusinessDelegate.getSeasonInstance().createSeason(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Season : "
                          + successValue.getSeasonId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + seasonId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SeasonBusinessDelegate.getSeasonInstance()
          .delete(new DeleteSeasonCommand(entity.getSeasonId()))
          .get();
