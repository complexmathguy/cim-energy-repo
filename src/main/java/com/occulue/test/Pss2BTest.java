...
public class Pss2BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pss2BId = Pss2BBusinessDelegate.getPss2BInstance().createPss2B(generateNewCommand()).get();
    ...
    Pss2BBusinessDelegate.getPss2BInstance().createPss2B(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Pss2B : "
                          + successValue.getPss2BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pss2BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      Pss2BBusinessDelegate.getPss2BInstance()
          .delete(new DeletePss2BCommand(entity.getPss2BId()))
          .get();
  ...
  protected CreatePss2BCommand generateNewCommand() {
    CreatePss2BCommand command =
        new CreatePss2BCommand(null, InputSignalKind.values()[0], InputSignalKind.values()[0]);
  ...
  protected UpdatePss2BCommand generateUpdateCommand() {
    UpdatePss2BCommand command =
        new UpdatePss2BCommand(
            null,
            null,
