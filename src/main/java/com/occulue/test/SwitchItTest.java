...
public class SwitchItTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    switchItId =
        SwitchItBusinessDelegate.getSwitchItInstance().createSwitchIt(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SwitchIt : " + successValue.getSwitchItId());
                  if (successValue.getSwitchItId().equals(switchItId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSwitchItList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for SwitchIt : "
                          + successValue.getSwitchItId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + switchItId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SwitchItBusinessDelegate.getSwitchItInstance()
          .delete(new DeleteSwitchItCommand(entity.getSwitchItId()))
          .get();
