...
public class PFVArControllerType1UserDefinedTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pFVArControllerType1UserDefinedId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArControllerType1UserDefined : "
                          + successValue.getPFVArControllerType1UserDefinedId());
                  if (successValue
                      .getPFVArControllerType1UserDefinedId()
                      .equals(pFVArControllerType1UserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArControllerType1UserDefinedList - 1,
      ...
      subscriber
          .pFVArControllerType1UserDefinedSubscribe(pFVArControllerType1UserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArControllerType1UserDefined : "
                          + successValue.getPFVArControllerType1UserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArControllerType1UserDefined for pFVArControllerType1UserDefinedId consumed"));
  ...
  protected PFVArControllerType1UserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArControllerType1UserDefined with primary key");
    msg.append(pFVArControllerType1UserDefinedId);

    PFVArControllerType1UserDefinedFetchOneSummary fetchOneSummary =
        new PFVArControllerType1UserDefinedFetchOneSummary(pFVArControllerType1UserDefinedId);

    try {
      entity =
          PFVArControllerType1UserDefinedBusinessDelegate
              .getPFVArControllerType1UserDefinedInstance()
              .getPFVArControllerType1UserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArControllerType1UserDefinedBusinessDelegate proxy =
          PFVArControllerType1UserDefinedBusinessDelegate
              .getPFVArControllerType1UserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArControllerType1UserDefined with id "
              + pFVArControllerType1UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArControllerType1UserDefined with id "
              + pFVArControllerType1UserDefinedId);
    ...
    try {
      PFVArControllerType1UserDefinedBusinessDelegate.getPFVArControllerType1UserDefinedInstance()
          .delete(
              new DeletePFVArControllerType1UserDefinedCommand(
                  entity.getPFVArControllerType1UserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArControllerType1UserDefined with id "
              + pFVArControllerType1UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArControllerType1UserDefined with id "
              + pFVArControllerType1UserDefinedId);
  ...
  protected List<PFVArControllerType1UserDefined> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all PFVArControllerType1UserDefined : ");
    ...
    try {
      ...
      collection =
          PFVArControllerType1UserDefinedBusinessDelegate
              .getPFVArControllerType1UserDefinedInstance()
              .getAllPFVArControllerType1UserDefined();
      assertNotNull(
          collection,
          "An Empty collection of PFVArControllerType1UserDefined was incorrectly returned.");
  ...
  protected CreatePFVArControllerType1UserDefinedCommand generateNewCommand() {
    CreatePFVArControllerType1UserDefinedCommand command =
        new CreatePFVArControllerType1UserDefinedCommand(null);
  ...
  protected UpdatePFVArControllerType1UserDefinedCommand generateUpdateCommand() {
    UpdatePFVArControllerType1UserDefinedCommand command =
        new UpdatePFVArControllerType1UserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(PFVArControllerType1UserDefinedTest.class.getName());
