...
public class ExcIEEEDC3ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEDC3A : "
                          + successValue.getExcIEEEDC3AId());
                  if (successValue.getExcIEEEDC3AId().equals(excIEEEDC3AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEDC3AList - 1,
      ...
      subscriber
          .excIEEEDC3ASubscribe(excIEEEDC3AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEDC3A : "
                          + successValue.getExcIEEEDC3AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEDC3ABusinessDelegate.getExcIEEEDC3AInstance()
          .delete(new DeleteExcIEEEDC3ACommand(entity.getExcIEEEDC3AId()))
          .get();
