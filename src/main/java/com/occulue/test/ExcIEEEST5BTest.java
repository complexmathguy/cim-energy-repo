...
public class ExcIEEEST5BTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEST5B : "
                          + successValue.getExcIEEEST5BId());
                  if (successValue.getExcIEEEST5BId().equals(excIEEEST5BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEST5BList - 1,
      ...
      subscriber
          .excIEEEST5BSubscribe(excIEEEST5BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEST5B : "
                          + successValue.getExcIEEEST5BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEST5BBusinessDelegate.getExcIEEEST5BInstance()
          .delete(new DeleteExcIEEEST5BCommand(entity.getExcIEEEST5BId()))
          .get();
  ...
  protected UpdateExcIEEEST5BCommand generateUpdateCommand() {
    UpdateExcIEEEST5BCommand command =
        new UpdateExcIEEEST5BCommand(
