...
public class ResistancePerLengthTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ResistancePerLength : "
                          + successValue.getResistancePerLengthId());
                  if (successValue.getResistancePerLengthId().equals(resistancePerLengthId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfResistancePerLengthList - 1,
      ...
      subscriber
          .resistancePerLengthSubscribe(resistancePerLengthId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ResistancePerLength : "
                          + successValue.getResistancePerLengthId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on resistancePerLength for resistancePerLengthId consumed"));
  ...
  protected ResistancePerLength read() throws Throwable {
    ...
    ResistancePerLengthFetchOneSummary fetchOneSummary =
        new ResistancePerLengthFetchOneSummary(resistancePerLengthId);

    try {
      entity =
          ResistancePerLengthBusinessDelegate.getResistancePerLengthInstance()
              .getResistancePerLength(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ResistancePerLengthBusinessDelegate proxy =
          ResistancePerLengthBusinessDelegate.getResistancePerLengthInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ResistancePerLengthBusinessDelegate.getResistancePerLengthInstance()
          .delete(new DeleteResistancePerLengthCommand(entity.getResistancePerLengthId()))
          .get();
  ...
  protected List<ResistancePerLength> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ResistancePerLengthBusinessDelegate.getResistancePerLengthInstance()
              .getAllResistancePerLength();
      assertNotNull(
          collection, "An Empty collection of ResistancePerLength was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getResistancePerLengthId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateResistancePerLengthCommand generateNewCommand() {
    CreateResistancePerLengthCommand command =
        new CreateResistancePerLengthCommand(
            null,
  ...
  protected UpdateResistancePerLengthCommand generateUpdateCommand() {
    UpdateResistancePerLengthCommand command =
        new UpdateResistancePerLengthCommand(
            null,
            UnitMultiplier.values()[0],
            UnitSymbol.values()[0],
            UnitMultiplier.values()[0],
