...
public class DiagramTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    diagramId =
        DiagramBusinessDelegate.getDiagramInstance().createDiagram(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Diagram : " + successValue.getDiagramId());
                  if (successValue.getDiagramId().equals(diagramId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiagramList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Diagram : "
                          + successValue.getDiagramId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + diagramId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DiagramBusinessDelegate.getDiagramInstance()
          .delete(new DeleteDiagramCommand(entity.getDiagramId()))
          .get();
  ...
  protected UpdateDiagramCommand generateUpdateCommand() {
    UpdateDiagramCommand command =
        new UpdateDiagramCommand(null, OrientationKind.values()[0], null, null, null, null);
