...
public class ConformLoadScheduleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ConformLoadSchedule : "
                          + successValue.getConformLoadScheduleId());
                  if (successValue.getConformLoadScheduleId().equals(conformLoadScheduleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfConformLoadScheduleList - 1,
      ...
      subscriber
          .conformLoadScheduleSubscribe(conformLoadScheduleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ConformLoadSchedule : "
                          + successValue.getConformLoadScheduleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on conformLoadSchedule for conformLoadScheduleId consumed"));
  ...
  protected ConformLoadSchedule read() throws Throwable {
    ...
    ConformLoadScheduleFetchOneSummary fetchOneSummary =
        new ConformLoadScheduleFetchOneSummary(conformLoadScheduleId);

    try {
      entity =
          ConformLoadScheduleBusinessDelegate.getConformLoadScheduleInstance()
              .getConformLoadSchedule(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ConformLoadScheduleBusinessDelegate proxy =
          ConformLoadScheduleBusinessDelegate.getConformLoadScheduleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ConformLoadScheduleBusinessDelegate.getConformLoadScheduleInstance()
          .delete(new DeleteConformLoadScheduleCommand(entity.getConformLoadScheduleId()))
          .get();
  ...
  protected List<ConformLoadSchedule> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of ConformLoadSchedule was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getConformLoadScheduleId(), "-- entity in Collection has a null primary key");
