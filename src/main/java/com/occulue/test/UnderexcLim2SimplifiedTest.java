...
public class UnderexcLim2SimplifiedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for UnderexcLim2Simplified : "
                          + successValue.getUnderexcLim2SimplifiedId());
                  if (successValue.getUnderexcLim2SimplifiedId().equals(underexcLim2SimplifiedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfUnderexcLim2SimplifiedList - 1,
      ...
      subscriber
          .underexcLim2SimplifiedSubscribe(underexcLim2SimplifiedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for UnderexcLim2Simplified : "
                          + successValue.getUnderexcLim2SimplifiedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on underexcLim2Simplified for underexcLim2SimplifiedId consumed"));
  ...
  protected UnderexcLim2Simplified read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read UnderexcLim2Simplified with primary key");
    msg.append(underexcLim2SimplifiedId);

    UnderexcLim2SimplifiedFetchOneSummary fetchOneSummary =
        new UnderexcLim2SimplifiedFetchOneSummary(underexcLim2SimplifiedId);

    try {
      entity =
          UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance()
              .getUnderexcLim2Simplified(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      UnderexcLim2SimplifiedBusinessDelegate proxy =
          UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read UnderexcLim2Simplified with id " + underexcLim2SimplifiedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read UnderexcLim2Simplified with id " + underexcLim2SimplifiedId);
    ...
    try {
      UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance()
          .delete(new DeleteUnderexcLim2SimplifiedCommand(entity.getUnderexcLim2SimplifiedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted UnderexcLim2Simplified with id " + underexcLim2SimplifiedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete UnderexcLim2Simplified with id " + underexcLim2SimplifiedId);
  ...
  protected List<UnderexcLim2Simplified> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          UnderexcLim2SimplifiedBusinessDelegate.getUnderexcLim2SimplifiedInstance()
              .getAllUnderexcLim2Simplified();
      assertNotNull(
          collection, "An Empty collection of UnderexcLim2Simplified was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getUnderexcLim2SimplifiedId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateUnderexcLim2SimplifiedCommand generateUpdateCommand() {
    UpdateUnderexcLim2SimplifiedCommand command =
        new UpdateUnderexcLim2SimplifiedCommand(null, null, null, null, null, null, null, null);
