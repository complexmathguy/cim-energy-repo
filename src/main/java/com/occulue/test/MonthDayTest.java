...
public class MonthDayTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    monthDayId =
        MonthDayBusinessDelegate.getMonthDayInstance().createMonthDay(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for MonthDay : " + successValue.getMonthDayId());
                  if (successValue.getMonthDayId().equals(monthDayId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfMonthDayList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for MonthDay : "
                          + successValue.getMonthDayId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + monthDayId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      MonthDayBusinessDelegate.getMonthDayInstance()
          .delete(new DeleteMonthDayCommand(entity.getMonthDayId()))
          .get();
