...
public class PFVArType1IEEEVArControllerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArType1IEEEVArController : "
                          + successValue.getPFVArType1IEEEVArControllerId());
                  if (successValue
                      .getPFVArType1IEEEVArControllerId()
                      .equals(pFVArType1IEEEVArControllerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArType1IEEEVArControllerList - 1,
      ...
      subscriber
          .pFVArType1IEEEVArControllerSubscribe(pFVArType1IEEEVArControllerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArType1IEEEVArController : "
                          + successValue.getPFVArType1IEEEVArControllerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArType1IEEEVArController for pFVArType1IEEEVArControllerId consumed"));
  ...
  protected PFVArType1IEEEVArController read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArType1IEEEVArController with primary key");
    msg.append(pFVArType1IEEEVArControllerId);

    PFVArType1IEEEVArControllerFetchOneSummary fetchOneSummary =
        new PFVArType1IEEEVArControllerFetchOneSummary(pFVArType1IEEEVArControllerId);

    try {
      entity =
          PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance()
              .getPFVArType1IEEEVArController(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArType1IEEEVArControllerBusinessDelegate proxy =
          PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArType1IEEEVArController with id "
              + pFVArType1IEEEVArControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArType1IEEEVArController with id " + pFVArType1IEEEVArControllerId);
    ...
    try {
      PFVArType1IEEEVArControllerBusinessDelegate.getPFVArType1IEEEVArControllerInstance()
          .delete(
              new DeletePFVArType1IEEEVArControllerCommand(
                  entity.getPFVArType1IEEEVArControllerId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArType1IEEEVArController with id "
              + pFVArType1IEEEVArControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArType1IEEEVArController with id "
              + pFVArType1IEEEVArControllerId);
  ...
  protected List<PFVArType1IEEEVArController> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of PFVArType1IEEEVArController was incorrectly returned.");
  ...
  protected CreatePFVArType1IEEEVArControllerCommand generateNewCommand() {
    CreatePFVArType1IEEEVArControllerCommand command =
        new CreatePFVArType1IEEEVArControllerCommand(null);
  ...
  protected UpdatePFVArType1IEEEVArControllerCommand generateUpdateCommand() {
    UpdatePFVArType1IEEEVArControllerCommand command =
        new UpdatePFVArType1IEEEVArControllerCommand(null, null, null, null, null, null, null);
