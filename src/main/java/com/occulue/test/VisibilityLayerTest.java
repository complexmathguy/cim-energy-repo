...
public class VisibilityLayerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VisibilityLayer : "
                          + successValue.getVisibilityLayerId());
                  if (successValue.getVisibilityLayerId().equals(visibilityLayerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVisibilityLayerList - 1,
      ...
      subscriber
          .visibilityLayerSubscribe(visibilityLayerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VisibilityLayer : "
                          + successValue.getVisibilityLayerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected VisibilityLayer read() throws Throwable {
    ...
    VisibilityLayerFetchOneSummary fetchOneSummary =
        new VisibilityLayerFetchOneSummary(visibilityLayerId);

    try {
      entity =
          VisibilityLayerBusinessDelegate.getVisibilityLayerInstance()
              .getVisibilityLayer(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VisibilityLayerBusinessDelegate proxy =
          VisibilityLayerBusinessDelegate.getVisibilityLayerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      VisibilityLayerBusinessDelegate.getVisibilityLayerInstance()
          .delete(new DeleteVisibilityLayerCommand(entity.getVisibilityLayerId()))
          .get();
  ...
  protected List<VisibilityLayer> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVisibilityLayerId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateVisibilityLayerCommand generateUpdateCommand() {
    UpdateVisibilityLayerCommand command = new UpdateVisibilityLayerCommand(null, null);
