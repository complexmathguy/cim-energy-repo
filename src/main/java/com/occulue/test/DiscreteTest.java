...
public class DiscreteTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    discreteId =
        DiscreteBusinessDelegate.getDiscreteInstance().createDiscrete(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Discrete : " + successValue.getDiscreteId());
                  if (successValue.getDiscreteId().equals(discreteId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiscreteList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Discrete : "
                          + successValue.getDiscreteId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + discreteId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DiscreteBusinessDelegate.getDiscreteInstance()
          .delete(new DeleteDiscreteCommand(entity.getDiscreteId()))
          .get();
