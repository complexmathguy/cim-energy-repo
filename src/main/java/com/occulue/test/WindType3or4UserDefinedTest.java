...
public class WindType3or4UserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindType3or4UserDefined : "
                          + successValue.getWindType3or4UserDefinedId());
                  if (successValue
                      .getWindType3or4UserDefinedId()
                      .equals(windType3or4UserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindType3or4UserDefinedList - 1,
      ...
      subscriber
          .windType3or4UserDefinedSubscribe(windType3or4UserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindType3or4UserDefined : "
                          + successValue.getWindType3or4UserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windType3or4UserDefined for windType3or4UserDefinedId consumed"));
  ...
  protected WindType3or4UserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindType3or4UserDefined with primary key");
    msg.append(windType3or4UserDefinedId);

    WindType3or4UserDefinedFetchOneSummary fetchOneSummary =
        new WindType3or4UserDefinedFetchOneSummary(windType3or4UserDefinedId);

    try {
      entity =
          WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance()
              .getWindType3or4UserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindType3or4UserDefinedBusinessDelegate proxy =
          WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindType3or4UserDefined with id " + windType3or4UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindType3or4UserDefined with id " + windType3or4UserDefinedId);
    ...
    try {
      WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance()
          .delete(new DeleteWindType3or4UserDefinedCommand(entity.getWindType3or4UserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindType3or4UserDefined with id " + windType3or4UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindType3or4UserDefined with id " + windType3or4UserDefinedId);
  ...
  protected List<WindType3or4UserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance()
              .getAllWindType3or4UserDefined();
      assertNotNull(
          collection, "An Empty collection of WindType3or4UserDefined was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindType3or4UserDefinedId(),
  ...
  protected UpdateWindType3or4UserDefinedCommand generateUpdateCommand() {
    UpdateWindType3or4UserDefinedCommand command =
        new UpdateWindType3or4UserDefinedCommand(null, null);
