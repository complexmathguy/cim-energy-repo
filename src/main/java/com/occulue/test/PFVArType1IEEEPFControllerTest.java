...
public class PFVArType1IEEEPFControllerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArType1IEEEPFController : "
                          + successValue.getPFVArType1IEEEPFControllerId());
                  if (successValue
                      .getPFVArType1IEEEPFControllerId()
                      .equals(pFVArType1IEEEPFControllerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArType1IEEEPFControllerList - 1,
      ...
      subscriber
          .pFVArType1IEEEPFControllerSubscribe(pFVArType1IEEEPFControllerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArType1IEEEPFController : "
                          + successValue.getPFVArType1IEEEPFControllerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArType1IEEEPFController for pFVArType1IEEEPFControllerId consumed"));
  ...
  protected PFVArType1IEEEPFController read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArType1IEEEPFController with primary key");
    msg.append(pFVArType1IEEEPFControllerId);

    PFVArType1IEEEPFControllerFetchOneSummary fetchOneSummary =
        new PFVArType1IEEEPFControllerFetchOneSummary(pFVArType1IEEEPFControllerId);

    try {
      entity =
          PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance()
              .getPFVArType1IEEEPFController(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArType1IEEEPFControllerBusinessDelegate proxy =
          PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArType1IEEEPFController with id "
              + pFVArType1IEEEPFControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArType1IEEEPFController with id " + pFVArType1IEEEPFControllerId);
    ...
    try {
      PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance()
          .delete(
              new DeletePFVArType1IEEEPFControllerCommand(entity.getPFVArType1IEEEPFControllerId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArType1IEEEPFController with id "
              + pFVArType1IEEEPFControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArType1IEEEPFController with id " + pFVArType1IEEEPFControllerId);
  ...
  protected List<PFVArType1IEEEPFController> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PFVArType1IEEEPFControllerBusinessDelegate.getPFVArType1IEEEPFControllerInstance()
              .getAllPFVArType1IEEEPFController();
      assertNotNull(
          collection,
          "An Empty collection of PFVArType1IEEEPFController was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPFVArType1IEEEPFControllerId(),
  ...
  protected CreatePFVArType1IEEEPFControllerCommand generateNewCommand() {
    CreatePFVArType1IEEEPFControllerCommand command =
        new CreatePFVArType1IEEEPFControllerCommand(null);
  ...
  protected UpdatePFVArType1IEEEPFControllerCommand generateUpdateCommand() {
    UpdatePFVArType1IEEEPFControllerCommand command =
        new UpdatePFVArType1IEEEPFControllerCommand(
