...
public class GovSteamFV4Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteamFV4 : "
                          + successValue.getGovSteamFV4Id());
                  if (successValue.getGovSteamFV4Id().equals(govSteamFV4Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteamFV4List - 1,
      ...
      subscriber
          .govSteamFV4Subscribe(govSteamFV4Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteamFV4 : "
                          + successValue.getGovSteamFV4Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteamFV4BusinessDelegate.getGovSteamFV4Instance()
          .delete(new DeleteGovSteamFV4Command(entity.getGovSteamFV4Id()))
          .get();
  ...
  protected UpdateGovSteamFV4Command generateUpdateCommand() {
    UpdateGovSteamFV4Command command =
        new UpdateGovSteamFV4Command(
