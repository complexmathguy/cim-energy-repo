...
public class GroundingImpedanceTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GroundingImpedance : "
                          + successValue.getGroundingImpedanceId());
                  if (successValue.getGroundingImpedanceId().equals(groundingImpedanceId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGroundingImpedanceList - 1,
      ...
      subscriber
          .groundingImpedanceSubscribe(groundingImpedanceId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GroundingImpedance : "
                          + successValue.getGroundingImpedanceId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on groundingImpedance for groundingImpedanceId consumed"));
  ...
  protected GroundingImpedance read() throws Throwable {
    ...
    GroundingImpedanceFetchOneSummary fetchOneSummary =
        new GroundingImpedanceFetchOneSummary(groundingImpedanceId);

    try {
      entity =
          GroundingImpedanceBusinessDelegate.getGroundingImpedanceInstance()
              .getGroundingImpedance(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GroundingImpedanceBusinessDelegate proxy =
          GroundingImpedanceBusinessDelegate.getGroundingImpedanceInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GroundingImpedanceBusinessDelegate.getGroundingImpedanceInstance()
          .delete(new DeleteGroundingImpedanceCommand(entity.getGroundingImpedanceId()))
          .get();
  ...
  protected List<GroundingImpedance> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          GroundingImpedanceBusinessDelegate.getGroundingImpedanceInstance()
              .getAllGroundingImpedance();
      assertNotNull(
          collection, "An Empty collection of GroundingImpedance was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGroundingImpedanceId(), "-- entity in Collection has a null primary key");
