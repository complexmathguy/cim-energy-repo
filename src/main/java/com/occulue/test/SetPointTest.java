...
public class SetPointTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    setPointId =
        SetPointBusinessDelegate.getSetPointInstance().createSetPoint(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SetPoint : " + successValue.getSetPointId());
                  if (successValue.getSetPointId().equals(setPointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSetPointList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for SetPoint : "
                          + successValue.getSetPointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + setPointId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SetPointBusinessDelegate.getSetPointInstance()
          .delete(new DeleteSetPointCommand(entity.getSetPointId()))
          .get();
