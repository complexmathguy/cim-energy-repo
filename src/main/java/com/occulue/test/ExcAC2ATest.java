...
public class ExcAC2ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAC2AId =
        ExcAC2ABusinessDelegate.getExcAC2AInstance().createExcAC2A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAC2A : " + successValue.getExcAC2AId());
                  if (successValue.getExcAC2AId().equals(excAC2AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAC2AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAC2A : "
                          + successValue.getExcAC2AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAC2AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAC2ABusinessDelegate.getExcAC2AInstance()
          .delete(new DeleteExcAC2ACommand(entity.getExcAC2AId()))
          .get();
  ...
  protected UpdateExcAC2ACommand generateUpdateCommand() {
    UpdateExcAC2ACommand command =
        new UpdateExcAC2ACommand(
