...
public class LimitSetTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    limitSetId =
        LimitSetBusinessDelegate.getLimitSetInstance().createLimitSet(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LimitSet : " + successValue.getLimitSetId());
                  if (successValue.getLimitSetId().equals(limitSetId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLimitSetList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for LimitSet : "
                          + successValue.getLimitSetId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + limitSetId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LimitSetBusinessDelegate.getLimitSetInstance()
          .delete(new DeleteLimitSetCommand(entity.getLimitSetId()))
          .get();
