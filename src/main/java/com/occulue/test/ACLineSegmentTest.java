...
public class ACLineSegmentTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ACLineSegment : "
                          + successValue.getACLineSegmentId());
                  if (successValue.getACLineSegmentId().equals(aCLineSegmentId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfACLineSegmentList - 1,
      ...
      subscriber
          .aCLineSegmentSubscribe(aCLineSegmentId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ACLineSegment : "
                          + successValue.getACLineSegmentId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ACLineSegment read() throws Throwable {
    ...
    ACLineSegmentFetchOneSummary fetchOneSummary =
        new ACLineSegmentFetchOneSummary(aCLineSegmentId);

    try {
      entity =
          ACLineSegmentBusinessDelegate.getACLineSegmentInstance()
              .getACLineSegment(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ACLineSegmentBusinessDelegate proxy =
          ACLineSegmentBusinessDelegate.getACLineSegmentInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ACLineSegmentBusinessDelegate.getACLineSegmentInstance()
          .delete(new DeleteACLineSegmentCommand(entity.getACLineSegmentId()))
          .get();
  ...
  protected List<ACLineSegment> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getACLineSegmentId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateACLineSegmentCommand generateUpdateCommand() {
    UpdateACLineSegmentCommand command =
        new UpdateACLineSegmentCommand(null, null, null, null, null, null, null, null, null, null);
