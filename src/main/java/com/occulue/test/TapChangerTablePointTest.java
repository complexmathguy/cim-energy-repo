...
public class TapChangerTablePointTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TapChangerTablePoint : "
                          + successValue.getTapChangerTablePointId());
                  if (successValue.getTapChangerTablePointId().equals(tapChangerTablePointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTapChangerTablePointList - 1,
      ...
      subscriber
          .tapChangerTablePointSubscribe(tapChangerTablePointId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TapChangerTablePoint : "
                          + successValue.getTapChangerTablePointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on tapChangerTablePoint for tapChangerTablePointId consumed"));
  ...
  protected TapChangerTablePoint read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read TapChangerTablePoint with primary key");
    msg.append(tapChangerTablePointId);

    TapChangerTablePointFetchOneSummary fetchOneSummary =
        new TapChangerTablePointFetchOneSummary(tapChangerTablePointId);

    try {
      entity =
          TapChangerTablePointBusinessDelegate.getTapChangerTablePointInstance()
              .getTapChangerTablePoint(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TapChangerTablePointBusinessDelegate proxy =
          TapChangerTablePointBusinessDelegate.getTapChangerTablePointInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TapChangerTablePointBusinessDelegate.getTapChangerTablePointInstance()
          .delete(new DeleteTapChangerTablePointCommand(entity.getTapChangerTablePointId()))
          .get();
  ...
  protected List<TapChangerTablePoint> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of TapChangerTablePoint was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTapChangerTablePointId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateTapChangerTablePointCommand generateUpdateCommand() {
    UpdateTapChangerTablePointCommand command =
        new UpdateTapChangerTablePointCommand(null, null, null, null, null, null, null);
