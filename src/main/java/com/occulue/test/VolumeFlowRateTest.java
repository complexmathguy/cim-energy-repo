...
public class VolumeFlowRateTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VolumeFlowRate : "
                          + successValue.getVolumeFlowRateId());
                  if (successValue.getVolumeFlowRateId().equals(volumeFlowRateId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVolumeFlowRateList - 1,
      ...
      subscriber
          .volumeFlowRateSubscribe(volumeFlowRateId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VolumeFlowRate : "
                          + successValue.getVolumeFlowRateId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected VolumeFlowRate read() throws Throwable {
    ...
    VolumeFlowRateFetchOneSummary fetchOneSummary =
        new VolumeFlowRateFetchOneSummary(volumeFlowRateId);

    try {
      entity =
          VolumeFlowRateBusinessDelegate.getVolumeFlowRateInstance()
              .getVolumeFlowRate(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VolumeFlowRateBusinessDelegate proxy =
          VolumeFlowRateBusinessDelegate.getVolumeFlowRateInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      VolumeFlowRateBusinessDelegate.getVolumeFlowRateInstance()
          .delete(new DeleteVolumeFlowRateCommand(entity.getVolumeFlowRateId()))
          .get();
  ...
  protected List<VolumeFlowRate> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVolumeFlowRateId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateVolumeFlowRateCommand generateNewCommand() {
    CreateVolumeFlowRateCommand command =
        new CreateVolumeFlowRateCommand(
            null,
  ...
  protected UpdateVolumeFlowRateCommand generateUpdateCommand() {
    UpdateVolumeFlowRateCommand command =
        new UpdateVolumeFlowRateCommand(
            null,
            UnitMultiplier.values()[0],
            UnitSymbol.values()[0],
            UnitMultiplier.values()[0],
