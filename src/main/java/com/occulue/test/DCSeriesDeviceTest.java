...
public class DCSeriesDeviceTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCSeriesDevice : "
                          + successValue.getDCSeriesDeviceId());
                  if (successValue.getDCSeriesDeviceId().equals(dCSeriesDeviceId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCSeriesDeviceList - 1,
      ...
      subscriber
          .dCSeriesDeviceSubscribe(dCSeriesDeviceId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCSeriesDevice : "
                          + successValue.getDCSeriesDeviceId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected DCSeriesDevice read() throws Throwable {
    ...
    DCSeriesDeviceFetchOneSummary fetchOneSummary =
        new DCSeriesDeviceFetchOneSummary(dCSeriesDeviceId);

    try {
      entity =
          DCSeriesDeviceBusinessDelegate.getDCSeriesDeviceInstance()
              .getDCSeriesDevice(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DCSeriesDeviceBusinessDelegate proxy =
          DCSeriesDeviceBusinessDelegate.getDCSeriesDeviceInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCSeriesDeviceBusinessDelegate.getDCSeriesDeviceInstance()
          .delete(new DeleteDCSeriesDeviceCommand(entity.getDCSeriesDeviceId()))
          .get();
  ...
  protected List<DCSeriesDevice> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDCSeriesDeviceId(), "-- entity in Collection has a null primary key");
