...
public class ProtectedSwitchTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ProtectedSwitch : "
                          + successValue.getProtectedSwitchId());
                  if (successValue.getProtectedSwitchId().equals(protectedSwitchId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfProtectedSwitchList - 1,
      ...
      subscriber
          .protectedSwitchSubscribe(protectedSwitchId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ProtectedSwitch : "
                          + successValue.getProtectedSwitchId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ProtectedSwitch read() throws Throwable {
    ...
    ProtectedSwitchFetchOneSummary fetchOneSummary =
        new ProtectedSwitchFetchOneSummary(protectedSwitchId);

    try {
      entity =
          ProtectedSwitchBusinessDelegate.getProtectedSwitchInstance()
              .getProtectedSwitch(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ProtectedSwitchBusinessDelegate proxy =
          ProtectedSwitchBusinessDelegate.getProtectedSwitchInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ProtectedSwitchBusinessDelegate.getProtectedSwitchInstance()
          .delete(new DeleteProtectedSwitchCommand(entity.getProtectedSwitchId()))
          .get();
  ...
  protected List<ProtectedSwitch> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getProtectedSwitchId(), "-- entity in Collection has a null primary key");
