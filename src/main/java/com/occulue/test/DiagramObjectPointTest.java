...
public class DiagramObjectPointTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DiagramObjectPoint : "
                          + successValue.getDiagramObjectPointId());
                  if (successValue.getDiagramObjectPointId().equals(diagramObjectPointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiagramObjectPointList - 1,
      ...
      subscriber
          .diagramObjectPointSubscribe(diagramObjectPointId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DiagramObjectPoint : "
                          + successValue.getDiagramObjectPointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on diagramObjectPoint for diagramObjectPointId consumed"));
  ...
  protected DiagramObjectPoint read() throws Throwable {
    ...
    DiagramObjectPointFetchOneSummary fetchOneSummary =
        new DiagramObjectPointFetchOneSummary(diagramObjectPointId);

    try {
      entity =
          DiagramObjectPointBusinessDelegate.getDiagramObjectPointInstance()
              .getDiagramObjectPoint(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DiagramObjectPointBusinessDelegate proxy =
          DiagramObjectPointBusinessDelegate.getDiagramObjectPointInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DiagramObjectPointBusinessDelegate.getDiagramObjectPointInstance()
          .delete(new DeleteDiagramObjectPointCommand(entity.getDiagramObjectPointId()))
          .get();
  ...
  protected List<DiagramObjectPoint> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of DiagramObjectPoint was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDiagramObjectPointId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateDiagramObjectPointCommand generateUpdateCommand() {
    UpdateDiagramObjectPointCommand command =
        new UpdateDiagramObjectPointCommand(null, null, null, null, null);
