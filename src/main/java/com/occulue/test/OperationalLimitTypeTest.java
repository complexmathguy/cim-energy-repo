...
public class OperationalLimitTypeTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OperationalLimitType : "
                          + successValue.getOperationalLimitTypeId());
                  if (successValue.getOperationalLimitTypeId().equals(operationalLimitTypeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOperationalLimitTypeList - 1,
      ...
      subscriber
          .operationalLimitTypeSubscribe(operationalLimitTypeId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OperationalLimitType : "
                          + successValue.getOperationalLimitTypeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on operationalLimitType for operationalLimitTypeId consumed"));
  ...
  protected OperationalLimitType read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read OperationalLimitType with primary key");
    msg.append(operationalLimitTypeId);

    OperationalLimitTypeFetchOneSummary fetchOneSummary =
        new OperationalLimitTypeFetchOneSummary(operationalLimitTypeId);

    try {
      entity =
          OperationalLimitTypeBusinessDelegate.getOperationalLimitTypeInstance()
              .getOperationalLimitType(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      OperationalLimitTypeBusinessDelegate proxy =
          OperationalLimitTypeBusinessDelegate.getOperationalLimitTypeInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      OperationalLimitTypeBusinessDelegate.getOperationalLimitTypeInstance()
          .delete(new DeleteOperationalLimitTypeCommand(entity.getOperationalLimitTypeId()))
          .get();
  ...
  protected List<OperationalLimitType> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          OperationalLimitTypeBusinessDelegate.getOperationalLimitTypeInstance()
              .getAllOperationalLimitType();
      assertNotNull(
          collection, "An Empty collection of OperationalLimitType was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getOperationalLimitTypeId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateOperationalLimitTypeCommand generateNewCommand() {
    CreateOperationalLimitTypeCommand command =
        new CreateOperationalLimitTypeCommand(
            null, OperationalLimitDirectionKind.values()[0], LimitTypeEnum.values()[0]);
  ...
  protected UpdateOperationalLimitTypeCommand generateUpdateCommand() {
    UpdateOperationalLimitTypeCommand command =
        new UpdateOperationalLimitTypeCommand(
            null, null, OperationalLimitDirectionKind.values()[0], LimitTypeEnum.values()[0]);
