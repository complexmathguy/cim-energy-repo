...
public class NonlinearShuntCompensatorPointTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for NonlinearShuntCompensatorPoint : "
                          + successValue.getNonlinearShuntCompensatorPointId());
                  if (successValue
                      .getNonlinearShuntCompensatorPointId()
                      .equals(nonlinearShuntCompensatorPointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfNonlinearShuntCompensatorPointList - 1,
      ...
      subscriber
          .nonlinearShuntCompensatorPointSubscribe(nonlinearShuntCompensatorPointId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for NonlinearShuntCompensatorPoint : "
                          + successValue.getNonlinearShuntCompensatorPointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on nonlinearShuntCompensatorPoint for nonlinearShuntCompensatorPointId consumed"));
  ...
  protected NonlinearShuntCompensatorPoint read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read NonlinearShuntCompensatorPoint with primary key");
    msg.append(nonlinearShuntCompensatorPointId);

    NonlinearShuntCompensatorPointFetchOneSummary fetchOneSummary =
        new NonlinearShuntCompensatorPointFetchOneSummary(nonlinearShuntCompensatorPointId);

    try {
      entity =
          NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance()
              .getNonlinearShuntCompensatorPoint(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      NonlinearShuntCompensatorPointBusinessDelegate proxy =
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read NonlinearShuntCompensatorPoint with id "
              + nonlinearShuntCompensatorPointId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read NonlinearShuntCompensatorPoint with id "
              + nonlinearShuntCompensatorPointId);
    ...
    try {
      NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance()
          .delete(
              new DeleteNonlinearShuntCompensatorPointCommand(
                  entity.getNonlinearShuntCompensatorPointId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted NonlinearShuntCompensatorPoint with id "
              + nonlinearShuntCompensatorPointId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete NonlinearShuntCompensatorPoint with id "
              + nonlinearShuntCompensatorPointId);
  ...
  protected List<NonlinearShuntCompensatorPoint> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of NonlinearShuntCompensatorPoint was incorrectly returned.");
  ...
  protected CreateNonlinearShuntCompensatorPointCommand generateNewCommand() {
    CreateNonlinearShuntCompensatorPointCommand command =
        new CreateNonlinearShuntCompensatorPointCommand(null);
  ...
  protected UpdateNonlinearShuntCompensatorPointCommand generateUpdateCommand() {
    UpdateNonlinearShuntCompensatorPointCommand command =
        new UpdateNonlinearShuntCompensatorPointCommand(null, null, null, null, null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(NonlinearShuntCompensatorPointTest.class.getName());
