...
public class PssIEEE2BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    PssIEEE2BBusinessDelegate.getPssIEEE2BInstance().createPssIEEE2B(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PssIEEE2B : " + successValue.getPssIEEE2BId());
                  if (successValue.getPssIEEE2BId().equals(pssIEEE2BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPssIEEE2BList - 1,
      ...
      subscriber
          .pssIEEE2BSubscribe(pssIEEE2BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PssIEEE2B : "
                          + successValue.getPssIEEE2BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssIEEE2BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssIEEE2BBusinessDelegate.getPssIEEE2BInstance()
          .delete(new DeletePssIEEE2BCommand(entity.getPssIEEE2BId()))
          .get();
  ...
  protected CreatePssIEEE2BCommand generateNewCommand() {
    CreatePssIEEE2BCommand command =
        new CreatePssIEEE2BCommand(null, InputSignalKind.values()[0], InputSignalKind.values()[0]);
  ...
  protected UpdatePssIEEE2BCommand generateUpdateCommand() {
    UpdatePssIEEE2BCommand command =
        new UpdatePssIEEE2BCommand(
            null,
