...
public class OverexcLimX1Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OverexcLimX1 : "
                          + successValue.getOverexcLimX1Id());
                  if (successValue.getOverexcLimX1Id().equals(overexcLimX1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOverexcLimX1List - 1,
      ...
      subscriber
          .overexcLimX1Subscribe(overexcLimX1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OverexcLimX1 : "
                          + successValue.getOverexcLimX1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected OverexcLimX1 read() throws Throwable {
    ...
    try {
      entity =
          OverexcLimX1BusinessDelegate.getOverexcLimX1Instance().getOverexcLimX1(fetchOneSummary);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      OverexcLimX1BusinessDelegate.getOverexcLimX1Instance()
          .delete(new DeleteOverexcLimX1Command(entity.getOverexcLimX1Id()))
          .get();
