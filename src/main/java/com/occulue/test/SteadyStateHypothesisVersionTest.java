...
public class SteadyStateHypothesisVersionTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    steadyStateHypothesisVersionId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SteadyStateHypothesisVersion : "
                          + successValue.getSteadyStateHypothesisVersionId());
                  if (successValue
                      .getSteadyStateHypothesisVersionId()
                      .equals(steadyStateHypothesisVersionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSteadyStateHypothesisVersionList - 1,
      ...
      subscriber
          .steadyStateHypothesisVersionSubscribe(steadyStateHypothesisVersionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SteadyStateHypothesisVersion : "
                          + successValue.getSteadyStateHypothesisVersionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on steadyStateHypothesisVersion for steadyStateHypothesisVersionId consumed"));
  ...
  protected SteadyStateHypothesisVersion read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SteadyStateHypothesisVersion with primary key");
    msg.append(steadyStateHypothesisVersionId);

    SteadyStateHypothesisVersionFetchOneSummary fetchOneSummary =
        new SteadyStateHypothesisVersionFetchOneSummary(steadyStateHypothesisVersionId);

    try {
      entity =
          SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance()
              .getSteadyStateHypothesisVersion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SteadyStateHypothesisVersionBusinessDelegate proxy =
          SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SteadyStateHypothesisVersion with id "
              + steadyStateHypothesisVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SteadyStateHypothesisVersion with id "
              + steadyStateHypothesisVersionId);
    ...
    try {
      SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance()
          .delete(
              new DeleteSteadyStateHypothesisVersionCommand(
                  entity.getSteadyStateHypothesisVersionId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SteadyStateHypothesisVersion with id "
              + steadyStateHypothesisVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SteadyStateHypothesisVersion with id "
              + steadyStateHypothesisVersionId);
  ...
  protected List<SteadyStateHypothesisVersion> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SteadyStateHypothesisVersionBusinessDelegate.getSteadyStateHypothesisVersionInstance()
              .getAllSteadyStateHypothesisVersion();
      assertNotNull(
          collection,
          "An Empty collection of SteadyStateHypothesisVersion was incorrectly returned.");
  ...
  protected CreateSteadyStateHypothesisVersionCommand generateNewCommand() {
    CreateSteadyStateHypothesisVersionCommand command =
        new CreateSteadyStateHypothesisVersionCommand(null);
  ...
  protected UpdateSteadyStateHypothesisVersionCommand generateUpdateCommand() {
    UpdateSteadyStateHypothesisVersionCommand command =
        new UpdateSteadyStateHypothesisVersionCommand(
