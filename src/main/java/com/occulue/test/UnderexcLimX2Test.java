...
public class UnderexcLimX2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for UnderexcLimX2 : "
                          + successValue.getUnderexcLimX2Id());
                  if (successValue.getUnderexcLimX2Id().equals(underexcLimX2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfUnderexcLimX2List - 1,
      ...
      subscriber
          .underexcLimX2Subscribe(underexcLimX2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for UnderexcLimX2 : "
                          + successValue.getUnderexcLimX2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected UnderexcLimX2 read() throws Throwable {
    ...
    UnderexcLimX2FetchOneSummary fetchOneSummary =
        new UnderexcLimX2FetchOneSummary(underexcLimX2Id);

    try {
      entity =
          UnderexcLimX2BusinessDelegate.getUnderexcLimX2Instance()
              .getUnderexcLimX2(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      UnderexcLimX2BusinessDelegate proxy =
          UnderexcLimX2BusinessDelegate.getUnderexcLimX2Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      UnderexcLimX2BusinessDelegate.getUnderexcLimX2Instance()
          .delete(new DeleteUnderexcLimX2Command(entity.getUnderexcLimX2Id()))
          .get();
  ...
  protected List<UnderexcLimX2> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getUnderexcLimX2Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateUnderexcLimX2Command generateUpdateCommand() {
    UpdateUnderexcLimX2Command command =
        new UpdateUnderexcLimX2Command(null, null, null, null, null, null, null, null);
