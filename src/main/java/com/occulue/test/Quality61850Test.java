...
public class Quality61850Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Quality61850 : "
                          + successValue.getQuality61850Id());
                  if (successValue.getQuality61850Id().equals(quality61850Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfQuality61850List - 1,
      ...
      subscriber
          .quality61850Subscribe(quality61850Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for Quality61850 : "
                          + successValue.getQuality61850Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected Quality61850 read() throws Throwable {
    ...
    try {
      entity =
          Quality61850BusinessDelegate.getQuality61850Instance().getQuality61850(fetchOneSummary);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      Quality61850BusinessDelegate.getQuality61850Instance()
          .delete(new DeleteQuality61850Command(entity.getQuality61850Id()))
          .get();
  ...
  protected CreateQuality61850Command generateNewCommand() {
    CreateQuality61850Command command =
        new CreateQuality61850Command(null, Source.values()[0], Validity.values()[0]);
  ...
  protected UpdateQuality61850Command generateUpdateCommand() {
    UpdateQuality61850Command command =
        new UpdateQuality61850Command(
            null,
            null,
            null,
            null,
