...
public class PowerSystemStabilizerDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PowerSystemStabilizerDynamics : "
                          + successValue.getPowerSystemStabilizerDynamicsId());
                  if (successValue
                      .getPowerSystemStabilizerDynamicsId()
                      .equals(powerSystemStabilizerDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPowerSystemStabilizerDynamicsList - 1,
      ...
      subscriber
          .powerSystemStabilizerDynamicsSubscribe(powerSystemStabilizerDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PowerSystemStabilizerDynamics : "
                          + successValue.getPowerSystemStabilizerDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on powerSystemStabilizerDynamics for powerSystemStabilizerDynamicsId consumed"));
  ...
  protected PowerSystemStabilizerDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PowerSystemStabilizerDynamics with primary key");
    msg.append(powerSystemStabilizerDynamicsId);

    PowerSystemStabilizerDynamicsFetchOneSummary fetchOneSummary =
        new PowerSystemStabilizerDynamicsFetchOneSummary(powerSystemStabilizerDynamicsId);

    try {
      entity =
          PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance()
              .getPowerSystemStabilizerDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PowerSystemStabilizerDynamicsBusinessDelegate proxy =
          PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PowerSystemStabilizerDynamics with id "
              + powerSystemStabilizerDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PowerSystemStabilizerDynamics with id "
              + powerSystemStabilizerDynamicsId);
    ...
    try {
      PowerSystemStabilizerDynamicsBusinessDelegate.getPowerSystemStabilizerDynamicsInstance()
          .delete(
              new DeletePowerSystemStabilizerDynamicsCommand(
                  entity.getPowerSystemStabilizerDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PowerSystemStabilizerDynamics with id "
              + powerSystemStabilizerDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PowerSystemStabilizerDynamics with id "
              + powerSystemStabilizerDynamicsId);
  ...
  protected List<PowerSystemStabilizerDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of PowerSystemStabilizerDynamics was incorrectly returned.");
  ...
  protected CreatePowerSystemStabilizerDynamicsCommand generateNewCommand() {
    CreatePowerSystemStabilizerDynamicsCommand command =
        new CreatePowerSystemStabilizerDynamicsCommand(null);
  ...
  protected UpdatePowerSystemStabilizerDynamicsCommand generateUpdateCommand() {
    UpdatePowerSystemStabilizerDynamicsCommand command =
        new UpdatePowerSystemStabilizerDynamicsCommand(null);
