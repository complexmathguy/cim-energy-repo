...
public class PssIEEE3BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    PssIEEE3BBusinessDelegate.getPssIEEE3BInstance().createPssIEEE3B(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PssIEEE3B : " + successValue.getPssIEEE3BId());
                  if (successValue.getPssIEEE3BId().equals(pssIEEE3BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPssIEEE3BList - 1,
      ...
      subscriber
          .pssIEEE3BSubscribe(pssIEEE3BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PssIEEE3B : "
                          + successValue.getPssIEEE3BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssIEEE3BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssIEEE3BBusinessDelegate.getPssIEEE3BInstance()
          .delete(new DeletePssIEEE3BCommand(entity.getPssIEEE3BId()))
          .get();
  ...
  protected CreatePssIEEE3BCommand generateNewCommand() {
    CreatePssIEEE3BCommand command =
        new CreatePssIEEE3BCommand(null, InputSignalKind.values()[0], InputSignalKind.values()[0]);
  ...
  protected UpdatePssIEEE3BCommand generateUpdateCommand() {
    UpdatePssIEEE3BCommand command =
        new UpdatePssIEEE3BCommand(
            null,
            null,
            null,
            null,
