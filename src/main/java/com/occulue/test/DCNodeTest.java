...
public class DCNodeTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dCNodeId = DCNodeBusinessDelegate.getDCNodeInstance().createDCNode(generateNewCommand()).get();
    ...
    DCNodeBusinessDelegate.getDCNodeInstance().createDCNode(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DCNode : "
                          + successValue.getDCNodeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dCNodeId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCNodeBusinessDelegate.getDCNodeInstance()
          .delete(new DeleteDCNodeCommand(entity.getDCNodeId()))
          .get();
