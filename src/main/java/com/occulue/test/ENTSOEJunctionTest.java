...
public class ENTSOEJunctionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ENTSOEJunction : "
                          + successValue.getENTSOEJunctionId());
                  if (successValue.getENTSOEJunctionId().equals(eNTSOEJunctionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfENTSOEJunctionList - 1,
      ...
      subscriber
          .eNTSOEJunctionSubscribe(eNTSOEJunctionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ENTSOEJunction : "
                          + successValue.getENTSOEJunctionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ENTSOEJunction read() throws Throwable {
    ...
    ENTSOEJunctionFetchOneSummary fetchOneSummary =
        new ENTSOEJunctionFetchOneSummary(eNTSOEJunctionId);

    try {
      entity =
          ENTSOEJunctionBusinessDelegate.getENTSOEJunctionInstance()
              .getENTSOEJunction(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ENTSOEJunctionBusinessDelegate proxy =
          ENTSOEJunctionBusinessDelegate.getENTSOEJunctionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ENTSOEJunctionBusinessDelegate.getENTSOEJunctionInstance()
          .delete(new DeleteENTSOEJunctionCommand(entity.getENTSOEJunctionId()))
          .get();
  ...
  protected List<ENTSOEJunction> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getENTSOEJunctionId(), "-- entity in Collection has a null primary key");
