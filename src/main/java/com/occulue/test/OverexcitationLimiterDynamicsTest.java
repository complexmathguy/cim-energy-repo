...
public class OverexcitationLimiterDynamicsTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    overexcitationLimiterDynamicsId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OverexcitationLimiterDynamics : "
                          + successValue.getOverexcitationLimiterDynamicsId());
                  if (successValue
                      .getOverexcitationLimiterDynamicsId()
                      .equals(overexcitationLimiterDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOverexcitationLimiterDynamicsList - 1,
      ...
      subscriber
          .overexcitationLimiterDynamicsSubscribe(overexcitationLimiterDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OverexcitationLimiterDynamics : "
                          + successValue.getOverexcitationLimiterDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on overexcitationLimiterDynamics for overexcitationLimiterDynamicsId consumed"));
  ...
  protected OverexcitationLimiterDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read OverexcitationLimiterDynamics with primary key");
    msg.append(overexcitationLimiterDynamicsId);

    OverexcitationLimiterDynamicsFetchOneSummary fetchOneSummary =
        new OverexcitationLimiterDynamicsFetchOneSummary(overexcitationLimiterDynamicsId);

    try {
      entity =
          OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance()
              .getOverexcitationLimiterDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      OverexcitationLimiterDynamicsBusinessDelegate proxy =
          OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read OverexcitationLimiterDynamics with id "
              + overexcitationLimiterDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read OverexcitationLimiterDynamics with id "
              + overexcitationLimiterDynamicsId);
    ...
    try {
      OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance()
          .delete(
              new DeleteOverexcitationLimiterDynamicsCommand(
                  entity.getOverexcitationLimiterDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted OverexcitationLimiterDynamics with id "
              + overexcitationLimiterDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete OverexcitationLimiterDynamics with id "
              + overexcitationLimiterDynamicsId);
  ...
  protected List<OverexcitationLimiterDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          OverexcitationLimiterDynamicsBusinessDelegate.getOverexcitationLimiterDynamicsInstance()
              .getAllOverexcitationLimiterDynamics();
      assertNotNull(
          collection,
          "An Empty collection of OverexcitationLimiterDynamics was incorrectly returned.");
  ...
  protected CreateOverexcitationLimiterDynamicsCommand generateNewCommand() {
    CreateOverexcitationLimiterDynamicsCommand command =
        new CreateOverexcitationLimiterDynamicsCommand(null);
  ...
  protected UpdateOverexcitationLimiterDynamicsCommand generateUpdateCommand() {
    UpdateOverexcitationLimiterDynamicsCommand command =
        new UpdateOverexcitationLimiterDynamicsCommand(null);
