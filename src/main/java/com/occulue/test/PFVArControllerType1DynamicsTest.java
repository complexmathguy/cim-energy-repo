...
public class PFVArControllerType1DynamicsTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pFVArControllerType1DynamicsId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArControllerType1Dynamics : "
                          + successValue.getPFVArControllerType1DynamicsId());
                  if (successValue
                      .getPFVArControllerType1DynamicsId()
                      .equals(pFVArControllerType1DynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArControllerType1DynamicsList - 1,
      ...
      subscriber
          .pFVArControllerType1DynamicsSubscribe(pFVArControllerType1DynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArControllerType1Dynamics : "
                          + successValue.getPFVArControllerType1DynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArControllerType1Dynamics for pFVArControllerType1DynamicsId consumed"));
  ...
  protected PFVArControllerType1Dynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArControllerType1Dynamics with primary key");
    msg.append(pFVArControllerType1DynamicsId);

    PFVArControllerType1DynamicsFetchOneSummary fetchOneSummary =
        new PFVArControllerType1DynamicsFetchOneSummary(pFVArControllerType1DynamicsId);

    try {
      entity =
          PFVArControllerType1DynamicsBusinessDelegate.getPFVArControllerType1DynamicsInstance()
              .getPFVArControllerType1Dynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArControllerType1DynamicsBusinessDelegate proxy =
          PFVArControllerType1DynamicsBusinessDelegate.getPFVArControllerType1DynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArControllerType1Dynamics with id "
              + pFVArControllerType1DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArControllerType1Dynamics with id "
              + pFVArControllerType1DynamicsId);
    ...
    try {
      PFVArControllerType1DynamicsBusinessDelegate.getPFVArControllerType1DynamicsInstance()
          .delete(
              new DeletePFVArControllerType1DynamicsCommand(
                  entity.getPFVArControllerType1DynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArControllerType1Dynamics with id "
              + pFVArControllerType1DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArControllerType1Dynamics with id "
              + pFVArControllerType1DynamicsId);
  ...
  protected List<PFVArControllerType1Dynamics> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of PFVArControllerType1Dynamics was incorrectly returned.");
  ...
  protected CreatePFVArControllerType1DynamicsCommand generateNewCommand() {
    CreatePFVArControllerType1DynamicsCommand command =
        new CreatePFVArControllerType1DynamicsCommand(null);
  ...
  protected UpdatePFVArControllerType1DynamicsCommand generateUpdateCommand() {
    UpdatePFVArControllerType1DynamicsCommand command =
        new UpdatePFVArControllerType1DynamicsCommand(null);
