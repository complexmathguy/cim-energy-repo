...
public class WindTurbineType4aIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindTurbineType4aIEC : "
                          + successValue.getWindTurbineType4aIECId());
                  if (successValue.getWindTurbineType4aIECId().equals(windTurbineType4aIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindTurbineType4aIECList - 1,
      ...
      subscriber
          .windTurbineType4aIECSubscribe(windTurbineType4aIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindTurbineType4aIEC : "
                          + successValue.getWindTurbineType4aIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windTurbineType4aIEC for windTurbineType4aIECId consumed"));
  ...
  protected WindTurbineType4aIEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindTurbineType4aIEC with primary key");
    msg.append(windTurbineType4aIECId);

    WindTurbineType4aIECFetchOneSummary fetchOneSummary =
        new WindTurbineType4aIECFetchOneSummary(windTurbineType4aIECId);

    try {
      entity =
          WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance()
              .getWindTurbineType4aIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindTurbineType4aIECBusinessDelegate proxy =
          WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance()
          .delete(new DeleteWindTurbineType4aIECCommand(entity.getWindTurbineType4aIECId()))
          .get();
  ...
  protected List<WindTurbineType4aIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance()
              .getAllWindTurbineType4aIEC();
      assertNotNull(
          collection, "An Empty collection of WindTurbineType4aIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindTurbineType4aIECId(), "-- entity in Collection has a null primary key");
