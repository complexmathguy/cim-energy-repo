...
public class PssSKTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pssSKId = PssSKBusinessDelegate.getPssSKInstance().createPssSK(generateNewCommand()).get();
    ...
    PssSKBusinessDelegate.getPssSKInstance().createPssSK(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for PssSK : "
                          + successValue.getPssSKId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssSKId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssSKBusinessDelegate.getPssSKInstance()
          .delete(new DeletePssSKCommand(entity.getPssSKId()))
          .get();
  ...
  protected UpdatePssSKCommand generateUpdateCommand() {
    UpdatePssSKCommand command =
        new UpdatePssSKCommand(
