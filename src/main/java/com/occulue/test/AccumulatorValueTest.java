...
public class AccumulatorValueTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AccumulatorValue : "
                          + successValue.getAccumulatorValueId());
                  if (successValue.getAccumulatorValueId().equals(accumulatorValueId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAccumulatorValueList - 1,
      ...
      subscriber
          .accumulatorValueSubscribe(accumulatorValueId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AccumulatorValue : "
                          + successValue.getAccumulatorValueId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected AccumulatorValue read() throws Throwable {
    ...
    AccumulatorValueFetchOneSummary fetchOneSummary =
        new AccumulatorValueFetchOneSummary(accumulatorValueId);

    try {
      entity =
          AccumulatorValueBusinessDelegate.getAccumulatorValueInstance()
              .getAccumulatorValue(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      AccumulatorValueBusinessDelegate proxy =
          AccumulatorValueBusinessDelegate.getAccumulatorValueInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      AccumulatorValueBusinessDelegate.getAccumulatorValueInstance()
          .delete(new DeleteAccumulatorValueCommand(entity.getAccumulatorValueId()))
          .get();
  ...
  protected List<AccumulatorValue> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of AccumulatorValue was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getAccumulatorValueId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateAccumulatorValueCommand generateUpdateCommand() {
    UpdateAccumulatorValueCommand command = new UpdateAccumulatorValueCommand(null, null);
