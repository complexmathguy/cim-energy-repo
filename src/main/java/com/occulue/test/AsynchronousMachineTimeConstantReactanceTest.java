...
public class AsynchronousMachineTimeConstantReactanceTest {
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AsynchronousMachineTimeConstantReactance : "
                          + successValue.getAsynchronousMachineTimeConstantReactanceId());
                  if (successValue
                      .getAsynchronousMachineTimeConstantReactanceId()
                      .equals(asynchronousMachineTimeConstantReactanceId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAsynchronousMachineTimeConstantReactanceList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "AsynchronousMachineTimeConstantReactance test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for AsynchronousMachineTimeConstantReactance : "
                          + successValue.getAsynchronousMachineTimeConstantReactanceId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on asynchronousMachineTimeConstantReactance for asynchronousMachineTimeConstantReactanceId consumed"));
  ...
  protected AsynchronousMachineTimeConstantReactance read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder(
            "-- Failed to read AsynchronousMachineTimeConstantReactance with primary key");
    msg.append(asynchronousMachineTimeConstantReactanceId);

    AsynchronousMachineTimeConstantReactanceFetchOneSummary fetchOneSummary =
    ...
    try {
      entity =
          AsynchronousMachineTimeConstantReactanceBusinessDelegate
              .getAsynchronousMachineTimeConstantReactanceInstance()
              .getAsynchronousMachineTimeConstantReactance(fetchOneSummary);

      assertNotNull(entity, msg.toString());

      LOGGER.info(
          "-- Successfully found AsynchronousMachineTimeConstantReactance " + entity.toString());
    } catch (Throwable e) {
  ...
  protected void update() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("Failed to update a AsynchronousMachineTimeConstantReactance : ");
    ...
    command.setAsynchronousMachineTimeConstantReactanceId(
        entity.getAsynchronousMachineTimeConstantReactanceId());
    ...
    try {
      ...
      AsynchronousMachineTimeConstantReactanceBusinessDelegate proxy =
          AsynchronousMachineTimeConstantReactanceBusinessDelegate
              .getAsynchronousMachineTimeConstantReactanceInstance();
      ...
      LOGGER.info(
          "-- Successfully saved AsynchronousMachineTimeConstantReactance - " + entity.toString());
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString()
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read AsynchronousMachineTimeConstantReactance with id "
              + asynchronousMachineTimeConstantReactanceId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read AsynchronousMachineTimeConstantReactance with id "
              + asynchronousMachineTimeConstantReactanceId);
    ...
    try {
      AsynchronousMachineTimeConstantReactanceBusinessDelegate
          ...
          .get();
      LOGGER.info(
          "-- Successfully deleted AsynchronousMachineTimeConstantReactance with id "
              + asynchronousMachineTimeConstantReactanceId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete AsynchronousMachineTimeConstantReactance with id "
              + asynchronousMachineTimeConstantReactanceId);
  ...
  protected List<AsynchronousMachineTimeConstantReactance> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all AsynchronousMachineTimeConstantReactance : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of AsynchronousMachineTimeConstantReactance was incorrectly returned.");
  ...
  protected CreateAsynchronousMachineTimeConstantReactanceCommand generateNewCommand() {
    CreateAsynchronousMachineTimeConstantReactanceCommand command =
        new CreateAsynchronousMachineTimeConstantReactanceCommand(null);
  ...
  protected UpdateAsynchronousMachineTimeConstantReactanceCommand generateUpdateCommand() {
    UpdateAsynchronousMachineTimeConstantReactanceCommand command =
        new UpdateAsynchronousMachineTimeConstantReactanceCommand(
  ...
  private final Logger LOGGER =
      Logger.getLogger(AsynchronousMachineTimeConstantReactanceTest.class.getName());
