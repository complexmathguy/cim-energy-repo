...
public class MechLoad1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    MechLoad1BusinessDelegate.getMechLoad1Instance().createMechLoad1(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for MechLoad1 : " + successValue.getMechLoad1Id());
                  if (successValue.getMechLoad1Id().equals(mechLoad1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfMechLoad1List - 1,
      ...
      subscriber
          .mechLoad1Subscribe(mechLoad1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for MechLoad1 : "
                          + successValue.getMechLoad1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + mechLoad1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      MechLoad1BusinessDelegate.getMechLoad1Instance()
          .delete(new DeleteMechLoad1Command(entity.getMechLoad1Id()))
          .get();
