...
public class ExcIEEEAC4ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC4A : "
                          + successValue.getExcIEEEAC4AId());
                  if (successValue.getExcIEEEAC4AId().equals(excIEEEAC4AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC4AList - 1,
      ...
      subscriber
          .excIEEEAC4ASubscribe(excIEEEAC4AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC4A : "
                          + successValue.getExcIEEEAC4AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC4ABusinessDelegate.getExcIEEEAC4AInstance()
          .delete(new DeleteExcIEEEAC4ACommand(entity.getExcIEEEAC4AId()))
          .get();
  ...
  protected UpdateExcIEEEAC4ACommand generateUpdateCommand() {
    UpdateExcIEEEAC4ACommand command =
        new UpdateExcIEEEAC4ACommand(null, null, null, null, null, null, null, null, null, null);
