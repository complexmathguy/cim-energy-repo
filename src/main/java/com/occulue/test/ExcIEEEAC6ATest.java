...
public class ExcIEEEAC6ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC6A : "
                          + successValue.getExcIEEEAC6AId());
                  if (successValue.getExcIEEEAC6AId().equals(excIEEEAC6AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC6AList - 1,
      ...
      subscriber
          .excIEEEAC6ASubscribe(excIEEEAC6AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC6A : "
                          + successValue.getExcIEEEAC6AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC6ABusinessDelegate.getExcIEEEAC6AInstance()
          .delete(new DeleteExcIEEEAC6ACommand(entity.getExcIEEEAC6AId()))
          .get();
  ...
  protected UpdateExcIEEEAC6ACommand generateUpdateCommand() {
    UpdateExcIEEEAC6ACommand command =
        new UpdateExcIEEEAC6ACommand(
