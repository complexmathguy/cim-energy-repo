...
public class LoadBreakSwitchTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LoadBreakSwitch : "
                          + successValue.getLoadBreakSwitchId());
                  if (successValue.getLoadBreakSwitchId().equals(loadBreakSwitchId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLoadBreakSwitchList - 1,
      ...
      subscriber
          .loadBreakSwitchSubscribe(loadBreakSwitchId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for LoadBreakSwitch : "
                          + successValue.getLoadBreakSwitchId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected LoadBreakSwitch read() throws Throwable {
    ...
    LoadBreakSwitchFetchOneSummary fetchOneSummary =
        new LoadBreakSwitchFetchOneSummary(loadBreakSwitchId);

    try {
      entity =
          LoadBreakSwitchBusinessDelegate.getLoadBreakSwitchInstance()
              .getLoadBreakSwitch(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LoadBreakSwitchBusinessDelegate proxy =
          LoadBreakSwitchBusinessDelegate.getLoadBreakSwitchInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LoadBreakSwitchBusinessDelegate.getLoadBreakSwitchInstance()
          .delete(new DeleteLoadBreakSwitchCommand(entity.getLoadBreakSwitchId()))
          .get();
  ...
  protected List<LoadBreakSwitch> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          LoadBreakSwitchBusinessDelegate.getLoadBreakSwitchInstance().getAllLoadBreakSwitch();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getLoadBreakSwitchId(), "-- entity in Collection has a null primary key");
