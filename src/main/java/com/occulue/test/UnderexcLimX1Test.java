...
public class UnderexcLimX1Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for UnderexcLimX1 : "
                          + successValue.getUnderexcLimX1Id());
                  if (successValue.getUnderexcLimX1Id().equals(underexcLimX1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfUnderexcLimX1List - 1,
      ...
      subscriber
          .underexcLimX1Subscribe(underexcLimX1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for UnderexcLimX1 : "
                          + successValue.getUnderexcLimX1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected UnderexcLimX1 read() throws Throwable {
    ...
    UnderexcLimX1FetchOneSummary fetchOneSummary =
        new UnderexcLimX1FetchOneSummary(underexcLimX1Id);

    try {
      entity =
          UnderexcLimX1BusinessDelegate.getUnderexcLimX1Instance()
              .getUnderexcLimX1(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      UnderexcLimX1BusinessDelegate proxy =
          UnderexcLimX1BusinessDelegate.getUnderexcLimX1Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      UnderexcLimX1BusinessDelegate.getUnderexcLimX1Instance()
          .delete(new DeleteUnderexcLimX1Command(entity.getUnderexcLimX1Id()))
          .get();
  ...
  protected List<UnderexcLimX1> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getUnderexcLimX1Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateUnderexcLimX1Command generateUpdateCommand() {
    UpdateUnderexcLimX1Command command =
        new UpdateUnderexcLimX1Command(null, null, null, null, null, null, null);
