...
public class CoordinateSystemTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for CoordinateSystem : "
                          + successValue.getCoordinateSystemId());
                  if (successValue.getCoordinateSystemId().equals(coordinateSystemId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfCoordinateSystemList - 1,
      ...
      subscriber
          .coordinateSystemSubscribe(coordinateSystemId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for CoordinateSystem : "
                          + successValue.getCoordinateSystemId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected CoordinateSystem read() throws Throwable {
    ...
    CoordinateSystemFetchOneSummary fetchOneSummary =
        new CoordinateSystemFetchOneSummary(coordinateSystemId);

    try {
      entity =
          CoordinateSystemBusinessDelegate.getCoordinateSystemInstance()
              .getCoordinateSystem(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      CoordinateSystemBusinessDelegate proxy =
          CoordinateSystemBusinessDelegate.getCoordinateSystemInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      CoordinateSystemBusinessDelegate.getCoordinateSystemInstance()
          .delete(new DeleteCoordinateSystemCommand(entity.getCoordinateSystemId()))
          .get();
  ...
  protected List<CoordinateSystem> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          CoordinateSystemBusinessDelegate.getCoordinateSystemInstance().getAllCoordinateSystem();
      assertNotNull(
          collection, "An Empty collection of CoordinateSystem was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getCoordinateSystemId(), "-- entity in Collection has a null primary key");
