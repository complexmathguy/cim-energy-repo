...
public class TopologyBoundaryVersionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TopologyBoundaryVersion : "
                          + successValue.getTopologyBoundaryVersionId());
                  if (successValue
                      .getTopologyBoundaryVersionId()
                      .equals(topologyBoundaryVersionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTopologyBoundaryVersionList - 1,
      ...
      subscriber
          .topologyBoundaryVersionSubscribe(topologyBoundaryVersionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TopologyBoundaryVersion : "
                          + successValue.getTopologyBoundaryVersionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on topologyBoundaryVersion for topologyBoundaryVersionId consumed"));
  ...
  protected TopologyBoundaryVersion read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read TopologyBoundaryVersion with primary key");
    msg.append(topologyBoundaryVersionId);

    TopologyBoundaryVersionFetchOneSummary fetchOneSummary =
        new TopologyBoundaryVersionFetchOneSummary(topologyBoundaryVersionId);

    try {
      entity =
          TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance()
              .getTopologyBoundaryVersion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TopologyBoundaryVersionBusinessDelegate proxy =
          TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read TopologyBoundaryVersion with id " + topologyBoundaryVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read TopologyBoundaryVersion with id " + topologyBoundaryVersionId);
    ...
    try {
      TopologyBoundaryVersionBusinessDelegate.getTopologyBoundaryVersionInstance()
          .delete(new DeleteTopologyBoundaryVersionCommand(entity.getTopologyBoundaryVersionId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted TopologyBoundaryVersion with id " + topologyBoundaryVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete TopologyBoundaryVersion with id " + topologyBoundaryVersionId);
  ...
  protected List<TopologyBoundaryVersion> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of TopologyBoundaryVersion was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTopologyBoundaryVersionId(),
  ...
  protected UpdateTopologyBoundaryVersionCommand generateUpdateCommand() {
    UpdateTopologyBoundaryVersionCommand command =
        new UpdateTopologyBoundaryVersionCommand(
