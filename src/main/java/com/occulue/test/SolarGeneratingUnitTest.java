...
public class SolarGeneratingUnitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SolarGeneratingUnit : "
                          + successValue.getSolarGeneratingUnitId());
                  if (successValue.getSolarGeneratingUnitId().equals(solarGeneratingUnitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSolarGeneratingUnitList - 1,
      ...
      subscriber
          .solarGeneratingUnitSubscribe(solarGeneratingUnitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SolarGeneratingUnit : "
                          + successValue.getSolarGeneratingUnitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on solarGeneratingUnit for solarGeneratingUnitId consumed"));
  ...
  protected SolarGeneratingUnit read() throws Throwable {
    ...
    SolarGeneratingUnitFetchOneSummary fetchOneSummary =
        new SolarGeneratingUnitFetchOneSummary(solarGeneratingUnitId);

    try {
      entity =
          SolarGeneratingUnitBusinessDelegate.getSolarGeneratingUnitInstance()
              .getSolarGeneratingUnit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SolarGeneratingUnitBusinessDelegate proxy =
          SolarGeneratingUnitBusinessDelegate.getSolarGeneratingUnitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SolarGeneratingUnitBusinessDelegate.getSolarGeneratingUnitInstance()
          .delete(new DeleteSolarGeneratingUnitCommand(entity.getSolarGeneratingUnitId()))
          .get();
  ...
  protected List<SolarGeneratingUnit> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of SolarGeneratingUnit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSolarGeneratingUnitId(), "-- entity in Collection has a null primary key");
