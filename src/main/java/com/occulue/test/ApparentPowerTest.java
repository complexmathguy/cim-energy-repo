...
public class ApparentPowerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ApparentPower : "
                          + successValue.getApparentPowerId());
                  if (successValue.getApparentPowerId().equals(apparentPowerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfApparentPowerList - 1,
      ...
      subscriber
          .apparentPowerSubscribe(apparentPowerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ApparentPower : "
                          + successValue.getApparentPowerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ApparentPower read() throws Throwable {
    ...
    ApparentPowerFetchOneSummary fetchOneSummary =
        new ApparentPowerFetchOneSummary(apparentPowerId);

    try {
      entity =
          ApparentPowerBusinessDelegate.getApparentPowerInstance()
              .getApparentPower(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ApparentPowerBusinessDelegate proxy =
          ApparentPowerBusinessDelegate.getApparentPowerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ApparentPowerBusinessDelegate.getApparentPowerInstance()
          .delete(new DeleteApparentPowerCommand(entity.getApparentPowerId()))
          .get();
  ...
  protected List<ApparentPower> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getApparentPowerId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateApparentPowerCommand generateNewCommand() {
    CreateApparentPowerCommand command =
        new CreateApparentPowerCommand(null, UnitMultiplier.values()[0], UnitSymbol.values()[0]);
  ...
  protected UpdateApparentPowerCommand generateUpdateCommand() {
    UpdateApparentPowerCommand command =
        new UpdateApparentPowerCommand(
            null, UnitMultiplier.values()[0], UnitSymbol.values()[0], null);
