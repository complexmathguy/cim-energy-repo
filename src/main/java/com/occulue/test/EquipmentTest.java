...
public class EquipmentTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    EquipmentBusinessDelegate.getEquipmentInstance().createEquipment(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Equipment : " + successValue.getEquipmentId());
                  if (successValue.getEquipmentId().equals(equipmentId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEquipmentList - 1,
      ...
      subscriber
          .equipmentSubscribe(equipmentId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for Equipment : "
                          + successValue.getEquipmentId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + equipmentId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EquipmentBusinessDelegate.getEquipmentInstance()
          .delete(new DeleteEquipmentCommand(entity.getEquipmentId()))
          .get();
