...
public class MutualCouplingTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for MutualCoupling : "
                          + successValue.getMutualCouplingId());
                  if (successValue.getMutualCouplingId().equals(mutualCouplingId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfMutualCouplingList - 1,
      ...
      subscriber
          .mutualCouplingSubscribe(mutualCouplingId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for MutualCoupling : "
                          + successValue.getMutualCouplingId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected MutualCoupling read() throws Throwable {
    ...
    MutualCouplingFetchOneSummary fetchOneSummary =
        new MutualCouplingFetchOneSummary(mutualCouplingId);

    try {
      entity =
          MutualCouplingBusinessDelegate.getMutualCouplingInstance()
              .getMutualCoupling(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      MutualCouplingBusinessDelegate proxy =
          MutualCouplingBusinessDelegate.getMutualCouplingInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      MutualCouplingBusinessDelegate.getMutualCouplingInstance()
          .delete(new DeleteMutualCouplingCommand(entity.getMutualCouplingId()))
          .get();
  ...
  protected List<MutualCoupling> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          MutualCouplingBusinessDelegate.getMutualCouplingInstance().getAllMutualCoupling();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getMutualCouplingId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateMutualCouplingCommand generateUpdateCommand() {
    UpdateMutualCouplingCommand command =
        new UpdateMutualCouplingCommand(null, null, null, null, null, null, null, null, null);
