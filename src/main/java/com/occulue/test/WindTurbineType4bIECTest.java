...
public class WindTurbineType4bIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindTurbineType4bIEC : "
                          + successValue.getWindTurbineType4bIECId());
                  if (successValue.getWindTurbineType4bIECId().equals(windTurbineType4bIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindTurbineType4bIECList - 1,
      ...
      subscriber
          .windTurbineType4bIECSubscribe(windTurbineType4bIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindTurbineType4bIEC : "
                          + successValue.getWindTurbineType4bIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windTurbineType4bIEC for windTurbineType4bIECId consumed"));
  ...
  protected WindTurbineType4bIEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindTurbineType4bIEC with primary key");
    msg.append(windTurbineType4bIECId);

    WindTurbineType4bIECFetchOneSummary fetchOneSummary =
        new WindTurbineType4bIECFetchOneSummary(windTurbineType4bIECId);

    try {
      entity =
          WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance()
              .getWindTurbineType4bIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindTurbineType4bIECBusinessDelegate proxy =
          WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance()
          .delete(new DeleteWindTurbineType4bIECCommand(entity.getWindTurbineType4bIECId()))
          .get();
  ...
  protected List<WindTurbineType4bIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindTurbineType4bIECBusinessDelegate.getWindTurbineType4bIECInstance()
              .getAllWindTurbineType4bIEC();
      assertNotNull(
          collection, "An Empty collection of WindTurbineType4bIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindTurbineType4bIECId(), "-- entity in Collection has a null primary key");
