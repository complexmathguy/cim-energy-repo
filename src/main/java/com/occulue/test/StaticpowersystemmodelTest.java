...
public class StaticpowersystemmodelTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Staticpowersystemmodel : "
                          + successValue.getStaticpowersystemmodelId());
                  if (successValue.getStaticpowersystemmodelId().equals(staticpowersystemmodelId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfStaticpowersystemmodelList - 1,
      ...
      subscriber
          .staticpowersystemmodelSubscribe(staticpowersystemmodelId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for Staticpowersystemmodel : "
                          + successValue.getStaticpowersystemmodelId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on staticpowersystemmodel for staticpowersystemmodelId consumed"));
  ...
  protected Staticpowersystemmodel read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read Staticpowersystemmodel with primary key");
    msg.append(staticpowersystemmodelId);

    StaticpowersystemmodelFetchOneSummary fetchOneSummary =
        new StaticpowersystemmodelFetchOneSummary(staticpowersystemmodelId);

    try {
      entity =
          StaticpowersystemmodelBusinessDelegate.getStaticpowersystemmodelInstance()
              .getStaticpowersystemmodel(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      StaticpowersystemmodelBusinessDelegate proxy =
          StaticpowersystemmodelBusinessDelegate.getStaticpowersystemmodelInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read Staticpowersystemmodel with id " + staticpowersystemmodelId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read Staticpowersystemmodel with id " + staticpowersystemmodelId);
    ...
    try {
      StaticpowersystemmodelBusinessDelegate.getStaticpowersystemmodelInstance()
          .delete(new DeleteStaticpowersystemmodelCommand(entity.getStaticpowersystemmodelId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted Staticpowersystemmodel with id " + staticpowersystemmodelId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete Staticpowersystemmodel with id " + staticpowersystemmodelId);
  ...
  protected List<Staticpowersystemmodel> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of Staticpowersystemmodel was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getStaticpowersystemmodelId(), "-- entity in Collection has a null primary key");
