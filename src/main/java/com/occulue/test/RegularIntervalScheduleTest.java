...
public class RegularIntervalScheduleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RegularIntervalSchedule : "
                          + successValue.getRegularIntervalScheduleId());
                  if (successValue
                      .getRegularIntervalScheduleId()
                      .equals(regularIntervalScheduleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRegularIntervalScheduleList - 1,
      ...
      subscriber
          .regularIntervalScheduleSubscribe(regularIntervalScheduleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RegularIntervalSchedule : "
                          + successValue.getRegularIntervalScheduleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on regularIntervalSchedule for regularIntervalScheduleId consumed"));
  ...
  protected RegularIntervalSchedule read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read RegularIntervalSchedule with primary key");
    msg.append(regularIntervalScheduleId);

    RegularIntervalScheduleFetchOneSummary fetchOneSummary =
        new RegularIntervalScheduleFetchOneSummary(regularIntervalScheduleId);

    try {
      entity =
          RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance()
              .getRegularIntervalSchedule(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RegularIntervalScheduleBusinessDelegate proxy =
          RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read RegularIntervalSchedule with id " + regularIntervalScheduleId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read RegularIntervalSchedule with id " + regularIntervalScheduleId);
    ...
    try {
      RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance()
          .delete(new DeleteRegularIntervalScheduleCommand(entity.getRegularIntervalScheduleId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted RegularIntervalSchedule with id " + regularIntervalScheduleId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete RegularIntervalSchedule with id " + regularIntervalScheduleId);
  ...
  protected List<RegularIntervalSchedule> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          RegularIntervalScheduleBusinessDelegate.getRegularIntervalScheduleInstance()
              .getAllRegularIntervalSchedule();
      assertNotNull(
          collection, "An Empty collection of RegularIntervalSchedule was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRegularIntervalScheduleId(),
  ...
  protected UpdateRegularIntervalScheduleCommand generateUpdateCommand() {
    UpdateRegularIntervalScheduleCommand command =
        new UpdateRegularIntervalScheduleCommand(null, null, null);
