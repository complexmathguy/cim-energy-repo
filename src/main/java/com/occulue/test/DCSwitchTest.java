...
public class DCSwitchTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dCSwitchId =
        DCSwitchBusinessDelegate.getDCSwitchInstance().createDCSwitch(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCSwitch : " + successValue.getDCSwitchId());
                  if (successValue.getDCSwitchId().equals(dCSwitchId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCSwitchList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DCSwitch : "
                          + successValue.getDCSwitchId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dCSwitchId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCSwitchBusinessDelegate.getDCSwitchInstance()
          .delete(new DeleteDCSwitchCommand(entity.getDCSwitchId()))
          .get();
