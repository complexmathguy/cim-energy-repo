...
public class ActivePowerPerCurrentFlowTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ActivePowerPerCurrentFlow : "
                          + successValue.getActivePowerPerCurrentFlowId());
                  if (successValue
                      .getActivePowerPerCurrentFlowId()
                      .equals(activePowerPerCurrentFlowId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfActivePowerPerCurrentFlowList - 1,
      ...
      subscriber
          .activePowerPerCurrentFlowSubscribe(activePowerPerCurrentFlowId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ActivePowerPerCurrentFlow : "
                          + successValue.getActivePowerPerCurrentFlowId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on activePowerPerCurrentFlow for activePowerPerCurrentFlowId consumed"));
  ...
  protected ActivePowerPerCurrentFlow read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ActivePowerPerCurrentFlow with primary key");
    msg.append(activePowerPerCurrentFlowId);

    ActivePowerPerCurrentFlowFetchOneSummary fetchOneSummary =
        new ActivePowerPerCurrentFlowFetchOneSummary(activePowerPerCurrentFlowId);

    try {
      entity =
          ActivePowerPerCurrentFlowBusinessDelegate.getActivePowerPerCurrentFlowInstance()
              .getActivePowerPerCurrentFlow(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ActivePowerPerCurrentFlowBusinessDelegate proxy =
          ActivePowerPerCurrentFlowBusinessDelegate.getActivePowerPerCurrentFlowInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ActivePowerPerCurrentFlow with id " + activePowerPerCurrentFlowId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ActivePowerPerCurrentFlow with id " + activePowerPerCurrentFlowId);
    ...
    try {
      ActivePowerPerCurrentFlowBusinessDelegate.getActivePowerPerCurrentFlowInstance()
          .delete(
              new DeleteActivePowerPerCurrentFlowCommand(entity.getActivePowerPerCurrentFlowId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ActivePowerPerCurrentFlow with id "
              + activePowerPerCurrentFlowId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ActivePowerPerCurrentFlow with id " + activePowerPerCurrentFlowId);
  ...
  protected List<ActivePowerPerCurrentFlow> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of ActivePowerPerCurrentFlow was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getActivePowerPerCurrentFlowId(),
  ...
  protected CreateActivePowerPerCurrentFlowCommand generateNewCommand() {
    CreateActivePowerPerCurrentFlowCommand command =
        new CreateActivePowerPerCurrentFlowCommand(null);
  ...
  protected UpdateActivePowerPerCurrentFlowCommand generateUpdateCommand() {
    UpdateActivePowerPerCurrentFlowCommand command =
        new UpdateActivePowerPerCurrentFlowCommand(null);
