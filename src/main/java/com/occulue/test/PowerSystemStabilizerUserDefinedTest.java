...
public class PowerSystemStabilizerUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PowerSystemStabilizerUserDefined : "
                          + successValue.getPowerSystemStabilizerUserDefinedId());
                  if (successValue
                      .getPowerSystemStabilizerUserDefinedId()
                      .equals(powerSystemStabilizerUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPowerSystemStabilizerUserDefinedList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "PowerSystemStabilizerUserDefined test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          .powerSystemStabilizerUserDefinedSubscribe(powerSystemStabilizerUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PowerSystemStabilizerUserDefined : "
                          + successValue.getPowerSystemStabilizerUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on powerSystemStabilizerUserDefined for powerSystemStabilizerUserDefinedId consumed"));
  ...
  protected PowerSystemStabilizerUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PowerSystemStabilizerUserDefined with primary key");
    msg.append(powerSystemStabilizerUserDefinedId);

    PowerSystemStabilizerUserDefinedFetchOneSummary fetchOneSummary =
        new PowerSystemStabilizerUserDefinedFetchOneSummary(powerSystemStabilizerUserDefinedId);

    try {
      entity =
          PowerSystemStabilizerUserDefinedBusinessDelegate
              .getPowerSystemStabilizerUserDefinedInstance()
              .getPowerSystemStabilizerUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PowerSystemStabilizerUserDefinedBusinessDelegate proxy =
          PowerSystemStabilizerUserDefinedBusinessDelegate
              .getPowerSystemStabilizerUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PowerSystemStabilizerUserDefined with id "
              + powerSystemStabilizerUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PowerSystemStabilizerUserDefined with id "
              + powerSystemStabilizerUserDefinedId);
    ...
    try {
      PowerSystemStabilizerUserDefinedBusinessDelegate.getPowerSystemStabilizerUserDefinedInstance()
          .delete(
              new DeletePowerSystemStabilizerUserDefinedCommand(
                  entity.getPowerSystemStabilizerUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PowerSystemStabilizerUserDefined with id "
              + powerSystemStabilizerUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PowerSystemStabilizerUserDefined with id "
              + powerSystemStabilizerUserDefinedId);
  ...
  protected List<PowerSystemStabilizerUserDefined> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all PowerSystemStabilizerUserDefined : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of PowerSystemStabilizerUserDefined was incorrectly returned.");
  ...
  protected CreatePowerSystemStabilizerUserDefinedCommand generateNewCommand() {
    CreatePowerSystemStabilizerUserDefinedCommand command =
        new CreatePowerSystemStabilizerUserDefinedCommand(null);
  ...
  protected UpdatePowerSystemStabilizerUserDefinedCommand generateUpdateCommand() {
    UpdatePowerSystemStabilizerUserDefinedCommand command =
        new UpdatePowerSystemStabilizerUserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(PowerSystemStabilizerUserDefinedTest.class.getName());
