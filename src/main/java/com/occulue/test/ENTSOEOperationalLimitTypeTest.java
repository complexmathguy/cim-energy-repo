...
public class ENTSOEOperationalLimitTypeTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ENTSOEOperationalLimitType : "
                          + successValue.getENTSOEOperationalLimitTypeId());
                  if (successValue
                      .getENTSOEOperationalLimitTypeId()
                      .equals(eNTSOEOperationalLimitTypeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfENTSOEOperationalLimitTypeList - 1,
      ...
      subscriber
          .eNTSOEOperationalLimitTypeSubscribe(eNTSOEOperationalLimitTypeId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ENTSOEOperationalLimitType : "
                          + successValue.getENTSOEOperationalLimitTypeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on eNTSOEOperationalLimitType for eNTSOEOperationalLimitTypeId consumed"));
  ...
  protected ENTSOEOperationalLimitType read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ENTSOEOperationalLimitType with primary key");
    msg.append(eNTSOEOperationalLimitTypeId);

    ENTSOEOperationalLimitTypeFetchOneSummary fetchOneSummary =
        new ENTSOEOperationalLimitTypeFetchOneSummary(eNTSOEOperationalLimitTypeId);

    try {
      entity =
          ENTSOEOperationalLimitTypeBusinessDelegate.getENTSOEOperationalLimitTypeInstance()
              .getENTSOEOperationalLimitType(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ENTSOEOperationalLimitTypeBusinessDelegate proxy =
          ENTSOEOperationalLimitTypeBusinessDelegate.getENTSOEOperationalLimitTypeInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ENTSOEOperationalLimitType with id "
              + eNTSOEOperationalLimitTypeId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ENTSOEOperationalLimitType with id " + eNTSOEOperationalLimitTypeId);
    ...
    try {
      ENTSOEOperationalLimitTypeBusinessDelegate.getENTSOEOperationalLimitTypeInstance()
          .delete(
              new DeleteENTSOEOperationalLimitTypeCommand(entity.getENTSOEOperationalLimitTypeId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ENTSOEOperationalLimitType with id "
              + eNTSOEOperationalLimitTypeId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ENTSOEOperationalLimitType with id " + eNTSOEOperationalLimitTypeId);
  ...
  protected List<ENTSOEOperationalLimitType> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of ENTSOEOperationalLimitType was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getENTSOEOperationalLimitTypeId(),
  ...
  protected CreateENTSOEOperationalLimitTypeCommand generateNewCommand() {
    CreateENTSOEOperationalLimitTypeCommand command =
        new CreateENTSOEOperationalLimitTypeCommand(null, LimitTypeKind.values()[0]);
  ...
  protected UpdateENTSOEOperationalLimitTypeCommand generateUpdateCommand() {
    UpdateENTSOEOperationalLimitTypeCommand command =
        new UpdateENTSOEOperationalLimitTypeCommand(null, LimitTypeKind.values()[0]);
