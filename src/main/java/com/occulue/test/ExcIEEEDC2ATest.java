...
public class ExcIEEEDC2ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEDC2A : "
                          + successValue.getExcIEEEDC2AId());
                  if (successValue.getExcIEEEDC2AId().equals(excIEEEDC2AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEDC2AList - 1,
      ...
      subscriber
          .excIEEEDC2ASubscribe(excIEEEDC2AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEDC2A : "
                          + successValue.getExcIEEEDC2AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEDC2ABusinessDelegate.getExcIEEEDC2AInstance()
          .delete(new DeleteExcIEEEDC2ACommand(entity.getExcIEEEDC2AId()))
          .get();
  ...
  protected UpdateExcIEEEDC2ACommand generateUpdateCommand() {
    UpdateExcIEEEDC2ACommand command =
        new UpdateExcIEEEDC2ACommand(
