...
public class CurveTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    curveId = CurveBusinessDelegate.getCurveInstance().createCurve(generateNewCommand()).get();
    ...
    CurveBusinessDelegate.getCurveInstance().createCurve(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Curve : "
                          + successValue.getCurveId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + curveId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      CurveBusinessDelegate.getCurveInstance()
          .delete(new DeleteCurveCommand(entity.getCurveId()))
          .get();
  ...
  protected CreateCurveCommand generateNewCommand() {
    CreateCurveCommand command =
        new CreateCurveCommand(
            null,
            CurveStyle.values()[0],
            UnitSymbol.values()[0],
            UnitSymbol.values()[0],
  ...
  protected UpdateCurveCommand generateUpdateCommand() {
    UpdateCurveCommand command =
        new UpdateCurveCommand(
            null,
            CurveStyle.values()[0],
            UnitSymbol.values()[0],
            UnitSymbol.values()[0],
