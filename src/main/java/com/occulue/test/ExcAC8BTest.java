...
public class ExcAC8BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAC8BId =
        ExcAC8BBusinessDelegate.getExcAC8BInstance().createExcAC8B(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAC8B : " + successValue.getExcAC8BId());
                  if (successValue.getExcAC8BId().equals(excAC8BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAC8BList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAC8B : "
                          + successValue.getExcAC8BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAC8BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAC8BBusinessDelegate.getExcAC8BInstance()
          .delete(new DeleteExcAC8BCommand(entity.getExcAC8BId()))
          .get();
  ...
  protected UpdateExcAC8BCommand generateUpdateCommand() {
    UpdateExcAC8BCommand command =
        new UpdateExcAC8BCommand(
