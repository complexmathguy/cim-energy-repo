...
public class DiagramObjectStyleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DiagramObjectStyle : "
                          + successValue.getDiagramObjectStyleId());
                  if (successValue.getDiagramObjectStyleId().equals(diagramObjectStyleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiagramObjectStyleList - 1,
      ...
      subscriber
          .diagramObjectStyleSubscribe(diagramObjectStyleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DiagramObjectStyle : "
                          + successValue.getDiagramObjectStyleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on diagramObjectStyle for diagramObjectStyleId consumed"));
  ...
  protected DiagramObjectStyle read() throws Throwable {
    ...
    DiagramObjectStyleFetchOneSummary fetchOneSummary =
        new DiagramObjectStyleFetchOneSummary(diagramObjectStyleId);

    try {
      entity =
          DiagramObjectStyleBusinessDelegate.getDiagramObjectStyleInstance()
              .getDiagramObjectStyle(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DiagramObjectStyleBusinessDelegate proxy =
          DiagramObjectStyleBusinessDelegate.getDiagramObjectStyleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DiagramObjectStyleBusinessDelegate.getDiagramObjectStyleInstance()
          .delete(new DeleteDiagramObjectStyleCommand(entity.getDiagramObjectStyleId()))
          .get();
  ...
  protected List<DiagramObjectStyle> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of DiagramObjectStyle was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDiagramObjectStyleId(), "-- entity in Collection has a null primary key");
