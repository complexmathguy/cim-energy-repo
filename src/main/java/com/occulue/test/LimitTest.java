...
public class LimitTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    limitId = LimitBusinessDelegate.getLimitInstance().createLimit(generateNewCommand()).get();
    ...
    LimitBusinessDelegate.getLimitInstance().createLimit(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Limit : "
                          + successValue.getLimitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + limitId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LimitBusinessDelegate.getLimitInstance()
          .delete(new DeleteLimitCommand(entity.getLimitId()))
          .get();
