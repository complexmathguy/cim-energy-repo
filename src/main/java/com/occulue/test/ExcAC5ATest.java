...
public class ExcAC5ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAC5AId =
        ExcAC5ABusinessDelegate.getExcAC5AInstance().createExcAC5A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAC5A : " + successValue.getExcAC5AId());
                  if (successValue.getExcAC5AId().equals(excAC5AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAC5AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAC5A : "
                          + successValue.getExcAC5AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAC5AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAC5ABusinessDelegate.getExcAC5AInstance()
          .delete(new DeleteExcAC5ACommand(entity.getExcAC5AId()))
          .get();
  ...
  protected UpdateExcAC5ACommand generateUpdateCommand() {
    UpdateExcAC5ACommand command =
        new UpdateExcAC5ACommand(
