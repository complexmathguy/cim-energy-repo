...
public class ExcPICTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excPICId = ExcPICBusinessDelegate.getExcPICInstance().createExcPIC(generateNewCommand()).get();
    ...
    ExcPICBusinessDelegate.getExcPICInstance().createExcPIC(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcPIC : "
                          + successValue.getExcPICId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excPICId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcPICBusinessDelegate.getExcPICInstance()
          .delete(new DeleteExcPICCommand(entity.getExcPICId()))
          .get();
  ...
  protected UpdateExcPICCommand generateUpdateCommand() {
    UpdateExcPICCommand command =
        new UpdateExcPICCommand(
