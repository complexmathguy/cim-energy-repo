...
public class ConductingEquipmentTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ConductingEquipment : "
                          + successValue.getConductingEquipmentId());
                  if (successValue.getConductingEquipmentId().equals(conductingEquipmentId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfConductingEquipmentList - 1,
      ...
      subscriber
          .conductingEquipmentSubscribe(conductingEquipmentId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ConductingEquipment : "
                          + successValue.getConductingEquipmentId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on conductingEquipment for conductingEquipmentId consumed"));
  ...
  protected ConductingEquipment read() throws Throwable {
    ...
    ConductingEquipmentFetchOneSummary fetchOneSummary =
        new ConductingEquipmentFetchOneSummary(conductingEquipmentId);

    try {
      entity =
          ConductingEquipmentBusinessDelegate.getConductingEquipmentInstance()
              .getConductingEquipment(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ConductingEquipmentBusinessDelegate proxy =
          ConductingEquipmentBusinessDelegate.getConductingEquipmentInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ConductingEquipmentBusinessDelegate.getConductingEquipmentInstance()
          .delete(new DeleteConductingEquipmentCommand(entity.getConductingEquipmentId()))
          .get();
  ...
  protected List<ConductingEquipment> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ConductingEquipmentBusinessDelegate.getConductingEquipmentInstance()
              .getAllConductingEquipment();
      assertNotNull(
          collection, "An Empty collection of ConductingEquipment was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getConductingEquipmentId(), "-- entity in Collection has a null primary key");
