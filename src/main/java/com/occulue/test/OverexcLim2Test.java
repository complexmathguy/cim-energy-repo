...
public class OverexcLim2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OverexcLim2 : "
                          + successValue.getOverexcLim2Id());
                  if (successValue.getOverexcLim2Id().equals(overexcLim2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOverexcLim2List - 1,
      ...
      subscriber
          .overexcLim2Subscribe(overexcLim2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OverexcLim2 : "
                          + successValue.getOverexcLim2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      OverexcLim2BusinessDelegate.getOverexcLim2Instance()
          .delete(new DeleteOverexcLim2Command(entity.getOverexcLim2Id()))
          .get();
