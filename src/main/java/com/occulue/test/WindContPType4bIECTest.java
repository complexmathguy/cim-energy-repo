...
public class WindContPType4bIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindContPType4bIEC : "
                          + successValue.getWindContPType4bIECId());
                  if (successValue.getWindContPType4bIECId().equals(windContPType4bIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindContPType4bIECList - 1,
      ...
      subscriber
          .windContPType4bIECSubscribe(windContPType4bIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindContPType4bIEC : "
                          + successValue.getWindContPType4bIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windContPType4bIEC for windContPType4bIECId consumed"));
  ...
  protected WindContPType4bIEC read() throws Throwable {
    ...
    WindContPType4bIECFetchOneSummary fetchOneSummary =
        new WindContPType4bIECFetchOneSummary(windContPType4bIECId);

    try {
      entity =
          WindContPType4bIECBusinessDelegate.getWindContPType4bIECInstance()
              .getWindContPType4bIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindContPType4bIECBusinessDelegate proxy =
          WindContPType4bIECBusinessDelegate.getWindContPType4bIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindContPType4bIECBusinessDelegate.getWindContPType4bIECInstance()
          .delete(new DeleteWindContPType4bIECCommand(entity.getWindContPType4bIECId()))
          .get();
  ...
  protected List<WindContPType4bIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindContPType4bIECBusinessDelegate.getWindContPType4bIECInstance()
              .getAllWindContPType4bIEC();
      assertNotNull(
          collection, "An Empty collection of WindContPType4bIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindContPType4bIECId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateWindContPType4bIECCommand generateUpdateCommand() {
    UpdateWindContPType4bIECCommand command =
        new UpdateWindContPType4bIECCommand(null, null, null, null, null);
