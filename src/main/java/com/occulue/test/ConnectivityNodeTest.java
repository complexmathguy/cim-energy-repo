...
public class ConnectivityNodeTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ConnectivityNode : "
                          + successValue.getConnectivityNodeId());
                  if (successValue.getConnectivityNodeId().equals(connectivityNodeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfConnectivityNodeList - 1,
      ...
      subscriber
          .connectivityNodeSubscribe(connectivityNodeId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ConnectivityNode : "
                          + successValue.getConnectivityNodeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ConnectivityNode read() throws Throwable {
    ...
    ConnectivityNodeFetchOneSummary fetchOneSummary =
        new ConnectivityNodeFetchOneSummary(connectivityNodeId);

    try {
      entity =
          ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance()
              .getConnectivityNode(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ConnectivityNodeBusinessDelegate proxy =
          ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance()
          .delete(new DeleteConnectivityNodeCommand(entity.getConnectivityNodeId()))
          .get();
  ...
  protected List<ConnectivityNode> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ConnectivityNodeBusinessDelegate.getConnectivityNodeInstance().getAllConnectivityNode();
      assertNotNull(
          collection, "An Empty collection of ConnectivityNode was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getConnectivityNodeId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateConnectivityNodeCommand generateUpdateCommand() {
    UpdateConnectivityNodeCommand command =
        new UpdateConnectivityNodeCommand(null, null, null, null, null, null, null, null);
