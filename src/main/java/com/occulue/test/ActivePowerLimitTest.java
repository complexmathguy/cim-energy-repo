...
public class ActivePowerLimitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ActivePowerLimit : "
                          + successValue.getActivePowerLimitId());
                  if (successValue.getActivePowerLimitId().equals(activePowerLimitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfActivePowerLimitList - 1,
      ...
      subscriber
          .activePowerLimitSubscribe(activePowerLimitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ActivePowerLimit : "
                          + successValue.getActivePowerLimitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ActivePowerLimit read() throws Throwable {
    ...
    ActivePowerLimitFetchOneSummary fetchOneSummary =
        new ActivePowerLimitFetchOneSummary(activePowerLimitId);

    try {
      entity =
          ActivePowerLimitBusinessDelegate.getActivePowerLimitInstance()
              .getActivePowerLimit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ActivePowerLimitBusinessDelegate proxy =
          ActivePowerLimitBusinessDelegate.getActivePowerLimitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ActivePowerLimitBusinessDelegate.getActivePowerLimitInstance()
          .delete(new DeleteActivePowerLimitCommand(entity.getActivePowerLimitId()))
          .get();
  ...
  protected List<ActivePowerLimit> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of ActivePowerLimit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getActivePowerLimitId(), "-- entity in Collection has a null primary key");
