...
public class NonConformLoadGroupTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for NonConformLoadGroup : "
                          + successValue.getNonConformLoadGroupId());
                  if (successValue.getNonConformLoadGroupId().equals(nonConformLoadGroupId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfNonConformLoadGroupList - 1,
      ...
      subscriber
          .nonConformLoadGroupSubscribe(nonConformLoadGroupId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for NonConformLoadGroup : "
                          + successValue.getNonConformLoadGroupId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on nonConformLoadGroup for nonConformLoadGroupId consumed"));
  ...
  protected NonConformLoadGroup read() throws Throwable {
    ...
    NonConformLoadGroupFetchOneSummary fetchOneSummary =
        new NonConformLoadGroupFetchOneSummary(nonConformLoadGroupId);

    try {
      entity =
          NonConformLoadGroupBusinessDelegate.getNonConformLoadGroupInstance()
              .getNonConformLoadGroup(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      NonConformLoadGroupBusinessDelegate proxy =
          NonConformLoadGroupBusinessDelegate.getNonConformLoadGroupInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      NonConformLoadGroupBusinessDelegate.getNonConformLoadGroupInstance()
          .delete(new DeleteNonConformLoadGroupCommand(entity.getNonConformLoadGroupId()))
          .get();
  ...
  protected List<NonConformLoadGroup> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          NonConformLoadGroupBusinessDelegate.getNonConformLoadGroupInstance()
              .getAllNonConformLoadGroup();
      assertNotNull(
          collection, "An Empty collection of NonConformLoadGroup was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getNonConformLoadGroupId(), "-- entity in Collection has a null primary key");
