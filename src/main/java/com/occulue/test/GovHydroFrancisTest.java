...
public class GovHydroFrancisTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydroFrancis : "
                          + successValue.getGovHydroFrancisId());
                  if (successValue.getGovHydroFrancisId().equals(govHydroFrancisId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydroFrancisList - 1,
      ...
      subscriber
          .govHydroFrancisSubscribe(govHydroFrancisId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydroFrancis : "
                          + successValue.getGovHydroFrancisId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected GovHydroFrancis read() throws Throwable {
    ...
    GovHydroFrancisFetchOneSummary fetchOneSummary =
        new GovHydroFrancisFetchOneSummary(govHydroFrancisId);

    try {
      entity =
          GovHydroFrancisBusinessDelegate.getGovHydroFrancisInstance()
              .getGovHydroFrancis(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GovHydroFrancisBusinessDelegate proxy =
          GovHydroFrancisBusinessDelegate.getGovHydroFrancisInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydroFrancisBusinessDelegate.getGovHydroFrancisInstance()
          .delete(new DeleteGovHydroFrancisCommand(entity.getGovHydroFrancisId()))
          .get();
  ...
  protected List<GovHydroFrancis> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGovHydroFrancisId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateGovHydroFrancisCommand generateNewCommand() {
    CreateGovHydroFrancisCommand command =
        new CreateGovHydroFrancisCommand(null, FrancisGovernorControlKind.values()[0]);
  ...
  protected UpdateGovHydroFrancisCommand generateUpdateCommand() {
    UpdateGovHydroFrancisCommand command =
        new UpdateGovHydroFrancisCommand(
            null,
            null,
            null,
            null,
            ...
            null,
            null,
            FrancisGovernorControlKind.values()[0],
            null,
            null,
            null,
            null,
