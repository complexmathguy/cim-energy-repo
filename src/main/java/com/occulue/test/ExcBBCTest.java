...
public class ExcBBCTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excBBCId = ExcBBCBusinessDelegate.getExcBBCInstance().createExcBBC(generateNewCommand()).get();
    ...
    ExcBBCBusinessDelegate.getExcBBCInstance().createExcBBC(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcBBC : "
                          + successValue.getExcBBCId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excBBCId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcBBCBusinessDelegate.getExcBBCInstance()
          .delete(new DeleteExcBBCCommand(entity.getExcBBCId()))
          .get();
