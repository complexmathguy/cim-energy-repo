...
public class ExcHUTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excHUId = ExcHUBusinessDelegate.getExcHUInstance().createExcHU(generateNewCommand()).get();
    ...
    ExcHUBusinessDelegate.getExcHUInstance().createExcHU(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcHU : "
                          + successValue.getExcHUId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excHUId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcHUBusinessDelegate.getExcHUInstance()
          .delete(new DeleteExcHUCommand(entity.getExcHUId()))
          .get();
  ...
  protected UpdateExcHUCommand generateUpdateCommand() {
    UpdateExcHUCommand command =
        new UpdateExcHUCommand(
