...
public class LoadAggregateTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LoadAggregate : "
                          + successValue.getLoadAggregateId());
                  if (successValue.getLoadAggregateId().equals(loadAggregateId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLoadAggregateList - 1,
      ...
      subscriber
          .loadAggregateSubscribe(loadAggregateId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for LoadAggregate : "
                          + successValue.getLoadAggregateId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected LoadAggregate read() throws Throwable {
    ...
    LoadAggregateFetchOneSummary fetchOneSummary =
        new LoadAggregateFetchOneSummary(loadAggregateId);

    try {
      entity =
          LoadAggregateBusinessDelegate.getLoadAggregateInstance()
              .getLoadAggregate(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LoadAggregateBusinessDelegate proxy =
          LoadAggregateBusinessDelegate.getLoadAggregateInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LoadAggregateBusinessDelegate.getLoadAggregateInstance()
          .delete(new DeleteLoadAggregateCommand(entity.getLoadAggregateId()))
          .get();
  ...
  protected List<LoadAggregate> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getLoadAggregateId(), "-- entity in Collection has a null primary key");
