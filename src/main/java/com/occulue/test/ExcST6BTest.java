...
public class ExcST6BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excST6BId =
        ExcST6BBusinessDelegate.getExcST6BInstance().createExcST6B(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcST6B : " + successValue.getExcST6BId());
                  if (successValue.getExcST6BId().equals(excST6BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcST6BList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcST6B : "
                          + successValue.getExcST6BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excST6BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcST6BBusinessDelegate.getExcST6BInstance()
          .delete(new DeleteExcST6BCommand(entity.getExcST6BId()))
          .get();
  ...
  protected CreateExcST6BCommand generateNewCommand() {
    CreateExcST6BCommand command =
        new CreateExcST6BCommand(null, ExcST6BOELselectorKind.values()[0]);
  ...
  protected UpdateExcST6BCommand generateUpdateCommand() {
    UpdateExcST6BCommand command =
        new UpdateExcST6BCommand(
            null,
            null,
            null,
            null,
            ...
            null,
            null,
            ExcST6BOELselectorKind.values()[0],
            null,
            null,
            null,
            null,
