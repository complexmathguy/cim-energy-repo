...
public class PFVArType2IEEEPFControllerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArType2IEEEPFController : "
                          + successValue.getPFVArType2IEEEPFControllerId());
                  if (successValue
                      .getPFVArType2IEEEPFControllerId()
                      .equals(pFVArType2IEEEPFControllerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArType2IEEEPFControllerList - 1,
      ...
      subscriber
          .pFVArType2IEEEPFControllerSubscribe(pFVArType2IEEEPFControllerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArType2IEEEPFController : "
                          + successValue.getPFVArType2IEEEPFControllerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArType2IEEEPFController for pFVArType2IEEEPFControllerId consumed"));
  ...
  protected PFVArType2IEEEPFController read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArType2IEEEPFController with primary key");
    msg.append(pFVArType2IEEEPFControllerId);

    PFVArType2IEEEPFControllerFetchOneSummary fetchOneSummary =
        new PFVArType2IEEEPFControllerFetchOneSummary(pFVArType2IEEEPFControllerId);

    try {
      entity =
          PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance()
              .getPFVArType2IEEEPFController(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArType2IEEEPFControllerBusinessDelegate proxy =
          PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArType2IEEEPFController with id "
              + pFVArType2IEEEPFControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArType2IEEEPFController with id " + pFVArType2IEEEPFControllerId);
    ...
    try {
      PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance()
          .delete(
              new DeletePFVArType2IEEEPFControllerCommand(entity.getPFVArType2IEEEPFControllerId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArType2IEEEPFController with id "
              + pFVArType2IEEEPFControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArType2IEEEPFController with id " + pFVArType2IEEEPFControllerId);
  ...
  protected List<PFVArType2IEEEPFController> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PFVArType2IEEEPFControllerBusinessDelegate.getPFVArType2IEEEPFControllerInstance()
              .getAllPFVArType2IEEEPFController();
      assertNotNull(
          collection,
          "An Empty collection of PFVArType2IEEEPFController was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPFVArType2IEEEPFControllerId(),
  ...
  protected CreatePFVArType2IEEEPFControllerCommand generateNewCommand() {
    CreatePFVArType2IEEEPFControllerCommand command =
        new CreatePFVArType2IEEEPFControllerCommand(null);
  ...
  protected UpdatePFVArType2IEEEPFControllerCommand generateUpdateCommand() {
    UpdatePFVArType2IEEEPFControllerCommand command =
        new UpdatePFVArType2IEEEPFControllerCommand(null, null, null, null, null, null, null, null);
