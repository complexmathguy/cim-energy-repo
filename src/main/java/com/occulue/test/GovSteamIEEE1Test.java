...
public class GovSteamIEEE1Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteamIEEE1 : "
                          + successValue.getGovSteamIEEE1Id());
                  if (successValue.getGovSteamIEEE1Id().equals(govSteamIEEE1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteamIEEE1List - 1,
      ...
      subscriber
          .govSteamIEEE1Subscribe(govSteamIEEE1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteamIEEE1 : "
                          + successValue.getGovSteamIEEE1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected GovSteamIEEE1 read() throws Throwable {
    ...
    GovSteamIEEE1FetchOneSummary fetchOneSummary =
        new GovSteamIEEE1FetchOneSummary(govSteamIEEE1Id);

    try {
      entity =
          GovSteamIEEE1BusinessDelegate.getGovSteamIEEE1Instance()
              .getGovSteamIEEE1(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GovSteamIEEE1BusinessDelegate proxy =
          GovSteamIEEE1BusinessDelegate.getGovSteamIEEE1Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteamIEEE1BusinessDelegate.getGovSteamIEEE1Instance()
          .delete(new DeleteGovSteamIEEE1Command(entity.getGovSteamIEEE1Id()))
          .get();
  ...
  protected List<GovSteamIEEE1> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGovSteamIEEE1Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateGovSteamIEEE1Command generateUpdateCommand() {
    UpdateGovSteamIEEE1Command command =
        new UpdateGovSteamIEEE1Command(
