...
public class PowerSystemResourceTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PowerSystemResource : "
                          + successValue.getPowerSystemResourceId());
                  if (successValue.getPowerSystemResourceId().equals(powerSystemResourceId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPowerSystemResourceList - 1,
      ...
      subscriber
          .powerSystemResourceSubscribe(powerSystemResourceId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PowerSystemResource : "
                          + successValue.getPowerSystemResourceId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on powerSystemResource for powerSystemResourceId consumed"));
  ...
  protected PowerSystemResource read() throws Throwable {
    ...
    PowerSystemResourceFetchOneSummary fetchOneSummary =
        new PowerSystemResourceFetchOneSummary(powerSystemResourceId);

    try {
      entity =
          PowerSystemResourceBusinessDelegate.getPowerSystemResourceInstance()
              .getPowerSystemResource(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PowerSystemResourceBusinessDelegate proxy =
          PowerSystemResourceBusinessDelegate.getPowerSystemResourceInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PowerSystemResourceBusinessDelegate.getPowerSystemResourceInstance()
          .delete(new DeletePowerSystemResourceCommand(entity.getPowerSystemResourceId()))
          .get();
  ...
  protected List<PowerSystemResource> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PowerSystemResourceBusinessDelegate.getPowerSystemResourceInstance()
              .getAllPowerSystemResource();
      assertNotNull(
          collection, "An Empty collection of PowerSystemResource was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPowerSystemResourceId(), "-- entity in Collection has a null primary key");
