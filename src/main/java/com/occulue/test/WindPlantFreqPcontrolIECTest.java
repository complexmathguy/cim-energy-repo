...
public class WindPlantFreqPcontrolIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindPlantFreqPcontrolIEC : "
                          + successValue.getWindPlantFreqPcontrolIECId());
                  if (successValue
                      .getWindPlantFreqPcontrolIECId()
                      .equals(windPlantFreqPcontrolIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindPlantFreqPcontrolIECList - 1,
      ...
      subscriber
          .windPlantFreqPcontrolIECSubscribe(windPlantFreqPcontrolIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindPlantFreqPcontrolIEC : "
                          + successValue.getWindPlantFreqPcontrolIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windPlantFreqPcontrolIEC for windPlantFreqPcontrolIECId consumed"));
  ...
  protected WindPlantFreqPcontrolIEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindPlantFreqPcontrolIEC with primary key");
    msg.append(windPlantFreqPcontrolIECId);

    WindPlantFreqPcontrolIECFetchOneSummary fetchOneSummary =
        new WindPlantFreqPcontrolIECFetchOneSummary(windPlantFreqPcontrolIECId);

    try {
      entity =
          WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance()
              .getWindPlantFreqPcontrolIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindPlantFreqPcontrolIECBusinessDelegate proxy =
          WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindPlantFreqPcontrolIEC with id " + windPlantFreqPcontrolIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindPlantFreqPcontrolIEC with id " + windPlantFreqPcontrolIECId);
    ...
    try {
      WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance()
          .delete(new DeleteWindPlantFreqPcontrolIECCommand(entity.getWindPlantFreqPcontrolIECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindPlantFreqPcontrolIEC with id " + windPlantFreqPcontrolIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindPlantFreqPcontrolIEC with id " + windPlantFreqPcontrolIECId);
  ...
  protected List<WindPlantFreqPcontrolIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindPlantFreqPcontrolIECBusinessDelegate.getWindPlantFreqPcontrolIECInstance()
              .getAllWindPlantFreqPcontrolIEC();
      assertNotNull(
          collection, "An Empty collection of WindPlantFreqPcontrolIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindPlantFreqPcontrolIECId(),
