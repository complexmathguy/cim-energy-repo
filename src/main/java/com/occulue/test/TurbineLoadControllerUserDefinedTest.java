...
public class TurbineLoadControllerUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TurbineLoadControllerUserDefined : "
                          + successValue.getTurbineLoadControllerUserDefinedId());
                  if (successValue
                      .getTurbineLoadControllerUserDefinedId()
                      .equals(turbineLoadControllerUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTurbineLoadControllerUserDefinedList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "TurbineLoadControllerUserDefined test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          .turbineLoadControllerUserDefinedSubscribe(turbineLoadControllerUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TurbineLoadControllerUserDefined : "
                          + successValue.getTurbineLoadControllerUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on turbineLoadControllerUserDefined for turbineLoadControllerUserDefinedId consumed"));
  ...
  protected TurbineLoadControllerUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read TurbineLoadControllerUserDefined with primary key");
    msg.append(turbineLoadControllerUserDefinedId);

    TurbineLoadControllerUserDefinedFetchOneSummary fetchOneSummary =
        new TurbineLoadControllerUserDefinedFetchOneSummary(turbineLoadControllerUserDefinedId);

    try {
      entity =
          TurbineLoadControllerUserDefinedBusinessDelegate
              .getTurbineLoadControllerUserDefinedInstance()
              .getTurbineLoadControllerUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TurbineLoadControllerUserDefinedBusinessDelegate proxy =
          TurbineLoadControllerUserDefinedBusinessDelegate
              .getTurbineLoadControllerUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read TurbineLoadControllerUserDefined with id "
              + turbineLoadControllerUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read TurbineLoadControllerUserDefined with id "
              + turbineLoadControllerUserDefinedId);
    ...
    try {
      TurbineLoadControllerUserDefinedBusinessDelegate.getTurbineLoadControllerUserDefinedInstance()
          .delete(
              new DeleteTurbineLoadControllerUserDefinedCommand(
                  entity.getTurbineLoadControllerUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted TurbineLoadControllerUserDefined with id "
              + turbineLoadControllerUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete TurbineLoadControllerUserDefined with id "
              + turbineLoadControllerUserDefinedId);
  ...
  protected List<TurbineLoadControllerUserDefined> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all TurbineLoadControllerUserDefined : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of TurbineLoadControllerUserDefined was incorrectly returned.");
  ...
  protected CreateTurbineLoadControllerUserDefinedCommand generateNewCommand() {
    CreateTurbineLoadControllerUserDefinedCommand command =
        new CreateTurbineLoadControllerUserDefinedCommand(null);
  ...
  protected UpdateTurbineLoadControllerUserDefinedCommand generateUpdateCommand() {
    UpdateTurbineLoadControllerUserDefinedCommand command =
        new UpdateTurbineLoadControllerUserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(TurbineLoadControllerUserDefinedTest.class.getName());
