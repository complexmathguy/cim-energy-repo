...
public class ExcIEEEAC3ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC3A : "
                          + successValue.getExcIEEEAC3AId());
                  if (successValue.getExcIEEEAC3AId().equals(excIEEEAC3AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC3AList - 1,
      ...
      subscriber
          .excIEEEAC3ASubscribe(excIEEEAC3AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC3A : "
                          + successValue.getExcIEEEAC3AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC3ABusinessDelegate.getExcIEEEAC3AInstance()
          .delete(new DeleteExcIEEEAC3ACommand(entity.getExcIEEEAC3AId()))
          .get();
  ...
  protected UpdateExcIEEEAC3ACommand generateUpdateCommand() {
    UpdateExcIEEEAC3ACommand command =
        new UpdateExcIEEEAC3ACommand(
