...
public class PFVArType2IEEEVArControllerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArType2IEEEVArController : "
                          + successValue.getPFVArType2IEEEVArControllerId());
                  if (successValue
                      .getPFVArType2IEEEVArControllerId()
                      .equals(pFVArType2IEEEVArControllerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArType2IEEEVArControllerList - 1,
      ...
      subscriber
          .pFVArType2IEEEVArControllerSubscribe(pFVArType2IEEEVArControllerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArType2IEEEVArController : "
                          + successValue.getPFVArType2IEEEVArControllerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArType2IEEEVArController for pFVArType2IEEEVArControllerId consumed"));
  ...
  protected PFVArType2IEEEVArController read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArType2IEEEVArController with primary key");
    msg.append(pFVArType2IEEEVArControllerId);

    PFVArType2IEEEVArControllerFetchOneSummary fetchOneSummary =
        new PFVArType2IEEEVArControllerFetchOneSummary(pFVArType2IEEEVArControllerId);

    try {
      entity =
          PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance()
              .getPFVArType2IEEEVArController(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArType2IEEEVArControllerBusinessDelegate proxy =
          PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArType2IEEEVArController with id "
              + pFVArType2IEEEVArControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArType2IEEEVArController with id " + pFVArType2IEEEVArControllerId);
    ...
    try {
      PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance()
          .delete(
              new DeletePFVArType2IEEEVArControllerCommand(
                  entity.getPFVArType2IEEEVArControllerId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArType2IEEEVArController with id "
              + pFVArType2IEEEVArControllerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArType2IEEEVArController with id "
              + pFVArType2IEEEVArControllerId);
  ...
  protected List<PFVArType2IEEEVArController> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PFVArType2IEEEVArControllerBusinessDelegate.getPFVArType2IEEEVArControllerInstance()
              .getAllPFVArType2IEEEVArController();
      assertNotNull(
          collection,
          "An Empty collection of PFVArType2IEEEVArController was incorrectly returned.");
  ...
  protected CreatePFVArType2IEEEVArControllerCommand generateNewCommand() {
    CreatePFVArType2IEEEVArControllerCommand command =
        new CreatePFVArType2IEEEVArControllerCommand(null);
  ...
  protected UpdatePFVArType2IEEEVArControllerCommand generateUpdateCommand() {
    UpdatePFVArType2IEEEVArControllerCommand command =
        new UpdatePFVArType2IEEEVArControllerCommand(
