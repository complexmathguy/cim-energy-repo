...
public class HydroPumpTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    HydroPumpBusinessDelegate.getHydroPumpInstance().createHydroPump(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for HydroPump : " + successValue.getHydroPumpId());
                  if (successValue.getHydroPumpId().equals(hydroPumpId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfHydroPumpList - 1,
      ...
      subscriber
          .hydroPumpSubscribe(hydroPumpId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for HydroPump : "
                          + successValue.getHydroPumpId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + hydroPumpId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      HydroPumpBusinessDelegate.getHydroPumpInstance()
          .delete(new DeleteHydroPumpCommand(entity.getHydroPumpId()))
          .get();
