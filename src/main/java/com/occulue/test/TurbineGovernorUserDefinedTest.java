...
public class TurbineGovernorUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TurbineGovernorUserDefined : "
                          + successValue.getTurbineGovernorUserDefinedId());
                  if (successValue
                      .getTurbineGovernorUserDefinedId()
                      .equals(turbineGovernorUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTurbineGovernorUserDefinedList - 1,
      ...
      subscriber
          .turbineGovernorUserDefinedSubscribe(turbineGovernorUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TurbineGovernorUserDefined : "
                          + successValue.getTurbineGovernorUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on turbineGovernorUserDefined for turbineGovernorUserDefinedId consumed"));
  ...
  protected TurbineGovernorUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read TurbineGovernorUserDefined with primary key");
    msg.append(turbineGovernorUserDefinedId);

    TurbineGovernorUserDefinedFetchOneSummary fetchOneSummary =
        new TurbineGovernorUserDefinedFetchOneSummary(turbineGovernorUserDefinedId);

    try {
      entity =
          TurbineGovernorUserDefinedBusinessDelegate.getTurbineGovernorUserDefinedInstance()
              .getTurbineGovernorUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TurbineGovernorUserDefinedBusinessDelegate proxy =
          TurbineGovernorUserDefinedBusinessDelegate.getTurbineGovernorUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read TurbineGovernorUserDefined with id "
              + turbineGovernorUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read TurbineGovernorUserDefined with id " + turbineGovernorUserDefinedId);
    ...
    try {
      TurbineGovernorUserDefinedBusinessDelegate.getTurbineGovernorUserDefinedInstance()
          .delete(
              new DeleteTurbineGovernorUserDefinedCommand(entity.getTurbineGovernorUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted TurbineGovernorUserDefined with id "
              + turbineGovernorUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete TurbineGovernorUserDefined with id " + turbineGovernorUserDefinedId);
  ...
  protected List<TurbineGovernorUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of TurbineGovernorUserDefined was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTurbineGovernorUserDefinedId(),
  ...
  protected CreateTurbineGovernorUserDefinedCommand generateNewCommand() {
    CreateTurbineGovernorUserDefinedCommand command =
        new CreateTurbineGovernorUserDefinedCommand(null);
  ...
  protected UpdateTurbineGovernorUserDefinedCommand generateUpdateCommand() {
    UpdateTurbineGovernorUserDefinedCommand command =
        new UpdateTurbineGovernorUserDefinedCommand(null, null);
