...
public class GovGASTWDTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovGASTWDBusinessDelegate.getGovGASTWDInstance().createGovGASTWD(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovGASTWD : " + successValue.getGovGASTWDId());
                  if (successValue.getGovGASTWDId().equals(govGASTWDId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovGASTWDList - 1,
      ...
      subscriber
          .govGASTWDSubscribe(govGASTWDId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovGASTWD : "
                          + successValue.getGovGASTWDId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govGASTWDId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovGASTWDBusinessDelegate.getGovGASTWDInstance()
          .delete(new DeleteGovGASTWDCommand(entity.getGovGASTWDId()))
          .get();
  ...
  protected UpdateGovGASTWDCommand generateUpdateCommand() {
    UpdateGovGASTWDCommand command =
        new UpdateGovGASTWDCommand(
