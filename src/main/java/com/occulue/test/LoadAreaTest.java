...
public class LoadAreaTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    loadAreaId =
        LoadAreaBusinessDelegate.getLoadAreaInstance().createLoadArea(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LoadArea : " + successValue.getLoadAreaId());
                  if (successValue.getLoadAreaId().equals(loadAreaId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLoadAreaList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for LoadArea : "
                          + successValue.getLoadAreaId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + loadAreaId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LoadAreaBusinessDelegate.getLoadAreaInstance()
          .delete(new DeleteLoadAreaCommand(entity.getLoadAreaId()))
          .get();
