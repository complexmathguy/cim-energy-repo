...
public class JunctionTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    junctionId =
        JunctionBusinessDelegate.getJunctionInstance().createJunction(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Junction : " + successValue.getJunctionId());
                  if (successValue.getJunctionId().equals(junctionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfJunctionList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Junction : "
                          + successValue.getJunctionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + junctionId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      JunctionBusinessDelegate.getJunctionInstance()
          .delete(new DeleteJunctionCommand(entity.getJunctionId()))
          .get();
