...
public class GovHydro4Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovHydro4BusinessDelegate.getGovHydro4Instance().createGovHydro4(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydro4 : " + successValue.getGovHydro4Id());
                  if (successValue.getGovHydro4Id().equals(govHydro4Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydro4List - 1,
      ...
      subscriber
          .govHydro4Subscribe(govHydro4Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydro4 : "
                          + successValue.getGovHydro4Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govHydro4Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydro4BusinessDelegate.getGovHydro4Instance()
          .delete(new DeleteGovHydro4Command(entity.getGovHydro4Id()))
          .get();
  ...
  protected UpdateGovHydro4Command generateUpdateCommand() {
    UpdateGovHydro4Command command =
        new UpdateGovHydro4Command(
