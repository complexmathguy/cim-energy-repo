...
public class WindGenTurbineType3bIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindGenTurbineType3bIEC : "
                          + successValue.getWindGenTurbineType3bIECId());
                  if (successValue
                      .getWindGenTurbineType3bIECId()
                      .equals(windGenTurbineType3bIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindGenTurbineType3bIECList - 1,
      ...
      subscriber
          .windGenTurbineType3bIECSubscribe(windGenTurbineType3bIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindGenTurbineType3bIEC : "
                          + successValue.getWindGenTurbineType3bIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windGenTurbineType3bIEC for windGenTurbineType3bIECId consumed"));
  ...
  protected WindGenTurbineType3bIEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindGenTurbineType3bIEC with primary key");
    msg.append(windGenTurbineType3bIECId);

    WindGenTurbineType3bIECFetchOneSummary fetchOneSummary =
        new WindGenTurbineType3bIECFetchOneSummary(windGenTurbineType3bIECId);

    try {
      entity =
          WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance()
              .getWindGenTurbineType3bIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindGenTurbineType3bIECBusinessDelegate proxy =
          WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindGenTurbineType3bIEC with id " + windGenTurbineType3bIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindGenTurbineType3bIEC with id " + windGenTurbineType3bIECId);
    ...
    try {
      WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance()
          .delete(new DeleteWindGenTurbineType3bIECCommand(entity.getWindGenTurbineType3bIECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindGenTurbineType3bIEC with id " + windGenTurbineType3bIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindGenTurbineType3bIEC with id " + windGenTurbineType3bIECId);
  ...
  protected List<WindGenTurbineType3bIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindGenTurbineType3bIECBusinessDelegate.getWindGenTurbineType3bIECInstance()
              .getAllWindGenTurbineType3bIEC();
      assertNotNull(
          collection, "An Empty collection of WindGenTurbineType3bIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindGenTurbineType3bIECId(),
  ...
  protected UpdateWindGenTurbineType3bIECCommand generateUpdateCommand() {
    UpdateWindGenTurbineType3bIECCommand command =
        new UpdateWindGenTurbineType3bIECCommand(null, null, null, null, null, null);
