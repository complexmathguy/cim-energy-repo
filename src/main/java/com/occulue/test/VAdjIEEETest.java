...
public class VAdjIEEETest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    vAdjIEEEId =
        VAdjIEEEBusinessDelegate.getVAdjIEEEInstance().createVAdjIEEE(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VAdjIEEE : " + successValue.getVAdjIEEEId());
                  if (successValue.getVAdjIEEEId().equals(vAdjIEEEId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVAdjIEEEList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for VAdjIEEE : "
                          + successValue.getVAdjIEEEId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + vAdjIEEEId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      VAdjIEEEBusinessDelegate.getVAdjIEEEInstance()
          .delete(new DeleteVAdjIEEECommand(entity.getVAdjIEEEId()))
          .get();
  ...
  protected UpdateVAdjIEEECommand generateUpdateCommand() {
    UpdateVAdjIEEECommand command =
        new UpdateVAdjIEEECommand(null, null, null, null, null, null, null);
