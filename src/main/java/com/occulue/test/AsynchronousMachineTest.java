...
public class AsynchronousMachineTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AsynchronousMachine : "
                          + successValue.getAsynchronousMachineId());
                  if (successValue.getAsynchronousMachineId().equals(asynchronousMachineId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAsynchronousMachineList - 1,
      ...
      subscriber
          .asynchronousMachineSubscribe(asynchronousMachineId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AsynchronousMachine : "
                          + successValue.getAsynchronousMachineId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on asynchronousMachine for asynchronousMachineId consumed"));
  ...
  protected AsynchronousMachine read() throws Throwable {
    ...
    AsynchronousMachineFetchOneSummary fetchOneSummary =
        new AsynchronousMachineFetchOneSummary(asynchronousMachineId);

    try {
      entity =
          AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance()
              .getAsynchronousMachine(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      AsynchronousMachineBusinessDelegate proxy =
          AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      AsynchronousMachineBusinessDelegate.getAsynchronousMachineInstance()
          .delete(new DeleteAsynchronousMachineCommand(entity.getAsynchronousMachineId()))
          .get();
  ...
  protected List<AsynchronousMachine> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of AsynchronousMachine was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getAsynchronousMachineId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateAsynchronousMachineCommand generateUpdateCommand() {
    UpdateAsynchronousMachineCommand command =
        new UpdateAsynchronousMachineCommand(
