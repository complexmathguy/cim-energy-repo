...
public class RatioTapChangerTablePointTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RatioTapChangerTablePoint : "
                          + successValue.getRatioTapChangerTablePointId());
                  if (successValue
                      .getRatioTapChangerTablePointId()
                      .equals(ratioTapChangerTablePointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRatioTapChangerTablePointList - 1,
      ...
      subscriber
          .ratioTapChangerTablePointSubscribe(ratioTapChangerTablePointId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RatioTapChangerTablePoint : "
                          + successValue.getRatioTapChangerTablePointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on ratioTapChangerTablePoint for ratioTapChangerTablePointId consumed"));
  ...
  protected RatioTapChangerTablePoint read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read RatioTapChangerTablePoint with primary key");
    msg.append(ratioTapChangerTablePointId);

    RatioTapChangerTablePointFetchOneSummary fetchOneSummary =
        new RatioTapChangerTablePointFetchOneSummary(ratioTapChangerTablePointId);

    try {
      entity =
          RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance()
              .getRatioTapChangerTablePoint(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RatioTapChangerTablePointBusinessDelegate proxy =
          RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read RatioTapChangerTablePoint with id " + ratioTapChangerTablePointId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read RatioTapChangerTablePoint with id " + ratioTapChangerTablePointId);
    ...
    try {
      RatioTapChangerTablePointBusinessDelegate.getRatioTapChangerTablePointInstance()
          .delete(
              new DeleteRatioTapChangerTablePointCommand(entity.getRatioTapChangerTablePointId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted RatioTapChangerTablePoint with id "
              + ratioTapChangerTablePointId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete RatioTapChangerTablePoint with id " + ratioTapChangerTablePointId);
  ...
  protected List<RatioTapChangerTablePoint> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of RatioTapChangerTablePoint was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRatioTapChangerTablePointId(),
  ...
  protected CreateRatioTapChangerTablePointCommand generateNewCommand() {
    CreateRatioTapChangerTablePointCommand command =
        new CreateRatioTapChangerTablePointCommand(null);
  ...
  protected UpdateRatioTapChangerTablePointCommand generateUpdateCommand() {
    UpdateRatioTapChangerTablePointCommand command =
        new UpdateRatioTapChangerTablePointCommand(null);
