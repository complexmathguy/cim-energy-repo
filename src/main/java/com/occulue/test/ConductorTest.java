...
public class ConductorTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    ConductorBusinessDelegate.getConductorInstance().createConductor(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Conductor : " + successValue.getConductorId());
                  if (successValue.getConductorId().equals(conductorId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfConductorList - 1,
      ...
      subscriber
          .conductorSubscribe(conductorId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for Conductor : "
                          + successValue.getConductorId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + conductorId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ConductorBusinessDelegate.getConductorInstance()
          .delete(new DeleteConductorCommand(entity.getConductorId()))
          .get();
