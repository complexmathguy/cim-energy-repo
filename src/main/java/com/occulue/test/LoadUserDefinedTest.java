...
public class LoadUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LoadUserDefined : "
                          + successValue.getLoadUserDefinedId());
                  if (successValue.getLoadUserDefinedId().equals(loadUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLoadUserDefinedList - 1,
      ...
      subscriber
          .loadUserDefinedSubscribe(loadUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for LoadUserDefined : "
                          + successValue.getLoadUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected LoadUserDefined read() throws Throwable {
    ...
    LoadUserDefinedFetchOneSummary fetchOneSummary =
        new LoadUserDefinedFetchOneSummary(loadUserDefinedId);

    try {
      entity =
          LoadUserDefinedBusinessDelegate.getLoadUserDefinedInstance()
              .getLoadUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LoadUserDefinedBusinessDelegate proxy =
          LoadUserDefinedBusinessDelegate.getLoadUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LoadUserDefinedBusinessDelegate.getLoadUserDefinedInstance()
          .delete(new DeleteLoadUserDefinedCommand(entity.getLoadUserDefinedId()))
          .get();
  ...
  protected List<LoadUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          LoadUserDefinedBusinessDelegate.getLoadUserDefinedInstance().getAllLoadUserDefined();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getLoadUserDefinedId(), "-- entity in Collection has a null primary key");
