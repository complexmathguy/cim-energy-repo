...
public class VsCapabilityCurveTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VsCapabilityCurve : "
                          + successValue.getVsCapabilityCurveId());
                  if (successValue.getVsCapabilityCurveId().equals(vsCapabilityCurveId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVsCapabilityCurveList - 1,
      ...
      subscriber
          .vsCapabilityCurveSubscribe(vsCapabilityCurveId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VsCapabilityCurve : "
                          + successValue.getVsCapabilityCurveId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on vsCapabilityCurve for vsCapabilityCurveId consumed"));
  ...
  protected VsCapabilityCurve read() throws Throwable {
    ...
    VsCapabilityCurveFetchOneSummary fetchOneSummary =
        new VsCapabilityCurveFetchOneSummary(vsCapabilityCurveId);

    try {
      entity =
          VsCapabilityCurveBusinessDelegate.getVsCapabilityCurveInstance()
              .getVsCapabilityCurve(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VsCapabilityCurveBusinessDelegate proxy =
          VsCapabilityCurveBusinessDelegate.getVsCapabilityCurveInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      VsCapabilityCurveBusinessDelegate.getVsCapabilityCurveInstance()
          .delete(new DeleteVsCapabilityCurveCommand(entity.getVsCapabilityCurveId()))
          .get();
  ...
  protected List<VsCapabilityCurve> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of VsCapabilityCurve was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVsCapabilityCurveId(), "-- entity in Collection has a null primary key");
