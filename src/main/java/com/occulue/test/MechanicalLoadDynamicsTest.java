...
public class MechanicalLoadDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for MechanicalLoadDynamics : "
                          + successValue.getMechanicalLoadDynamicsId());
                  if (successValue.getMechanicalLoadDynamicsId().equals(mechanicalLoadDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfMechanicalLoadDynamicsList - 1,
      ...
      subscriber
          .mechanicalLoadDynamicsSubscribe(mechanicalLoadDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for MechanicalLoadDynamics : "
                          + successValue.getMechanicalLoadDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on mechanicalLoadDynamics for mechanicalLoadDynamicsId consumed"));
  ...
  protected MechanicalLoadDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read MechanicalLoadDynamics with primary key");
    msg.append(mechanicalLoadDynamicsId);

    MechanicalLoadDynamicsFetchOneSummary fetchOneSummary =
        new MechanicalLoadDynamicsFetchOneSummary(mechanicalLoadDynamicsId);

    try {
      entity =
          MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance()
              .getMechanicalLoadDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      MechanicalLoadDynamicsBusinessDelegate proxy =
          MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read MechanicalLoadDynamics with id " + mechanicalLoadDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read MechanicalLoadDynamics with id " + mechanicalLoadDynamicsId);
    ...
    try {
      MechanicalLoadDynamicsBusinessDelegate.getMechanicalLoadDynamicsInstance()
          .delete(new DeleteMechanicalLoadDynamicsCommand(entity.getMechanicalLoadDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted MechanicalLoadDynamics with id " + mechanicalLoadDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete MechanicalLoadDynamics with id " + mechanicalLoadDynamicsId);
  ...
  protected List<MechanicalLoadDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of MechanicalLoadDynamics was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getMechanicalLoadDynamicsId(), "-- entity in Collection has a null primary key");
