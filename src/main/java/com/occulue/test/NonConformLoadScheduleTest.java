...
public class NonConformLoadScheduleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          .nonConformLoadScheduleSubscribe()
          .updates()
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for NonConformLoadSchedule : "
                          + successValue.getNonConformLoadScheduleId());
                  if (successValue.getNonConformLoadScheduleId().equals(nonConformLoadScheduleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfNonConformLoadScheduleList - 1,
      ...
      subscriber
          .nonConformLoadScheduleSubscribe(nonConformLoadScheduleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for NonConformLoadSchedule : "
                          + successValue.getNonConformLoadScheduleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on nonConformLoadSchedule for nonConformLoadScheduleId consumed"));
  ...
  protected NonConformLoadSchedule read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read NonConformLoadSchedule with primary key");
    msg.append(nonConformLoadScheduleId);

    NonConformLoadScheduleFetchOneSummary fetchOneSummary =
        new NonConformLoadScheduleFetchOneSummary(nonConformLoadScheduleId);

    try {
      entity =
          NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance()
              .getNonConformLoadSchedule(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      NonConformLoadScheduleBusinessDelegate proxy =
          NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read NonConformLoadSchedule with id " + nonConformLoadScheduleId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read NonConformLoadSchedule with id " + nonConformLoadScheduleId);
    ...
    try {
      NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance()
          .delete(new DeleteNonConformLoadScheduleCommand(entity.getNonConformLoadScheduleId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted NonConformLoadSchedule with id " + nonConformLoadScheduleId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete NonConformLoadSchedule with id " + nonConformLoadScheduleId);
  ...
  protected List<NonConformLoadSchedule> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          NonConformLoadScheduleBusinessDelegate.getNonConformLoadScheduleInstance()
              .getAllNonConformLoadSchedule();
      assertNotNull(
          collection, "An Empty collection of NonConformLoadSchedule was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getNonConformLoadScheduleId(), "-- entity in Collection has a null primary key");
