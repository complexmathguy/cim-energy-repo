...
public class ExcST3ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excST3AId =
        ExcST3ABusinessDelegate.getExcST3AInstance().createExcST3A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcST3A : " + successValue.getExcST3AId());
                  if (successValue.getExcST3AId().equals(excST3AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcST3AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcST3A : "
                          + successValue.getExcST3AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excST3AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcST3ABusinessDelegate.getExcST3AInstance()
          .delete(new DeleteExcST3ACommand(entity.getExcST3AId()))
          .get();
  ...
  protected UpdateExcST3ACommand generateUpdateCommand() {
    UpdateExcST3ACommand command =
        new UpdateExcST3ACommand(
