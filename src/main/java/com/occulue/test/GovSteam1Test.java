...
public class GovSteam1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovSteam1BusinessDelegate.getGovSteam1Instance().createGovSteam1(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteam1 : " + successValue.getGovSteam1Id());
                  if (successValue.getGovSteam1Id().equals(govSteam1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteam1List - 1,
      ...
      subscriber
          .govSteam1Subscribe(govSteam1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteam1 : "
                          + successValue.getGovSteam1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govSteam1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteam1BusinessDelegate.getGovSteam1Instance()
          .delete(new DeleteGovSteam1Command(entity.getGovSteam1Id()))
          .get();
  ...
  protected UpdateGovSteam1Command generateUpdateCommand() {
    UpdateGovSteam1Command command =
        new UpdateGovSteam1Command(
