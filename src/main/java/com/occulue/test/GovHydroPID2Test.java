...
public class GovHydroPID2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydroPID2 : "
                          + successValue.getGovHydroPID2Id());
                  if (successValue.getGovHydroPID2Id().equals(govHydroPID2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydroPID2List - 1,
      ...
      subscriber
          .govHydroPID2Subscribe(govHydroPID2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydroPID2 : "
                          + successValue.getGovHydroPID2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected GovHydroPID2 read() throws Throwable {
    ...
    try {
      entity =
          GovHydroPID2BusinessDelegate.getGovHydroPID2Instance().getGovHydroPID2(fetchOneSummary);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydroPID2BusinessDelegate.getGovHydroPID2Instance()
          .delete(new DeleteGovHydroPID2Command(entity.getGovHydroPID2Id()))
          .get();
  ...
  protected UpdateGovHydroPID2Command generateUpdateCommand() {
    UpdateGovHydroPID2Command command =
        new UpdateGovHydroPID2Command(
