...
public class PhaseTapChangerTablePointTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PhaseTapChangerTablePoint : "
                          + successValue.getPhaseTapChangerTablePointId());
                  if (successValue
                      .getPhaseTapChangerTablePointId()
                      .equals(phaseTapChangerTablePointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPhaseTapChangerTablePointList - 1,
      ...
      subscriber
          .phaseTapChangerTablePointSubscribe(phaseTapChangerTablePointId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PhaseTapChangerTablePoint : "
                          + successValue.getPhaseTapChangerTablePointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on phaseTapChangerTablePoint for phaseTapChangerTablePointId consumed"));
  ...
  protected PhaseTapChangerTablePoint read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PhaseTapChangerTablePoint with primary key");
    msg.append(phaseTapChangerTablePointId);

    PhaseTapChangerTablePointFetchOneSummary fetchOneSummary =
        new PhaseTapChangerTablePointFetchOneSummary(phaseTapChangerTablePointId);

    try {
      entity =
          PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance()
              .getPhaseTapChangerTablePoint(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PhaseTapChangerTablePointBusinessDelegate proxy =
          PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PhaseTapChangerTablePoint with id " + phaseTapChangerTablePointId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PhaseTapChangerTablePoint with id " + phaseTapChangerTablePointId);
    ...
    try {
      PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance()
          .delete(
              new DeletePhaseTapChangerTablePointCommand(entity.getPhaseTapChangerTablePointId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PhaseTapChangerTablePoint with id "
              + phaseTapChangerTablePointId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PhaseTapChangerTablePoint with id " + phaseTapChangerTablePointId);
  ...
  protected List<PhaseTapChangerTablePoint> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PhaseTapChangerTablePointBusinessDelegate.getPhaseTapChangerTablePointInstance()
              .getAllPhaseTapChangerTablePoint();
      assertNotNull(
          collection, "An Empty collection of PhaseTapChangerTablePoint was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPhaseTapChangerTablePointId(),
  ...
  protected CreatePhaseTapChangerTablePointCommand generateNewCommand() {
    CreatePhaseTapChangerTablePointCommand command =
        new CreatePhaseTapChangerTablePointCommand(null);
  ...
  protected UpdatePhaseTapChangerTablePointCommand generateUpdateCommand() {
    UpdatePhaseTapChangerTablePointCommand command =
        new UpdatePhaseTapChangerTablePointCommand(null, null);
