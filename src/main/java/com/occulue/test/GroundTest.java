...
public class GroundTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    groundId = GroundBusinessDelegate.getGroundInstance().createGround(generateNewCommand()).get();
    ...
    GroundBusinessDelegate.getGroundInstance().createGround(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Ground : "
                          + successValue.getGroundId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + groundId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GroundBusinessDelegate.getGroundInstance()
          .delete(new DeleteGroundCommand(entity.getGroundId()))
          .get();
