...
public class AnalogControlTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AnalogControl : "
                          + successValue.getAnalogControlId());
                  if (successValue.getAnalogControlId().equals(analogControlId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAnalogControlList - 1,
      ...
      subscriber
          .analogControlSubscribe(analogControlId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AnalogControl : "
                          + successValue.getAnalogControlId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected AnalogControl read() throws Throwable {
    ...
    AnalogControlFetchOneSummary fetchOneSummary =
        new AnalogControlFetchOneSummary(analogControlId);

    try {
      entity =
          AnalogControlBusinessDelegate.getAnalogControlInstance()
              .getAnalogControl(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      AnalogControlBusinessDelegate proxy =
          AnalogControlBusinessDelegate.getAnalogControlInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      AnalogControlBusinessDelegate.getAnalogControlInstance()
          .delete(new DeleteAnalogControlCommand(entity.getAnalogControlId()))
          .get();
  ...
  protected List<AnalogControl> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getAnalogControlId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateAnalogControlCommand generateUpdateCommand() {
    UpdateAnalogControlCommand command = new UpdateAnalogControlCommand(null, null, null);
