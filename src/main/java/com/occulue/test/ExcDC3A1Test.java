...
public class ExcDC3A1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excDC3A1Id =
        ExcDC3A1BusinessDelegate.getExcDC3A1Instance().createExcDC3A1(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcDC3A1 : " + successValue.getExcDC3A1Id());
                  if (successValue.getExcDC3A1Id().equals(excDC3A1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcDC3A1List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcDC3A1 : "
                          + successValue.getExcDC3A1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excDC3A1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcDC3A1BusinessDelegate.getExcDC3A1Instance()
          .delete(new DeleteExcDC3A1Command(entity.getExcDC3A1Id()))
          .get();
