...
public class CommandTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    commandId =
        CommandBusinessDelegate.getCommandInstance().createCommand(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Command : " + successValue.getCommandId());
                  if (successValue.getCommandId().equals(commandId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfCommandList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Command : "
                          + successValue.getCommandId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + commandId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      CommandBusinessDelegate.getCommandInstance()
          .delete(new DeleteCommandCommand(entity.getCommandId()))
          .get();
  ...
  protected UpdateCommandCommand generateUpdateCommand() {
    UpdateCommandCommand command = new UpdateCommandCommand(null, null, null);
