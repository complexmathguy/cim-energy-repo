...
public class UnderexcLimIEEE1Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for UnderexcLimIEEE1 : "
                          + successValue.getUnderexcLimIEEE1Id());
                  if (successValue.getUnderexcLimIEEE1Id().equals(underexcLimIEEE1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfUnderexcLimIEEE1List - 1,
      ...
      subscriber
          .underexcLimIEEE1Subscribe(underexcLimIEEE1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for UnderexcLimIEEE1 : "
                          + successValue.getUnderexcLimIEEE1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected UnderexcLimIEEE1 read() throws Throwable {
    ...
    UnderexcLimIEEE1FetchOneSummary fetchOneSummary =
        new UnderexcLimIEEE1FetchOneSummary(underexcLimIEEE1Id);

    try {
      entity =
          UnderexcLimIEEE1BusinessDelegate.getUnderexcLimIEEE1Instance()
              .getUnderexcLimIEEE1(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      UnderexcLimIEEE1BusinessDelegate proxy =
          UnderexcLimIEEE1BusinessDelegate.getUnderexcLimIEEE1Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      UnderexcLimIEEE1BusinessDelegate.getUnderexcLimIEEE1Instance()
          .delete(new DeleteUnderexcLimIEEE1Command(entity.getUnderexcLimIEEE1Id()))
          .get();
  ...
  protected List<UnderexcLimIEEE1> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          UnderexcLimIEEE1BusinessDelegate.getUnderexcLimIEEE1Instance().getAllUnderexcLimIEEE1();
      assertNotNull(
          collection, "An Empty collection of UnderexcLimIEEE1 was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getUnderexcLimIEEE1Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateUnderexcLimIEEE1Command generateUpdateCommand() {
    UpdateUnderexcLimIEEE1Command command =
        new UpdateUnderexcLimIEEE1Command(
