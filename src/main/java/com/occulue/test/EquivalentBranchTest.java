...
public class EquivalentBranchTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EquivalentBranch : "
                          + successValue.getEquivalentBranchId());
                  if (successValue.getEquivalentBranchId().equals(equivalentBranchId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEquivalentBranchList - 1,
      ...
      subscriber
          .equivalentBranchSubscribe(equivalentBranchId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EquivalentBranch : "
                          + successValue.getEquivalentBranchId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected EquivalentBranch read() throws Throwable {
    ...
    EquivalentBranchFetchOneSummary fetchOneSummary =
        new EquivalentBranchFetchOneSummary(equivalentBranchId);

    try {
      entity =
          EquivalentBranchBusinessDelegate.getEquivalentBranchInstance()
              .getEquivalentBranch(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EquivalentBranchBusinessDelegate proxy =
          EquivalentBranchBusinessDelegate.getEquivalentBranchInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EquivalentBranchBusinessDelegate.getEquivalentBranchInstance()
          .delete(new DeleteEquivalentBranchCommand(entity.getEquivalentBranchId()))
          .get();
  ...
  protected List<EquivalentBranch> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of EquivalentBranch was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEquivalentBranchId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateEquivalentBranchCommand generateUpdateCommand() {
    UpdateEquivalentBranchCommand command =
        new UpdateEquivalentBranchCommand(
