...
public class GeographicalLocationVersionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GeographicalLocationVersion : "
                          + successValue.getGeographicalLocationVersionId());
                  if (successValue
                      .getGeographicalLocationVersionId()
                      .equals(geographicalLocationVersionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGeographicalLocationVersionList - 1,
      ...
      subscriber
          .geographicalLocationVersionSubscribe(geographicalLocationVersionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GeographicalLocationVersion : "
                          + successValue.getGeographicalLocationVersionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on geographicalLocationVersion for geographicalLocationVersionId consumed"));
  ...
  protected GeographicalLocationVersion read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read GeographicalLocationVersion with primary key");
    msg.append(geographicalLocationVersionId);

    GeographicalLocationVersionFetchOneSummary fetchOneSummary =
        new GeographicalLocationVersionFetchOneSummary(geographicalLocationVersionId);

    try {
      entity =
          GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance()
              .getGeographicalLocationVersion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GeographicalLocationVersionBusinessDelegate proxy =
          GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read GeographicalLocationVersion with id "
              + geographicalLocationVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read GeographicalLocationVersion with id " + geographicalLocationVersionId);
    ...
    try {
      GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance()
          .delete(
              new DeleteGeographicalLocationVersionCommand(
                  entity.getGeographicalLocationVersionId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted GeographicalLocationVersion with id "
              + geographicalLocationVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete GeographicalLocationVersion with id "
              + geographicalLocationVersionId);
  ...
  protected List<GeographicalLocationVersion> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          GeographicalLocationVersionBusinessDelegate.getGeographicalLocationVersionInstance()
              .getAllGeographicalLocationVersion();
      assertNotNull(
          collection,
          "An Empty collection of GeographicalLocationVersion was incorrectly returned.");
  ...
  protected CreateGeographicalLocationVersionCommand generateNewCommand() {
    CreateGeographicalLocationVersionCommand command =
        new CreateGeographicalLocationVersionCommand(null);
  ...
  protected UpdateGeographicalLocationVersionCommand generateUpdateCommand() {
    UpdateGeographicalLocationVersionCommand command =
        new UpdateGeographicalLocationVersionCommand(
