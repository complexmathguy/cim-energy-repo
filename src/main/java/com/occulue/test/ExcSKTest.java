...
public class ExcSKTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excSKId = ExcSKBusinessDelegate.getExcSKInstance().createExcSK(generateNewCommand()).get();
    ...
    ExcSKBusinessDelegate.getExcSKInstance().createExcSK(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcSK : "
                          + successValue.getExcSKId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excSKId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcSKBusinessDelegate.getExcSKInstance()
          .delete(new DeleteExcSKCommand(entity.getExcSKId()))
          .get();
  ...
  protected UpdateExcSKCommand generateUpdateCommand() {
    UpdateExcSKCommand command =
        new UpdateExcSKCommand(
