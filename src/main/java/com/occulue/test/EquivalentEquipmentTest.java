...
public class EquivalentEquipmentTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EquivalentEquipment : "
                          + successValue.getEquivalentEquipmentId());
                  if (successValue.getEquivalentEquipmentId().equals(equivalentEquipmentId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEquivalentEquipmentList - 1,
      ...
      subscriber
          .equivalentEquipmentSubscribe(equivalentEquipmentId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EquivalentEquipment : "
                          + successValue.getEquivalentEquipmentId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on equivalentEquipment for equivalentEquipmentId consumed"));
  ...
  protected EquivalentEquipment read() throws Throwable {
    ...
    EquivalentEquipmentFetchOneSummary fetchOneSummary =
        new EquivalentEquipmentFetchOneSummary(equivalentEquipmentId);

    try {
      entity =
          EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance()
              .getEquivalentEquipment(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EquivalentEquipmentBusinessDelegate proxy =
          EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance()
          .delete(new DeleteEquivalentEquipmentCommand(entity.getEquivalentEquipmentId()))
          .get();
  ...
  protected List<EquivalentEquipment> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          EquivalentEquipmentBusinessDelegate.getEquivalentEquipmentInstance()
              .getAllEquivalentEquipment();
      assertNotNull(
          collection, "An Empty collection of EquivalentEquipment was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEquivalentEquipmentId(), "-- entity in Collection has a null primary key");
