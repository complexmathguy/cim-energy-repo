...
public class VoltageCompensatorUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VoltageCompensatorUserDefined : "
                          + successValue.getVoltageCompensatorUserDefinedId());
                  if (successValue
                      .getVoltageCompensatorUserDefinedId()
                      .equals(voltageCompensatorUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVoltageCompensatorUserDefinedList - 1,
      ...
      subscriber
          .voltageCompensatorUserDefinedSubscribe(voltageCompensatorUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VoltageCompensatorUserDefined : "
                          + successValue.getVoltageCompensatorUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on voltageCompensatorUserDefined for voltageCompensatorUserDefinedId consumed"));
  ...
  protected VoltageCompensatorUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read VoltageCompensatorUserDefined with primary key");
    msg.append(voltageCompensatorUserDefinedId);

    VoltageCompensatorUserDefinedFetchOneSummary fetchOneSummary =
        new VoltageCompensatorUserDefinedFetchOneSummary(voltageCompensatorUserDefinedId);

    try {
      entity =
          VoltageCompensatorUserDefinedBusinessDelegate.getVoltageCompensatorUserDefinedInstance()
              .getVoltageCompensatorUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VoltageCompensatorUserDefinedBusinessDelegate proxy =
          VoltageCompensatorUserDefinedBusinessDelegate.getVoltageCompensatorUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read VoltageCompensatorUserDefined with id "
              + voltageCompensatorUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read VoltageCompensatorUserDefined with id "
              + voltageCompensatorUserDefinedId);
    ...
    try {
      VoltageCompensatorUserDefinedBusinessDelegate.getVoltageCompensatorUserDefinedInstance()
          .delete(
              new DeleteVoltageCompensatorUserDefinedCommand(
                  entity.getVoltageCompensatorUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted VoltageCompensatorUserDefined with id "
              + voltageCompensatorUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete VoltageCompensatorUserDefined with id "
              + voltageCompensatorUserDefinedId);
  ...
  protected List<VoltageCompensatorUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of VoltageCompensatorUserDefined was incorrectly returned.");
  ...
  protected CreateVoltageCompensatorUserDefinedCommand generateNewCommand() {
    CreateVoltageCompensatorUserDefinedCommand command =
        new CreateVoltageCompensatorUserDefinedCommand(null);
  ...
  protected UpdateVoltageCompensatorUserDefinedCommand generateUpdateCommand() {
    UpdateVoltageCompensatorUserDefinedCommand command =
        new UpdateVoltageCompensatorUserDefinedCommand(null, null);
