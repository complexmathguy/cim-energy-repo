...
public class ExcIEEEAC5ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC5A : "
                          + successValue.getExcIEEEAC5AId());
                  if (successValue.getExcIEEEAC5AId().equals(excIEEEAC5AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC5AList - 1,
      ...
      subscriber
          .excIEEEAC5ASubscribe(excIEEEAC5AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC5A : "
                          + successValue.getExcIEEEAC5AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC5ABusinessDelegate.getExcIEEEAC5AInstance()
          .delete(new DeleteExcIEEEAC5ACommand(entity.getExcIEEEAC5AId()))
          .get();
  ...
  protected UpdateExcIEEEAC5ACommand generateUpdateCommand() {
    UpdateExcIEEEAC5ACommand command =
        new UpdateExcIEEEAC5ACommand(
