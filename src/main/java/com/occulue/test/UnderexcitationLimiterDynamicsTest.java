...
public class UnderexcitationLimiterDynamicsTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    underexcitationLimiterDynamicsId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for UnderexcitationLimiterDynamics : "
                          + successValue.getUnderexcitationLimiterDynamicsId());
                  if (successValue
                      .getUnderexcitationLimiterDynamicsId()
                      .equals(underexcitationLimiterDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfUnderexcitationLimiterDynamicsList - 1,
      ...
      subscriber
          .underexcitationLimiterDynamicsSubscribe(underexcitationLimiterDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for UnderexcitationLimiterDynamics : "
                          + successValue.getUnderexcitationLimiterDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on underexcitationLimiterDynamics for underexcitationLimiterDynamicsId consumed"));
  ...
  protected UnderexcitationLimiterDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read UnderexcitationLimiterDynamics with primary key");
    msg.append(underexcitationLimiterDynamicsId);

    UnderexcitationLimiterDynamicsFetchOneSummary fetchOneSummary =
        new UnderexcitationLimiterDynamicsFetchOneSummary(underexcitationLimiterDynamicsId);

    try {
      entity =
          UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance()
              .getUnderexcitationLimiterDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      UnderexcitationLimiterDynamicsBusinessDelegate proxy =
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read UnderexcitationLimiterDynamics with id "
              + underexcitationLimiterDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read UnderexcitationLimiterDynamics with id "
              + underexcitationLimiterDynamicsId);
    ...
    try {
      UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance()
          .delete(
              new DeleteUnderexcitationLimiterDynamicsCommand(
                  entity.getUnderexcitationLimiterDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted UnderexcitationLimiterDynamics with id "
              + underexcitationLimiterDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete UnderexcitationLimiterDynamics with id "
              + underexcitationLimiterDynamicsId);
  ...
  protected List<UnderexcitationLimiterDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          UnderexcitationLimiterDynamicsBusinessDelegate.getUnderexcitationLimiterDynamicsInstance()
              .getAllUnderexcitationLimiterDynamics();
      assertNotNull(
          collection,
          "An Empty collection of UnderexcitationLimiterDynamics was incorrectly returned.");
  ...
  protected CreateUnderexcitationLimiterDynamicsCommand generateNewCommand() {
    CreateUnderexcitationLimiterDynamicsCommand command =
        new CreateUnderexcitationLimiterDynamicsCommand(null);
  ...
  protected UpdateUnderexcitationLimiterDynamicsCommand generateUpdateCommand() {
    UpdateUnderexcitationLimiterDynamicsCommand command =
        new UpdateUnderexcitationLimiterDynamicsCommand(null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(UnderexcitationLimiterDynamicsTest.class.getName());
