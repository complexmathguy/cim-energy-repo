...
public class FloatProxyTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    FloatProxyBusinessDelegate.getFloatProxyInstance().createFloatProxy(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for FloatProxy : " + successValue.getFloatProxyId());
                  if (successValue.getFloatProxyId().equals(floatProxyId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfFloatProxyList - 1,
      ...
      subscriber
          .floatProxySubscribe(floatProxyId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for FloatProxy : "
                          + successValue.getFloatProxyId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      FloatProxyBusinessDelegate.getFloatProxyInstance()
          .delete(new DeleteFloatProxyCommand(entity.getFloatProxyId()))
          .get();
