...
public class DCBaseTerminalTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCBaseTerminal : "
                          + successValue.getDCBaseTerminalId());
                  if (successValue.getDCBaseTerminalId().equals(dCBaseTerminalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCBaseTerminalList - 1,
      ...
      subscriber
          .dCBaseTerminalSubscribe(dCBaseTerminalId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCBaseTerminal : "
                          + successValue.getDCBaseTerminalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected DCBaseTerminal read() throws Throwable {
    ...
    DCBaseTerminalFetchOneSummary fetchOneSummary =
        new DCBaseTerminalFetchOneSummary(dCBaseTerminalId);

    try {
      entity =
          DCBaseTerminalBusinessDelegate.getDCBaseTerminalInstance()
              .getDCBaseTerminal(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DCBaseTerminalBusinessDelegate proxy =
          DCBaseTerminalBusinessDelegate.getDCBaseTerminalInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCBaseTerminalBusinessDelegate.getDCBaseTerminalInstance()
          .delete(new DeleteDCBaseTerminalCommand(entity.getDCBaseTerminalId()))
          .get();
  ...
  protected List<DCBaseTerminal> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDCBaseTerminalId(), "-- entity in Collection has a null primary key");
