...
public class ExcIEEEAC2ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC2A : "
                          + successValue.getExcIEEEAC2AId());
                  if (successValue.getExcIEEEAC2AId().equals(excIEEEAC2AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC2AList - 1,
      ...
      subscriber
          .excIEEEAC2ASubscribe(excIEEEAC2AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC2A : "
                          + successValue.getExcIEEEAC2AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC2ABusinessDelegate.getExcIEEEAC2AInstance()
          .delete(new DeleteExcIEEEAC2ACommand(entity.getExcIEEEAC2AId()))
          .get();
  ...
  protected UpdateExcIEEEAC2ACommand generateUpdateCommand() {
    UpdateExcIEEEAC2ACommand command =
        new UpdateExcIEEEAC2ACommand(
