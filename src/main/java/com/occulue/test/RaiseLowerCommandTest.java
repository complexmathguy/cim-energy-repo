...
public class RaiseLowerCommandTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RaiseLowerCommand : "
                          + successValue.getRaiseLowerCommandId());
                  if (successValue.getRaiseLowerCommandId().equals(raiseLowerCommandId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRaiseLowerCommandList - 1,
      ...
      subscriber
          .raiseLowerCommandSubscribe(raiseLowerCommandId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RaiseLowerCommand : "
                          + successValue.getRaiseLowerCommandId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on raiseLowerCommand for raiseLowerCommandId consumed"));
  ...
  protected RaiseLowerCommand read() throws Throwable {
    ...
    RaiseLowerCommandFetchOneSummary fetchOneSummary =
        new RaiseLowerCommandFetchOneSummary(raiseLowerCommandId);

    try {
      entity =
          RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance()
              .getRaiseLowerCommand(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RaiseLowerCommandBusinessDelegate proxy =
          RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      RaiseLowerCommandBusinessDelegate.getRaiseLowerCommandInstance()
          .delete(new DeleteRaiseLowerCommandCommand(entity.getRaiseLowerCommandId()))
          .get();
  ...
  protected List<RaiseLowerCommand> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of RaiseLowerCommand was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRaiseLowerCommandId(), "-- entity in Collection has a null primary key");
