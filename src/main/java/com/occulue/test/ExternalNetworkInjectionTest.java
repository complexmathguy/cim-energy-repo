...
public class ExternalNetworkInjectionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExternalNetworkInjection : "
                          + successValue.getExternalNetworkInjectionId());
                  if (successValue
                      .getExternalNetworkInjectionId()
                      .equals(externalNetworkInjectionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExternalNetworkInjectionList - 1,
      ...
      subscriber
          .externalNetworkInjectionSubscribe(externalNetworkInjectionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExternalNetworkInjection : "
                          + successValue.getExternalNetworkInjectionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on externalNetworkInjection for externalNetworkInjectionId consumed"));
  ...
  protected ExternalNetworkInjection read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ExternalNetworkInjection with primary key");
    msg.append(externalNetworkInjectionId);

    ExternalNetworkInjectionFetchOneSummary fetchOneSummary =
        new ExternalNetworkInjectionFetchOneSummary(externalNetworkInjectionId);

    try {
      entity =
          ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance()
              .getExternalNetworkInjection(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ExternalNetworkInjectionBusinessDelegate proxy =
          ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ExternalNetworkInjection with id " + externalNetworkInjectionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ExternalNetworkInjection with id " + externalNetworkInjectionId);
    ...
    try {
      ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance()
          .delete(new DeleteExternalNetworkInjectionCommand(entity.getExternalNetworkInjectionId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ExternalNetworkInjection with id " + externalNetworkInjectionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ExternalNetworkInjection with id " + externalNetworkInjectionId);
  ...
  protected List<ExternalNetworkInjection> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ExternalNetworkInjectionBusinessDelegate.getExternalNetworkInjectionInstance()
              .getAllExternalNetworkInjection();
      assertNotNull(
          collection, "An Empty collection of ExternalNetworkInjection was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getExternalNetworkInjectionId(),
  ...
  protected UpdateExternalNetworkInjectionCommand generateUpdateCommand() {
    UpdateExternalNetworkInjectionCommand command =
        new UpdateExternalNetworkInjectionCommand(
