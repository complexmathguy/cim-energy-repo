...
public class PerLengthDCLineParameterTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PerLengthDCLineParameter : "
                          + successValue.getPerLengthDCLineParameterId());
                  if (successValue
                      .getPerLengthDCLineParameterId()
                      .equals(perLengthDCLineParameterId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPerLengthDCLineParameterList - 1,
      ...
      subscriber
          .perLengthDCLineParameterSubscribe(perLengthDCLineParameterId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PerLengthDCLineParameter : "
                          + successValue.getPerLengthDCLineParameterId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on perLengthDCLineParameter for perLengthDCLineParameterId consumed"));
  ...
  protected PerLengthDCLineParameter read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PerLengthDCLineParameter with primary key");
    msg.append(perLengthDCLineParameterId);

    PerLengthDCLineParameterFetchOneSummary fetchOneSummary =
        new PerLengthDCLineParameterFetchOneSummary(perLengthDCLineParameterId);

    try {
      entity =
          PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance()
              .getPerLengthDCLineParameter(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PerLengthDCLineParameterBusinessDelegate proxy =
          PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PerLengthDCLineParameter with id " + perLengthDCLineParameterId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PerLengthDCLineParameter with id " + perLengthDCLineParameterId);
    ...
    try {
      PerLengthDCLineParameterBusinessDelegate.getPerLengthDCLineParameterInstance()
          .delete(new DeletePerLengthDCLineParameterCommand(entity.getPerLengthDCLineParameterId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PerLengthDCLineParameter with id " + perLengthDCLineParameterId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PerLengthDCLineParameter with id " + perLengthDCLineParameterId);
  ...
  protected List<PerLengthDCLineParameter> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of PerLengthDCLineParameter was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPerLengthDCLineParameterId(),
  ...
  protected UpdatePerLengthDCLineParameterCommand generateUpdateCommand() {
    UpdatePerLengthDCLineParameterCommand command =
        new UpdatePerLengthDCLineParameterCommand(null, null, null, null);
