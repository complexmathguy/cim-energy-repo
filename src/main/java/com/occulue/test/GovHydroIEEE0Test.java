...
public class GovHydroIEEE0Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydroIEEE0 : "
                          + successValue.getGovHydroIEEE0Id());
                  if (successValue.getGovHydroIEEE0Id().equals(govHydroIEEE0Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydroIEEE0List - 1,
      ...
      subscriber
          .govHydroIEEE0Subscribe(govHydroIEEE0Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydroIEEE0 : "
                          + successValue.getGovHydroIEEE0Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected GovHydroIEEE0 read() throws Throwable {
    ...
    GovHydroIEEE0FetchOneSummary fetchOneSummary =
        new GovHydroIEEE0FetchOneSummary(govHydroIEEE0Id);

    try {
      entity =
          GovHydroIEEE0BusinessDelegate.getGovHydroIEEE0Instance()
              .getGovHydroIEEE0(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GovHydroIEEE0BusinessDelegate proxy =
          GovHydroIEEE0BusinessDelegate.getGovHydroIEEE0Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydroIEEE0BusinessDelegate.getGovHydroIEEE0Instance()
          .delete(new DeleteGovHydroIEEE0Command(entity.getGovHydroIEEE0Id()))
          .get();
  ...
  protected List<GovHydroIEEE0> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGovHydroIEEE0Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateGovHydroIEEE0Command generateUpdateCommand() {
    UpdateGovHydroIEEE0Command command =
        new UpdateGovHydroIEEE0Command(null, null, null, null, null, null, null, null, null);
