...
public class WindPlantUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindPlantUserDefined : "
                          + successValue.getWindPlantUserDefinedId());
                  if (successValue.getWindPlantUserDefinedId().equals(windPlantUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindPlantUserDefinedList - 1,
      ...
      subscriber
          .windPlantUserDefinedSubscribe(windPlantUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindPlantUserDefined : "
                          + successValue.getWindPlantUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windPlantUserDefined for windPlantUserDefinedId consumed"));
  ...
  protected WindPlantUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindPlantUserDefined with primary key");
    msg.append(windPlantUserDefinedId);

    WindPlantUserDefinedFetchOneSummary fetchOneSummary =
        new WindPlantUserDefinedFetchOneSummary(windPlantUserDefinedId);

    try {
      entity =
          WindPlantUserDefinedBusinessDelegate.getWindPlantUserDefinedInstance()
              .getWindPlantUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindPlantUserDefinedBusinessDelegate proxy =
          WindPlantUserDefinedBusinessDelegate.getWindPlantUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindPlantUserDefinedBusinessDelegate.getWindPlantUserDefinedInstance()
          .delete(new DeleteWindPlantUserDefinedCommand(entity.getWindPlantUserDefinedId()))
          .get();
  ...
  protected List<WindPlantUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of WindPlantUserDefined was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindPlantUserDefinedId(), "-- entity in Collection has a null primary key");
