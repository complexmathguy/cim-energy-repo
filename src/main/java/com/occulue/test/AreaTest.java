...
public class AreaTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    areaId = AreaBusinessDelegate.getAreaInstance().createArea(generateNewCommand()).get();
    ...
    AreaBusinessDelegate.getAreaInstance().createArea(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Area : "
                          + successValue.getAreaId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + areaId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      AreaBusinessDelegate.getAreaInstance()
          .delete(new DeleteAreaCommand(entity.getAreaId()))
          .get();
  ...
  protected CreateAreaCommand generateNewCommand() {
    CreateAreaCommand command =
        new CreateAreaCommand(null, UnitMultiplier.values()[0], UnitSymbol.values()[0]);
  ...
  protected UpdateAreaCommand generateUpdateCommand() {
    UpdateAreaCommand command =
        new UpdateAreaCommand(null, UnitMultiplier.values()[0], UnitSymbol.values()[0], null);
