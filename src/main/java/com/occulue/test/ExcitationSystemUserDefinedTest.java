...
public class ExcitationSystemUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcitationSystemUserDefined : "
                          + successValue.getExcitationSystemUserDefinedId());
                  if (successValue
                      .getExcitationSystemUserDefinedId()
                      .equals(excitationSystemUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcitationSystemUserDefinedList - 1,
      ...
      subscriber
          .excitationSystemUserDefinedSubscribe(excitationSystemUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcitationSystemUserDefined : "
                          + successValue.getExcitationSystemUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on excitationSystemUserDefined for excitationSystemUserDefinedId consumed"));
  ...
  protected ExcitationSystemUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ExcitationSystemUserDefined with primary key");
    msg.append(excitationSystemUserDefinedId);

    ExcitationSystemUserDefinedFetchOneSummary fetchOneSummary =
        new ExcitationSystemUserDefinedFetchOneSummary(excitationSystemUserDefinedId);

    try {
      entity =
          ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance()
              .getExcitationSystemUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ExcitationSystemUserDefinedBusinessDelegate proxy =
          ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ExcitationSystemUserDefined with id "
              + excitationSystemUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ExcitationSystemUserDefined with id " + excitationSystemUserDefinedId);
    ...
    try {
      ExcitationSystemUserDefinedBusinessDelegate.getExcitationSystemUserDefinedInstance()
          .delete(
              new DeleteExcitationSystemUserDefinedCommand(
                  entity.getExcitationSystemUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ExcitationSystemUserDefined with id "
              + excitationSystemUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ExcitationSystemUserDefined with id "
              + excitationSystemUserDefinedId);
  ...
  protected List<ExcitationSystemUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of ExcitationSystemUserDefined was incorrectly returned.");
  ...
  protected CreateExcitationSystemUserDefinedCommand generateNewCommand() {
    CreateExcitationSystemUserDefinedCommand command =
        new CreateExcitationSystemUserDefinedCommand(null);
  ...
  protected UpdateExcitationSystemUserDefinedCommand generateUpdateCommand() {
    UpdateExcitationSystemUserDefinedCommand command =
        new UpdateExcitationSystemUserDefinedCommand(null, null);
