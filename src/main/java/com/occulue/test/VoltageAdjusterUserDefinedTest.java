...
public class VoltageAdjusterUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VoltageAdjusterUserDefined : "
                          + successValue.getVoltageAdjusterUserDefinedId());
                  if (successValue
                      .getVoltageAdjusterUserDefinedId()
                      .equals(voltageAdjusterUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVoltageAdjusterUserDefinedList - 1,
      ...
      subscriber
          .voltageAdjusterUserDefinedSubscribe(voltageAdjusterUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VoltageAdjusterUserDefined : "
                          + successValue.getVoltageAdjusterUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on voltageAdjusterUserDefined for voltageAdjusterUserDefinedId consumed"));
  ...
  protected VoltageAdjusterUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read VoltageAdjusterUserDefined with primary key");
    msg.append(voltageAdjusterUserDefinedId);

    VoltageAdjusterUserDefinedFetchOneSummary fetchOneSummary =
        new VoltageAdjusterUserDefinedFetchOneSummary(voltageAdjusterUserDefinedId);

    try {
      entity =
          VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance()
              .getVoltageAdjusterUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VoltageAdjusterUserDefinedBusinessDelegate proxy =
          VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read VoltageAdjusterUserDefined with id "
              + voltageAdjusterUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read VoltageAdjusterUserDefined with id " + voltageAdjusterUserDefinedId);
    ...
    try {
      VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance()
          .delete(
              new DeleteVoltageAdjusterUserDefinedCommand(entity.getVoltageAdjusterUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted VoltageAdjusterUserDefined with id "
              + voltageAdjusterUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete VoltageAdjusterUserDefined with id " + voltageAdjusterUserDefinedId);
  ...
  protected List<VoltageAdjusterUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          VoltageAdjusterUserDefinedBusinessDelegate.getVoltageAdjusterUserDefinedInstance()
              .getAllVoltageAdjusterUserDefined();
      assertNotNull(
          collection,
          "An Empty collection of VoltageAdjusterUserDefined was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVoltageAdjusterUserDefinedId(),
  ...
  protected CreateVoltageAdjusterUserDefinedCommand generateNewCommand() {
    CreateVoltageAdjusterUserDefinedCommand command =
        new CreateVoltageAdjusterUserDefinedCommand(null);
  ...
  protected UpdateVoltageAdjusterUserDefinedCommand generateUpdateCommand() {
    UpdateVoltageAdjusterUserDefinedCommand command =
        new UpdateVoltageAdjusterUserDefinedCommand(null, null);
