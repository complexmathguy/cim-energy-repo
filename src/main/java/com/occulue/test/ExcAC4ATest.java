...
public class ExcAC4ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAC4AId =
        ExcAC4ABusinessDelegate.getExcAC4AInstance().createExcAC4A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAC4A : " + successValue.getExcAC4AId());
                  if (successValue.getExcAC4AId().equals(excAC4AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAC4AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAC4A : "
                          + successValue.getExcAC4AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAC4AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAC4ABusinessDelegate.getExcAC4AInstance()
          .delete(new DeleteExcAC4ACommand(entity.getExcAC4AId()))
          .get();
  ...
  protected UpdateExcAC4ACommand generateUpdateCommand() {
    UpdateExcAC4ACommand command =
        new UpdateExcAC4ACommand(null, null, null, null, null, null, null, null, null, null);
