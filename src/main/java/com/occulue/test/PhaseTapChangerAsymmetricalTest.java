...
public class PhaseTapChangerAsymmetricalTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PhaseTapChangerAsymmetrical : "
                          + successValue.getPhaseTapChangerAsymmetricalId());
                  if (successValue
                      .getPhaseTapChangerAsymmetricalId()
                      .equals(phaseTapChangerAsymmetricalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPhaseTapChangerAsymmetricalList - 1,
      ...
      subscriber
          .phaseTapChangerAsymmetricalSubscribe(phaseTapChangerAsymmetricalId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PhaseTapChangerAsymmetrical : "
                          + successValue.getPhaseTapChangerAsymmetricalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on phaseTapChangerAsymmetrical for phaseTapChangerAsymmetricalId consumed"));
  ...
  protected PhaseTapChangerAsymmetrical read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PhaseTapChangerAsymmetrical with primary key");
    msg.append(phaseTapChangerAsymmetricalId);

    PhaseTapChangerAsymmetricalFetchOneSummary fetchOneSummary =
        new PhaseTapChangerAsymmetricalFetchOneSummary(phaseTapChangerAsymmetricalId);

    try {
      entity =
          PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance()
              .getPhaseTapChangerAsymmetrical(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PhaseTapChangerAsymmetricalBusinessDelegate proxy =
          PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PhaseTapChangerAsymmetrical with id "
              + phaseTapChangerAsymmetricalId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PhaseTapChangerAsymmetrical with id " + phaseTapChangerAsymmetricalId);
    ...
    try {
      PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance()
          .delete(
              new DeletePhaseTapChangerAsymmetricalCommand(
                  entity.getPhaseTapChangerAsymmetricalId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PhaseTapChangerAsymmetrical with id "
              + phaseTapChangerAsymmetricalId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PhaseTapChangerAsymmetrical with id "
              + phaseTapChangerAsymmetricalId);
  ...
  protected List<PhaseTapChangerAsymmetrical> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PhaseTapChangerAsymmetricalBusinessDelegate.getPhaseTapChangerAsymmetricalInstance()
              .getAllPhaseTapChangerAsymmetrical();
      assertNotNull(
          collection,
          "An Empty collection of PhaseTapChangerAsymmetrical was incorrectly returned.");
  ...
  protected CreatePhaseTapChangerAsymmetricalCommand generateNewCommand() {
    CreatePhaseTapChangerAsymmetricalCommand command =
        new CreatePhaseTapChangerAsymmetricalCommand(null);
  ...
  protected UpdatePhaseTapChangerAsymmetricalCommand generateUpdateCommand() {
    UpdatePhaseTapChangerAsymmetricalCommand command =
        new UpdatePhaseTapChangerAsymmetricalCommand(null, null);
