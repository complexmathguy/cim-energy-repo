...
public class ACDCConverterTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ACDCConverter : "
                          + successValue.getACDCConverterId());
                  if (successValue.getACDCConverterId().equals(aCDCConverterId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfACDCConverterList - 1,
      ...
      subscriber
          .aCDCConverterSubscribe(aCDCConverterId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ACDCConverter : "
                          + successValue.getACDCConverterId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ACDCConverter read() throws Throwable {
    ...
    ACDCConverterFetchOneSummary fetchOneSummary =
        new ACDCConverterFetchOneSummary(aCDCConverterId);

    try {
      entity =
          ACDCConverterBusinessDelegate.getACDCConverterInstance()
              .getACDCConverter(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ACDCConverterBusinessDelegate proxy =
          ACDCConverterBusinessDelegate.getACDCConverterInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ACDCConverterBusinessDelegate.getACDCConverterInstance()
          .delete(new DeleteACDCConverterCommand(entity.getACDCConverterId()))
          .get();
  ...
  protected List<ACDCConverter> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getACDCConverterId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateACDCConverterCommand generateUpdateCommand() {
    UpdateACDCConverterCommand command =
        new UpdateACDCConverterCommand(null, null, null, null, null, null, null, null, null, null);
