...
public class SynchronousMachineDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SynchronousMachineDynamics : "
                          + successValue.getSynchronousMachineDynamicsId());
                  if (successValue
                      .getSynchronousMachineDynamicsId()
                      .equals(synchronousMachineDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSynchronousMachineDynamicsList - 1,
      ...
      subscriber
          .synchronousMachineDynamicsSubscribe(synchronousMachineDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SynchronousMachineDynamics : "
                          + successValue.getSynchronousMachineDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on synchronousMachineDynamics for synchronousMachineDynamicsId consumed"));
  ...
  protected SynchronousMachineDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SynchronousMachineDynamics with primary key");
    msg.append(synchronousMachineDynamicsId);

    SynchronousMachineDynamicsFetchOneSummary fetchOneSummary =
        new SynchronousMachineDynamicsFetchOneSummary(synchronousMachineDynamicsId);

    try {
      entity =
          SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance()
              .getSynchronousMachineDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SynchronousMachineDynamicsBusinessDelegate proxy =
          SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SynchronousMachineDynamics with id "
              + synchronousMachineDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SynchronousMachineDynamics with id " + synchronousMachineDynamicsId);
    ...
    try {
      SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance()
          .delete(
              new DeleteSynchronousMachineDynamicsCommand(entity.getSynchronousMachineDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SynchronousMachineDynamics with id "
              + synchronousMachineDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SynchronousMachineDynamics with id " + synchronousMachineDynamicsId);
  ...
  protected List<SynchronousMachineDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SynchronousMachineDynamicsBusinessDelegate.getSynchronousMachineDynamicsInstance()
              .getAllSynchronousMachineDynamics();
      assertNotNull(
          collection,
          "An Empty collection of SynchronousMachineDynamics was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSynchronousMachineDynamicsId(),
  ...
  protected CreateSynchronousMachineDynamicsCommand generateNewCommand() {
    CreateSynchronousMachineDynamicsCommand command =
        new CreateSynchronousMachineDynamicsCommand(null);
  ...
  protected UpdateSynchronousMachineDynamicsCommand generateUpdateCommand() {
    UpdateSynchronousMachineDynamicsCommand command =
        new UpdateSynchronousMachineDynamicsCommand(null);
