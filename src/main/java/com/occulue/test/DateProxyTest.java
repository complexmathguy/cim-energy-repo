...
public class DateProxyTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    DateProxyBusinessDelegate.getDateProxyInstance().createDateProxy(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DateProxy : " + successValue.getDateProxyId());
                  if (successValue.getDateProxyId().equals(dateProxyId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDateProxyList - 1,
      ...
      subscriber
          .dateProxySubscribe(dateProxyId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DateProxy : "
                          + successValue.getDateProxyId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dateProxyId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DateProxyBusinessDelegate.getDateProxyInstance()
          .delete(new DeleteDateProxyCommand(entity.getDateProxyId()))
          .get();
