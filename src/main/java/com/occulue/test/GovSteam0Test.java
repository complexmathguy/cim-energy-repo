...
public class GovSteam0Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovSteam0BusinessDelegate.getGovSteam0Instance().createGovSteam0(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteam0 : " + successValue.getGovSteam0Id());
                  if (successValue.getGovSteam0Id().equals(govSteam0Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteam0List - 1,
      ...
      subscriber
          .govSteam0Subscribe(govSteam0Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteam0 : "
                          + successValue.getGovSteam0Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govSteam0Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteam0BusinessDelegate.getGovSteam0Instance()
          .delete(new DeleteGovSteam0Command(entity.getGovSteam0Id()))
          .get();
  ...
  protected UpdateGovSteam0Command generateUpdateCommand() {
    UpdateGovSteam0Command command =
        new UpdateGovSteam0Command(null, null, null, null, null, null, null, null, null);
