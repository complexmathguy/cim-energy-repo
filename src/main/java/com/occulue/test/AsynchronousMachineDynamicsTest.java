...
public class AsynchronousMachineDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AsynchronousMachineDynamics : "
                          + successValue.getAsynchronousMachineDynamicsId());
                  if (successValue
                      .getAsynchronousMachineDynamicsId()
                      .equals(asynchronousMachineDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAsynchronousMachineDynamicsList - 1,
      ...
      subscriber
          .asynchronousMachineDynamicsSubscribe(asynchronousMachineDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AsynchronousMachineDynamics : "
                          + successValue.getAsynchronousMachineDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on asynchronousMachineDynamics for asynchronousMachineDynamicsId consumed"));
  ...
  protected AsynchronousMachineDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read AsynchronousMachineDynamics with primary key");
    msg.append(asynchronousMachineDynamicsId);

    AsynchronousMachineDynamicsFetchOneSummary fetchOneSummary =
        new AsynchronousMachineDynamicsFetchOneSummary(asynchronousMachineDynamicsId);

    try {
      entity =
          AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance()
              .getAsynchronousMachineDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      AsynchronousMachineDynamicsBusinessDelegate proxy =
          AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read AsynchronousMachineDynamics with id "
              + asynchronousMachineDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read AsynchronousMachineDynamics with id " + asynchronousMachineDynamicsId);
    ...
    try {
      AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance()
          .delete(
              new DeleteAsynchronousMachineDynamicsCommand(
                  entity.getAsynchronousMachineDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted AsynchronousMachineDynamics with id "
              + asynchronousMachineDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete AsynchronousMachineDynamics with id "
              + asynchronousMachineDynamicsId);
  ...
  protected List<AsynchronousMachineDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          AsynchronousMachineDynamicsBusinessDelegate.getAsynchronousMachineDynamicsInstance()
              .getAllAsynchronousMachineDynamics();
      assertNotNull(
          collection,
          "An Empty collection of AsynchronousMachineDynamics was incorrectly returned.");
  ...
  protected CreateAsynchronousMachineDynamicsCommand generateNewCommand() {
    CreateAsynchronousMachineDynamicsCommand command =
        new CreateAsynchronousMachineDynamicsCommand(null);
  ...
  protected UpdateAsynchronousMachineDynamicsCommand generateUpdateCommand() {
    UpdateAsynchronousMachineDynamicsCommand command =
        new UpdateAsynchronousMachineDynamicsCommand(null);
