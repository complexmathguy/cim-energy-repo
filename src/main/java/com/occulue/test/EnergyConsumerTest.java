...
public class EnergyConsumerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EnergyConsumer : "
                          + successValue.getEnergyConsumerId());
                  if (successValue.getEnergyConsumerId().equals(energyConsumerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEnergyConsumerList - 1,
      ...
      subscriber
          .energyConsumerSubscribe(energyConsumerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EnergyConsumer : "
                          + successValue.getEnergyConsumerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected EnergyConsumer read() throws Throwable {
    ...
    EnergyConsumerFetchOneSummary fetchOneSummary =
        new EnergyConsumerFetchOneSummary(energyConsumerId);

    try {
      entity =
          EnergyConsumerBusinessDelegate.getEnergyConsumerInstance()
              .getEnergyConsumer(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EnergyConsumerBusinessDelegate proxy =
          EnergyConsumerBusinessDelegate.getEnergyConsumerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EnergyConsumerBusinessDelegate.getEnergyConsumerInstance()
          .delete(new DeleteEnergyConsumerCommand(entity.getEnergyConsumerId()))
          .get();
  ...
  protected List<EnergyConsumer> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          EnergyConsumerBusinessDelegate.getEnergyConsumerInstance().getAllEnergyConsumer();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEnergyConsumerId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateEnergyConsumerCommand generateUpdateCommand() {
    UpdateEnergyConsumerCommand command =
        new UpdateEnergyConsumerCommand(null, null, null, null, null);
