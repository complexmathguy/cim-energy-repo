...
public class DiscontinuousExcitationControlDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DiscontinuousExcitationControlDynamics : "
                          + successValue.getDiscontinuousExcitationControlDynamicsId());
                  if (successValue
                      .getDiscontinuousExcitationControlDynamicsId()
                      .equals(discontinuousExcitationControlDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiscontinuousExcitationControlDynamicsList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "DiscontinuousExcitationControlDynamics test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          .discontinuousExcitationControlDynamicsSubscribe(discontinuousExcitationControlDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DiscontinuousExcitationControlDynamics : "
                          + successValue.getDiscontinuousExcitationControlDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on discontinuousExcitationControlDynamics for discontinuousExcitationControlDynamicsId consumed"));
  ...
  protected DiscontinuousExcitationControlDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder(
            "-- Failed to read DiscontinuousExcitationControlDynamics with primary key");
    msg.append(discontinuousExcitationControlDynamicsId);

    DiscontinuousExcitationControlDynamicsFetchOneSummary fetchOneSummary =
    ...
    try {
      entity =
          DiscontinuousExcitationControlDynamicsBusinessDelegate
              .getDiscontinuousExcitationControlDynamicsInstance()
              .getDiscontinuousExcitationControlDynamics(fetchOneSummary);

      assertNotNull(entity, msg.toString());

      LOGGER.info(
          "-- Successfully found DiscontinuousExcitationControlDynamics " + entity.toString());
    } catch (Throwable e) {
  ...
  protected void update() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("Failed to update a DiscontinuousExcitationControlDynamics : ");
    ...
    command.setDiscontinuousExcitationControlDynamicsId(
        entity.getDiscontinuousExcitationControlDynamicsId());
    ...
    try {
      ...
      DiscontinuousExcitationControlDynamicsBusinessDelegate proxy =
          DiscontinuousExcitationControlDynamicsBusinessDelegate
              .getDiscontinuousExcitationControlDynamicsInstance();
      ...
      LOGGER.info(
          "-- Successfully saved DiscontinuousExcitationControlDynamics - " + entity.toString());
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString()
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read DiscontinuousExcitationControlDynamics with id "
              + discontinuousExcitationControlDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read DiscontinuousExcitationControlDynamics with id "
              + discontinuousExcitationControlDynamicsId);
    ...
    try {
      DiscontinuousExcitationControlDynamicsBusinessDelegate
          ...
          .get();
      LOGGER.info(
          "-- Successfully deleted DiscontinuousExcitationControlDynamics with id "
              + discontinuousExcitationControlDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete DiscontinuousExcitationControlDynamics with id "
              + discontinuousExcitationControlDynamicsId);
  ...
  protected List<DiscontinuousExcitationControlDynamics> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all DiscontinuousExcitationControlDynamics : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of DiscontinuousExcitationControlDynamics was incorrectly returned.");
  ...
  protected CreateDiscontinuousExcitationControlDynamicsCommand generateNewCommand() {
    CreateDiscontinuousExcitationControlDynamicsCommand command =
        new CreateDiscontinuousExcitationControlDynamicsCommand(null);
  ...
  protected UpdateDiscontinuousExcitationControlDynamicsCommand generateUpdateCommand() {
    UpdateDiscontinuousExcitationControlDynamicsCommand command =
        new UpdateDiscontinuousExcitationControlDynamicsCommand(null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(DiscontinuousExcitationControlDynamicsTest.class.getName());
