...
public class GovSteamSGOTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteamSGO : "
                          + successValue.getGovSteamSGOId());
                  if (successValue.getGovSteamSGOId().equals(govSteamSGOId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteamSGOList - 1,
      ...
      subscriber
          .govSteamSGOSubscribe(govSteamSGOId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteamSGO : "
                          + successValue.getGovSteamSGOId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteamSGOBusinessDelegate.getGovSteamSGOInstance()
          .delete(new DeleteGovSteamSGOCommand(entity.getGovSteamSGOId()))
          .get();
  ...
  protected UpdateGovSteamSGOCommand generateUpdateCommand() {
    UpdateGovSteamSGOCommand command =
        new UpdateGovSteamSGOCommand(
