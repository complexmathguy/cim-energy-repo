...
public class DiscExcContIEEEDEC1ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DiscExcContIEEEDEC1A : "
                          + successValue.getDiscExcContIEEEDEC1AId());
                  if (successValue.getDiscExcContIEEEDEC1AId().equals(discExcContIEEEDEC1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiscExcContIEEEDEC1AList - 1,
      ...
      subscriber
          .discExcContIEEEDEC1ASubscribe(discExcContIEEEDEC1AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DiscExcContIEEEDEC1A : "
                          + successValue.getDiscExcContIEEEDEC1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on discExcContIEEEDEC1A for discExcContIEEEDEC1AId consumed"));
  ...
  protected DiscExcContIEEEDEC1A read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read DiscExcContIEEEDEC1A with primary key");
    msg.append(discExcContIEEEDEC1AId);

    DiscExcContIEEEDEC1AFetchOneSummary fetchOneSummary =
        new DiscExcContIEEEDEC1AFetchOneSummary(discExcContIEEEDEC1AId);

    try {
      entity =
          DiscExcContIEEEDEC1ABusinessDelegate.getDiscExcContIEEEDEC1AInstance()
              .getDiscExcContIEEEDEC1A(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DiscExcContIEEEDEC1ABusinessDelegate proxy =
          DiscExcContIEEEDEC1ABusinessDelegate.getDiscExcContIEEEDEC1AInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DiscExcContIEEEDEC1ABusinessDelegate.getDiscExcContIEEEDEC1AInstance()
          .delete(new DeleteDiscExcContIEEEDEC1ACommand(entity.getDiscExcContIEEEDEC1AId()))
          .get();
  ...
  protected List<DiscExcContIEEEDEC1A> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          DiscExcContIEEEDEC1ABusinessDelegate.getDiscExcContIEEEDEC1AInstance()
              .getAllDiscExcContIEEEDEC1A();
      assertNotNull(
          collection, "An Empty collection of DiscExcContIEEEDEC1A was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDiscExcContIEEEDEC1AId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateDiscExcContIEEEDEC1ACommand generateUpdateCommand() {
    UpdateDiscExcContIEEEDEC1ACommand command =
        new UpdateDiscExcContIEEEDEC1ACommand(
