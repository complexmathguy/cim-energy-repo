...
public class GovHydroRTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovHydroRBusinessDelegate.getGovHydroRInstance().createGovHydroR(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydroR : " + successValue.getGovHydroRId());
                  if (successValue.getGovHydroRId().equals(govHydroRId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydroRList - 1,
      ...
      subscriber
          .govHydroRSubscribe(govHydroRId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydroR : "
                          + successValue.getGovHydroRId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govHydroRId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydroRBusinessDelegate.getGovHydroRInstance()
          .delete(new DeleteGovHydroRCommand(entity.getGovHydroRId()))
          .get();
  ...
  protected UpdateGovHydroRCommand generateUpdateCommand() {
    UpdateGovHydroRCommand command =
        new UpdateGovHydroRCommand(
