...
public class TurbLCFB1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    TurbLCFB1BusinessDelegate.getTurbLCFB1Instance().createTurbLCFB1(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TurbLCFB1 : " + successValue.getTurbLCFB1Id());
                  if (successValue.getTurbLCFB1Id().equals(turbLCFB1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTurbLCFB1List - 1,
      ...
      subscriber
          .turbLCFB1Subscribe(turbLCFB1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TurbLCFB1 : "
                          + successValue.getTurbLCFB1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + turbLCFB1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TurbLCFB1BusinessDelegate.getTurbLCFB1Instance()
          .delete(new DeleteTurbLCFB1Command(entity.getTurbLCFB1Id()))
          .get();
  ...
  protected UpdateTurbLCFB1Command generateUpdateCommand() {
    UpdateTurbLCFB1Command command =
        new UpdateTurbLCFB1Command(
