...
public class GovSteamFV2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteamFV2 : "
                          + successValue.getGovSteamFV2Id());
                  if (successValue.getGovSteamFV2Id().equals(govSteamFV2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteamFV2List - 1,
      ...
      subscriber
          .govSteamFV2Subscribe(govSteamFV2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteamFV2 : "
                          + successValue.getGovSteamFV2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteamFV2BusinessDelegate.getGovSteamFV2Instance()
          .delete(new DeleteGovSteamFV2Command(entity.getGovSteamFV2Id()))
          .get();
  ...
  protected UpdateGovSteamFV2Command generateUpdateCommand() {
    UpdateGovSteamFV2Command command =
        new UpdateGovSteamFV2Command(
