...
public class TapChangerTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    TapChangerBusinessDelegate.getTapChangerInstance().createTapChanger(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TapChanger : " + successValue.getTapChangerId());
                  if (successValue.getTapChangerId().equals(tapChangerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTapChangerList - 1,
      ...
      subscriber
          .tapChangerSubscribe(tapChangerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TapChanger : "
                          + successValue.getTapChangerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TapChangerBusinessDelegate.getTapChangerInstance()
          .delete(new DeleteTapChangerCommand(entity.getTapChangerId()))
          .get();
  ...
  protected UpdateTapChangerCommand generateUpdateCommand() {
    UpdateTapChangerCommand command =
        new UpdateTapChangerCommand(null, null, null, null, null, null, null);
