...
public class ExcAC6ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAC6AId =
        ExcAC6ABusinessDelegate.getExcAC6AInstance().createExcAC6A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAC6A : " + successValue.getExcAC6AId());
                  if (successValue.getExcAC6AId().equals(excAC6AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAC6AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAC6A : "
                          + successValue.getExcAC6AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAC6AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAC6ABusinessDelegate.getExcAC6AInstance()
          .delete(new DeleteExcAC6ACommand(entity.getExcAC6AId()))
          .get();
  ...
  protected UpdateExcAC6ACommand generateUpdateCommand() {
    UpdateExcAC6ACommand command =
        new UpdateExcAC6ACommand(
