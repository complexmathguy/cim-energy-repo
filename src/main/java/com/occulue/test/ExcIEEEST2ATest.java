...
public class ExcIEEEST2ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEST2A : "
                          + successValue.getExcIEEEST2AId());
                  if (successValue.getExcIEEEST2AId().equals(excIEEEST2AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEST2AList - 1,
      ...
      subscriber
          .excIEEEST2ASubscribe(excIEEEST2AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEST2A : "
                          + successValue.getExcIEEEST2AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEST2ABusinessDelegate.getExcIEEEST2AInstance()
          .delete(new DeleteExcIEEEST2ACommand(entity.getExcIEEEST2AId()))
          .get();
  ...
  protected UpdateExcIEEEST2ACommand generateUpdateCommand() {
    UpdateExcIEEEST2ACommand command =
        new UpdateExcIEEEST2ACommand(
