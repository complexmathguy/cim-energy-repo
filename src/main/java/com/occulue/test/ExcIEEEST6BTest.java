...
public class ExcIEEEST6BTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEST6B : "
                          + successValue.getExcIEEEST6BId());
                  if (successValue.getExcIEEEST6BId().equals(excIEEEST6BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEST6BList - 1,
      ...
      subscriber
          .excIEEEST6BSubscribe(excIEEEST6BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEST6B : "
                          + successValue.getExcIEEEST6BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEST6BBusinessDelegate.getExcIEEEST6BInstance()
          .delete(new DeleteExcIEEEST6BCommand(entity.getExcIEEEST6BId()))
          .get();
  ...
  protected CreateExcIEEEST6BCommand generateNewCommand() {
    CreateExcIEEEST6BCommand command =
        new CreateExcIEEEST6BCommand(null, ExcST6BOELselectorKind.values()[0]);
  ...
  protected UpdateExcIEEEST6BCommand generateUpdateCommand() {
    UpdateExcIEEEST6BCommand command =
        new UpdateExcIEEEST6BCommand(
            null,
            null,
            null,
            null,
