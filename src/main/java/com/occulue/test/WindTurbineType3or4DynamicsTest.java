...
public class WindTurbineType3or4DynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          .windTurbineType3or4DynamicsSubscribe()
          .updates()
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindTurbineType3or4Dynamics : "
                          + successValue.getWindTurbineType3or4DynamicsId());
                  if (successValue
                      .getWindTurbineType3or4DynamicsId()
                      .equals(windTurbineType3or4DynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindTurbineType3or4DynamicsList - 1,
      ...
      subscriber
          .windTurbineType3or4DynamicsSubscribe(windTurbineType3or4DynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindTurbineType3or4Dynamics : "
                          + successValue.getWindTurbineType3or4DynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windTurbineType3or4Dynamics for windTurbineType3or4DynamicsId consumed"));
  ...
  protected WindTurbineType3or4Dynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindTurbineType3or4Dynamics with primary key");
    msg.append(windTurbineType3or4DynamicsId);

    WindTurbineType3or4DynamicsFetchOneSummary fetchOneSummary =
        new WindTurbineType3or4DynamicsFetchOneSummary(windTurbineType3or4DynamicsId);

    try {
      entity =
          WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance()
              .getWindTurbineType3or4Dynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindTurbineType3or4DynamicsBusinessDelegate proxy =
          WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindTurbineType3or4Dynamics with id "
              + windTurbineType3or4DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindTurbineType3or4Dynamics with id " + windTurbineType3or4DynamicsId);
    ...
    try {
      WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance()
          .delete(
              new DeleteWindTurbineType3or4DynamicsCommand(
                  entity.getWindTurbineType3or4DynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindTurbineType3or4Dynamics with id "
              + windTurbineType3or4DynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindTurbineType3or4Dynamics with id "
              + windTurbineType3or4DynamicsId);
  ...
  protected List<WindTurbineType3or4Dynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindTurbineType3or4DynamicsBusinessDelegate.getWindTurbineType3or4DynamicsInstance()
              .getAllWindTurbineType3or4Dynamics();
      assertNotNull(
          collection,
          "An Empty collection of WindTurbineType3or4Dynamics was incorrectly returned.");
  ...
  protected CreateWindTurbineType3or4DynamicsCommand generateNewCommand() {
    CreateWindTurbineType3or4DynamicsCommand command =
        new CreateWindTurbineType3or4DynamicsCommand(null);
  ...
  protected UpdateWindTurbineType3or4DynamicsCommand generateUpdateCommand() {
    UpdateWindTurbineType3or4DynamicsCommand command =
        new UpdateWindTurbineType3or4DynamicsCommand(null);
