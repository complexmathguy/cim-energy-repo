...
public class WindPlantReactiveControlIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindPlantReactiveControlIEC : "
                          + successValue.getWindPlantReactiveControlIECId());
                  if (successValue
                      .getWindPlantReactiveControlIECId()
                      .equals(windPlantReactiveControlIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindPlantReactiveControlIECList - 1,
      ...
      subscriber
          .windPlantReactiveControlIECSubscribe(windPlantReactiveControlIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindPlantReactiveControlIEC : "
                          + successValue.getWindPlantReactiveControlIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windPlantReactiveControlIEC for windPlantReactiveControlIECId consumed"));
  ...
  protected WindPlantReactiveControlIEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindPlantReactiveControlIEC with primary key");
    msg.append(windPlantReactiveControlIECId);

    WindPlantReactiveControlIECFetchOneSummary fetchOneSummary =
        new WindPlantReactiveControlIECFetchOneSummary(windPlantReactiveControlIECId);

    try {
      entity =
          WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance()
              .getWindPlantReactiveControlIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindPlantReactiveControlIECBusinessDelegate proxy =
          WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindPlantReactiveControlIEC with id "
              + windPlantReactiveControlIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindPlantReactiveControlIEC with id " + windPlantReactiveControlIECId);
    ...
    try {
      WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance()
          .delete(
              new DeleteWindPlantReactiveControlIECCommand(
                  entity.getWindPlantReactiveControlIECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindPlantReactiveControlIEC with id "
              + windPlantReactiveControlIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindPlantReactiveControlIEC with id "
              + windPlantReactiveControlIECId);
  ...
  protected List<WindPlantReactiveControlIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindPlantReactiveControlIECBusinessDelegate.getWindPlantReactiveControlIECInstance()
              .getAllWindPlantReactiveControlIEC();
      assertNotNull(
          collection,
          "An Empty collection of WindPlantReactiveControlIEC was incorrectly returned.");
  ...
  protected CreateWindPlantReactiveControlIECCommand generateNewCommand() {
    CreateWindPlantReactiveControlIECCommand command =
        new CreateWindPlantReactiveControlIECCommand(null);
  ...
  protected UpdateWindPlantReactiveControlIECCommand generateUpdateCommand() {
    UpdateWindPlantReactiveControlIECCommand command =
        new UpdateWindPlantReactiveControlIECCommand(
