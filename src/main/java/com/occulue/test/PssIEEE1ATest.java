...
public class PssIEEE1ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    PssIEEE1ABusinessDelegate.getPssIEEE1AInstance().createPssIEEE1A(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PssIEEE1A : " + successValue.getPssIEEE1AId());
                  if (successValue.getPssIEEE1AId().equals(pssIEEE1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPssIEEE1AList - 1,
      ...
      subscriber
          .pssIEEE1ASubscribe(pssIEEE1AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PssIEEE1A : "
                          + successValue.getPssIEEE1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssIEEE1AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssIEEE1ABusinessDelegate.getPssIEEE1AInstance()
          .delete(new DeletePssIEEE1ACommand(entity.getPssIEEE1AId()))
          .get();
  ...
  protected UpdatePssIEEE1ACommand generateUpdateCommand() {
    UpdatePssIEEE1ACommand command =
        new UpdatePssIEEE1ACommand(
            null,
            null,
            null,
