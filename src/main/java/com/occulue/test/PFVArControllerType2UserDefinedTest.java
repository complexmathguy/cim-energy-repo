...
public class PFVArControllerType2UserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PFVArControllerType2UserDefined : "
                          + successValue.getPFVArControllerType2UserDefinedId());
                  if (successValue
                      .getPFVArControllerType2UserDefinedId()
                      .equals(pFVArControllerType2UserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPFVArControllerType2UserDefinedList - 1,
      ...
      subscriber
          .pFVArControllerType2UserDefinedSubscribe(pFVArControllerType2UserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PFVArControllerType2UserDefined : "
                          + successValue.getPFVArControllerType2UserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on pFVArControllerType2UserDefined for pFVArControllerType2UserDefinedId consumed"));
  ...
  protected PFVArControllerType2UserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PFVArControllerType2UserDefined with primary key");
    msg.append(pFVArControllerType2UserDefinedId);

    PFVArControllerType2UserDefinedFetchOneSummary fetchOneSummary =
        new PFVArControllerType2UserDefinedFetchOneSummary(pFVArControllerType2UserDefinedId);

    try {
      entity =
          PFVArControllerType2UserDefinedBusinessDelegate
              .getPFVArControllerType2UserDefinedInstance()
              .getPFVArControllerType2UserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PFVArControllerType2UserDefinedBusinessDelegate proxy =
          PFVArControllerType2UserDefinedBusinessDelegate
              .getPFVArControllerType2UserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read PFVArControllerType2UserDefined with id "
              + pFVArControllerType2UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read PFVArControllerType2UserDefined with id "
              + pFVArControllerType2UserDefinedId);
    ...
    try {
      PFVArControllerType2UserDefinedBusinessDelegate.getPFVArControllerType2UserDefinedInstance()
          .delete(
              new DeletePFVArControllerType2UserDefinedCommand(
                  entity.getPFVArControllerType2UserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PFVArControllerType2UserDefined with id "
              + pFVArControllerType2UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PFVArControllerType2UserDefined with id "
              + pFVArControllerType2UserDefinedId);
  ...
  protected List<PFVArControllerType2UserDefined> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all PFVArControllerType2UserDefined : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of PFVArControllerType2UserDefined was incorrectly returned.");
  ...
  protected CreatePFVArControllerType2UserDefinedCommand generateNewCommand() {
    CreatePFVArControllerType2UserDefinedCommand command =
        new CreatePFVArControllerType2UserDefinedCommand(null);
  ...
  protected UpdatePFVArControllerType2UserDefinedCommand generateUpdateCommand() {
    UpdatePFVArControllerType2UserDefinedCommand command =
        new UpdatePFVArControllerType2UserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(PFVArControllerType2UserDefinedTest.class.getName());
