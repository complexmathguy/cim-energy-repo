...
public class TieFlowTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    tieFlowId =
        TieFlowBusinessDelegate.getTieFlowInstance().createTieFlow(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TieFlow : " + successValue.getTieFlowId());
                  if (successValue.getTieFlowId().equals(tieFlowId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTieFlowList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for TieFlow : "
                          + successValue.getTieFlowId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + tieFlowId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TieFlowBusinessDelegate.getTieFlowInstance()
          .delete(new DeleteTieFlowCommand(entity.getTieFlowId()))
          .get();
  ...
  protected UpdateTieFlowCommand generateUpdateCommand() {
    UpdateTieFlowCommand command = new UpdateTieFlowCommand(null, null);
