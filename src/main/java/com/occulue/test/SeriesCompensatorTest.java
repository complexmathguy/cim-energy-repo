...
public class SeriesCompensatorTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SeriesCompensator : "
                          + successValue.getSeriesCompensatorId());
                  if (successValue.getSeriesCompensatorId().equals(seriesCompensatorId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSeriesCompensatorList - 1,
      ...
      subscriber
          .seriesCompensatorSubscribe(seriesCompensatorId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SeriesCompensator : "
                          + successValue.getSeriesCompensatorId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on seriesCompensator for seriesCompensatorId consumed"));
  ...
  protected SeriesCompensator read() throws Throwable {
    ...
    SeriesCompensatorFetchOneSummary fetchOneSummary =
        new SeriesCompensatorFetchOneSummary(seriesCompensatorId);

    try {
      entity =
          SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance()
              .getSeriesCompensator(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SeriesCompensatorBusinessDelegate proxy =
          SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance()
          .delete(new DeleteSeriesCompensatorCommand(entity.getSeriesCompensatorId()))
          .get();
  ...
  protected List<SeriesCompensator> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SeriesCompensatorBusinessDelegate.getSeriesCompensatorInstance()
              .getAllSeriesCompensator();
      assertNotNull(
          collection, "An Empty collection of SeriesCompensator was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSeriesCompensatorId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateSeriesCompensatorCommand generateUpdateCommand() {
    UpdateSeriesCompensatorCommand command =
        new UpdateSeriesCompensatorCommand(null, null, null, null, null, null, null, null);
