...
public class MoneyTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    moneyId = MoneyBusinessDelegate.getMoneyInstance().createMoney(generateNewCommand()).get();
    ...
    MoneyBusinessDelegate.getMoneyInstance().createMoney(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Money : "
                          + successValue.getMoneyId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + moneyId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      MoneyBusinessDelegate.getMoneyInstance()
          .delete(new DeleteMoneyCommand(entity.getMoneyId()))
          .get();
