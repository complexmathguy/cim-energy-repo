...
public class ExcST7BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excST7BId =
        ExcST7BBusinessDelegate.getExcST7BInstance().createExcST7B(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcST7B : " + successValue.getExcST7BId());
                  if (successValue.getExcST7BId().equals(excST7BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcST7BList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcST7B : "
                          + successValue.getExcST7BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excST7BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcST7BBusinessDelegate.getExcST7BInstance()
          .delete(new DeleteExcST7BCommand(entity.getExcST7BId()))
          .get();
  ...
  protected CreateExcST7BCommand generateNewCommand() {
    CreateExcST7BCommand command =
        new CreateExcST7BCommand(
            null, ExcST7BOELselectorKind.values()[0], ExcST7BUELselectorKind.values()[0]);
  ...
  protected UpdateExcST7BCommand generateUpdateCommand() {
    UpdateExcST7BCommand command =
        new UpdateExcST7BCommand(
            null,
            null,
            null,
            null,
            null,
            ExcST7BOELselectorKind.values()[0],
            null,
            null,
            null,
            null,
            null,
            null,
            ExcST7BUELselectorKind.values()[0],
            null,
            null,
            null,
            null);
