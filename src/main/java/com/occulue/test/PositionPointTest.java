...
public class PositionPointTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PositionPoint : "
                          + successValue.getPositionPointId());
                  if (successValue.getPositionPointId().equals(positionPointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPositionPointList - 1,
      ...
      subscriber
          .positionPointSubscribe(positionPointId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PositionPoint : "
                          + successValue.getPositionPointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected PositionPoint read() throws Throwable {
    ...
    PositionPointFetchOneSummary fetchOneSummary =
        new PositionPointFetchOneSummary(positionPointId);

    try {
      entity =
          PositionPointBusinessDelegate.getPositionPointInstance()
              .getPositionPoint(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PositionPointBusinessDelegate proxy =
          PositionPointBusinessDelegate.getPositionPointInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PositionPointBusinessDelegate.getPositionPointInstance()
          .delete(new DeletePositionPointCommand(entity.getPositionPointId()))
          .get();
  ...
  protected List<PositionPoint> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPositionPointId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdatePositionPointCommand generateUpdateCommand() {
    UpdatePositionPointCommand command =
        new UpdatePositionPointCommand(null, null, null, null, null);
