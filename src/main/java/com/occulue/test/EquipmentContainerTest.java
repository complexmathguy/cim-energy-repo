...
public class EquipmentContainerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EquipmentContainer : "
                          + successValue.getEquipmentContainerId());
                  if (successValue.getEquipmentContainerId().equals(equipmentContainerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEquipmentContainerList - 1,
      ...
      subscriber
          .equipmentContainerSubscribe(equipmentContainerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EquipmentContainer : "
                          + successValue.getEquipmentContainerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on equipmentContainer for equipmentContainerId consumed"));
  ...
  protected EquipmentContainer read() throws Throwable {
    ...
    EquipmentContainerFetchOneSummary fetchOneSummary =
        new EquipmentContainerFetchOneSummary(equipmentContainerId);

    try {
      entity =
          EquipmentContainerBusinessDelegate.getEquipmentContainerInstance()
              .getEquipmentContainer(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EquipmentContainerBusinessDelegate proxy =
          EquipmentContainerBusinessDelegate.getEquipmentContainerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EquipmentContainerBusinessDelegate.getEquipmentContainerInstance()
          .delete(new DeleteEquipmentContainerCommand(entity.getEquipmentContainerId()))
          .get();
  ...
  protected List<EquipmentContainer> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          EquipmentContainerBusinessDelegate.getEquipmentContainerInstance()
              .getAllEquipmentContainer();
      assertNotNull(
          collection, "An Empty collection of EquipmentContainer was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEquipmentContainerId(), "-- entity in Collection has a null primary key");
