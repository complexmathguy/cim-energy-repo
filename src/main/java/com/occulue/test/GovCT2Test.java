...
public class GovCT2Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    govCT2Id = GovCT2BusinessDelegate.getGovCT2Instance().createGovCT2(generateNewCommand()).get();
    ...
    GovCT2BusinessDelegate.getGovCT2Instance().createGovCT2(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for GovCT2 : "
                          + successValue.getGovCT2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govCT2Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovCT2BusinessDelegate.getGovCT2Instance()
          .delete(new DeleteGovCT2Command(entity.getGovCT2Id()))
          .get();
  ...
  protected CreateGovCT2Command generateNewCommand() {
    CreateGovCT2Command command =
        new CreateGovCT2Command(null, DroopSignalFeedbackKind.values()[0]);
  ...
  protected UpdateGovCT2Command generateUpdateCommand() {
    UpdateGovCT2Command command =
        new UpdateGovCT2Command(
            null,
            null,
            null,
            null,
