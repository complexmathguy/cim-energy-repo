...
public class GovGAST1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    govGAST1Id =
        GovGAST1BusinessDelegate.getGovGAST1Instance().createGovGAST1(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovGAST1 : " + successValue.getGovGAST1Id());
                  if (successValue.getGovGAST1Id().equals(govGAST1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovGAST1List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for GovGAST1 : "
                          + successValue.getGovGAST1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govGAST1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovGAST1BusinessDelegate.getGovGAST1Instance()
          .delete(new DeleteGovGAST1Command(entity.getGovGAST1Id()))
          .get();
  ...
  protected UpdateGovGAST1Command generateUpdateCommand() {
    UpdateGovGAST1Command command =
        new UpdateGovGAST1Command(
