...
public class GovHydro2Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovHydro2BusinessDelegate.getGovHydro2Instance().createGovHydro2(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydro2 : " + successValue.getGovHydro2Id());
                  if (successValue.getGovHydro2Id().equals(govHydro2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydro2List - 1,
      ...
      subscriber
          .govHydro2Subscribe(govHydro2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydro2 : "
                          + successValue.getGovHydro2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govHydro2Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydro2BusinessDelegate.getGovHydro2Instance()
          .delete(new DeleteGovHydro2Command(entity.getGovHydro2Id()))
          .get();
  ...
  protected UpdateGovHydro2Command generateUpdateCommand() {
    UpdateGovHydro2Command command =
        new UpdateGovHydro2Command(
