...
public class WindGenTurbineType1IECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindGenTurbineType1IEC : "
                          + successValue.getWindGenTurbineType1IECId());
                  if (successValue.getWindGenTurbineType1IECId().equals(windGenTurbineType1IECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindGenTurbineType1IECList - 1,
      ...
      subscriber
          .windGenTurbineType1IECSubscribe(windGenTurbineType1IECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindGenTurbineType1IEC : "
                          + successValue.getWindGenTurbineType1IECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windGenTurbineType1IEC for windGenTurbineType1IECId consumed"));
  ...
  protected WindGenTurbineType1IEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindGenTurbineType1IEC with primary key");
    msg.append(windGenTurbineType1IECId);

    WindGenTurbineType1IECFetchOneSummary fetchOneSummary =
        new WindGenTurbineType1IECFetchOneSummary(windGenTurbineType1IECId);

    try {
      entity =
          WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance()
              .getWindGenTurbineType1IEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindGenTurbineType1IECBusinessDelegate proxy =
          WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindGenTurbineType1IEC with id " + windGenTurbineType1IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindGenTurbineType1IEC with id " + windGenTurbineType1IECId);
    ...
    try {
      WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance()
          .delete(new DeleteWindGenTurbineType1IECCommand(entity.getWindGenTurbineType1IECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindGenTurbineType1IEC with id " + windGenTurbineType1IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindGenTurbineType1IEC with id " + windGenTurbineType1IECId);
  ...
  protected List<WindGenTurbineType1IEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance()
              .getAllWindGenTurbineType1IEC();
      assertNotNull(
          collection, "An Empty collection of WindGenTurbineType1IEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindGenTurbineType1IECId(), "-- entity in Collection has a null primary key");
