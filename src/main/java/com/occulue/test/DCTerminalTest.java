...
public class DCTerminalTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    DCTerminalBusinessDelegate.getDCTerminalInstance().createDCTerminal(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCTerminal : " + successValue.getDCTerminalId());
                  if (successValue.getDCTerminalId().equals(dCTerminalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCTerminalList - 1,
      ...
      subscriber
          .dCTerminalSubscribe(dCTerminalId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCTerminal : "
                          + successValue.getDCTerminalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCTerminalBusinessDelegate.getDCTerminalInstance()
          .delete(new DeleteDCTerminalCommand(entity.getDCTerminalId()))
          .get();
