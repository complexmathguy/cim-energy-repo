...
public class LoadGroupTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    LoadGroupBusinessDelegate.getLoadGroupInstance().createLoadGroup(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LoadGroup : " + successValue.getLoadGroupId());
                  if (successValue.getLoadGroupId().equals(loadGroupId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLoadGroupList - 1,
      ...
      subscriber
          .loadGroupSubscribe(loadGroupId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for LoadGroup : "
                          + successValue.getLoadGroupId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + loadGroupId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LoadGroupBusinessDelegate.getLoadGroupInstance()
          .delete(new DeleteLoadGroupCommand(entity.getLoadGroupId()))
          .get();
