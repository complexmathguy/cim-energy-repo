...
public class OverexcLimX2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OverexcLimX2 : "
                          + successValue.getOverexcLimX2Id());
                  if (successValue.getOverexcLimX2Id().equals(overexcLimX2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOverexcLimX2List - 1,
      ...
      subscriber
          .overexcLimX2Subscribe(overexcLimX2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OverexcLimX2 : "
                          + successValue.getOverexcLimX2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected OverexcLimX2 read() throws Throwable {
    ...
    try {
      entity =
          OverexcLimX2BusinessDelegate.getOverexcLimX2Instance().getOverexcLimX2(fetchOneSummary);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      OverexcLimX2BusinessDelegate.getOverexcLimX2Instance()
          .delete(new DeleteOverexcLimX2Command(entity.getOverexcLimX2Id()))
          .get();
  ...
  protected UpdateOverexcLimX2Command generateUpdateCommand() {
    UpdateOverexcLimX2Command command =
        new UpdateOverexcLimX2Command(
