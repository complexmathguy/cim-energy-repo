...
public class Pss5Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pss5Id = Pss5BusinessDelegate.getPss5Instance().createPss5(generateNewCommand()).get();
    ...
    Pss5BusinessDelegate.getPss5Instance().createPss5(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Pss5 : "
                          + successValue.getPss5Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pss5Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      Pss5BusinessDelegate.getPss5Instance()
          .delete(new DeletePss5Command(entity.getPss5Id()))
          .get();
  ...
  protected UpdatePss5Command generateUpdateCommand() {
    UpdatePss5Command command =
        new UpdatePss5Command(
