...
public class HydroGeneratingUnitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for HydroGeneratingUnit : "
                          + successValue.getHydroGeneratingUnitId());
                  if (successValue.getHydroGeneratingUnitId().equals(hydroGeneratingUnitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfHydroGeneratingUnitList - 1,
      ...
      subscriber
          .hydroGeneratingUnitSubscribe(hydroGeneratingUnitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for HydroGeneratingUnit : "
                          + successValue.getHydroGeneratingUnitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on hydroGeneratingUnit for hydroGeneratingUnitId consumed"));
  ...
  protected HydroGeneratingUnit read() throws Throwable {
    ...
    HydroGeneratingUnitFetchOneSummary fetchOneSummary =
        new HydroGeneratingUnitFetchOneSummary(hydroGeneratingUnitId);

    try {
      entity =
          HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance()
              .getHydroGeneratingUnit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      HydroGeneratingUnitBusinessDelegate proxy =
          HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance()
          .delete(new DeleteHydroGeneratingUnitCommand(entity.getHydroGeneratingUnitId()))
          .get();
  ...
  protected List<HydroGeneratingUnit> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          HydroGeneratingUnitBusinessDelegate.getHydroGeneratingUnitInstance()
              .getAllHydroGeneratingUnit();
      assertNotNull(
          collection, "An Empty collection of HydroGeneratingUnit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getHydroGeneratingUnitId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateHydroGeneratingUnitCommand generateNewCommand() {
    CreateHydroGeneratingUnitCommand command =
        new CreateHydroGeneratingUnitCommand(null, HydroEnergyConversionKind.values()[0]);
  ...
  protected UpdateHydroGeneratingUnitCommand generateUpdateCommand() {
    UpdateHydroGeneratingUnitCommand command =
        new UpdateHydroGeneratingUnitCommand(null, HydroEnergyConversionKind.values()[0]);
