...
public class ControlAreaGeneratingUnitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ControlAreaGeneratingUnit : "
                          + successValue.getControlAreaGeneratingUnitId());
                  if (successValue
                      .getControlAreaGeneratingUnitId()
                      .equals(controlAreaGeneratingUnitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfControlAreaGeneratingUnitList - 1,
      ...
      subscriber
          .controlAreaGeneratingUnitSubscribe(controlAreaGeneratingUnitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ControlAreaGeneratingUnit : "
                          + successValue.getControlAreaGeneratingUnitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on controlAreaGeneratingUnit for controlAreaGeneratingUnitId consumed"));
  ...
  protected ControlAreaGeneratingUnit read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ControlAreaGeneratingUnit with primary key");
    msg.append(controlAreaGeneratingUnitId);

    ControlAreaGeneratingUnitFetchOneSummary fetchOneSummary =
        new ControlAreaGeneratingUnitFetchOneSummary(controlAreaGeneratingUnitId);

    try {
      entity =
          ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance()
              .getControlAreaGeneratingUnit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ControlAreaGeneratingUnitBusinessDelegate proxy =
          ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ControlAreaGeneratingUnit with id " + controlAreaGeneratingUnitId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ControlAreaGeneratingUnit with id " + controlAreaGeneratingUnitId);
    ...
    try {
      ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance()
          .delete(
              new DeleteControlAreaGeneratingUnitCommand(entity.getControlAreaGeneratingUnitId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ControlAreaGeneratingUnit with id "
              + controlAreaGeneratingUnitId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ControlAreaGeneratingUnit with id " + controlAreaGeneratingUnitId);
  ...
  protected List<ControlAreaGeneratingUnit> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ControlAreaGeneratingUnitBusinessDelegate.getControlAreaGeneratingUnitInstance()
              .getAllControlAreaGeneratingUnit();
      assertNotNull(
          collection, "An Empty collection of ControlAreaGeneratingUnit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getControlAreaGeneratingUnitId(),
  ...
  protected CreateControlAreaGeneratingUnitCommand generateNewCommand() {
    CreateControlAreaGeneratingUnitCommand command =
        new CreateControlAreaGeneratingUnitCommand(null);
  ...
  protected UpdateControlAreaGeneratingUnitCommand generateUpdateCommand() {
    UpdateControlAreaGeneratingUnitCommand command =
        new UpdateControlAreaGeneratingUnitCommand(null);
