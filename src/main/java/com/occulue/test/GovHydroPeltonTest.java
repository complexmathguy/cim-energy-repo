...
public class GovHydroPeltonTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydroPelton : "
                          + successValue.getGovHydroPeltonId());
                  if (successValue.getGovHydroPeltonId().equals(govHydroPeltonId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydroPeltonList - 1,
      ...
      subscriber
          .govHydroPeltonSubscribe(govHydroPeltonId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydroPelton : "
                          + successValue.getGovHydroPeltonId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected GovHydroPelton read() throws Throwable {
    ...
    GovHydroPeltonFetchOneSummary fetchOneSummary =
        new GovHydroPeltonFetchOneSummary(govHydroPeltonId);

    try {
      entity =
          GovHydroPeltonBusinessDelegate.getGovHydroPeltonInstance()
              .getGovHydroPelton(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GovHydroPeltonBusinessDelegate proxy =
          GovHydroPeltonBusinessDelegate.getGovHydroPeltonInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydroPeltonBusinessDelegate.getGovHydroPeltonInstance()
          .delete(new DeleteGovHydroPeltonCommand(entity.getGovHydroPeltonId()))
          .get();
  ...
  protected List<GovHydroPelton> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          GovHydroPeltonBusinessDelegate.getGovHydroPeltonInstance().getAllGovHydroPelton();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGovHydroPeltonId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateGovHydroPeltonCommand generateUpdateCommand() {
    UpdateGovHydroPeltonCommand command =
        new UpdateGovHydroPeltonCommand(
