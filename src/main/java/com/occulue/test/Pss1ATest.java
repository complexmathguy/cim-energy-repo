...
public class Pss1ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pss1AId = Pss1ABusinessDelegate.getPss1AInstance().createPss1A(generateNewCommand()).get();
    ...
    Pss1ABusinessDelegate.getPss1AInstance().createPss1A(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Pss1A : "
                          + successValue.getPss1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pss1AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      Pss1ABusinessDelegate.getPss1AInstance()
          .delete(new DeletePss1ACommand(entity.getPss1AId()))
          .get();
  ...
  protected UpdatePss1ACommand generateUpdateCommand() {
    UpdatePss1ACommand command =
        new UpdatePss1ACommand(
            null,
            null,
            null,
            null,
