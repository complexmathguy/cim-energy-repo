...
public class ExcCZTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excCZId = ExcCZBusinessDelegate.getExcCZInstance().createExcCZ(generateNewCommand()).get();
    ...
    ExcCZBusinessDelegate.getExcCZInstance().createExcCZ(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcCZ : "
                          + successValue.getExcCZId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excCZId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcCZBusinessDelegate.getExcCZInstance()
          .delete(new DeleteExcCZCommand(entity.getExcCZId()))
          .get();
  ...
  protected UpdateExcCZCommand generateUpdateCommand() {
    UpdateExcCZCommand command =
        new UpdateExcCZCommand(null, null, null, null, null, null, null, null, null, null, null);
