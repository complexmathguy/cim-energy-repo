...
public class PhaseTapChangerLinearTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PhaseTapChangerLinear : "
                          + successValue.getPhaseTapChangerLinearId());
                  if (successValue.getPhaseTapChangerLinearId().equals(phaseTapChangerLinearId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPhaseTapChangerLinearList - 1,
      ...
      subscriber
          .phaseTapChangerLinearSubscribe(phaseTapChangerLinearId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PhaseTapChangerLinear : "
                          + successValue.getPhaseTapChangerLinearId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on phaseTapChangerLinear for phaseTapChangerLinearId consumed"));
  ...
  protected PhaseTapChangerLinear read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read PhaseTapChangerLinear with primary key");
    msg.append(phaseTapChangerLinearId);

    PhaseTapChangerLinearFetchOneSummary fetchOneSummary =
        new PhaseTapChangerLinearFetchOneSummary(phaseTapChangerLinearId);

    try {
      entity =
          PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance()
              .getPhaseTapChangerLinear(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PhaseTapChangerLinearBusinessDelegate proxy =
          PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance()
          .delete(new DeletePhaseTapChangerLinearCommand(entity.getPhaseTapChangerLinearId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted PhaseTapChangerLinear with id " + phaseTapChangerLinearId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete PhaseTapChangerLinear with id " + phaseTapChangerLinearId);
  ...
  protected List<PhaseTapChangerLinear> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PhaseTapChangerLinearBusinessDelegate.getPhaseTapChangerLinearInstance()
              .getAllPhaseTapChangerLinear();
      assertNotNull(
          collection, "An Empty collection of PhaseTapChangerLinear was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPhaseTapChangerLinearId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdatePhaseTapChangerLinearCommand generateUpdateCommand() {
    UpdatePhaseTapChangerLinearCommand command =
        new UpdatePhaseTapChangerLinearCommand(null, null, null, null);
