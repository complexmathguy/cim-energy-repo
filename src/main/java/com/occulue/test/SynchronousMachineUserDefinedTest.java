...
public class SynchronousMachineUserDefinedTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    synchronousMachineUserDefinedId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SynchronousMachineUserDefined : "
                          + successValue.getSynchronousMachineUserDefinedId());
                  if (successValue
                      .getSynchronousMachineUserDefinedId()
                      .equals(synchronousMachineUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSynchronousMachineUserDefinedList - 1,
      ...
      subscriber
          .synchronousMachineUserDefinedSubscribe(synchronousMachineUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SynchronousMachineUserDefined : "
                          + successValue.getSynchronousMachineUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on synchronousMachineUserDefined for synchronousMachineUserDefinedId consumed"));
  ...
  protected SynchronousMachineUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SynchronousMachineUserDefined with primary key");
    msg.append(synchronousMachineUserDefinedId);

    SynchronousMachineUserDefinedFetchOneSummary fetchOneSummary =
        new SynchronousMachineUserDefinedFetchOneSummary(synchronousMachineUserDefinedId);

    try {
      entity =
          SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance()
              .getSynchronousMachineUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SynchronousMachineUserDefinedBusinessDelegate proxy =
          SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SynchronousMachineUserDefined with id "
              + synchronousMachineUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SynchronousMachineUserDefined with id "
              + synchronousMachineUserDefinedId);
    ...
    try {
      SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance()
          .delete(
              new DeleteSynchronousMachineUserDefinedCommand(
                  entity.getSynchronousMachineUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SynchronousMachineUserDefined with id "
              + synchronousMachineUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SynchronousMachineUserDefined with id "
              + synchronousMachineUserDefinedId);
  ...
  protected List<SynchronousMachineUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SynchronousMachineUserDefinedBusinessDelegate.getSynchronousMachineUserDefinedInstance()
              .getAllSynchronousMachineUserDefined();
      assertNotNull(
          collection,
          "An Empty collection of SynchronousMachineUserDefined was incorrectly returned.");
  ...
  protected CreateSynchronousMachineUserDefinedCommand generateNewCommand() {
    CreateSynchronousMachineUserDefinedCommand command =
        new CreateSynchronousMachineUserDefinedCommand(null);
  ...
  protected UpdateSynchronousMachineUserDefinedCommand generateUpdateCommand() {
    UpdateSynchronousMachineUserDefinedCommand command =
        new UpdateSynchronousMachineUserDefinedCommand(null, null);
