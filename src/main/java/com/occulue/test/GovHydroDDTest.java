...
public class GovHydroDDTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovHydroDDBusinessDelegate.getGovHydroDDInstance().createGovHydroDD(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydroDD : " + successValue.getGovHydroDDId());
                  if (successValue.getGovHydroDDId().equals(govHydroDDId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydroDDList - 1,
      ...
      subscriber
          .govHydroDDSubscribe(govHydroDDId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydroDD : "
                          + successValue.getGovHydroDDId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydroDDBusinessDelegate.getGovHydroDDInstance()
          .delete(new DeleteGovHydroDDCommand(entity.getGovHydroDDId()))
          .get();
  ...
  protected UpdateGovHydroDDCommand generateUpdateCommand() {
    UpdateGovHydroDDCommand command =
        new UpdateGovHydroDDCommand(
