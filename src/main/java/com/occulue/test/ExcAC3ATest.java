...
public class ExcAC3ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAC3AId =
        ExcAC3ABusinessDelegate.getExcAC3AInstance().createExcAC3A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAC3A : " + successValue.getExcAC3AId());
                  if (successValue.getExcAC3AId().equals(excAC3AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAC3AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAC3A : "
                          + successValue.getExcAC3AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAC3AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAC3ABusinessDelegate.getExcAC3AInstance()
          .delete(new DeleteExcAC3ACommand(entity.getExcAC3AId()))
          .get();
  ...
  protected UpdateExcAC3ACommand generateUpdateCommand() {
    UpdateExcAC3ACommand command =
        new UpdateExcAC3ACommand(
