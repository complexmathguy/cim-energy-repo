...
public class UnderexcitationLimiterUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for UnderexcitationLimiterUserDefined : "
                          + successValue.getUnderexcitationLimiterUserDefinedId());
                  if (successValue
                      .getUnderexcitationLimiterUserDefinedId()
                      .equals(underexcitationLimiterUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfUnderexcitationLimiterUserDefinedList - 1,
                          "value not deleted from list");
                      LOGGER.info("**********************************************************");
                      LOGGER.info(
                          "UnderexcitationLimiterUserDefined test completed successfully...");
                      LOGGER.info("**********************************************************\n");
                    }
                  }
                } catch (Throwable exc) {
      ...
      subscriber
          .underexcitationLimiterUserDefinedSubscribe(underexcitationLimiterUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for UnderexcitationLimiterUserDefined : "
                          + successValue.getUnderexcitationLimiterUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on underexcitationLimiterUserDefined for underexcitationLimiterUserDefinedId consumed"));
  ...
  protected UnderexcitationLimiterUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read UnderexcitationLimiterUserDefined with primary key");
    msg.append(underexcitationLimiterUserDefinedId);

    UnderexcitationLimiterUserDefinedFetchOneSummary fetchOneSummary =
        new UnderexcitationLimiterUserDefinedFetchOneSummary(underexcitationLimiterUserDefinedId);

    try {
      entity =
          UnderexcitationLimiterUserDefinedBusinessDelegate
              .getUnderexcitationLimiterUserDefinedInstance()
              .getUnderexcitationLimiterUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("Failed to update a UnderexcitationLimiterUserDefined : ");
    ...
    try {
      ...
      UnderexcitationLimiterUserDefinedBusinessDelegate proxy =
          UnderexcitationLimiterUserDefinedBusinessDelegate
              .getUnderexcitationLimiterUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read UnderexcitationLimiterUserDefined with id "
              + underexcitationLimiterUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read UnderexcitationLimiterUserDefined with id "
              + underexcitationLimiterUserDefinedId);
    ...
    try {
      UnderexcitationLimiterUserDefinedBusinessDelegate
          .getUnderexcitationLimiterUserDefinedInstance()
          .delete(
              new DeleteUnderexcitationLimiterUserDefinedCommand(
                  entity.getUnderexcitationLimiterUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted UnderexcitationLimiterUserDefined with id "
              + underexcitationLimiterUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete UnderexcitationLimiterUserDefined with id "
              + underexcitationLimiterUserDefinedId);
  ...
  protected List<UnderexcitationLimiterUserDefined> getAll() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to get all UnderexcitationLimiterUserDefined : ");
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of UnderexcitationLimiterUserDefined was incorrectly returned.");
  ...
  protected CreateUnderexcitationLimiterUserDefinedCommand generateNewCommand() {
    CreateUnderexcitationLimiterUserDefinedCommand command =
        new CreateUnderexcitationLimiterUserDefinedCommand(null);
  ...
  protected UpdateUnderexcitationLimiterUserDefinedCommand generateUpdateCommand() {
    UpdateUnderexcitationLimiterUserDefinedCommand command =
        new UpdateUnderexcitationLimiterUserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(UnderexcitationLimiterUserDefinedTest.class.getName());
