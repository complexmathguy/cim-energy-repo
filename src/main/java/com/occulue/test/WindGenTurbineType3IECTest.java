...
public class WindGenTurbineType3IECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindGenTurbineType3IEC : "
                          + successValue.getWindGenTurbineType3IECId());
                  if (successValue.getWindGenTurbineType3IECId().equals(windGenTurbineType3IECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindGenTurbineType3IECList - 1,
      ...
      subscriber
          .windGenTurbineType3IECSubscribe(windGenTurbineType3IECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindGenTurbineType3IEC : "
                          + successValue.getWindGenTurbineType3IECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windGenTurbineType3IEC for windGenTurbineType3IECId consumed"));
  ...
  protected WindGenTurbineType3IEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindGenTurbineType3IEC with primary key");
    msg.append(windGenTurbineType3IECId);

    WindGenTurbineType3IECFetchOneSummary fetchOneSummary =
        new WindGenTurbineType3IECFetchOneSummary(windGenTurbineType3IECId);

    try {
      entity =
          WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance()
              .getWindGenTurbineType3IEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindGenTurbineType3IECBusinessDelegate proxy =
          WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindGenTurbineType3IEC with id " + windGenTurbineType3IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindGenTurbineType3IEC with id " + windGenTurbineType3IECId);
    ...
    try {
      WindGenTurbineType3IECBusinessDelegate.getWindGenTurbineType3IECInstance()
          .delete(new DeleteWindGenTurbineType3IECCommand(entity.getWindGenTurbineType3IECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindGenTurbineType3IEC with id " + windGenTurbineType3IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindGenTurbineType3IEC with id " + windGenTurbineType3IECId);
  ...
  protected List<WindGenTurbineType3IEC> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of WindGenTurbineType3IEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindGenTurbineType3IECId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateWindGenTurbineType3IECCommand generateUpdateCommand() {
    UpdateWindGenTurbineType3IECCommand command =
        new UpdateWindGenTurbineType3IECCommand(null, null, null);
