...
public class EnergySchedulingTypeTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EnergySchedulingType : "
                          + successValue.getEnergySchedulingTypeId());
                  if (successValue.getEnergySchedulingTypeId().equals(energySchedulingTypeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEnergySchedulingTypeList - 1,
      ...
      subscriber
          .energySchedulingTypeSubscribe(energySchedulingTypeId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EnergySchedulingType : "
                          + successValue.getEnergySchedulingTypeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on energySchedulingType for energySchedulingTypeId consumed"));
  ...
  protected EnergySchedulingType read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read EnergySchedulingType with primary key");
    msg.append(energySchedulingTypeId);

    EnergySchedulingTypeFetchOneSummary fetchOneSummary =
        new EnergySchedulingTypeFetchOneSummary(energySchedulingTypeId);

    try {
      entity =
          EnergySchedulingTypeBusinessDelegate.getEnergySchedulingTypeInstance()
              .getEnergySchedulingType(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EnergySchedulingTypeBusinessDelegate proxy =
          EnergySchedulingTypeBusinessDelegate.getEnergySchedulingTypeInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EnergySchedulingTypeBusinessDelegate.getEnergySchedulingTypeInstance()
          .delete(new DeleteEnergySchedulingTypeCommand(entity.getEnergySchedulingTypeId()))
          .get();
  ...
  protected List<EnergySchedulingType> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          EnergySchedulingTypeBusinessDelegate.getEnergySchedulingTypeInstance()
              .getAllEnergySchedulingType();
      assertNotNull(
          collection, "An Empty collection of EnergySchedulingType was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEnergySchedulingTypeId(), "-- entity in Collection has a null primary key");
