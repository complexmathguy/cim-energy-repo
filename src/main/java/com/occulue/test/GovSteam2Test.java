...
public class GovSteam2Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovSteam2BusinessDelegate.getGovSteam2Instance().createGovSteam2(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteam2 : " + successValue.getGovSteam2Id());
                  if (successValue.getGovSteam2Id().equals(govSteam2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteam2List - 1,
      ...
      subscriber
          .govSteam2Subscribe(govSteam2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteam2 : "
                          + successValue.getGovSteam2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govSteam2Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteam2BusinessDelegate.getGovSteam2Instance()
          .delete(new DeleteGovSteam2Command(entity.getGovSteam2Id()))
          .get();
  ...
  protected UpdateGovSteam2Command generateUpdateCommand() {
    UpdateGovSteam2Command command =
        new UpdateGovSteam2Command(null, null, null, null, null, null, null, null, null);
