...
public class MechanicalLoadUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for MechanicalLoadUserDefined : "
                          + successValue.getMechanicalLoadUserDefinedId());
                  if (successValue
                      .getMechanicalLoadUserDefinedId()
                      .equals(mechanicalLoadUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfMechanicalLoadUserDefinedList - 1,
      ...
      subscriber
          .mechanicalLoadUserDefinedSubscribe(mechanicalLoadUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for MechanicalLoadUserDefined : "
                          + successValue.getMechanicalLoadUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on mechanicalLoadUserDefined for mechanicalLoadUserDefinedId consumed"));
  ...
  protected MechanicalLoadUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read MechanicalLoadUserDefined with primary key");
    msg.append(mechanicalLoadUserDefinedId);

    MechanicalLoadUserDefinedFetchOneSummary fetchOneSummary =
        new MechanicalLoadUserDefinedFetchOneSummary(mechanicalLoadUserDefinedId);

    try {
      entity =
          MechanicalLoadUserDefinedBusinessDelegate.getMechanicalLoadUserDefinedInstance()
              .getMechanicalLoadUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      MechanicalLoadUserDefinedBusinessDelegate proxy =
          MechanicalLoadUserDefinedBusinessDelegate.getMechanicalLoadUserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read MechanicalLoadUserDefined with id " + mechanicalLoadUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read MechanicalLoadUserDefined with id " + mechanicalLoadUserDefinedId);
    ...
    try {
      MechanicalLoadUserDefinedBusinessDelegate.getMechanicalLoadUserDefinedInstance()
          .delete(
              new DeleteMechanicalLoadUserDefinedCommand(entity.getMechanicalLoadUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted MechanicalLoadUserDefined with id "
              + mechanicalLoadUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete MechanicalLoadUserDefined with id " + mechanicalLoadUserDefinedId);
  ...
  protected List<MechanicalLoadUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of MechanicalLoadUserDefined was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getMechanicalLoadUserDefinedId(),
  ...
  protected CreateMechanicalLoadUserDefinedCommand generateNewCommand() {
    CreateMechanicalLoadUserDefinedCommand command =
        new CreateMechanicalLoadUserDefinedCommand(null);
  ...
  protected UpdateMechanicalLoadUserDefinedCommand generateUpdateCommand() {
    UpdateMechanicalLoadUserDefinedCommand command =
        new UpdateMechanicalLoadUserDefinedCommand(null, null);
