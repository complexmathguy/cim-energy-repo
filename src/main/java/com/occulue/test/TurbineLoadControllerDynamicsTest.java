...
public class TurbineLoadControllerDynamicsTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    turbineLoadControllerDynamicsId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TurbineLoadControllerDynamics : "
                          + successValue.getTurbineLoadControllerDynamicsId());
                  if (successValue
                      .getTurbineLoadControllerDynamicsId()
                      .equals(turbineLoadControllerDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTurbineLoadControllerDynamicsList - 1,
      ...
      subscriber
          .turbineLoadControllerDynamicsSubscribe(turbineLoadControllerDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TurbineLoadControllerDynamics : "
                          + successValue.getTurbineLoadControllerDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on turbineLoadControllerDynamics for turbineLoadControllerDynamicsId consumed"));
  ...
  protected TurbineLoadControllerDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read TurbineLoadControllerDynamics with primary key");
    msg.append(turbineLoadControllerDynamicsId);

    TurbineLoadControllerDynamicsFetchOneSummary fetchOneSummary =
        new TurbineLoadControllerDynamicsFetchOneSummary(turbineLoadControllerDynamicsId);

    try {
      entity =
          TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance()
              .getTurbineLoadControllerDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TurbineLoadControllerDynamicsBusinessDelegate proxy =
          TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read TurbineLoadControllerDynamics with id "
              + turbineLoadControllerDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read TurbineLoadControllerDynamics with id "
              + turbineLoadControllerDynamicsId);
    ...
    try {
      TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance()
          .delete(
              new DeleteTurbineLoadControllerDynamicsCommand(
                  entity.getTurbineLoadControllerDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted TurbineLoadControllerDynamics with id "
              + turbineLoadControllerDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete TurbineLoadControllerDynamics with id "
              + turbineLoadControllerDynamicsId);
  ...
  protected List<TurbineLoadControllerDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          TurbineLoadControllerDynamicsBusinessDelegate.getTurbineLoadControllerDynamicsInstance()
              .getAllTurbineLoadControllerDynamics();
      assertNotNull(
          collection,
          "An Empty collection of TurbineLoadControllerDynamics was incorrectly returned.");
  ...
  protected CreateTurbineLoadControllerDynamicsCommand generateNewCommand() {
    CreateTurbineLoadControllerDynamicsCommand command =
        new CreateTurbineLoadControllerDynamicsCommand(null);
  ...
  protected UpdateTurbineLoadControllerDynamicsCommand generateUpdateCommand() {
    UpdateTurbineLoadControllerDynamicsCommand command =
        new UpdateTurbineLoadControllerDynamicsCommand(null);
