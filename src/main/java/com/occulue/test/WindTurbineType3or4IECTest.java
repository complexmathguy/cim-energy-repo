...
public class WindTurbineType3or4IECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindTurbineType3or4IEC : "
                          + successValue.getWindTurbineType3or4IECId());
                  if (successValue.getWindTurbineType3or4IECId().equals(windTurbineType3or4IECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindTurbineType3or4IECList - 1,
      ...
      subscriber
          .windTurbineType3or4IECSubscribe(windTurbineType3or4IECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindTurbineType3or4IEC : "
                          + successValue.getWindTurbineType3or4IECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windTurbineType3or4IEC for windTurbineType3or4IECId consumed"));
  ...
  protected WindTurbineType3or4IEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindTurbineType3or4IEC with primary key");
    msg.append(windTurbineType3or4IECId);

    WindTurbineType3or4IECFetchOneSummary fetchOneSummary =
        new WindTurbineType3or4IECFetchOneSummary(windTurbineType3or4IECId);

    try {
      entity =
          WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance()
              .getWindTurbineType3or4IEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindTurbineType3or4IECBusinessDelegate proxy =
          WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindTurbineType3or4IEC with id " + windTurbineType3or4IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindTurbineType3or4IEC with id " + windTurbineType3or4IECId);
    ...
    try {
      WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance()
          .delete(new DeleteWindTurbineType3or4IECCommand(entity.getWindTurbineType3or4IECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindTurbineType3or4IEC with id " + windTurbineType3or4IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindTurbineType3or4IEC with id " + windTurbineType3or4IECId);
  ...
  protected List<WindTurbineType3or4IEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindTurbineType3or4IECBusinessDelegate.getWindTurbineType3or4IECInstance()
              .getAllWindTurbineType3or4IEC();
      assertNotNull(
          collection, "An Empty collection of WindTurbineType3or4IEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindTurbineType3or4IECId(), "-- entity in Collection has a null primary key");
