...
public class DynamicsmodelTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Dynamicsmodel : "
                          + successValue.getDynamicsmodelId());
                  if (successValue.getDynamicsmodelId().equals(dynamicsmodelId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDynamicsmodelList - 1,
      ...
      subscriber
          .dynamicsmodelSubscribe(dynamicsmodelId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for Dynamicsmodel : "
                          + successValue.getDynamicsmodelId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected Dynamicsmodel read() throws Throwable {
    ...
    DynamicsmodelFetchOneSummary fetchOneSummary =
        new DynamicsmodelFetchOneSummary(dynamicsmodelId);

    try {
      entity =
          DynamicsmodelBusinessDelegate.getDynamicsmodelInstance()
              .getDynamicsmodel(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DynamicsmodelBusinessDelegate proxy =
          DynamicsmodelBusinessDelegate.getDynamicsmodelInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DynamicsmodelBusinessDelegate.getDynamicsmodelInstance()
          .delete(new DeleteDynamicsmodelCommand(entity.getDynamicsmodelId()))
          .get();
  ...
  protected List<Dynamicsmodel> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDynamicsmodelId(), "-- entity in Collection has a null primary key");
