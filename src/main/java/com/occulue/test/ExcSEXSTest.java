...
public class ExcSEXSTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excSEXSId =
        ExcSEXSBusinessDelegate.getExcSEXSInstance().createExcSEXS(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcSEXS : " + successValue.getExcSEXSId());
                  if (successValue.getExcSEXSId().equals(excSEXSId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcSEXSList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcSEXS : "
                          + successValue.getExcSEXSId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excSEXSId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcSEXSBusinessDelegate.getExcSEXSInstance()
          .delete(new DeleteExcSEXSCommand(entity.getExcSEXSId()))
          .get();
  ...
  protected UpdateExcSEXSCommand generateUpdateCommand() {
    UpdateExcSEXSCommand command =
        new UpdateExcSEXSCommand(null, null, null, null, null, null, null, null, null, null, null);
