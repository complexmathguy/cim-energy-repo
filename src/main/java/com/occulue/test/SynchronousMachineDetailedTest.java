...
public class SynchronousMachineDetailedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SynchronousMachineDetailed : "
                          + successValue.getSynchronousMachineDetailedId());
                  if (successValue
                      .getSynchronousMachineDetailedId()
                      .equals(synchronousMachineDetailedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSynchronousMachineDetailedList - 1,
      ...
      subscriber
          .synchronousMachineDetailedSubscribe(synchronousMachineDetailedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SynchronousMachineDetailed : "
                          + successValue.getSynchronousMachineDetailedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on synchronousMachineDetailed for synchronousMachineDetailedId consumed"));
  ...
  protected SynchronousMachineDetailed read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SynchronousMachineDetailed with primary key");
    msg.append(synchronousMachineDetailedId);

    SynchronousMachineDetailedFetchOneSummary fetchOneSummary =
        new SynchronousMachineDetailedFetchOneSummary(synchronousMachineDetailedId);

    try {
      entity =
          SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance()
              .getSynchronousMachineDetailed(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SynchronousMachineDetailedBusinessDelegate proxy =
          SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SynchronousMachineDetailed with id "
              + synchronousMachineDetailedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SynchronousMachineDetailed with id " + synchronousMachineDetailedId);
    ...
    try {
      SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance()
          .delete(
              new DeleteSynchronousMachineDetailedCommand(entity.getSynchronousMachineDetailedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SynchronousMachineDetailed with id "
              + synchronousMachineDetailedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SynchronousMachineDetailed with id " + synchronousMachineDetailedId);
  ...
  protected List<SynchronousMachineDetailed> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SynchronousMachineDetailedBusinessDelegate.getSynchronousMachineDetailedInstance()
              .getAllSynchronousMachineDetailed();
      assertNotNull(
          collection,
          "An Empty collection of SynchronousMachineDetailed was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSynchronousMachineDetailedId(),
  ...
  protected CreateSynchronousMachineDetailedCommand generateNewCommand() {
    CreateSynchronousMachineDetailedCommand command =
        new CreateSynchronousMachineDetailedCommand(null, IfdBaseKind.values()[0]);
  ...
  protected UpdateSynchronousMachineDetailedCommand generateUpdateCommand() {
    UpdateSynchronousMachineDetailedCommand command =
        new UpdateSynchronousMachineDetailedCommand(
            null, null, IfdBaseKind.values()[0], null, null, null);
