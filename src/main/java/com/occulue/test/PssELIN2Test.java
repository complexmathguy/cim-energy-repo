...
public class PssELIN2Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pssELIN2Id =
        PssELIN2BusinessDelegate.getPssELIN2Instance().createPssELIN2(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PssELIN2 : " + successValue.getPssELIN2Id());
                  if (successValue.getPssELIN2Id().equals(pssELIN2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPssELIN2List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for PssELIN2 : "
                          + successValue.getPssELIN2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssELIN2Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssELIN2BusinessDelegate.getPssELIN2Instance()
          .delete(new DeletePssELIN2Command(entity.getPssELIN2Id()))
          .get();
  ...
  protected UpdatePssELIN2Command generateUpdateCommand() {
    UpdatePssELIN2Command command =
        new UpdatePssELIN2Command(
