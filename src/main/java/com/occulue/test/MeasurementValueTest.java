...
public class MeasurementValueTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for MeasurementValue : "
                          + successValue.getMeasurementValueId());
                  if (successValue.getMeasurementValueId().equals(measurementValueId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfMeasurementValueList - 1,
      ...
      subscriber
          .measurementValueSubscribe(measurementValueId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for MeasurementValue : "
                          + successValue.getMeasurementValueId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected MeasurementValue read() throws Throwable {
    ...
    MeasurementValueFetchOneSummary fetchOneSummary =
        new MeasurementValueFetchOneSummary(measurementValueId);

    try {
      entity =
          MeasurementValueBusinessDelegate.getMeasurementValueInstance()
              .getMeasurementValue(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      MeasurementValueBusinessDelegate proxy =
          MeasurementValueBusinessDelegate.getMeasurementValueInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      MeasurementValueBusinessDelegate.getMeasurementValueInstance()
          .delete(new DeleteMeasurementValueCommand(entity.getMeasurementValueId()))
          .get();
  ...
  protected List<MeasurementValue> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of MeasurementValue was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getMeasurementValueId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateMeasurementValueCommand generateUpdateCommand() {
    UpdateMeasurementValueCommand command = new UpdateMeasurementValueCommand(null, null, null);
