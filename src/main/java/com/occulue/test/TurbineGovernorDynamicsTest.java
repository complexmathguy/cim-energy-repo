...
public class TurbineGovernorDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for TurbineGovernorDynamics : "
                          + successValue.getTurbineGovernorDynamicsId());
                  if (successValue
                      .getTurbineGovernorDynamicsId()
                      .equals(turbineGovernorDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTurbineGovernorDynamicsList - 1,
      ...
      subscriber
          .turbineGovernorDynamicsSubscribe(turbineGovernorDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for TurbineGovernorDynamics : "
                          + successValue.getTurbineGovernorDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on turbineGovernorDynamics for turbineGovernorDynamicsId consumed"));
  ...
  protected TurbineGovernorDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read TurbineGovernorDynamics with primary key");
    msg.append(turbineGovernorDynamicsId);

    TurbineGovernorDynamicsFetchOneSummary fetchOneSummary =
        new TurbineGovernorDynamicsFetchOneSummary(turbineGovernorDynamicsId);

    try {
      entity =
          TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance()
              .getTurbineGovernorDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      TurbineGovernorDynamicsBusinessDelegate proxy =
          TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read TurbineGovernorDynamics with id " + turbineGovernorDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read TurbineGovernorDynamics with id " + turbineGovernorDynamicsId);
    ...
    try {
      TurbineGovernorDynamicsBusinessDelegate.getTurbineGovernorDynamicsInstance()
          .delete(new DeleteTurbineGovernorDynamicsCommand(entity.getTurbineGovernorDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted TurbineGovernorDynamics with id " + turbineGovernorDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete TurbineGovernorDynamics with id " + turbineGovernorDynamicsId);
  ...
  protected List<TurbineGovernorDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of TurbineGovernorDynamics was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getTurbineGovernorDynamicsId(),
