...
public class AnalogLimitSetTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AnalogLimitSet : "
                          + successValue.getAnalogLimitSetId());
                  if (successValue.getAnalogLimitSetId().equals(analogLimitSetId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAnalogLimitSetList - 1,
      ...
      subscriber
          .analogLimitSetSubscribe(analogLimitSetId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AnalogLimitSet : "
                          + successValue.getAnalogLimitSetId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected AnalogLimitSet read() throws Throwable {
    ...
    AnalogLimitSetFetchOneSummary fetchOneSummary =
        new AnalogLimitSetFetchOneSummary(analogLimitSetId);

    try {
      entity =
          AnalogLimitSetBusinessDelegate.getAnalogLimitSetInstance()
              .getAnalogLimitSet(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      AnalogLimitSetBusinessDelegate proxy =
          AnalogLimitSetBusinessDelegate.getAnalogLimitSetInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      AnalogLimitSetBusinessDelegate.getAnalogLimitSetInstance()
          .delete(new DeleteAnalogLimitSetCommand(entity.getAnalogLimitSetId()))
          .get();
  ...
  protected List<AnalogLimitSet> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          AnalogLimitSetBusinessDelegate.getAnalogLimitSetInstance().getAllAnalogLimitSet();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getAnalogLimitSetId(), "-- entity in Collection has a null primary key");
