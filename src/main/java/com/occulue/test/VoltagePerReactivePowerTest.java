...
public class VoltagePerReactivePowerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          .voltagePerReactivePowerSubscribe()
          .updates()
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VoltagePerReactivePower : "
                          + successValue.getVoltagePerReactivePowerId());
                  if (successValue
                      .getVoltagePerReactivePowerId()
                      .equals(voltagePerReactivePowerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVoltagePerReactivePowerList - 1,
      ...
      subscriber
          .voltagePerReactivePowerSubscribe(voltagePerReactivePowerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VoltagePerReactivePower : "
                          + successValue.getVoltagePerReactivePowerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on voltagePerReactivePower for voltagePerReactivePowerId consumed"));
  ...
  protected VoltagePerReactivePower read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read VoltagePerReactivePower with primary key");
    msg.append(voltagePerReactivePowerId);

    VoltagePerReactivePowerFetchOneSummary fetchOneSummary =
        new VoltagePerReactivePowerFetchOneSummary(voltagePerReactivePowerId);

    try {
      entity =
          VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance()
              .getVoltagePerReactivePower(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VoltagePerReactivePowerBusinessDelegate proxy =
          VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read VoltagePerReactivePower with id " + voltagePerReactivePowerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read VoltagePerReactivePower with id " + voltagePerReactivePowerId);
    ...
    try {
      VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance()
          .delete(new DeleteVoltagePerReactivePowerCommand(entity.getVoltagePerReactivePowerId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted VoltagePerReactivePower with id " + voltagePerReactivePowerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete VoltagePerReactivePower with id " + voltagePerReactivePowerId);
  ...
  protected List<VoltagePerReactivePower> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          VoltagePerReactivePowerBusinessDelegate.getVoltagePerReactivePowerInstance()
              .getAllVoltagePerReactivePower();
      assertNotNull(
          collection, "An Empty collection of VoltagePerReactivePower was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVoltagePerReactivePowerId(),
  ...
  protected CreateVoltagePerReactivePowerCommand generateNewCommand() {
    CreateVoltagePerReactivePowerCommand command =
        new CreateVoltagePerReactivePowerCommand(
            null,
            UnitMultiplier.values()[0],
            UnitSymbol.values()[0],
            UnitMultiplier.values()[0],
            UnitSymbol.values()[0]);
  ...
  protected UpdateVoltagePerReactivePowerCommand generateUpdateCommand() {
    UpdateVoltagePerReactivePowerCommand command =
        new UpdateVoltagePerReactivePowerCommand(
            null,
            UnitMultiplier.values()[0],
            UnitSymbol.values()[0],
            UnitMultiplier.values()[0],
