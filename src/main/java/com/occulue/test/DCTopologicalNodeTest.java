...
public class DCTopologicalNodeTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCTopologicalNode : "
                          + successValue.getDCTopologicalNodeId());
                  if (successValue.getDCTopologicalNodeId().equals(dCTopologicalNodeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCTopologicalNodeList - 1,
      ...
      subscriber
          .dCTopologicalNodeSubscribe(dCTopologicalNodeId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCTopologicalNode : "
                          + successValue.getDCTopologicalNodeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on dCTopologicalNode for dCTopologicalNodeId consumed"));
  ...
  protected DCTopologicalNode read() throws Throwable {
    ...
    DCTopologicalNodeFetchOneSummary fetchOneSummary =
        new DCTopologicalNodeFetchOneSummary(dCTopologicalNodeId);

    try {
      entity =
          DCTopologicalNodeBusinessDelegate.getDCTopologicalNodeInstance()
              .getDCTopologicalNode(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DCTopologicalNodeBusinessDelegate proxy =
          DCTopologicalNodeBusinessDelegate.getDCTopologicalNodeInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCTopologicalNodeBusinessDelegate.getDCTopologicalNodeInstance()
          .delete(new DeleteDCTopologicalNodeCommand(entity.getDCTopologicalNodeId()))
          .get();
  ...
  protected List<DCTopologicalNode> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of DCTopologicalNode was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDCTopologicalNodeId(), "-- entity in Collection has a null primary key");
