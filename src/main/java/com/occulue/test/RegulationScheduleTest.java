...
public class RegulationScheduleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RegulationSchedule : "
                          + successValue.getRegulationScheduleId());
                  if (successValue.getRegulationScheduleId().equals(regulationScheduleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRegulationScheduleList - 1,
      ...
      subscriber
          .regulationScheduleSubscribe(regulationScheduleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RegulationSchedule : "
                          + successValue.getRegulationScheduleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on regulationSchedule for regulationScheduleId consumed"));
  ...
  protected RegulationSchedule read() throws Throwable {
    ...
    RegulationScheduleFetchOneSummary fetchOneSummary =
        new RegulationScheduleFetchOneSummary(regulationScheduleId);

    try {
      entity =
          RegulationScheduleBusinessDelegate.getRegulationScheduleInstance()
              .getRegulationSchedule(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RegulationScheduleBusinessDelegate proxy =
          RegulationScheduleBusinessDelegate.getRegulationScheduleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      RegulationScheduleBusinessDelegate.getRegulationScheduleInstance()
          .delete(new DeleteRegulationScheduleCommand(entity.getRegulationScheduleId()))
          .get();
  ...
  protected List<RegulationSchedule> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          RegulationScheduleBusinessDelegate.getRegulationScheduleInstance()
              .getAllRegulationSchedule();
      assertNotNull(
          collection, "An Empty collection of RegulationSchedule was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRegulationScheduleId(), "-- entity in Collection has a null primary key");
