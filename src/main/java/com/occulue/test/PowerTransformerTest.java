...
public class PowerTransformerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PowerTransformer : "
                          + successValue.getPowerTransformerId());
                  if (successValue.getPowerTransformerId().equals(powerTransformerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPowerTransformerList - 1,
      ...
      subscriber
          .powerTransformerSubscribe(powerTransformerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PowerTransformer : "
                          + successValue.getPowerTransformerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected PowerTransformer read() throws Throwable {
    ...
    PowerTransformerFetchOneSummary fetchOneSummary =
        new PowerTransformerFetchOneSummary(powerTransformerId);

    try {
      entity =
          PowerTransformerBusinessDelegate.getPowerTransformerInstance()
              .getPowerTransformer(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      PowerTransformerBusinessDelegate proxy =
          PowerTransformerBusinessDelegate.getPowerTransformerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PowerTransformerBusinessDelegate.getPowerTransformerInstance()
          .delete(new DeletePowerTransformerCommand(entity.getPowerTransformerId()))
          .get();
  ...
  protected List<PowerTransformer> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          PowerTransformerBusinessDelegate.getPowerTransformerInstance().getAllPowerTransformer();
      assertNotNull(
          collection, "An Empty collection of PowerTransformer was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getPowerTransformerId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdatePowerTransformerCommand generateUpdateCommand() {
    UpdatePowerTransformerCommand command =
        new UpdatePowerTransformerCommand(null, null, null, null, null, null, null);
