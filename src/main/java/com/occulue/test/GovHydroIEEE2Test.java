...
public class GovHydroIEEE2Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydroIEEE2 : "
                          + successValue.getGovHydroIEEE2Id());
                  if (successValue.getGovHydroIEEE2Id().equals(govHydroIEEE2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydroIEEE2List - 1,
      ...
      subscriber
          .govHydroIEEE2Subscribe(govHydroIEEE2Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydroIEEE2 : "
                          + successValue.getGovHydroIEEE2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected GovHydroIEEE2 read() throws Throwable {
    ...
    GovHydroIEEE2FetchOneSummary fetchOneSummary =
        new GovHydroIEEE2FetchOneSummary(govHydroIEEE2Id);

    try {
      entity =
          GovHydroIEEE2BusinessDelegate.getGovHydroIEEE2Instance()
              .getGovHydroIEEE2(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GovHydroIEEE2BusinessDelegate proxy =
          GovHydroIEEE2BusinessDelegate.getGovHydroIEEE2Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydroIEEE2BusinessDelegate.getGovHydroIEEE2Instance()
          .delete(new DeleteGovHydroIEEE2Command(entity.getGovHydroIEEE2Id()))
          .get();
  ...
  protected List<GovHydroIEEE2> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGovHydroIEEE2Id(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateGovHydroIEEE2Command generateUpdateCommand() {
    UpdateGovHydroIEEE2Command command =
        new UpdateGovHydroIEEE2Command(
