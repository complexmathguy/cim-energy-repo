...
public class EquipmentBoundaryVersionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EquipmentBoundaryVersion : "
                          + successValue.getEquipmentBoundaryVersionId());
                  if (successValue
                      .getEquipmentBoundaryVersionId()
                      .equals(equipmentBoundaryVersionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEquipmentBoundaryVersionList - 1,
      ...
      subscriber
          .equipmentBoundaryVersionSubscribe(equipmentBoundaryVersionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EquipmentBoundaryVersion : "
                          + successValue.getEquipmentBoundaryVersionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on equipmentBoundaryVersion for equipmentBoundaryVersionId consumed"));
  ...
  protected EquipmentBoundaryVersion read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read EquipmentBoundaryVersion with primary key");
    msg.append(equipmentBoundaryVersionId);

    EquipmentBoundaryVersionFetchOneSummary fetchOneSummary =
        new EquipmentBoundaryVersionFetchOneSummary(equipmentBoundaryVersionId);

    try {
      entity =
          EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance()
              .getEquipmentBoundaryVersion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EquipmentBoundaryVersionBusinessDelegate proxy =
          EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read EquipmentBoundaryVersion with id " + equipmentBoundaryVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read EquipmentBoundaryVersion with id " + equipmentBoundaryVersionId);
    ...
    try {
      EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance()
          .delete(new DeleteEquipmentBoundaryVersionCommand(entity.getEquipmentBoundaryVersionId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted EquipmentBoundaryVersion with id " + equipmentBoundaryVersionId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete EquipmentBoundaryVersion with id " + equipmentBoundaryVersionId);
  ...
  protected List<EquipmentBoundaryVersion> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          EquipmentBoundaryVersionBusinessDelegate.getEquipmentBoundaryVersionInstance()
              .getAllEquipmentBoundaryVersion();
      assertNotNull(
          collection, "An Empty collection of EquipmentBoundaryVersion was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEquipmentBoundaryVersionId(),
  ...
  protected UpdateEquipmentBoundaryVersionCommand generateUpdateCommand() {
    UpdateEquipmentBoundaryVersionCommand command =
        new UpdateEquipmentBoundaryVersionCommand(
