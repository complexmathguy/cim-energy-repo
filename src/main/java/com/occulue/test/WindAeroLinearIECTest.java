...
public class WindAeroLinearIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindAeroLinearIEC : "
                          + successValue.getWindAeroLinearIECId());
                  if (successValue.getWindAeroLinearIECId().equals(windAeroLinearIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindAeroLinearIECList - 1,
      ...
      subscriber
          .windAeroLinearIECSubscribe(windAeroLinearIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindAeroLinearIEC : "
                          + successValue.getWindAeroLinearIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windAeroLinearIEC for windAeroLinearIECId consumed"));
  ...
  protected WindAeroLinearIEC read() throws Throwable {
    ...
    WindAeroLinearIECFetchOneSummary fetchOneSummary =
        new WindAeroLinearIECFetchOneSummary(windAeroLinearIECId);

    try {
      entity =
          WindAeroLinearIECBusinessDelegate.getWindAeroLinearIECInstance()
              .getWindAeroLinearIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindAeroLinearIECBusinessDelegate proxy =
          WindAeroLinearIECBusinessDelegate.getWindAeroLinearIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindAeroLinearIECBusinessDelegate.getWindAeroLinearIECInstance()
          .delete(new DeleteWindAeroLinearIECCommand(entity.getWindAeroLinearIECId()))
          .get();
  ...
  protected List<WindAeroLinearIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindAeroLinearIECBusinessDelegate.getWindAeroLinearIECInstance()
              .getAllWindAeroLinearIEC();
      assertNotNull(
          collection, "An Empty collection of WindAeroLinearIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindAeroLinearIECId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateWindAeroLinearIECCommand generateUpdateCommand() {
    UpdateWindAeroLinearIECCommand command =
        new UpdateWindAeroLinearIECCommand(null, null, null, null, null, null);
