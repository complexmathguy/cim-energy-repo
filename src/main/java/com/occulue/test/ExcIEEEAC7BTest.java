...
public class ExcIEEEAC7BTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC7B : "
                          + successValue.getExcIEEEAC7BId());
                  if (successValue.getExcIEEEAC7BId().equals(excIEEEAC7BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC7BList - 1,
      ...
      subscriber
          .excIEEEAC7BSubscribe(excIEEEAC7BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC7B : "
                          + successValue.getExcIEEEAC7BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC7BBusinessDelegate.getExcIEEEAC7BInstance()
          .delete(new DeleteExcIEEEAC7BCommand(entity.getExcIEEEAC7BId()))
          .get();
  ...
  protected UpdateExcIEEEAC7BCommand generateUpdateCommand() {
    UpdateExcIEEEAC7BCommand command =
        new UpdateExcIEEEAC7BCommand(
