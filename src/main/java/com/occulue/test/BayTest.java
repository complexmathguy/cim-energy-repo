...
public class BayTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    bayId = BayBusinessDelegate.getBayInstance().createBay(generateNewCommand()).get();
    ...
    BayBusinessDelegate.getBayInstance().createBay(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Bay : "
                          + successValue.getBayId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + bayId + " : command -" + command + " : " + e);
