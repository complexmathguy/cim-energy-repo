...
public class Simple_FloatTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Simple_Float : "
                          + successValue.getSimple_FloatId());
                  if (successValue.getSimple_FloatId().equals(simple_FloatId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSimple_FloatList - 1,
      ...
      subscriber
          .simple_FloatSubscribe(simple_FloatId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for Simple_Float : "
                          + successValue.getSimple_FloatId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected Simple_Float read() throws Throwable {
    ...
    try {
      entity =
          Simple_FloatBusinessDelegate.getSimple_FloatInstance().getSimple_Float(fetchOneSummary);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      Simple_FloatBusinessDelegate.getSimple_FloatInstance()
          .delete(new DeleteSimple_FloatCommand(entity.getSimple_FloatId()))
          .get();
