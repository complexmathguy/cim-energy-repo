...
public class GovGAST2Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    govGAST2Id =
        GovGAST2BusinessDelegate.getGovGAST2Instance().createGovGAST2(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovGAST2 : " + successValue.getGovGAST2Id());
                  if (successValue.getGovGAST2Id().equals(govGAST2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovGAST2List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for GovGAST2 : "
                          + successValue.getGovGAST2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govGAST2Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovGAST2BusinessDelegate.getGovGAST2Instance()
          .delete(new DeleteGovGAST2Command(entity.getGovGAST2Id()))
          .get();
  ...
  protected UpdateGovGAST2Command generateUpdateCommand() {
    UpdateGovGAST2Command command =
        new UpdateGovGAST2Command(
