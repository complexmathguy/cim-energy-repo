...
public class ApparentPowerLimitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ApparentPowerLimit : "
                          + successValue.getApparentPowerLimitId());
                  if (successValue.getApparentPowerLimitId().equals(apparentPowerLimitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfApparentPowerLimitList - 1,
      ...
      subscriber
          .apparentPowerLimitSubscribe(apparentPowerLimitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ApparentPowerLimit : "
                          + successValue.getApparentPowerLimitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on apparentPowerLimit for apparentPowerLimitId consumed"));
  ...
  protected ApparentPowerLimit read() throws Throwable {
    ...
    ApparentPowerLimitFetchOneSummary fetchOneSummary =
        new ApparentPowerLimitFetchOneSummary(apparentPowerLimitId);

    try {
      entity =
          ApparentPowerLimitBusinessDelegate.getApparentPowerLimitInstance()
              .getApparentPowerLimit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ApparentPowerLimitBusinessDelegate proxy =
          ApparentPowerLimitBusinessDelegate.getApparentPowerLimitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ApparentPowerLimitBusinessDelegate.getApparentPowerLimitInstance()
          .delete(new DeleteApparentPowerLimitCommand(entity.getApparentPowerLimitId()))
          .get();
  ...
  protected List<ApparentPowerLimit> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ApparentPowerLimitBusinessDelegate.getApparentPowerLimitInstance()
              .getAllApparentPowerLimit();
      assertNotNull(
          collection, "An Empty collection of ApparentPowerLimit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getApparentPowerLimitId(), "-- entity in Collection has a null primary key");
