...
public class ExcAVR3Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAVR3Id =
        ExcAVR3BusinessDelegate.getExcAVR3Instance().createExcAVR3(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAVR3 : " + successValue.getExcAVR3Id());
                  if (successValue.getExcAVR3Id().equals(excAVR3Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAVR3List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAVR3 : "
                          + successValue.getExcAVR3Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAVR3Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAVR3BusinessDelegate.getExcAVR3Instance()
          .delete(new DeleteExcAVR3Command(entity.getExcAVR3Id()))
          .get();
  ...
  protected UpdateExcAVR3Command generateUpdateCommand() {
    UpdateExcAVR3Command command =
        new UpdateExcAVR3Command(
