...
public class VoltageCompensatorDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VoltageCompensatorDynamics : "
                          + successValue.getVoltageCompensatorDynamicsId());
                  if (successValue
                      .getVoltageCompensatorDynamicsId()
                      .equals(voltageCompensatorDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVoltageCompensatorDynamicsList - 1,
      ...
      subscriber
          .voltageCompensatorDynamicsSubscribe(voltageCompensatorDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VoltageCompensatorDynamics : "
                          + successValue.getVoltageCompensatorDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on voltageCompensatorDynamics for voltageCompensatorDynamicsId consumed"));
  ...
  protected VoltageCompensatorDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read VoltageCompensatorDynamics with primary key");
    msg.append(voltageCompensatorDynamicsId);

    VoltageCompensatorDynamicsFetchOneSummary fetchOneSummary =
        new VoltageCompensatorDynamicsFetchOneSummary(voltageCompensatorDynamicsId);

    try {
      entity =
          VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance()
              .getVoltageCompensatorDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VoltageCompensatorDynamicsBusinessDelegate proxy =
          VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read VoltageCompensatorDynamics with id "
              + voltageCompensatorDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read VoltageCompensatorDynamics with id " + voltageCompensatorDynamicsId);
    ...
    try {
      VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance()
          .delete(
              new DeleteVoltageCompensatorDynamicsCommand(entity.getVoltageCompensatorDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted VoltageCompensatorDynamics with id "
              + voltageCompensatorDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete VoltageCompensatorDynamics with id " + voltageCompensatorDynamicsId);
  ...
  protected List<VoltageCompensatorDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          VoltageCompensatorDynamicsBusinessDelegate.getVoltageCompensatorDynamicsInstance()
              .getAllVoltageCompensatorDynamics();
      assertNotNull(
          collection,
          "An Empty collection of VoltageCompensatorDynamics was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVoltageCompensatorDynamicsId(),
  ...
  protected CreateVoltageCompensatorDynamicsCommand generateNewCommand() {
    CreateVoltageCompensatorDynamicsCommand command =
        new CreateVoltageCompensatorDynamicsCommand(null);
  ...
  protected UpdateVoltageCompensatorDynamicsCommand generateUpdateCommand() {
    UpdateVoltageCompensatorDynamicsCommand command =
        new UpdateVoltageCompensatorDynamicsCommand(null);
