...
public class AsynchronousMachineUserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AsynchronousMachineUserDefined : "
                          + successValue.getAsynchronousMachineUserDefinedId());
                  if (successValue
                      .getAsynchronousMachineUserDefinedId()
                      .equals(asynchronousMachineUserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAsynchronousMachineUserDefinedList - 1,
      ...
      subscriber
          .asynchronousMachineUserDefinedSubscribe(asynchronousMachineUserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AsynchronousMachineUserDefined : "
                          + successValue.getAsynchronousMachineUserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on asynchronousMachineUserDefined for asynchronousMachineUserDefinedId consumed"));
  ...
  protected AsynchronousMachineUserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read AsynchronousMachineUserDefined with primary key");
    msg.append(asynchronousMachineUserDefinedId);

    AsynchronousMachineUserDefinedFetchOneSummary fetchOneSummary =
        new AsynchronousMachineUserDefinedFetchOneSummary(asynchronousMachineUserDefinedId);

    try {
      entity =
          AsynchronousMachineUserDefinedBusinessDelegate.getAsynchronousMachineUserDefinedInstance()
              .getAsynchronousMachineUserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      AsynchronousMachineUserDefinedBusinessDelegate proxy =
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read AsynchronousMachineUserDefined with id "
              + asynchronousMachineUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read AsynchronousMachineUserDefined with id "
              + asynchronousMachineUserDefinedId);
    ...
    try {
      AsynchronousMachineUserDefinedBusinessDelegate.getAsynchronousMachineUserDefinedInstance()
          .delete(
              new DeleteAsynchronousMachineUserDefinedCommand(
                  entity.getAsynchronousMachineUserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted AsynchronousMachineUserDefined with id "
              + asynchronousMachineUserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete AsynchronousMachineUserDefined with id "
              + asynchronousMachineUserDefinedId);
  ...
  protected List<AsynchronousMachineUserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of AsynchronousMachineUserDefined was incorrectly returned.");
  ...
  protected CreateAsynchronousMachineUserDefinedCommand generateNewCommand() {
    CreateAsynchronousMachineUserDefinedCommand command =
        new CreateAsynchronousMachineUserDefinedCommand(null);
  ...
  protected UpdateAsynchronousMachineUserDefinedCommand generateUpdateCommand() {
    UpdateAsynchronousMachineUserDefinedCommand command =
        new UpdateAsynchronousMachineUserDefinedCommand(null, null);
  ...
  private final Logger LOGGER =
      Logger.getLogger(AsynchronousMachineUserDefinedTest.class.getName());
