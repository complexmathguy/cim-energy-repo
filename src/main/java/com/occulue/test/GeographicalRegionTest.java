...
public class GeographicalRegionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GeographicalRegion : "
                          + successValue.getGeographicalRegionId());
                  if (successValue.getGeographicalRegionId().equals(geographicalRegionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGeographicalRegionList - 1,
      ...
      subscriber
          .geographicalRegionSubscribe(geographicalRegionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GeographicalRegion : "
                          + successValue.getGeographicalRegionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on geographicalRegion for geographicalRegionId consumed"));
  ...
  protected GeographicalRegion read() throws Throwable {
    ...
    GeographicalRegionFetchOneSummary fetchOneSummary =
        new GeographicalRegionFetchOneSummary(geographicalRegionId);

    try {
      entity =
          GeographicalRegionBusinessDelegate.getGeographicalRegionInstance()
              .getGeographicalRegion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GeographicalRegionBusinessDelegate proxy =
          GeographicalRegionBusinessDelegate.getGeographicalRegionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GeographicalRegionBusinessDelegate.getGeographicalRegionInstance()
          .delete(new DeleteGeographicalRegionCommand(entity.getGeographicalRegionId()))
          .get();
  ...
  protected List<GeographicalRegion> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of GeographicalRegion was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGeographicalRegionId(), "-- entity in Collection has a null primary key");
