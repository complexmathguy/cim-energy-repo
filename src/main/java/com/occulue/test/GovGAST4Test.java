...
public class GovGAST4Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    govGAST4Id =
        GovGAST4BusinessDelegate.getGovGAST4Instance().createGovGAST4(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovGAST4 : " + successValue.getGovGAST4Id());
                  if (successValue.getGovGAST4Id().equals(govGAST4Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovGAST4List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for GovGAST4 : "
                          + successValue.getGovGAST4Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govGAST4Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovGAST4BusinessDelegate.getGovGAST4Instance()
          .delete(new DeleteGovGAST4Command(entity.getGovGAST4Id()))
          .get();
  ...
  protected UpdateGovGAST4Command generateUpdateCommand() {
    UpdateGovGAST4Command command =
        new UpdateGovGAST4Command(
