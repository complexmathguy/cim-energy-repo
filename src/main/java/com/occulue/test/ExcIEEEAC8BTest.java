...
public class ExcIEEEAC8BTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC8B : "
                          + successValue.getExcIEEEAC8BId());
                  if (successValue.getExcIEEEAC8BId().equals(excIEEEAC8BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC8BList - 1,
      ...
      subscriber
          .excIEEEAC8BSubscribe(excIEEEAC8BId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC8B : "
                          + successValue.getExcIEEEAC8BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC8BBusinessDelegate.getExcIEEEAC8BInstance()
          .delete(new DeleteExcIEEEAC8BCommand(entity.getExcIEEEAC8BId()))
          .get();
  ...
  protected UpdateExcIEEEAC8BCommand generateUpdateCommand() {
    UpdateExcIEEEAC8BCommand command =
        new UpdateExcIEEEAC8BCommand(
