...
public class Pss1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    pss1Id = Pss1BusinessDelegate.getPss1Instance().createPss1(generateNewCommand()).get();
    ...
    Pss1BusinessDelegate.getPss1Instance().createPss1(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Pss1 : "
                          + successValue.getPss1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pss1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      Pss1BusinessDelegate.getPss1Instance()
          .delete(new DeletePss1Command(entity.getPss1Id()))
          .get();
  ...
  protected UpdatePss1Command generateUpdateCommand() {
    UpdatePss1Command command =
        new UpdatePss1Command(
