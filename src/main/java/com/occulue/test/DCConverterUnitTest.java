...
public class DCConverterUnitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCConverterUnit : "
                          + successValue.getDCConverterUnitId());
                  if (successValue.getDCConverterUnitId().equals(dCConverterUnitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCConverterUnitList - 1,
      ...
      subscriber
          .dCConverterUnitSubscribe(dCConverterUnitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCConverterUnit : "
                          + successValue.getDCConverterUnitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected DCConverterUnit read() throws Throwable {
    ...
    DCConverterUnitFetchOneSummary fetchOneSummary =
        new DCConverterUnitFetchOneSummary(dCConverterUnitId);

    try {
      entity =
          DCConverterUnitBusinessDelegate.getDCConverterUnitInstance()
              .getDCConverterUnit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DCConverterUnitBusinessDelegate proxy =
          DCConverterUnitBusinessDelegate.getDCConverterUnitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCConverterUnitBusinessDelegate.getDCConverterUnitInstance()
          .delete(new DeleteDCConverterUnitCommand(entity.getDCConverterUnitId()))
          .get();
  ...
  protected List<DCConverterUnit> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          DCConverterUnitBusinessDelegate.getDCConverterUnitInstance().getAllDCConverterUnit();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDCConverterUnitId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateDCConverterUnitCommand generateNewCommand() {
    CreateDCConverterUnitCommand command =
        new CreateDCConverterUnitCommand(null, DCConverterOperatingModeKind.values()[0]);
  ...
  protected UpdateDCConverterUnitCommand generateUpdateCommand() {
    UpdateDCConverterUnitCommand command =
        new UpdateDCConverterUnitCommand(null, DCConverterOperatingModeKind.values()[0]);
