...
public class SynchronousMachineSimplifiedTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    synchronousMachineSimplifiedId =
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SynchronousMachineSimplified : "
                          + successValue.getSynchronousMachineSimplifiedId());
                  if (successValue
                      .getSynchronousMachineSimplifiedId()
                      .equals(synchronousMachineSimplifiedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSynchronousMachineSimplifiedList - 1,
      ...
      subscriber
          .synchronousMachineSimplifiedSubscribe(synchronousMachineSimplifiedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SynchronousMachineSimplified : "
                          + successValue.getSynchronousMachineSimplifiedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on synchronousMachineSimplified for synchronousMachineSimplifiedId consumed"));
  ...
  protected SynchronousMachineSimplified read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read SynchronousMachineSimplified with primary key");
    msg.append(synchronousMachineSimplifiedId);

    SynchronousMachineSimplifiedFetchOneSummary fetchOneSummary =
        new SynchronousMachineSimplifiedFetchOneSummary(synchronousMachineSimplifiedId);

    try {
      entity =
          SynchronousMachineSimplifiedBusinessDelegate.getSynchronousMachineSimplifiedInstance()
              .getSynchronousMachineSimplified(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SynchronousMachineSimplifiedBusinessDelegate proxy =
          SynchronousMachineSimplifiedBusinessDelegate.getSynchronousMachineSimplifiedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read SynchronousMachineSimplified with id "
              + synchronousMachineSimplifiedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read SynchronousMachineSimplified with id "
              + synchronousMachineSimplifiedId);
    ...
    try {
      SynchronousMachineSimplifiedBusinessDelegate.getSynchronousMachineSimplifiedInstance()
          .delete(
              new DeleteSynchronousMachineSimplifiedCommand(
                  entity.getSynchronousMachineSimplifiedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted SynchronousMachineSimplified with id "
              + synchronousMachineSimplifiedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete SynchronousMachineSimplified with id "
              + synchronousMachineSimplifiedId);
  ...
  protected List<SynchronousMachineSimplified> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SynchronousMachineSimplifiedBusinessDelegate.getSynchronousMachineSimplifiedInstance()
              .getAllSynchronousMachineSimplified();
      assertNotNull(
          collection,
          "An Empty collection of SynchronousMachineSimplified was incorrectly returned.");
  ...
  protected CreateSynchronousMachineSimplifiedCommand generateNewCommand() {
    CreateSynchronousMachineSimplifiedCommand command =
        new CreateSynchronousMachineSimplifiedCommand(null);
  ...
  protected UpdateSynchronousMachineSimplifiedCommand generateUpdateCommand() {
    UpdateSynchronousMachineSimplifiedCommand command =
        new UpdateSynchronousMachineSimplifiedCommand(null);
