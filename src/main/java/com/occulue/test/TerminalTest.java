...
public class TerminalTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    terminalId =
        TerminalBusinessDelegate.getTerminalInstance().createTerminal(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Terminal : " + successValue.getTerminalId());
                  if (successValue.getTerminalId().equals(terminalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfTerminalList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Terminal : "
                          + successValue.getTerminalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + terminalId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      TerminalBusinessDelegate.getTerminalInstance()
          .delete(new DeleteTerminalCommand(entity.getTerminalId()))
          .get();
