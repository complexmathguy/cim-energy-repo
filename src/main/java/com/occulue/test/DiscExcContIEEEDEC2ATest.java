...
public class DiscExcContIEEEDEC2ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DiscExcContIEEEDEC2A : "
                          + successValue.getDiscExcContIEEEDEC2AId());
                  if (successValue.getDiscExcContIEEEDEC2AId().equals(discExcContIEEEDEC2AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDiscExcContIEEEDEC2AList - 1,
      ...
      subscriber
          .discExcContIEEEDEC2ASubscribe(discExcContIEEEDEC2AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DiscExcContIEEEDEC2A : "
                          + successValue.getDiscExcContIEEEDEC2AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on discExcContIEEEDEC2A for discExcContIEEEDEC2AId consumed"));
  ...
  protected DiscExcContIEEEDEC2A read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read DiscExcContIEEEDEC2A with primary key");
    msg.append(discExcContIEEEDEC2AId);

    DiscExcContIEEEDEC2AFetchOneSummary fetchOneSummary =
        new DiscExcContIEEEDEC2AFetchOneSummary(discExcContIEEEDEC2AId);

    try {
      entity =
          DiscExcContIEEEDEC2ABusinessDelegate.getDiscExcContIEEEDEC2AInstance()
              .getDiscExcContIEEEDEC2A(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DiscExcContIEEEDEC2ABusinessDelegate proxy =
          DiscExcContIEEEDEC2ABusinessDelegate.getDiscExcContIEEEDEC2AInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DiscExcContIEEEDEC2ABusinessDelegate.getDiscExcContIEEEDEC2AInstance()
          .delete(new DeleteDiscExcContIEEEDEC2ACommand(entity.getDiscExcContIEEEDEC2AId()))
          .get();
  ...
  protected List<DiscExcContIEEEDEC2A> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          DiscExcContIEEEDEC2ABusinessDelegate.getDiscExcContIEEEDEC2AInstance()
              .getAllDiscExcContIEEEDEC2A();
      assertNotNull(
          collection, "An Empty collection of DiscExcContIEEEDEC2A was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDiscExcContIEEEDEC2AId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateDiscExcContIEEEDEC2ACommand generateUpdateCommand() {
    UpdateDiscExcContIEEEDEC2ACommand command =
        new UpdateDiscExcContIEEEDEC2ACommand(null, null, null, null, null, null);
