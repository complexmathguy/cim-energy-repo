...
public class ACDCTerminalTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ACDCTerminal : "
                          + successValue.getACDCTerminalId());
                  if (successValue.getACDCTerminalId().equals(aCDCTerminalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfACDCTerminalList - 1,
      ...
      subscriber
          .aCDCTerminalSubscribe(aCDCTerminalId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ACDCTerminal : "
                          + successValue.getACDCTerminalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected ACDCTerminal read() throws Throwable {
    ...
    try {
      entity =
          ACDCTerminalBusinessDelegate.getACDCTerminalInstance().getACDCTerminal(fetchOneSummary);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ACDCTerminalBusinessDelegate.getACDCTerminalInstance()
          .delete(new DeleteACDCTerminalCommand(entity.getACDCTerminalId()))
          .get();
  ...
  protected UpdateACDCTerminalCommand generateUpdateCommand() {
    UpdateACDCTerminalCommand command = new UpdateACDCTerminalCommand(null, null);
