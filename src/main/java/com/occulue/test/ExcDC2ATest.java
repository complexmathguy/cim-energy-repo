...
public class ExcDC2ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excDC2AId =
        ExcDC2ABusinessDelegate.getExcDC2AInstance().createExcDC2A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcDC2A : " + successValue.getExcDC2AId());
                  if (successValue.getExcDC2AId().equals(excDC2AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcDC2AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcDC2A : "
                          + successValue.getExcDC2AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excDC2AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcDC2ABusinessDelegate.getExcDC2AInstance()
          .delete(new DeleteExcDC2ACommand(entity.getExcDC2AId()))
          .get();
  ...
  protected UpdateExcDC2ACommand generateUpdateCommand() {
    UpdateExcDC2ACommand command =
        new UpdateExcDC2ACommand(
