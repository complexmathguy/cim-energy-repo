...
public class ExcIEEEST3ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEST3A : "
                          + successValue.getExcIEEEST3AId());
                  if (successValue.getExcIEEEST3AId().equals(excIEEEST3AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEST3AList - 1,
      ...
      subscriber
          .excIEEEST3ASubscribe(excIEEEST3AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEST3A : "
                          + successValue.getExcIEEEST3AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEST3ABusinessDelegate.getExcIEEEST3AInstance()
          .delete(new DeleteExcIEEEST3ACommand(entity.getExcIEEEST3AId()))
          .get();
