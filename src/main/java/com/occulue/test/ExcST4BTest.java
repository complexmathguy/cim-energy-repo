...
public class ExcST4BTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excST4BId =
        ExcST4BBusinessDelegate.getExcST4BInstance().createExcST4B(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcST4B : " + successValue.getExcST4BId());
                  if (successValue.getExcST4BId().equals(excST4BId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcST4BList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcST4B : "
                          + successValue.getExcST4BId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excST4BId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcST4BBusinessDelegate.getExcST4BInstance()
          .delete(new DeleteExcST4BCommand(entity.getExcST4BId()))
          .get();
  ...
  protected UpdateExcST4BCommand generateUpdateCommand() {
    UpdateExcST4BCommand command =
        new UpdateExcST4BCommand(
