...
public class LoadResponseCharacteristicTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for LoadResponseCharacteristic : "
                          + successValue.getLoadResponseCharacteristicId());
                  if (successValue
                      .getLoadResponseCharacteristicId()
                      .equals(loadResponseCharacteristicId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfLoadResponseCharacteristicList - 1,
      ...
      subscriber
          .loadResponseCharacteristicSubscribe(loadResponseCharacteristicId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for LoadResponseCharacteristic : "
                          + successValue.getLoadResponseCharacteristicId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on loadResponseCharacteristic for loadResponseCharacteristicId consumed"));
  ...
  protected LoadResponseCharacteristic read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read LoadResponseCharacteristic with primary key");
    msg.append(loadResponseCharacteristicId);

    LoadResponseCharacteristicFetchOneSummary fetchOneSummary =
        new LoadResponseCharacteristicFetchOneSummary(loadResponseCharacteristicId);

    try {
      entity =
          LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance()
              .getLoadResponseCharacteristic(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LoadResponseCharacteristicBusinessDelegate proxy =
          LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read LoadResponseCharacteristic with id "
              + loadResponseCharacteristicId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read LoadResponseCharacteristic with id " + loadResponseCharacteristicId);
    ...
    try {
      LoadResponseCharacteristicBusinessDelegate.getLoadResponseCharacteristicInstance()
          .delete(
              new DeleteLoadResponseCharacteristicCommand(entity.getLoadResponseCharacteristicId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted LoadResponseCharacteristic with id "
              + loadResponseCharacteristicId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete LoadResponseCharacteristic with id " + loadResponseCharacteristicId);
  ...
  protected List<LoadResponseCharacteristic> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of LoadResponseCharacteristic was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getLoadResponseCharacteristicId(),
  ...
  protected CreateLoadResponseCharacteristicCommand generateNewCommand() {
    CreateLoadResponseCharacteristicCommand command =
        new CreateLoadResponseCharacteristicCommand(null);
  ...
  protected UpdateLoadResponseCharacteristicCommand generateUpdateCommand() {
    UpdateLoadResponseCharacteristicCommand command =
        new UpdateLoadResponseCharacteristicCommand(
