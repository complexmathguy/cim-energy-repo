...
public class GovCT1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    govCT1Id = GovCT1BusinessDelegate.getGovCT1Instance().createGovCT1(generateNewCommand()).get();
    ...
    GovCT1BusinessDelegate.getGovCT1Instance().createGovCT1(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for GovCT1 : "
                          + successValue.getGovCT1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govCT1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovCT1BusinessDelegate.getGovCT1Instance()
          .delete(new DeleteGovCT1Command(entity.getGovCT1Id()))
          .get();
  ...
  protected CreateGovCT1Command generateNewCommand() {
    CreateGovCT1Command command =
        new CreateGovCT1Command(null, DroopSignalFeedbackKind.values()[0]);
  ...
  protected UpdateGovCT1Command generateUpdateCommand() {
    UpdateGovCT1Command command =
        new UpdateGovCT1Command(
            null,
            null,
            null,
            null,
            ...
            null,
            null,
            DroopSignalFeedbackKind.values()[0],
            null,
            null,
            null,
            null,
