...
public class ACDCConverterDCTerminalTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ACDCConverterDCTerminal : "
                          + successValue.getACDCConverterDCTerminalId());
                  if (successValue
                      .getACDCConverterDCTerminalId()
                      .equals(aCDCConverterDCTerminalId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfACDCConverterDCTerminalList - 1,
      ...
      subscriber
          .aCDCConverterDCTerminalSubscribe(aCDCConverterDCTerminalId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ACDCConverterDCTerminal : "
                          + successValue.getACDCConverterDCTerminalId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on aCDCConverterDCTerminal for aCDCConverterDCTerminalId consumed"));
  ...
  protected ACDCConverterDCTerminal read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ACDCConverterDCTerminal with primary key");
    msg.append(aCDCConverterDCTerminalId);

    ACDCConverterDCTerminalFetchOneSummary fetchOneSummary =
        new ACDCConverterDCTerminalFetchOneSummary(aCDCConverterDCTerminalId);

    try {
      entity =
          ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance()
              .getACDCConverterDCTerminal(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ACDCConverterDCTerminalBusinessDelegate proxy =
          ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ACDCConverterDCTerminal with id " + aCDCConverterDCTerminalId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ACDCConverterDCTerminal with id " + aCDCConverterDCTerminalId);
    ...
    try {
      ACDCConverterDCTerminalBusinessDelegate.getACDCConverterDCTerminalInstance()
          .delete(new DeleteACDCConverterDCTerminalCommand(entity.getACDCConverterDCTerminalId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ACDCConverterDCTerminal with id " + aCDCConverterDCTerminalId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ACDCConverterDCTerminal with id " + aCDCConverterDCTerminalId);
  ...
  protected List<ACDCConverterDCTerminal> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of ACDCConverterDCTerminal was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getACDCConverterDCTerminalId(),
  ...
  protected CreateACDCConverterDCTerminalCommand generateNewCommand() {
    CreateACDCConverterDCTerminalCommand command =
        new CreateACDCConverterDCTerminalCommand(null, DCPolarityKind.values()[0]);
  ...
  protected UpdateACDCConverterDCTerminalCommand generateUpdateCommand() {
    UpdateACDCConverterDCTerminalCommand command =
        new UpdateACDCConverterDCTerminalCommand(null, DCPolarityKind.values()[0]);
