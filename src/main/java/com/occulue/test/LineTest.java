...
public class LineTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    lineId = LineBusinessDelegate.getLineInstance().createLine(generateNewCommand()).get();
    ...
    LineBusinessDelegate.getLineInstance().createLine(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Line : "
                          + successValue.getLineId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + lineId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      LineBusinessDelegate.getLineInstance()
          .delete(new DeleteLineCommand(entity.getLineId()))
          .get();
