...
public class OperationalLimitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for OperationalLimit : "
                          + successValue.getOperationalLimitId());
                  if (successValue.getOperationalLimitId().equals(operationalLimitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfOperationalLimitList - 1,
      ...
      subscriber
          .operationalLimitSubscribe(operationalLimitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for OperationalLimit : "
                          + successValue.getOperationalLimitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected OperationalLimit read() throws Throwable {
    ...
    OperationalLimitFetchOneSummary fetchOneSummary =
        new OperationalLimitFetchOneSummary(operationalLimitId);

    try {
      entity =
          OperationalLimitBusinessDelegate.getOperationalLimitInstance()
              .getOperationalLimit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      OperationalLimitBusinessDelegate proxy =
          OperationalLimitBusinessDelegate.getOperationalLimitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      OperationalLimitBusinessDelegate.getOperationalLimitInstance()
          .delete(new DeleteOperationalLimitCommand(entity.getOperationalLimitId()))
          .get();
  ...
  protected List<OperationalLimit> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of OperationalLimit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getOperationalLimitId(), "-- entity in Collection has a null primary key");
