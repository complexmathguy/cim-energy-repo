...
public class InductancePerLengthTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for InductancePerLength : "
                          + successValue.getInductancePerLengthId());
                  if (successValue.getInductancePerLengthId().equals(inductancePerLengthId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfInductancePerLengthList - 1,
      ...
      subscriber
          .inductancePerLengthSubscribe(inductancePerLengthId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for InductancePerLength : "
                          + successValue.getInductancePerLengthId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on inductancePerLength for inductancePerLengthId consumed"));
  ...
  protected InductancePerLength read() throws Throwable {
    ...
    InductancePerLengthFetchOneSummary fetchOneSummary =
        new InductancePerLengthFetchOneSummary(inductancePerLengthId);

    try {
      entity =
          InductancePerLengthBusinessDelegate.getInductancePerLengthInstance()
              .getInductancePerLength(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      InductancePerLengthBusinessDelegate proxy =
          InductancePerLengthBusinessDelegate.getInductancePerLengthInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      InductancePerLengthBusinessDelegate.getInductancePerLengthInstance()
          .delete(new DeleteInductancePerLengthCommand(entity.getInductancePerLengthId()))
          .get();
  ...
  protected List<InductancePerLength> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          InductancePerLengthBusinessDelegate.getInductancePerLengthInstance()
              .getAllInductancePerLength();
      assertNotNull(
          collection, "An Empty collection of InductancePerLength was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getInductancePerLengthId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateInductancePerLengthCommand generateNewCommand() {
    CreateInductancePerLengthCommand command =
        new CreateInductancePerLengthCommand(
            null,
  ...
  protected UpdateInductancePerLengthCommand generateUpdateCommand() {
    UpdateInductancePerLengthCommand command =
        new UpdateInductancePerLengthCommand(
            null,
            UnitMultiplier.values()[0],
            UnitSymbol.values()[0],
            UnitMultiplier.values()[0],
