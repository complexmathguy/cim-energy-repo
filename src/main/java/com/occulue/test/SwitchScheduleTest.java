...
public class SwitchScheduleTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SwitchSchedule : "
                          + successValue.getSwitchScheduleId());
                  if (successValue.getSwitchScheduleId().equals(switchScheduleId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSwitchScheduleList - 1,
      ...
      subscriber
          .switchScheduleSubscribe(switchScheduleId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SwitchSchedule : "
                          + successValue.getSwitchScheduleId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected SwitchSchedule read() throws Throwable {
    ...
    SwitchScheduleFetchOneSummary fetchOneSummary =
        new SwitchScheduleFetchOneSummary(switchScheduleId);

    try {
      entity =
          SwitchScheduleBusinessDelegate.getSwitchScheduleInstance()
              .getSwitchSchedule(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SwitchScheduleBusinessDelegate proxy =
          SwitchScheduleBusinessDelegate.getSwitchScheduleInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SwitchScheduleBusinessDelegate.getSwitchScheduleInstance()
          .delete(new DeleteSwitchScheduleCommand(entity.getSwitchScheduleId()))
          .get();
  ...
  protected List<SwitchSchedule> getAll() throws Throwable {
    ...
    try {
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSwitchScheduleId(), "-- entity in Collection has a null primary key");
