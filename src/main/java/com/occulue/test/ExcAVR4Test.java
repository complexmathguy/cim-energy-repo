...
public class ExcAVR4Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAVR4Id =
        ExcAVR4BusinessDelegate.getExcAVR4Instance().createExcAVR4(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAVR4 : " + successValue.getExcAVR4Id());
                  if (successValue.getExcAVR4Id().equals(excAVR4Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAVR4List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAVR4 : "
                          + successValue.getExcAVR4Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAVR4Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAVR4BusinessDelegate.getExcAVR4Instance()
          .delete(new DeleteExcAVR4Command(entity.getExcAVR4Id()))
          .get();
  ...
  protected UpdateExcAVR4Command generateUpdateCommand() {
    UpdateExcAVR4Command command =
        new UpdateExcAVR4Command(
