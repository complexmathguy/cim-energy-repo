...
public class RegularTimePointTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RegularTimePoint : "
                          + successValue.getRegularTimePointId());
                  if (successValue.getRegularTimePointId().equals(regularTimePointId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRegularTimePointList - 1,
      ...
      subscriber
          .regularTimePointSubscribe(regularTimePointId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RegularTimePoint : "
                          + successValue.getRegularTimePointId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected RegularTimePoint read() throws Throwable {
    ...
    RegularTimePointFetchOneSummary fetchOneSummary =
        new RegularTimePointFetchOneSummary(regularTimePointId);

    try {
      entity =
          RegularTimePointBusinessDelegate.getRegularTimePointInstance()
              .getRegularTimePoint(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RegularTimePointBusinessDelegate proxy =
          RegularTimePointBusinessDelegate.getRegularTimePointInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      RegularTimePointBusinessDelegate.getRegularTimePointInstance()
          .delete(new DeleteRegularTimePointCommand(entity.getRegularTimePointId()))
          .get();
  ...
  protected List<RegularTimePoint> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of RegularTimePoint was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRegularTimePointId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateRegularTimePointCommand generateUpdateCommand() {
    UpdateRegularTimePointCommand command =
        new UpdateRegularTimePointCommand(null, null, null, null);
