...
public class WindGenTurbineType3aIECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindGenTurbineType3aIEC : "
                          + successValue.getWindGenTurbineType3aIECId());
                  if (successValue
                      .getWindGenTurbineType3aIECId()
                      .equals(windGenTurbineType3aIECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindGenTurbineType3aIECList - 1,
      ...
      subscriber
          .windGenTurbineType3aIECSubscribe(windGenTurbineType3aIECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindGenTurbineType3aIEC : "
                          + successValue.getWindGenTurbineType3aIECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windGenTurbineType3aIEC for windGenTurbineType3aIECId consumed"));
  ...
  protected WindGenTurbineType3aIEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindGenTurbineType3aIEC with primary key");
    msg.append(windGenTurbineType3aIECId);

    WindGenTurbineType3aIECFetchOneSummary fetchOneSummary =
        new WindGenTurbineType3aIECFetchOneSummary(windGenTurbineType3aIECId);

    try {
      entity =
          WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance()
              .getWindGenTurbineType3aIEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindGenTurbineType3aIECBusinessDelegate proxy =
          WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindGenTurbineType3aIEC with id " + windGenTurbineType3aIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindGenTurbineType3aIEC with id " + windGenTurbineType3aIECId);
    ...
    try {
      WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance()
          .delete(new DeleteWindGenTurbineType3aIECCommand(entity.getWindGenTurbineType3aIECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindGenTurbineType3aIEC with id " + windGenTurbineType3aIECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindGenTurbineType3aIEC with id " + windGenTurbineType3aIECId);
  ...
  protected List<WindGenTurbineType3aIEC> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindGenTurbineType3aIECBusinessDelegate.getWindGenTurbineType3aIECInstance()
              .getAllWindGenTurbineType3aIEC();
      assertNotNull(
          collection, "An Empty collection of WindGenTurbineType3aIEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindGenTurbineType3aIECId(),
  ...
  protected UpdateWindGenTurbineType3aIECCommand generateUpdateCommand() {
    UpdateWindGenTurbineType3aIECCommand command =
        new UpdateWindGenTurbineType3aIECCommand(null, null, null, null);
