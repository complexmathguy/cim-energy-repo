...
public class WindGenTurbineType2IECTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindGenTurbineType2IEC : "
                          + successValue.getWindGenTurbineType2IECId());
                  if (successValue.getWindGenTurbineType2IECId().equals(windGenTurbineType2IECId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindGenTurbineType2IECList - 1,
      ...
      subscriber
          .windGenTurbineType2IECSubscribe(windGenTurbineType2IECId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindGenTurbineType2IEC : "
                          + successValue.getWindGenTurbineType2IECId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windGenTurbineType2IEC for windGenTurbineType2IECId consumed"));
  ...
  protected WindGenTurbineType2IEC read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindGenTurbineType2IEC with primary key");
    msg.append(windGenTurbineType2IECId);

    WindGenTurbineType2IECFetchOneSummary fetchOneSummary =
        new WindGenTurbineType2IECFetchOneSummary(windGenTurbineType2IECId);

    try {
      entity =
          WindGenTurbineType2IECBusinessDelegate.getWindGenTurbineType2IECInstance()
              .getWindGenTurbineType2IEC(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindGenTurbineType2IECBusinessDelegate proxy =
          WindGenTurbineType2IECBusinessDelegate.getWindGenTurbineType2IECInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindGenTurbineType2IEC with id " + windGenTurbineType2IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindGenTurbineType2IEC with id " + windGenTurbineType2IECId);
    ...
    try {
      WindGenTurbineType2IECBusinessDelegate.getWindGenTurbineType2IECInstance()
          .delete(new DeleteWindGenTurbineType2IECCommand(entity.getWindGenTurbineType2IECId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindGenTurbineType2IEC with id " + windGenTurbineType2IECId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindGenTurbineType2IEC with id " + windGenTurbineType2IECId);
  ...
  protected List<WindGenTurbineType2IEC> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of WindGenTurbineType2IEC was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindGenTurbineType2IECId(), "-- entity in Collection has a null primary key");
