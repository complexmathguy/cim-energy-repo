...
public class DCShuntTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dCShuntId =
        DCShuntBusinessDelegate.getDCShuntInstance().createDCShunt(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCShunt : " + successValue.getDCShuntId());
                  if (successValue.getDCShuntId().equals(dCShuntId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCShuntList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DCShunt : "
                          + successValue.getDCShuntId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dCShuntId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCShuntBusinessDelegate.getDCShuntInstance()
          .delete(new DeleteDCShuntCommand(entity.getDCShuntId()))
          .get();
