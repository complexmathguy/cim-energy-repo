...
public class VCompIEEEType1Test {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for VCompIEEEType1 : "
                          + successValue.getVCompIEEEType1Id());
                  if (successValue.getVCompIEEEType1Id().equals(vCompIEEEType1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfVCompIEEEType1List - 1,
      ...
      subscriber
          .vCompIEEEType1Subscribe(vCompIEEEType1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for VCompIEEEType1 : "
                          + successValue.getVCompIEEEType1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected VCompIEEEType1 read() throws Throwable {
    ...
    VCompIEEEType1FetchOneSummary fetchOneSummary =
        new VCompIEEEType1FetchOneSummary(vCompIEEEType1Id);

    try {
      entity =
          VCompIEEEType1BusinessDelegate.getVCompIEEEType1Instance()
              .getVCompIEEEType1(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      VCompIEEEType1BusinessDelegate proxy =
          VCompIEEEType1BusinessDelegate.getVCompIEEEType1Instance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      VCompIEEEType1BusinessDelegate.getVCompIEEEType1Instance()
          .delete(new DeleteVCompIEEEType1Command(entity.getVCompIEEEType1Id()))
          .get();
  ...
  protected List<VCompIEEEType1> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          VCompIEEEType1BusinessDelegate.getVCompIEEEType1Instance().getAllVCompIEEEType1();
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getVCompIEEEType1Id(), "-- entity in Collection has a null primary key");
