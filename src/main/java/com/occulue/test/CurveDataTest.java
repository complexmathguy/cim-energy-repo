...
public class CurveDataTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    CurveDataBusinessDelegate.getCurveDataInstance().createCurveData(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for CurveData : " + successValue.getCurveDataId());
                  if (successValue.getCurveDataId().equals(curveDataId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfCurveDataList - 1,
      ...
      subscriber
          .curveDataSubscribe(curveDataId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for CurveData : "
                          + successValue.getCurveDataId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + curveDataId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      CurveDataBusinessDelegate.getCurveDataInstance()
          .delete(new DeleteCurveDataCommand(entity.getCurveDataId()))
          .get();
  ...
  protected UpdateCurveDataCommand generateUpdateCommand() {
    UpdateCurveDataCommand command = new UpdateCurveDataCommand(null, null, null, null);
