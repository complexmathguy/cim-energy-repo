...
public class GrossToNetActivePowerCurveTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GrossToNetActivePowerCurve : "
                          + successValue.getGrossToNetActivePowerCurveId());
                  if (successValue
                      .getGrossToNetActivePowerCurveId()
                      .equals(grossToNetActivePowerCurveId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGrossToNetActivePowerCurveList - 1,
      ...
      subscriber
          .grossToNetActivePowerCurveSubscribe(grossToNetActivePowerCurveId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GrossToNetActivePowerCurve : "
                          + successValue.getGrossToNetActivePowerCurveId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on grossToNetActivePowerCurve for grossToNetActivePowerCurveId consumed"));
  ...
  protected GrossToNetActivePowerCurve read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read GrossToNetActivePowerCurve with primary key");
    msg.append(grossToNetActivePowerCurveId);

    GrossToNetActivePowerCurveFetchOneSummary fetchOneSummary =
        new GrossToNetActivePowerCurveFetchOneSummary(grossToNetActivePowerCurveId);

    try {
      entity =
          GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance()
              .getGrossToNetActivePowerCurve(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      GrossToNetActivePowerCurveBusinessDelegate proxy =
          GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read GrossToNetActivePowerCurve with id "
              + grossToNetActivePowerCurveId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read GrossToNetActivePowerCurve with id " + grossToNetActivePowerCurveId);
    ...
    try {
      GrossToNetActivePowerCurveBusinessDelegate.getGrossToNetActivePowerCurveInstance()
          .delete(
              new DeleteGrossToNetActivePowerCurveCommand(entity.getGrossToNetActivePowerCurveId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted GrossToNetActivePowerCurve with id "
              + grossToNetActivePowerCurveId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete GrossToNetActivePowerCurve with id " + grossToNetActivePowerCurveId);
  ...
  protected List<GrossToNetActivePowerCurve> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection,
          "An Empty collection of GrossToNetActivePowerCurve was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getGrossToNetActivePowerCurveId(),
  ...
  protected CreateGrossToNetActivePowerCurveCommand generateNewCommand() {
    CreateGrossToNetActivePowerCurveCommand command =
        new CreateGrossToNetActivePowerCurveCommand(null);
  ...
  protected UpdateGrossToNetActivePowerCurveCommand generateUpdateCommand() {
    UpdateGrossToNetActivePowerCurveCommand command =
        new UpdateGrossToNetActivePowerCurveCommand(null);
