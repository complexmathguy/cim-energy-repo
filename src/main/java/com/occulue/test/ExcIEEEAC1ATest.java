...
public class ExcIEEEAC1ATest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcIEEEAC1A : "
                          + successValue.getExcIEEEAC1AId());
                  if (successValue.getExcIEEEAC1AId().equals(excIEEEAC1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcIEEEAC1AList - 1,
      ...
      subscriber
          .excIEEEAC1ASubscribe(excIEEEAC1AId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ExcIEEEAC1A : "
                          + successValue.getExcIEEEAC1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcIEEEAC1ABusinessDelegate.getExcIEEEAC1AInstance()
          .delete(new DeleteExcIEEEAC1ACommand(entity.getExcIEEEAC1AId()))
          .get();
  ...
  protected UpdateExcIEEEAC1ACommand generateUpdateCommand() {
    UpdateExcIEEEAC1ACommand command =
        new UpdateExcIEEEAC1ACommand(
