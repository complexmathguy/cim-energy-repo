...
public class ExcANSTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excANSId = ExcANSBusinessDelegate.getExcANSInstance().createExcANS(generateNewCommand()).get();
    ...
    ExcANSBusinessDelegate.getExcANSInstance().createExcANS(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcANS : "
                          + successValue.getExcANSId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excANSId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcANSBusinessDelegate.getExcANSInstance()
          .delete(new DeleteExcANSCommand(entity.getExcANSId()))
          .get();
  ...
  protected UpdateExcANSCommand generateUpdateCommand() {
    UpdateExcANSCommand command =
        new UpdateExcANSCommand(
