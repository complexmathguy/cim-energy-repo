...
public class WindType1or2UserDefinedTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindType1or2UserDefined : "
                          + successValue.getWindType1or2UserDefinedId());
                  if (successValue
                      .getWindType1or2UserDefinedId()
                      .equals(windType1or2UserDefinedId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindType1or2UserDefinedList - 1,
      ...
      subscriber
          .windType1or2UserDefinedSubscribe(windType1or2UserDefinedId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindType1or2UserDefined : "
                          + successValue.getWindType1or2UserDefinedId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windType1or2UserDefined for windType1or2UserDefinedId consumed"));
  ...
  protected WindType1or2UserDefined read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read WindType1or2UserDefined with primary key");
    msg.append(windType1or2UserDefinedId);

    WindType1or2UserDefinedFetchOneSummary fetchOneSummary =
        new WindType1or2UserDefinedFetchOneSummary(windType1or2UserDefinedId);

    try {
      entity =
          WindType1or2UserDefinedBusinessDelegate.getWindType1or2UserDefinedInstance()
              .getWindType1or2UserDefined(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindType1or2UserDefinedBusinessDelegate proxy =
          WindType1or2UserDefinedBusinessDelegate.getWindType1or2UserDefinedInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read WindType1or2UserDefined with id " + windType1or2UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read WindType1or2UserDefined with id " + windType1or2UserDefinedId);
    ...
    try {
      WindType1or2UserDefinedBusinessDelegate.getWindType1or2UserDefinedInstance()
          .delete(new DeleteWindType1or2UserDefinedCommand(entity.getWindType1or2UserDefinedId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted WindType1or2UserDefined with id " + windType1or2UserDefinedId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete WindType1or2UserDefined with id " + windType1or2UserDefinedId);
  ...
  protected List<WindType1or2UserDefined> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindType1or2UserDefinedBusinessDelegate.getWindType1or2UserDefinedInstance()
              .getAllWindType1or2UserDefined();
      assertNotNull(
          collection, "An Empty collection of WindType1or2UserDefined was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindType1or2UserDefinedId(),
  ...
  protected UpdateWindType1or2UserDefinedCommand generateUpdateCommand() {
    UpdateWindType1or2UserDefinedCommand command =
        new UpdateWindType1or2UserDefinedCommand(null, null);
