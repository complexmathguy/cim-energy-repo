...
public class DCTopologicalIslandTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DCTopologicalIsland : "
                          + successValue.getDCTopologicalIslandId());
                  if (successValue.getDCTopologicalIslandId().equals(dCTopologicalIslandId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDCTopologicalIslandList - 1,
      ...
      subscriber
          .dCTopologicalIslandSubscribe(dCTopologicalIslandId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for DCTopologicalIsland : "
                          + successValue.getDCTopologicalIslandId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on dCTopologicalIsland for dCTopologicalIslandId consumed"));
  ...
  protected DCTopologicalIsland read() throws Throwable {
    ...
    DCTopologicalIslandFetchOneSummary fetchOneSummary =
        new DCTopologicalIslandFetchOneSummary(dCTopologicalIslandId);

    try {
      entity =
          DCTopologicalIslandBusinessDelegate.getDCTopologicalIslandInstance()
              .getDCTopologicalIsland(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      DCTopologicalIslandBusinessDelegate proxy =
          DCTopologicalIslandBusinessDelegate.getDCTopologicalIslandInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DCTopologicalIslandBusinessDelegate.getDCTopologicalIslandInstance()
          .delete(new DeleteDCTopologicalIslandCommand(entity.getDCTopologicalIslandId()))
          .get();
  ...
  protected List<DCTopologicalIsland> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          DCTopologicalIslandBusinessDelegate.getDCTopologicalIslandInstance()
              .getAllDCTopologicalIsland();
      assertNotNull(
          collection, "An Empty collection of DCTopologicalIsland was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getDCTopologicalIslandId(), "-- entity in Collection has a null primary key");
