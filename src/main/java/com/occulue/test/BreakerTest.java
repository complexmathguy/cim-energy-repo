...
public class BreakerTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    breakerId =
        BreakerBusinessDelegate.getBreakerInstance().createBreaker(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for Breaker : " + successValue.getBreakerId());
                  if (successValue.getBreakerId().equals(breakerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfBreakerList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Breaker : "
                          + successValue.getBreakerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + breakerId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      BreakerBusinessDelegate.getBreakerInstance()
          .delete(new DeleteBreakerCommand(entity.getBreakerId()))
          .get();
