...
public class WindGeneratingUnitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for WindGeneratingUnit : "
                          + successValue.getWindGeneratingUnitId());
                  if (successValue.getWindGeneratingUnitId().equals(windGeneratingUnitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfWindGeneratingUnitList - 1,
      ...
      subscriber
          .windGeneratingUnitSubscribe(windGeneratingUnitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for WindGeneratingUnit : "
                          + successValue.getWindGeneratingUnitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on windGeneratingUnit for windGeneratingUnitId consumed"));
  ...
  protected WindGeneratingUnit read() throws Throwable {
    ...
    WindGeneratingUnitFetchOneSummary fetchOneSummary =
        new WindGeneratingUnitFetchOneSummary(windGeneratingUnitId);

    try {
      entity =
          WindGeneratingUnitBusinessDelegate.getWindGeneratingUnitInstance()
              .getWindGeneratingUnit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      WindGeneratingUnitBusinessDelegate proxy =
          WindGeneratingUnitBusinessDelegate.getWindGeneratingUnitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      WindGeneratingUnitBusinessDelegate.getWindGeneratingUnitInstance()
          .delete(new DeleteWindGeneratingUnitCommand(entity.getWindGeneratingUnitId()))
          .get();
  ...
  protected List<WindGeneratingUnit> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          WindGeneratingUnitBusinessDelegate.getWindGeneratingUnitInstance()
              .getAllWindGeneratingUnit();
      assertNotNull(
          collection, "An Empty collection of WindGeneratingUnit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getWindGeneratingUnitId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateWindGeneratingUnitCommand generateNewCommand() {
    CreateWindGeneratingUnitCommand command =
        new CreateWindGeneratingUnitCommand(null, WindGenUnitKind.values()[0]);
  ...
  protected UpdateWindGeneratingUnitCommand generateUpdateCommand() {
    UpdateWindGeneratingUnitCommand command =
        new UpdateWindGeneratingUnitCommand(null, WindGenUnitKind.values()[0]);
