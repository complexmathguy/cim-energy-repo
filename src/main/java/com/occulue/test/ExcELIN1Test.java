...
public class ExcELIN1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excELIN1Id =
        ExcELIN1BusinessDelegate.getExcELIN1Instance().createExcELIN1(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcELIN1 : " + successValue.getExcELIN1Id());
                  if (successValue.getExcELIN1Id().equals(excELIN1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcELIN1List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcELIN1 : "
                          + successValue.getExcELIN1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excELIN1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcELIN1BusinessDelegate.getExcELIN1Instance()
          .delete(new DeleteExcELIN1Command(entity.getExcELIN1Id()))
          .get();
  ...
  protected UpdateExcELIN1Command generateUpdateCommand() {
    UpdateExcELIN1Command command =
        new UpdateExcELIN1Command(
