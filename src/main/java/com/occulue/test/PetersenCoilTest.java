...
public class PetersenCoilTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PetersenCoil : "
                          + successValue.getPetersenCoilId());
                  if (successValue.getPetersenCoilId().equals(petersenCoilId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPetersenCoilList - 1,
      ...
      subscriber
          .petersenCoilSubscribe(petersenCoilId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PetersenCoil : "
                          + successValue.getPetersenCoilId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected PetersenCoil read() throws Throwable {
    ...
    try {
      entity =
          PetersenCoilBusinessDelegate.getPetersenCoilInstance().getPetersenCoil(fetchOneSummary);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PetersenCoilBusinessDelegate.getPetersenCoilInstance()
          .delete(new DeletePetersenCoilCommand(entity.getPetersenCoilId()))
          .get();
  ...
  protected CreatePetersenCoilCommand generateNewCommand() {
    CreatePetersenCoilCommand command =
        new CreatePetersenCoilCommand(null, PetersenCoilModeKind.values()[0]);
  ...
  protected UpdatePetersenCoilCommand generateUpdateCommand() {
    UpdatePetersenCoilCommand command =
        new UpdatePetersenCoilCommand(
            null, PetersenCoilModeKind.values()[0], null, null, null, null, null, null);
