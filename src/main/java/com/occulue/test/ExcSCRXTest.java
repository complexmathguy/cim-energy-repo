...
public class ExcSCRXTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excSCRXId =
        ExcSCRXBusinessDelegate.getExcSCRXInstance().createExcSCRX(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcSCRX : " + successValue.getExcSCRXId());
                  if (successValue.getExcSCRXId().equals(excSCRXId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcSCRXList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcSCRX : "
                          + successValue.getExcSCRXId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excSCRXId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcSCRXBusinessDelegate.getExcSCRXInstance()
          .delete(new DeleteExcSCRXCommand(entity.getExcSCRXId()))
          .get();
  ...
  protected UpdateExcSCRXCommand generateUpdateCommand() {
    UpdateExcSCRXCommand command =
        new UpdateExcSCRXCommand(null, null, null, null, null, null, null, null, null);
