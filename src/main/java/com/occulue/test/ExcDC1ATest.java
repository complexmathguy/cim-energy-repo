...
public class ExcDC1ATest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excDC1AId =
        ExcDC1ABusinessDelegate.getExcDC1AInstance().createExcDC1A(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcDC1A : " + successValue.getExcDC1AId());
                  if (successValue.getExcDC1AId().equals(excDC1AId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcDC1AList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcDC1A : "
                          + successValue.getExcDC1AId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excDC1AId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcDC1ABusinessDelegate.getExcDC1AInstance()
          .delete(new DeleteExcDC1ACommand(entity.getExcDC1AId()))
          .get();
  ...
  protected UpdateExcDC1ACommand generateUpdateCommand() {
    UpdateExcDC1ACommand command =
        new UpdateExcDC1ACommand(
