...
public class AccumulatorLimitTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for AccumulatorLimit : "
                          + successValue.getAccumulatorLimitId());
                  if (successValue.getAccumulatorLimitId().equals(accumulatorLimitId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfAccumulatorLimitList - 1,
      ...
      subscriber
          .accumulatorLimitSubscribe(accumulatorLimitId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for AccumulatorLimit : "
                          + successValue.getAccumulatorLimitId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected AccumulatorLimit read() throws Throwable {
    ...
    AccumulatorLimitFetchOneSummary fetchOneSummary =
        new AccumulatorLimitFetchOneSummary(accumulatorLimitId);

    try {
      entity =
          AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance()
              .getAccumulatorLimit(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      AccumulatorLimitBusinessDelegate proxy =
          AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      AccumulatorLimitBusinessDelegate.getAccumulatorLimitInstance()
          .delete(new DeleteAccumulatorLimitCommand(entity.getAccumulatorLimitId()))
          .get();
  ...
  protected List<AccumulatorLimit> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of AccumulatorLimit was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getAccumulatorLimitId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateAccumulatorLimitCommand generateUpdateCommand() {
    UpdateAccumulatorLimitCommand command = new UpdateAccumulatorLimitCommand(null, null);
