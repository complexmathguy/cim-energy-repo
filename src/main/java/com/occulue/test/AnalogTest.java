...
public class AnalogTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    analogId = AnalogBusinessDelegate.getAnalogInstance().createAnalog(generateNewCommand()).get();
    ...
    AnalogBusinessDelegate.getAnalogInstance().createAnalog(generateNewCommand()).get();
  }
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for Analog : "
                          + successValue.getAnalogId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + analogId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      AnalogBusinessDelegate.getAnalogInstance()
          .delete(new DeleteAnalogCommand(entity.getAnalogId()))
          .get();
