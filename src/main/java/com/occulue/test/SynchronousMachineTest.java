...
public class SynchronousMachineTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for SynchronousMachine : "
                          + successValue.getSynchronousMachineId());
                  if (successValue.getSynchronousMachineId().equals(synchronousMachineId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfSynchronousMachineList - 1,
      ...
      subscriber
          .synchronousMachineSubscribe(synchronousMachineId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for SynchronousMachine : "
                          + successValue.getSynchronousMachineId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on synchronousMachine for synchronousMachineId consumed"));
  ...
  protected SynchronousMachine read() throws Throwable {
    ...
    SynchronousMachineFetchOneSummary fetchOneSummary =
        new SynchronousMachineFetchOneSummary(synchronousMachineId);

    try {
      entity =
          SynchronousMachineBusinessDelegate.getSynchronousMachineInstance()
              .getSynchronousMachine(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      SynchronousMachineBusinessDelegate proxy =
          SynchronousMachineBusinessDelegate.getSynchronousMachineInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      SynchronousMachineBusinessDelegate.getSynchronousMachineInstance()
          .delete(new DeleteSynchronousMachineCommand(entity.getSynchronousMachineId()))
          .get();
  ...
  protected List<SynchronousMachine> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          SynchronousMachineBusinessDelegate.getSynchronousMachineInstance()
              .getAllSynchronousMachine();
      assertNotNull(
          collection, "An Empty collection of SynchronousMachine was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getSynchronousMachineId(), "-- entity in Collection has a null primary key");
  ...
  protected CreateSynchronousMachineCommand generateNewCommand() {
    CreateSynchronousMachineCommand command =
        new CreateSynchronousMachineCommand(
            null, ShortCircuitRotorKind.values()[0], SynchronousMachineKind.values()[0]);
  ...
  protected UpdateSynchronousMachineCommand generateUpdateCommand() {
    UpdateSynchronousMachineCommand command =
        new UpdateSynchronousMachineCommand(
            null,
            null,
            null,
            null,
            ...
            null,
            null,
            ShortCircuitRotorKind.values()[0],
            SynchronousMachineKind.values()[0],
            null,
            null,
            null);
