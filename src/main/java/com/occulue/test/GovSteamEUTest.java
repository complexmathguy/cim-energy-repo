...
public class GovSteamEUTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovSteamEUBusinessDelegate.getGovSteamEUInstance().createGovSteamEU(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovSteamEU : " + successValue.getGovSteamEUId());
                  if (successValue.getGovSteamEUId().equals(govSteamEUId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovSteamEUList - 1,
      ...
      subscriber
          .govSteamEUSubscribe(govSteamEUId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovSteamEU : "
                          + successValue.getGovSteamEUId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovSteamEUBusinessDelegate.getGovSteamEUInstance()
          .delete(new DeleteGovSteamEUCommand(entity.getGovSteamEUId()))
          .get();
  ...
  protected UpdateGovSteamEUCommand generateUpdateCommand() {
    UpdateGovSteamEUCommand command =
        new UpdateGovSteamEUCommand(
