...
public class ConnectivityNodeContainerTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ConnectivityNodeContainer : "
                          + successValue.getConnectivityNodeContainerId());
                  if (successValue
                      .getConnectivityNodeContainerId()
                      .equals(connectivityNodeContainerId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfConnectivityNodeContainerList - 1,
      ...
      subscriber
          .connectivityNodeContainerSubscribe(connectivityNodeContainerId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for ConnectivityNodeContainer : "
                          + successValue.getConnectivityNodeContainerId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on connectivityNodeContainer for connectivityNodeContainerId consumed"));
  ...
  protected ConnectivityNodeContainer read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read ConnectivityNodeContainer with primary key");
    msg.append(connectivityNodeContainerId);

    ConnectivityNodeContainerFetchOneSummary fetchOneSummary =
        new ConnectivityNodeContainerFetchOneSummary(connectivityNodeContainerId);

    try {
      entity =
          ConnectivityNodeContainerBusinessDelegate.getConnectivityNodeContainerInstance()
              .getConnectivityNodeContainer(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      ConnectivityNodeContainerBusinessDelegate proxy =
          ConnectivityNodeContainerBusinessDelegate.getConnectivityNodeContainerInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read ConnectivityNodeContainer with id " + connectivityNodeContainerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read ConnectivityNodeContainer with id " + connectivityNodeContainerId);
    ...
    try {
      ConnectivityNodeContainerBusinessDelegate.getConnectivityNodeContainerInstance()
          .delete(
              new DeleteConnectivityNodeContainerCommand(entity.getConnectivityNodeContainerId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted ConnectivityNodeContainer with id "
              + connectivityNodeContainerId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete ConnectivityNodeContainer with id " + connectivityNodeContainerId);
  ...
  protected List<ConnectivityNodeContainer> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          ConnectivityNodeContainerBusinessDelegate.getConnectivityNodeContainerInstance()
              .getAllConnectivityNodeContainer();
      assertNotNull(
          collection, "An Empty collection of ConnectivityNodeContainer was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getConnectivityNodeContainerId(),
  ...
  protected CreateConnectivityNodeContainerCommand generateNewCommand() {
    CreateConnectivityNodeContainerCommand command =
        new CreateConnectivityNodeContainerCommand(null);
  ...
  protected UpdateConnectivityNodeContainerCommand generateUpdateCommand() {
    UpdateConnectivityNodeContainerCommand command =
        new UpdateConnectivityNodeContainerCommand(null);
