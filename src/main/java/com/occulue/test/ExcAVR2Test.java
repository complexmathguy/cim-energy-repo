...
public class ExcAVR2Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    excAVR2Id =
        ExcAVR2BusinessDelegate.getExcAVR2Instance().createExcAVR2(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for ExcAVR2 : " + successValue.getExcAVR2Id());
                  if (successValue.getExcAVR2Id().equals(excAVR2Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfExcAVR2List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for ExcAVR2 : "
                          + successValue.getExcAVR2Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + excAVR2Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      ExcAVR2BusinessDelegate.getExcAVR2Instance()
          .delete(new DeleteExcAVR2Command(entity.getExcAVR2Id()))
          .get();
  ...
  protected UpdateExcAVR2Command generateUpdateCommand() {
    UpdateExcAVR2Command command =
        new UpdateExcAVR2Command(
