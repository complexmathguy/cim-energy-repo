...
public class DateTimeTest {
  ...
  protected void jumpStart() throws Throwable {
    ...
    dateTimeId =
        DateTimeBusinessDelegate.getDateTimeInstance().createDateTime(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for DateTime : " + successValue.getDateTimeId());
                  if (successValue.getDateTimeId().equals(dateTimeId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfDateTimeList - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for DateTime : "
                          + successValue.getDateTimeId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + dateTimeId + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      DateTimeBusinessDelegate.getDateTimeInstance()
          .delete(new DeleteDateTimeCommand(entity.getDateTimeId()))
          .get();
