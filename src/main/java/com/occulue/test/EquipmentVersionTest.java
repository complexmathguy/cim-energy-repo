...
public class EquipmentVersionTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for EquipmentVersion : "
                          + successValue.getEquipmentVersionId());
                  if (successValue.getEquipmentVersionId().equals(equipmentVersionId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfEquipmentVersionList - 1,
      ...
      subscriber
          .equipmentVersionSubscribe(equipmentVersionId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for EquipmentVersion : "
                          + successValue.getEquipmentVersionId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected EquipmentVersion read() throws Throwable {
    ...
    EquipmentVersionFetchOneSummary fetchOneSummary =
        new EquipmentVersionFetchOneSummary(equipmentVersionId);

    try {
      entity =
          EquipmentVersionBusinessDelegate.getEquipmentVersionInstance()
              .getEquipmentVersion(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      EquipmentVersionBusinessDelegate proxy =
          EquipmentVersionBusinessDelegate.getEquipmentVersionInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      EquipmentVersionBusinessDelegate.getEquipmentVersionInstance()
          .delete(new DeleteEquipmentVersionCommand(entity.getEquipmentVersionId()))
          .get();
  ...
  protected List<EquipmentVersion> getAll() throws Throwable {
    ...
    try {
      ...
      assertNotNull(
          collection, "An Empty collection of EquipmentVersion was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getEquipmentVersionId(), "-- entity in Collection has a null primary key");
  ...
  protected UpdateEquipmentVersionCommand generateUpdateCommand() {
    UpdateEquipmentVersionCommand command =
        new UpdateEquipmentVersionCommand(
