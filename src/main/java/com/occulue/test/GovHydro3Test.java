...
public class GovHydro3Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    GovHydro3BusinessDelegate.getGovHydro3Instance().createGovHydro3(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovHydro3 : " + successValue.getGovHydro3Id());
                  if (successValue.getGovHydro3Id().equals(govHydro3Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovHydro3List - 1,
      ...
      subscriber
          .govHydro3Subscribe(govHydro3Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for GovHydro3 : "
                          + successValue.getGovHydro3Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govHydro3Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovHydro3BusinessDelegate.getGovHydro3Instance()
          .delete(new DeleteGovHydro3Command(entity.getGovHydro3Id()))
          .get();
  ...
  protected UpdateGovHydro3Command generateUpdateCommand() {
    UpdateGovHydro3Command command =
        new UpdateGovHydro3Command(
