...
public class RotatingMachineDynamicsTest {
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for RotatingMachineDynamics : "
                          + successValue.getRotatingMachineDynamicsId());
                  if (successValue
                      .getRotatingMachineDynamicsId()
                      .equals(rotatingMachineDynamicsId)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfRotatingMachineDynamicsList - 1,
      ...
      subscriber
          .rotatingMachineDynamicsSubscribe(rotatingMachineDynamicsId)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for RotatingMachineDynamics : "
                          + successValue.getRotatingMachineDynamicsId()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
              ...
              () ->
                  LOGGER.info(
                      "Subscription on rotatingMachineDynamics for rotatingMachineDynamicsId consumed"));
  ...
  protected RotatingMachineDynamics read() throws Throwable {
    ...
    StringBuilder msg =
        new StringBuilder("-- Failed to read RotatingMachineDynamics with primary key");
    msg.append(rotatingMachineDynamicsId);

    RotatingMachineDynamicsFetchOneSummary fetchOneSummary =
        new RotatingMachineDynamicsFetchOneSummary(rotatingMachineDynamicsId);

    try {
      entity =
          RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance()
              .getRotatingMachineDynamics(fetchOneSummary);
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      RotatingMachineDynamicsBusinessDelegate proxy =
          RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance();
  ...
  protected void delete() throws Throwable {
    ...
    try {
      entity = read();
      LOGGER.info(
          "-- Successfully read RotatingMachineDynamics with id " + rotatingMachineDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to read RotatingMachineDynamics with id " + rotatingMachineDynamicsId);
    ...
    try {
      RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance()
          .delete(new DeleteRotatingMachineDynamicsCommand(entity.getRotatingMachineDynamicsId()))
          .get();
      LOGGER.info(
          "-- Successfully deleted RotatingMachineDynamics with id " + rotatingMachineDynamicsId);
    } catch (Throwable e) {
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          "-- Failed to delete RotatingMachineDynamics with id " + rotatingMachineDynamicsId);
  ...
  protected List<RotatingMachineDynamics> getAll() throws Throwable {
    ...
    try {
      ...
      collection =
          RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance()
              .getAllRotatingMachineDynamics();
      assertNotNull(
          collection, "An Empty collection of RotatingMachineDynamics was incorrectly returned.");
      ...
      while (iter.hasNext()) {
        ...
        assertNotNull(
            entity.getRotatingMachineDynamicsId(),
  ...
  protected UpdateRotatingMachineDynamicsCommand generateUpdateCommand() {
    UpdateRotatingMachineDynamicsCommand command =
        new UpdateRotatingMachineDynamicsCommand(null, null, null, null, null, null, null);
