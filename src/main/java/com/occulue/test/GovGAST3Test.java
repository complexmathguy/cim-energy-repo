...
public class GovGAST3Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    govGAST3Id =
        GovGAST3BusinessDelegate.getGovGAST3Instance().createGovGAST3(generateNewCommand()).get();
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for GovGAST3 : " + successValue.getGovGAST3Id());
                  if (successValue.getGovGAST3Id().equals(govGAST3Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfGovGAST3List - 1, "value not deleted from list");
                      LOGGER.info("**********************************************************");
      ...
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetOne update received for GovGAST3 : "
                          + successValue.getGovGAST3Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + govGAST3Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      GovGAST3BusinessDelegate.getGovGAST3Instance()
          .delete(new DeleteGovGAST3Command(entity.getGovGAST3Id()))
          .get();
  ...
  protected UpdateGovGAST3Command generateUpdateCommand() {
    UpdateGovGAST3Command command =
        new UpdateGovGAST3Command(
