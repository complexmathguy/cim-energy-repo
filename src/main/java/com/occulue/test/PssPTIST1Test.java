...
public class PssPTIST1Test {
  ...
  protected void jumpStart() throws Throwable {
    ...
    PssPTIST1BusinessDelegate.getPssPTIST1Instance().createPssPTIST1(generateNewCommand()).get();
  }
  ...
  protected void setUpQuerySubscriptions() throws Throwable {
    ...
    try {
      subscriber
          ...
          .subscribe(
              successValue -> {
                ...
                try {
                  LOGGER.info(
                      "GetAll update received for PssPTIST1 : " + successValue.getPssPTIST1Id());
                  if (successValue.getPssPTIST1Id().equals(pssPTIST1Id)) {
                    if (testingStep.equals("create")) {
                      ...
                      state(
                          getAll().size() == sizeOfPssPTIST1List - 1,
      ...
      subscriber
          .pssPTIST1Subscribe(pssPTIST1Id)
          .updates()
          .subscribe(
              successValue -> {
                LOGGER.info(successValue.toString());
                try {
                  LOGGER.info(
                      "GetOne update received for PssPTIST1 : "
                          + successValue.getPssPTIST1Id()
                          + " in step "
                          + testingStep);
                  testingStep = "delete";
  ...
  protected void update() throws Throwable {
    ...
    try {
      ...
      LOGGER.warning(unexpectedErrorMsg);
      LOGGER.warning(
          msg.toString() + " : primarykey = " + pssPTIST1Id + " : command -" + command + " : " + e);
  ...
  protected void delete() throws Throwable {
    ...
    try {
      PssPTIST1BusinessDelegate.getPssPTIST1Instance()
          .delete(new DeletePssPTIST1Command(entity.getPssPTIST1Id()))
          .get();
  ...
  protected UpdatePssPTIST1Command generateUpdateCommand() {
    UpdatePssPTIST1Command command =
        new UpdatePssPTIST1Command(
