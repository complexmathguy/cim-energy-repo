...
public class TopologicalNodeSubscriber extends BaseSubscriber {
  ...
  public SubscriptionQueryResult<List<TopologicalNode>, TopologicalNode>
  ...
  public SubscriptionQueryResult<TopologicalNode, TopologicalNode> topologicalNodeSubscribe(
      @DestinationVariable UUID topologicalNodeId) {
    return queryGateway.subscriptionQuery(
        new FindTopologicalNodeQuery(new LoadTopologicalNodeFilter(topologicalNodeId)),
        ResponseTypes.instanceOf(TopologicalNode.class),
        ResponseTypes.instanceOf(TopologicalNode.class));
  }
