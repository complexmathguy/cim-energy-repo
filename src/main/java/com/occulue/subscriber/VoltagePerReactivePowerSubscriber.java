...
public class VoltagePerReactivePowerSubscriber extends BaseSubscriber {
  ...
  public SubscriptionQueryResult<List<VoltagePerReactivePower>, VoltagePerReactivePower>
  ...
  public SubscriptionQueryResult<VoltagePerReactivePower, VoltagePerReactivePower>
      voltagePerReactivePowerSubscribe(@DestinationVariable UUID voltagePerReactivePowerId) {
    return queryGateway.subscriptionQuery(
        new FindVoltagePerReactivePowerQuery(
            new LoadVoltagePerReactivePowerFilter(voltagePerReactivePowerId)),
        ResponseTypes.instanceOf(VoltagePerReactivePower.class),
        ResponseTypes.instanceOf(VoltagePerReactivePower.class));
  }
