...
public class ConnectivityNodeSubscriber extends BaseSubscriber {
  ...
  public SubscriptionQueryResult<List<ConnectivityNode>, ConnectivityNode>
  ...
  public SubscriptionQueryResult<ConnectivityNode, ConnectivityNode> connectivityNodeSubscribe(
      @DestinationVariable UUID connectivityNodeId) {
    return queryGateway.subscriptionQuery(
        new FindConnectivityNodeQuery(new LoadConnectivityNodeFilter(connectivityNodeId)),
        ResponseTypes.instanceOf(ConnectivityNode.class),
        ResponseTypes.instanceOf(ConnectivityNode.class));
  }
