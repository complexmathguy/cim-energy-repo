...
public class WindTurbineType3or4DynamicsSubscriber extends BaseSubscriber {
  ...
  public SubscriptionQueryResult<List<WindTurbineType3or4Dynamics>, WindTurbineType3or4Dynamics>
  ...
  public SubscriptionQueryResult<WindTurbineType3or4Dynamics, WindTurbineType3or4Dynamics>
      windTurbineType3or4DynamicsSubscribe(
          @DestinationVariable UUID windTurbineType3or4DynamicsId) {
    return queryGateway.subscriptionQuery(
        new FindWindTurbineType3or4DynamicsQuery(
            new LoadWindTurbineType3or4DynamicsFilter(windTurbineType3or4DynamicsId)),
        ResponseTypes.instanceOf(WindTurbineType3or4Dynamics.class),
        ResponseTypes.instanceOf(WindTurbineType3or4Dynamics.class));
  }
