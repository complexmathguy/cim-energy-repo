...
/**
 * Aggregate handler for ENTSOETopologicalNode as outlined for the CQRS pattern, all write
 * responsibilities related to ENTSOETopologicalNode are handled here.
 *
...
public class ENTSOETopologicalNodeAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public ENTSOETopologicalNodeAggregate(CreateENTSOETopologicalNodeCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateENTSOETopologicalNodeCommand");
    CreateENTSOETopologicalNodeEvent event =
        new CreateENTSOETopologicalNodeEvent(command.getENTSOETopologicalNodeId());
  ...
  public void handle(UpdateENTSOETopologicalNodeCommand command) throws Exception {
    ...
    UpdateENTSOETopologicalNodeEvent event =
        new UpdateENTSOETopologicalNodeEvent(command.getENTSOETopologicalNodeId());
  ...
  @AggregateIdentifier private UUID eNTSOETopologicalNodeId;

  private static final Logger LOGGER =
      Logger.getLogger(ENTSOETopologicalNodeAggregate.class.getName());
}
