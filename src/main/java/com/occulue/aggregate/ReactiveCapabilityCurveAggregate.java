...
/**
 * Aggregate handler for ReactiveCapabilityCurve as outlined for the CQRS pattern, all write
 * responsibilities related to ReactiveCapabilityCurve are handled here.
 *
...
public class ReactiveCapabilityCurveAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public ReactiveCapabilityCurveAggregate(CreateReactiveCapabilityCurveCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateReactiveCapabilityCurveCommand");
    CreateReactiveCapabilityCurveEvent event =
        new CreateReactiveCapabilityCurveEvent(command.getReactiveCapabilityCurveId());
  ...
  public void handle(UpdateReactiveCapabilityCurveCommand command) throws Exception {
    ...
    UpdateReactiveCapabilityCurveEvent event =
        new UpdateReactiveCapabilityCurveEvent(command.getReactiveCapabilityCurveId());
  ...
  @AggregateIdentifier private UUID reactiveCapabilityCurveId;

  private static final Logger LOGGER =
      Logger.getLogger(ReactiveCapabilityCurveAggregate.class.getName());
}
