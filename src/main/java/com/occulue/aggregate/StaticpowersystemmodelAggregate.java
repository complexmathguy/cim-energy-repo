...
/**
 * Aggregate handler for Staticpowersystemmodel as outlined for the CQRS pattern, all write
 * responsibilities related to Staticpowersystemmodel are handled here.
 *
...
public class StaticpowersystemmodelAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public StaticpowersystemmodelAggregate(CreateStaticpowersystemmodelCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateStaticpowersystemmodelCommand");
    CreateStaticpowersystemmodelEvent event =
        new CreateStaticpowersystemmodelEvent(command.getStaticpowersystemmodelId());
  ...
  public void handle(UpdateStaticpowersystemmodelCommand command) throws Exception {
    ...
    UpdateStaticpowersystemmodelEvent event =
        new UpdateStaticpowersystemmodelEvent(command.getStaticpowersystemmodelId());
  ...
  @AggregateIdentifier private UUID staticpowersystemmodelId;

  private static final Logger LOGGER =
      Logger.getLogger(StaticpowersystemmodelAggregate.class.getName());
}
