...
/**
 * Aggregate handler for GroundDisconnector as outlined for the CQRS pattern, all write
 * responsibilities related to GroundDisconnector are handled here.
 *
...
public class GroundDisconnectorAggregate {
  ...
  public GroundDisconnectorAggregate(CreateGroundDisconnectorCommand command) throws Exception {
    ...
    CreateGroundDisconnectorEvent event =
        new CreateGroundDisconnectorEvent(command.getGroundDisconnectorId());
  ...
  public void handle(UpdateGroundDisconnectorCommand command) throws Exception {
    ...
    UpdateGroundDisconnectorEvent event =
        new UpdateGroundDisconnectorEvent(command.getGroundDisconnectorId());
  ...
  @AggregateIdentifier private UUID groundDisconnectorId;

  private static final Logger LOGGER =
      Logger.getLogger(GroundDisconnectorAggregate.class.getName());
}
