...
/**
 * Aggregate handler for SynchronousMachineSimplified as outlined for the CQRS pattern, all write
 * responsibilities related to SynchronousMachineSimplified are handled here.
 *
...
public class SynchronousMachineSimplifiedAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public SynchronousMachineSimplifiedAggregate(CreateSynchronousMachineSimplifiedCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateSynchronousMachineSimplifiedCommand");
    CreateSynchronousMachineSimplifiedEvent event =
        new CreateSynchronousMachineSimplifiedEvent(command.getSynchronousMachineSimplifiedId());
  ...
  public void handle(UpdateSynchronousMachineSimplifiedCommand command) throws Exception {
    ...
    UpdateSynchronousMachineSimplifiedEvent event =
        new UpdateSynchronousMachineSimplifiedEvent(command.getSynchronousMachineSimplifiedId());
  ...
  @AggregateIdentifier private UUID synchronousMachineSimplifiedId;

  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineSimplifiedAggregate.class.getName());
}
