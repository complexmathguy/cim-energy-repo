...
/**
 * Aggregate handler for ConformLoadGroup as outlined for the CQRS pattern, all write
 * responsibilities related to ConformLoadGroup are handled here.
 *
...
public class ConformLoadGroupAggregate {
  ...
  public ConformLoadGroupAggregate(CreateConformLoadGroupCommand command) throws Exception {
    ...
    CreateConformLoadGroupEvent event =
        new CreateConformLoadGroupEvent(command.getConformLoadGroupId());
  ...
  public void handle(UpdateConformLoadGroupCommand command) throws Exception {
    ...
    UpdateConformLoadGroupEvent event =
        new UpdateConformLoadGroupEvent(command.getConformLoadGroupId());
  ...
  @AggregateIdentifier private UUID conformLoadGroupId;
