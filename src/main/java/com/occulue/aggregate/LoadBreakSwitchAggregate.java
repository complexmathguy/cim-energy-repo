...
/**
 * Aggregate handler for LoadBreakSwitch as outlined for the CQRS pattern, all write
 * responsibilities related to LoadBreakSwitch are handled here.
 *
...
public class LoadBreakSwitchAggregate {
  ...
  public LoadBreakSwitchAggregate(CreateLoadBreakSwitchCommand command) throws Exception {
    ...
    CreateLoadBreakSwitchEvent event =
        new CreateLoadBreakSwitchEvent(command.getLoadBreakSwitchId());
  ...
  public void handle(UpdateLoadBreakSwitchCommand command) throws Exception {
    ...
    UpdateLoadBreakSwitchEvent event =
        new UpdateLoadBreakSwitchEvent(command.getLoadBreakSwitchId());
  ...
  @AggregateIdentifier private UUID loadBreakSwitchId;
