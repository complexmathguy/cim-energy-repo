...
/**
 * Aggregate handler for PhaseTapChangerTable as outlined for the CQRS pattern, all write
 * responsibilities related to PhaseTapChangerTable are handled here.
 *
...
public class PhaseTapChangerTableAggregate {
  ...
  public PhaseTapChangerTableAggregate(CreatePhaseTapChangerTableCommand command) throws Exception {
    ...
    CreatePhaseTapChangerTableEvent event =
        new CreatePhaseTapChangerTableEvent(command.getPhaseTapChangerTableId());
  ...
  public void handle(UpdatePhaseTapChangerTableCommand command) throws Exception {
    ...
    UpdatePhaseTapChangerTableEvent event =
        new UpdatePhaseTapChangerTableEvent(command.getPhaseTapChangerTableId());
  ...
  @AggregateIdentifier private UUID phaseTapChangerTableId;

  private static final Logger LOGGER =
      Logger.getLogger(PhaseTapChangerTableAggregate.class.getName());
}
