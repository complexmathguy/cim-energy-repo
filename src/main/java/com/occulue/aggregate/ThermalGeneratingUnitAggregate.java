...
/**
 * Aggregate handler for ThermalGeneratingUnit as outlined for the CQRS pattern, all write
 * responsibilities related to ThermalGeneratingUnit are handled here.
 *
...
public class ThermalGeneratingUnitAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public ThermalGeneratingUnitAggregate(CreateThermalGeneratingUnitCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateThermalGeneratingUnitCommand");
    CreateThermalGeneratingUnitEvent event =
        new CreateThermalGeneratingUnitEvent(command.getThermalGeneratingUnitId());
  ...
  public void handle(UpdateThermalGeneratingUnitCommand command) throws Exception {
    ...
    UpdateThermalGeneratingUnitEvent event =
        new UpdateThermalGeneratingUnitEvent(command.getThermalGeneratingUnitId());
  ...
  @AggregateIdentifier private UUID thermalGeneratingUnitId;

  private static final Logger LOGGER =
      Logger.getLogger(ThermalGeneratingUnitAggregate.class.getName());
}
