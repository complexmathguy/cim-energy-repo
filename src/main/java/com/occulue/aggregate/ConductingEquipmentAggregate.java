...
/**
 * Aggregate handler for ConductingEquipment as outlined for the CQRS pattern, all write
 * responsibilities related to ConductingEquipment are handled here.
 *
...
public class ConductingEquipmentAggregate {
  ...
  public ConductingEquipmentAggregate(CreateConductingEquipmentCommand command) throws Exception {
    ...
    CreateConductingEquipmentEvent event =
        new CreateConductingEquipmentEvent(command.getConductingEquipmentId());
  ...
  public void handle(UpdateConductingEquipmentCommand command) throws Exception {
    ...
    UpdateConductingEquipmentEvent event =
        new UpdateConductingEquipmentEvent(command.getConductingEquipmentId());
  ...
  @AggregateIdentifier private UUID conductingEquipmentId;

  private static final Logger LOGGER =
      Logger.getLogger(ConductingEquipmentAggregate.class.getName());
}
