...
/**
 * Aggregate handler for Ground as outlined for the CQRS pattern, all write responsibilities related
 * to Ground are handled here.
 *
...
public class GroundAggregate {
  ...
  @AggregateIdentifier private UUID groundId;
