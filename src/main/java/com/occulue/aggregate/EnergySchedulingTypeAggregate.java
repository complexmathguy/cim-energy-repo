...
/**
 * Aggregate handler for EnergySchedulingType as outlined for the CQRS pattern, all write
 * responsibilities related to EnergySchedulingType are handled here.
 *
...
public class EnergySchedulingTypeAggregate {
  ...
  public EnergySchedulingTypeAggregate(CreateEnergySchedulingTypeCommand command) throws Exception {
    ...
    CreateEnergySchedulingTypeEvent event =
        new CreateEnergySchedulingTypeEvent(command.getEnergySchedulingTypeId());
  ...
  public void handle(UpdateEnergySchedulingTypeCommand command) throws Exception {
    ...
    UpdateEnergySchedulingTypeEvent event =
        new UpdateEnergySchedulingTypeEvent(command.getEnergySchedulingTypeId());
  ...
  @AggregateIdentifier private UUID energySchedulingTypeId;

  private static final Logger LOGGER =
      Logger.getLogger(EnergySchedulingTypeAggregate.class.getName());
}
