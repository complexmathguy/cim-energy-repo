...
/**
 * Aggregate handler for ENTSOEConnectivityNode as outlined for the CQRS pattern, all write
 * responsibilities related to ENTSOEConnectivityNode are handled here.
 *
...
public class ENTSOEConnectivityNodeAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public ENTSOEConnectivityNodeAggregate(CreateENTSOEConnectivityNodeCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateENTSOEConnectivityNodeCommand");
    CreateENTSOEConnectivityNodeEvent event =
        new CreateENTSOEConnectivityNodeEvent(command.getENTSOEConnectivityNodeId());
  ...
  public void handle(UpdateENTSOEConnectivityNodeCommand command) throws Exception {
    ...
    UpdateENTSOEConnectivityNodeEvent event =
        new UpdateENTSOEConnectivityNodeEvent(command.getENTSOEConnectivityNodeId());
  ...
  @AggregateIdentifier private UUID eNTSOEConnectivityNodeId;

  private static final Logger LOGGER =
      Logger.getLogger(ENTSOEConnectivityNodeAggregate.class.getName());
}
