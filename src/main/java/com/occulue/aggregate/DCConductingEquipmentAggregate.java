...
/**
 * Aggregate handler for DCConductingEquipment as outlined for the CQRS pattern, all write
 * responsibilities related to DCConductingEquipment are handled here.
 *
...
public class DCConductingEquipmentAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public DCConductingEquipmentAggregate(CreateDCConductingEquipmentCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateDCConductingEquipmentCommand");
    CreateDCConductingEquipmentEvent event =
        new CreateDCConductingEquipmentEvent(command.getDCConductingEquipmentId());
  ...
  public void handle(UpdateDCConductingEquipmentCommand command) throws Exception {
    ...
    UpdateDCConductingEquipmentEvent event =
        new UpdateDCConductingEquipmentEvent(command.getDCConductingEquipmentId());
  ...
  @AggregateIdentifier private UUID dCConductingEquipmentId;

  private static final Logger LOGGER =
      Logger.getLogger(DCConductingEquipmentAggregate.class.getName());
}
