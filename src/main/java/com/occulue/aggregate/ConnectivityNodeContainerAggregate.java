...
/**
 * Aggregate handler for ConnectivityNodeContainer as outlined for the CQRS pattern, all write
 * responsibilities related to ConnectivityNodeContainer are handled here.
 *
...
public class ConnectivityNodeContainerAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public ConnectivityNodeContainerAggregate(CreateConnectivityNodeContainerCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateConnectivityNodeContainerCommand");
    CreateConnectivityNodeContainerEvent event =
        new CreateConnectivityNodeContainerEvent(command.getConnectivityNodeContainerId());
  ...
  public void handle(UpdateConnectivityNodeContainerCommand command) throws Exception {
    ...
    UpdateConnectivityNodeContainerEvent event =
        new UpdateConnectivityNodeContainerEvent(command.getConnectivityNodeContainerId());
  ...
  @AggregateIdentifier private UUID connectivityNodeContainerId;

  private static final Logger LOGGER =
      Logger.getLogger(ConnectivityNodeContainerAggregate.class.getName());
}
