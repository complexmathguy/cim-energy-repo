...
/**
 * Aggregate handler for NonConformLoadGroup as outlined for the CQRS pattern, all write
 * responsibilities related to NonConformLoadGroup are handled here.
 *
...
public class NonConformLoadGroupAggregate {
  ...
  public NonConformLoadGroupAggregate(CreateNonConformLoadGroupCommand command) throws Exception {
    ...
    CreateNonConformLoadGroupEvent event =
        new CreateNonConformLoadGroupEvent(command.getNonConformLoadGroupId());
  ...
  public void handle(UpdateNonConformLoadGroupCommand command) throws Exception {
    ...
    UpdateNonConformLoadGroupEvent event =
        new UpdateNonConformLoadGroupEvent(command.getNonConformLoadGroupId());
  ...
  @AggregateIdentifier private UUID nonConformLoadGroupId;

  private static final Logger LOGGER =
      Logger.getLogger(NonConformLoadGroupAggregate.class.getName());
}
