...
/**
 * Aggregate handler for ProtectedSwitch as outlined for the CQRS pattern, all write
 * responsibilities related to ProtectedSwitch are handled here.
 *
...
public class ProtectedSwitchAggregate {
  ...
  public ProtectedSwitchAggregate(CreateProtectedSwitchCommand command) throws Exception {
    ...
    CreateProtectedSwitchEvent event =
        new CreateProtectedSwitchEvent(command.getProtectedSwitchId());
  ...
  public void handle(UpdateProtectedSwitchCommand command) throws Exception {
    ...
    UpdateProtectedSwitchEvent event =
        new UpdateProtectedSwitchEvent(command.getProtectedSwitchId());
  ...
  @AggregateIdentifier private UUID protectedSwitchId;
