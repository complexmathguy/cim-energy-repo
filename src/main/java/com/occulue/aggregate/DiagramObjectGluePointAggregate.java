...
/**
 * Aggregate handler for DiagramObjectGluePoint as outlined for the CQRS pattern, all write
 * responsibilities related to DiagramObjectGluePoint are handled here.
 *
...
public class DiagramObjectGluePointAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public DiagramObjectGluePointAggregate(CreateDiagramObjectGluePointCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateDiagramObjectGluePointCommand");
    CreateDiagramObjectGluePointEvent event =
        new CreateDiagramObjectGluePointEvent(command.getDiagramObjectGluePointId());
  ...
  public void handle(UpdateDiagramObjectGluePointCommand command) throws Exception {
    ...
    UpdateDiagramObjectGluePointEvent event =
        new UpdateDiagramObjectGluePointEvent(command.getDiagramObjectGluePointId());
  ...
  @AggregateIdentifier private UUID diagramObjectGluePointId;

  private static final Logger LOGGER =
      Logger.getLogger(DiagramObjectGluePointAggregate.class.getName());
}
