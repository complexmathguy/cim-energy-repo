...
/**
 * Aggregate handler for NonlinearShuntCompensator as outlined for the CQRS pattern, all write
 * responsibilities related to NonlinearShuntCompensator are handled here.
 *
...
public class NonlinearShuntCompensatorAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public NonlinearShuntCompensatorAggregate(CreateNonlinearShuntCompensatorCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateNonlinearShuntCompensatorCommand");
    CreateNonlinearShuntCompensatorEvent event =
        new CreateNonlinearShuntCompensatorEvent(command.getNonlinearShuntCompensatorId());
  ...
  public void handle(UpdateNonlinearShuntCompensatorCommand command) throws Exception {
    ...
    UpdateNonlinearShuntCompensatorEvent event =
        new UpdateNonlinearShuntCompensatorEvent(command.getNonlinearShuntCompensatorId());
  ...
  @AggregateIdentifier private UUID nonlinearShuntCompensatorId;

  private static final Logger LOGGER =
      Logger.getLogger(NonlinearShuntCompensatorAggregate.class.getName());
}
