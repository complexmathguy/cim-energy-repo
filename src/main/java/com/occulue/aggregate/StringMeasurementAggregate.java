...
/**
 * Aggregate handler for StringMeasurement as outlined for the CQRS pattern, all write
 * responsibilities related to StringMeasurement are handled here.
 *
...
public class StringMeasurementAggregate {
  ...
  public StringMeasurementAggregate(CreateStringMeasurementCommand command) throws Exception {
    ...
    CreateStringMeasurementEvent event =
        new CreateStringMeasurementEvent(command.getStringMeasurementId());
  ...
  public void handle(UpdateStringMeasurementCommand command) throws Exception {
    ...
    UpdateStringMeasurementEvent event =
        new UpdateStringMeasurementEvent(command.getStringMeasurementId());
  ...
  @AggregateIdentifier private UUID stringMeasurementId;
