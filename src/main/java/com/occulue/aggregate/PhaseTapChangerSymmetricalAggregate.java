...
/**
 * Aggregate handler for PhaseTapChangerSymmetrical as outlined for the CQRS pattern, all write
 * responsibilities related to PhaseTapChangerSymmetrical are handled here.
 *
...
public class PhaseTapChangerSymmetricalAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public PhaseTapChangerSymmetricalAggregate(CreatePhaseTapChangerSymmetricalCommand command)
      throws Exception {
    LOGGER.info("Handling command CreatePhaseTapChangerSymmetricalCommand");
    CreatePhaseTapChangerSymmetricalEvent event =
        new CreatePhaseTapChangerSymmetricalEvent(command.getPhaseTapChangerSymmetricalId());
  ...
  public void handle(UpdatePhaseTapChangerSymmetricalCommand command) throws Exception {
    ...
    UpdatePhaseTapChangerSymmetricalEvent event =
        new UpdatePhaseTapChangerSymmetricalEvent(command.getPhaseTapChangerSymmetricalId());
  ...
  @AggregateIdentifier private UUID phaseTapChangerSymmetricalId;

  private static final Logger LOGGER =
      Logger.getLogger(PhaseTapChangerSymmetricalAggregate.class.getName());
}
