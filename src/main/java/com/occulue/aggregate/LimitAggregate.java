...
/**
 * Aggregate handler for Limit as outlined for the CQRS pattern, all write responsibilities related
 * to Limit are handled here.
 *
...
public class LimitAggregate {
  ...
  @AggregateIdentifier private UUID limitId;
