...
/**
 * Aggregate handler for ENTSOEOperationalLimitType as outlined for the CQRS pattern, all write
 * responsibilities related to ENTSOEOperationalLimitType are handled here.
 *
...
public class ENTSOEOperationalLimitTypeAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public ENTSOEOperationalLimitTypeAggregate(CreateENTSOEOperationalLimitTypeCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateENTSOEOperationalLimitTypeCommand");
    CreateENTSOEOperationalLimitTypeEvent event =
        new CreateENTSOEOperationalLimitTypeEvent(
            command.getENTSOEOperationalLimitTypeId(), command.getLimitType());
  ...
  public void handle(UpdateENTSOEOperationalLimitTypeCommand command) throws Exception {
    ...
    UpdateENTSOEOperationalLimitTypeEvent event =
        new UpdateENTSOEOperationalLimitTypeEvent(
            command.getENTSOEOperationalLimitTypeId(), command.getLimitType());
  ...
  @AggregateIdentifier private UUID eNTSOEOperationalLimitTypeId;

  private LimitTypeKind limitType;

  private static final Logger LOGGER =
      Logger.getLogger(ENTSOEOperationalLimitTypeAggregate.class.getName());
}
