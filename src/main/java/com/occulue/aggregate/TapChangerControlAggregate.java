...
/**
 * Aggregate handler for TapChangerControl as outlined for the CQRS pattern, all write
 * responsibilities related to TapChangerControl are handled here.
 *
...
public class TapChangerControlAggregate {
  ...
  public TapChangerControlAggregate(CreateTapChangerControlCommand command) throws Exception {
    ...
    CreateTapChangerControlEvent event =
        new CreateTapChangerControlEvent(command.getTapChangerControlId());
  ...
  public void handle(UpdateTapChangerControlCommand command) throws Exception {
    ...
    UpdateTapChangerControlEvent event =
        new UpdateTapChangerControlEvent(command.getTapChangerControlId());
  ...
  @AggregateIdentifier private UUID tapChangerControlId;
