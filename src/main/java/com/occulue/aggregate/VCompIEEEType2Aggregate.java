...
public class VCompIEEEType2Aggregate {
  ...
  public void handle(UpdateVCompIEEEType2Command command) throws Exception {
    ...
    UpdateVCompIEEEType2Event event =
        new UpdateVCompIEEEType2Event(command.getVCompIEEEType2Id(), command.getTr());
  ...
  public void handle(AssignTrToVCompIEEEType2Command command) throws Exception {
    ...
    apply(
        new AssignTrToVCompIEEEType2Event(command.getVCompIEEEType2Id(), command.getAssignment()));
  }
  ...
  @AggregateIdentifier private UUID vCompIEEEType2Id;
