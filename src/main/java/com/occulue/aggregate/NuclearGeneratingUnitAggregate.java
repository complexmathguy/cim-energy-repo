...
/**
 * Aggregate handler for NuclearGeneratingUnit as outlined for the CQRS pattern, all write
 * responsibilities related to NuclearGeneratingUnit are handled here.
 *
...
public class NuclearGeneratingUnitAggregate {
  ...
  // ----------------------------------------------
  @CommandHandler
  public NuclearGeneratingUnitAggregate(CreateNuclearGeneratingUnitCommand command)
      throws Exception {
    LOGGER.info("Handling command CreateNuclearGeneratingUnitCommand");
    CreateNuclearGeneratingUnitEvent event =
        new CreateNuclearGeneratingUnitEvent(command.getNuclearGeneratingUnitId());
  ...
  public void handle(UpdateNuclearGeneratingUnitCommand command) throws Exception {
    ...
    UpdateNuclearGeneratingUnitEvent event =
        new UpdateNuclearGeneratingUnitEvent(command.getNuclearGeneratingUnitId());
  ...
  @AggregateIdentifier private UUID nuclearGeneratingUnitId;

  private static final Logger LOGGER =
      Logger.getLogger(NuclearGeneratingUnitAggregate.class.getName());
}
