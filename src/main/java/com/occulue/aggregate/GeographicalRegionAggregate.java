...
/**
 * Aggregate handler for GeographicalRegion as outlined for the CQRS pattern, all write
 * responsibilities related to GeographicalRegion are handled here.
 *
...
public class GeographicalRegionAggregate {
  ...
  public GeographicalRegionAggregate(CreateGeographicalRegionCommand command) throws Exception {
    ...
    CreateGeographicalRegionEvent event =
        new CreateGeographicalRegionEvent(command.getGeographicalRegionId());
  ...
  public void handle(UpdateGeographicalRegionCommand command) throws Exception {
    ...
    UpdateGeographicalRegionEvent event =
        new UpdateGeographicalRegionEvent(command.getGeographicalRegionId());
  ...
  @AggregateIdentifier private UUID geographicalRegionId;

  private static final Logger LOGGER =
      Logger.getLogger(GeographicalRegionAggregate.class.getName());
}
